...
parser = argparse.ArgumentParser(description="Bitstream Manifest Fragment Extractor")
...
parser.add_argument("--design", required=True, help="Name of the design to extract")
...
def main(argv):
    ...
    manifest["designs"] = {args.design: metadata}
