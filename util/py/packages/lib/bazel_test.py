...
from util.py.packages.lib.bazel import (
    build_target,
    get_rule_deps_of_kind,
...
class TestRun(unittest.TestCase):
    ...
    def test_build_target(self, mock_run):
        ...
        mock_run.assert_called_once_with(
            "./bazelisk.sh", "build", "--config=config1", "--config=config2", "my_target"
        )
    ...
    def test_get_rule_deps_of_kind(self, mock_run):
        ...
        self.assertEqual(get_rule_deps_of_kind("my_target", "my_kind"), "query result")
        mock_run.assert_called_once_with(
            "./bazelisk.sh",
            "query",
    ...
    def test_get_target_files_with_ext(self, mock_run):
        ...
        self.assertEqual(
            get_target_files_with_ext("my_target", ["my_config_1", "my_config_2"], "my_ext"),
