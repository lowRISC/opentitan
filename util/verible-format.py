...
def process_file(filename_abs, verible_exec_path, inplace=False, show_diff=False, show_cst=False):
    ...
    verible = subprocess.run(
        args, check=False, universal_newlines=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE
    )
...
def main():
    ...
    parser.add_argument(
        "-q", "--quiet", action="store_true", default=False, help="print only errors and warnings"
    )
    parser.add_argument(
        "-v", "--verbose", action="store_true", default=False, help="print extra debug messages"
    )
    parser.add_argument(
        "--show-diff", action="store_true", default=False, help="print diff (when files differ)"
    )
    parser.add_argument("--show-cst", action="store_true", default=False, help="print CST tree")
