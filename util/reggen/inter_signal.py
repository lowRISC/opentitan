...
from reggen.lib import check_keys, check_name, check_str, check_optional_str, check_int
...
class InterSignal:
    ...
    def from_raw(params: ReggenParams, what: str, raw: object) -> "InterSignal":
        rd = check_keys(
            raw, what, ["name", "struct", "type", "act"], ["desc", "package", "width", "default"]
        )
        ...
        return InterSignal(name, desc, struct, package, signal_type, act, width, default)
