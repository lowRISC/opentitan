...
class IpBlock:
    ...
    def from_raw(param_defaults: List[Tuple[str, str]],
        ...
        return IpBlock(name, regwidth, params, reg_blocks, None, interrupts,
                       no_auto_intr, alerts, no_auto_alert, scan,
                       inter_signals, bus_interfaces, clocking, xputs, wakeups,
                       rst_reqs, expose_reg_if, scan_reset, scan_en,
