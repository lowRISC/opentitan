...
class TestGenerateBuildInfoCSource(unittest.TestCase):
    def test_simple(self):
        source = build_info.generate_build_info_c_source(EXAMPLE_SHA1_DIGEST)
        expected = """
// Copyright lowRISC contributors (OpenTitan project).
// Licensed under the Apache License, Version 2.0, see LICENSE for details.
// SPDX-License-Identifier: Apache-2.0
...
"""
    ...
    def test_sha1_digest_leading_zero_byte(self):
        ...
        source = build_info.generate_build_info_c_source(digest)
        expected = """
// Copyright lowRISC contributors (OpenTitan project).
// Licensed under the Apache License, Version 2.0, see LICENSE for details.
// SPDX-License-Identifier: Apache-2.0
...
"""
    ...
    def test_sha1_digest_too_large(self):
        ...
        with self.assertRaises(AssertionError):
            build_info.generate_build_info_c_source(
...
class TestFileOperations(unittest.TestCase):
    ...
    def test_read_version_file(self):
        ...
        """
        version = build_info.read_version_file(
    ...
    def test_write_source_file(self, mock_path_open):
        ...
        """
        src_path = build_info.write_source_file(pathlib.Path("fake/out/"),
                                                "// This is a C program")
        self.assertEqual(src_path, pathlib.Path("fake/out/build_info.c"))
