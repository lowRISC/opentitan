...
def main():
    ...
    parser.add_argument(
        "--ip-name-snake", "-s", required=True, help="the short name of the IP, in snake_case."
    )
    parser.add_argument(
        "--ip-name-long", "-l", required=True, help="the documentation-friendly name of the IP."
    )
    parser.add_argument(
        "--only",
        choices=ALL_PARTS,
    ...
    if "header" in args.only:
        ...
        logging.info("DIF header successfully written to {}.".format(str(header_out_file)))
    ...
    if "checklist" in args.only:
        ...
        logging.info("DIF Checklist successfully written to {}.".format(str(checklist_out_file)))
