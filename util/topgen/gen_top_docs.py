...
def gen_pinmux_docs(top, c_helper, out_path):
    ...
    topname = top['name']
    gencmd = (f"util/topgen.py -t hw/top_{topname}/data/top_{topname}.hjson "
              f"-o hw/top_{topname}")
    ...
    summary_table = autogen_warn + tabulate(table_rows,
                                            headers="firstrow",
                                            tablefmt="pipe",
                                            colalign=colalign)
