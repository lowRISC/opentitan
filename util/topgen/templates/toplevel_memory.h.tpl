...
addr_space_suffix = "" if addr_space == "hart" else "_" + addr_space.upper()
%>\

#ifndef ${helper.header_macro_prefix}_TOP${addr_space_suffix}_MEMORY_H_
#define ${helper.header_macro_prefix}_TOP${addr_space_suffix}_MEMORY_H_
...
#endif  // ${helper.header_macro_prefix}_TOP${addr_space_suffix}_MEMORY_H_
