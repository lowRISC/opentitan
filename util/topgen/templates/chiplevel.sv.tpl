...
%>\
  ...
  ast #(
    ...
    .gd_clks_i      ( clkmgr_aon_clocks    ),
    .gd_rsts_i      ( rstmgr_aon_resets    ),
    .gd_ext_clk_i   ( sck_monitor          ),
    // tlul
    .tl_i                  ( base_ast_bus ),
    .tl_o                  ( ast_base_bus ),
    ...
    // Due to the fact that comportable ips do not support split domains,
    // the reset power domain connection below is incorrect
    // This is TODO
