...
class Resets:
    ...
    def _get_top_resets_obj(self) -> list:
    ...
    def get_top_resets(self) -> list:
        ...
        ret = []
        for reset in self._get_top_resets_obj():
            if reset.rst_type == 'top':
                ret.append(reset.name)
    ...
    def get_unused_resets(self, domains: list) -> Dict[str, str]:
        ...
        top_resets = self._get_top_resets_obj()
