...
class Resets:
    ...
    def _asdict(self) -> Dict[str, object]:
        ret = {"hier_paths": self.hier_paths, "nodes": list(self.nodes.values())}
    ...
    def get_top_resets(self) -> list:
        ...
        return [reset for reset in self.nodes.values() if reset.rst_type == "top"]
    ...
    def get_unused_resets(self, domains: list) -> Dict[str, str]:
        ...
        top_resets = [reset for reset in self.nodes.values() if reset.rst_type == "top"]
