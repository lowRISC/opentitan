...
def device(top: hjson, ips: {'name': hjson}, copyright: str, version: str) -> ET.Element:
    ...
    device = create(ET.Element('device', attrib = {
                'schemaVersion': '1.1',
                'xmlns:xs': 'http://www.w3.org/2001/XMLSchema-instance',
                'xs:noNamespaceSchemaLocation': 'CMSIS-SVD.xsd',
            }),
            ET.Comment(copyright))
...
def generate(top: hjson, ips: {'name': hjson}, copyright: str, version: str, validate=True) -> ET.Element:
...
def test():
    ...
    svd = generate(top, ips, ['copyright'], 'g1234567-test', True)
