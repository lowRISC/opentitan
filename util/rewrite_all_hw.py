...
ips = {
    ...
    "hw/top_earlgrey/ip/pinmux": {'hjson': 'hw/top_earlgrey/ip/pinmux/data/autogen/pinmux.hjson'},
}
...
for (ip_dir, params) in ips.items():
    ...
    subprocess.run(
        [project_root / "util" / "rewrite_hw.py", "-v", "-g", "--root", project_root] + options +  [ip_dir],
        check=True,
    )
