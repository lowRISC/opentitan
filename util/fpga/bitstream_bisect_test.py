...
from bitstream_bisect import BisectLog, BisectSession, CommitHash, CommitJudgment, GitControllerABC
...
class TestParseBisectLog(unittest.TestCase):
    ...
    def test_candidates_simple(self):
        ...
        bisect_log = BisectLog("# first bad commit: [c42] Commit description...")
        self.assertEqual(bisect_log.judgments, [])
...
"""
        bisect_log = BisectLog(BISECT_LOG)
        self.assertEqual(bisect_log.candidates, ["d72b7491e6fdadb2ef742370410d5488a7bbfdba"])
        self.assertEqual(
            bisect_log.judgments,
            [
