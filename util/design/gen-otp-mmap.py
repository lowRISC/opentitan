...
def main():
    ...
    parser.add_argument(
        "--seed", type=int, metavar="<seed>", help="Custom seed for RNG to compute default values."
    )

    parser.add_argument(
        "--topname", required=True, help="The topname, as in earlgrey of darjeeling."
    )
    ...
    output_path = Path("hw") / f"top_{args.topname}" / "ip_autogen" / "otp_ctrl"
    ...
    params = {"otp_mmap": otp_mmap.config, "gen_comment": TPL_GEN_COMMENT, "topname": args.topname}
