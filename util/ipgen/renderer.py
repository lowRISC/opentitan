...
class IpTemplateRendererBase:
    ...
    def replace_uniquified_prefix(self, core_name: str) -> str:
    ...
    def _tplfunc_instance_vlnv(self, template_vlnv_str: str) -> str:
        ...
        template_library_name = template_vlnv[1]
        ...
        template_library_name = f"{topname}_{template_library_name}"
        core_name = self.replace_uniquified_prefix(template_core_name)

        instance_vlnv = ['lowrisc', template_library_name, core_name]
    ...
    def _filename_without_tpl_suffix(self, filepath: Path) -> str:
        ...
        if filename.startswith(self.ip_template.name) and \
           "module_instance_name" in self.ip_config.param_values:
