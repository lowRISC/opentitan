...
- [Hardware IP Blocks](./hw/ip/README.md)
  ...
  - [Alert Handler](./hw/ip_templates/alert_handler/README.md)
    - [Design Verification](./hw/ip_templates/alert_handler/dv/README.md)
    - [Interface and Registers](./hw/top_earlgrey/ip_autogen/alert_handler/data/alert_handler.hjson)
    - [Checklist](./hw/ip_templates/alert_handler/doc/checklist.md)
  ...
  - [PLIC](./hw/ip_templates/rv_plic/README.md)
    - [Design Verification](./hw/ip_templates/rv_plic/doc/dv/README.md)
    - [Interface and Registers](./hw/top_earlgrey/ip_autogen/rv_plic/data/rv_plic.hjson)
    - [Checklist](./hw/ip_templates/rv_plic/doc/checklist.md)
