...
static const uint8_t msg0[12] = {0x74, 0x65, 0x73, 0x74, 0x20, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65};
static const uint8_t msg1[12] = {0x74, 0x65, 0x73, 0x74, 0x20, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65};

static const ecdsa_p256_verify_test_vector_t ecdsa_p256_verify_tests[2] = {
    {
        .public_key =
            { .x = {
                    0x558bb24e, 0x246288eb, 0x9e1bbff2, 0xa7094ad8,
                    0xcd926786, 0x075d07ca, 0xac2de782, 0x1f791431,
              },
              .y = {
                    0x23e49c27, 0xfaa21024, 0xf17353bd, 0x40f008a5,
                    0x2155c09e, 0x5954f0a4, 0x155f3e00, 0x874bc63c,
              },
            },
        .signature =
            { .r = {
                    0xe16b7244, 0xff400338, 0x4c80ddbe, 0xc92e02ac,
                    0xa2f17ef1, 0x3c87e555, 0xa72d41d9, 0xcab93c16,
              },
              .s = {
                    0xf8d5a302, 0xce6a7410, 0x5f175139, 0xac901acc,
                    0xd696bf9f, 0x88ca514f, 0x0f1caf41, 0xeaa34275,
              },
            },
        .msg = msg0,
        .msg_len = 12,
