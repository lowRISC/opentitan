...
`ifndef SYNTHESIS
  ...
  fpv_reg_access_e access_policy [6];
  ...
  always_ff @(negedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
      ...
      if (h2d.a_valid && d2h.a_ready) begin
        if ((normalized_addr inside {[0:232]})
            || (normalized_addr inside {[4096: (4096+1024*8)]})
           ) begin
