...
VERSIONS = {
    "v1.9.0": {
        "commit": "ccb11556044540590ca6e45056e6b65cdca2deb2",
        "sha256": "1961189b202640bbd2262a145a655817fabc9285ac8befc53552b41976bddb34",
    },
    "v1.8.0": {
...
def _stm32h7xx_repository_impl(rctx):
    ...
    rctx.symlink(Label("//third_party_libs/devices/arm/st_microelectronics/stm32h7cube:stm32h7_defs.bzl"), "stm32h7_defs.bzl")
    target_template = """
stm32h7_project(
    name = "{name}",
    config = "{config}",
