...
def _doxygen_repos():
    ...
    http_archive(
        ...
        strip_prefix = "doxygen-" + DOT_VERSION,
        urls = [
            "https://github.com/doxygen/doxygen/releases/download/Release_{}/doxygen-{}.linux.bin.tar.gz".format("_".join(VERSION), DOT_VERSION),
        ],
    )
