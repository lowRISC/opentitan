...
# buildifier: disable=bzl-visibility
load("//third_party/rust/crates:defs.bzl", _crate_repositories = "crate_repositories")
...
def crate_repositories():
    ...
    maybe(
        ...
        name = "crate_index",
        build_file = Label("//third_party/rust/crates:BUILD.bazel"),
        defs_module = Label("//third_party/rust/crates:defs.bzl"),
    )
