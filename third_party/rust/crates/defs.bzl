...
_NORMAL_DEPENDENCIES = {
    "third_party/rust": {
        _COMMON_CONDITION: {
            ...
            "erased-serde": "@crate_index__erased-serde-0.4.4//:erased_serde",
            ...
            "inventory": "@crate_index__inventory-0.3.12//:inventory",
            ...
            "proc-macro2": "@crate_index__proc-macro2-1.0.80//:proc_macro2",
            ...
            "serde": "@crate_index__serde-1.0.197//:serde",
            ...
            "syn": "@crate_index__syn-2.0.59//:syn",
...
def crate_repositories():
    ...
    maybe(
        http_archive,
        name = "crate_index__erased-serde-0.4.4",
        sha256 = "2b73807008a3c7f171cc40312f37d95ef0396e048b5848d775f54b1a4dd4a0d3",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/erased-serde/0.4.4/download"],
        strip_prefix = "erased-serde-0.4.4",
        build_file = Label("@lowrisc_opentitan//third_party/rust/crates:BUILD.erased-serde-0.4.4.bazel"),
    )
    ...
    maybe(
        ...
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/openssl/0.10.59/download"],
    ...
    maybe(
        ...
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/openssl-sys/0.9.95/download"],
    ...
    maybe(
        http_archive,
        name = "crate_index__proc-macro2-1.0.80",
        sha256 = "a56dea16b0a29e94408b9aa5e2940a4eedbd128a1ba20e8f7ae60fd3d465af0e",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/proc-macro2/1.0.80/download"],
        strip_prefix = "proc-macro2-1.0.80",
        build_file = Label("@lowrisc_opentitan//third_party/rust/crates:BUILD.proc-macro2-1.0.80.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@lowrisc_opentitan//third_party/rust/crates:BUILD.serde-1.0.197.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@lowrisc_opentitan//third_party/rust/crates:BUILD.serde_derive-1.0.197.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crate_index__syn-2.0.59",
        sha256 = "4a6531ffc7b071655e4ce2e04bd464c4830bb585a61cabb96cf808f05172615a",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/syn/2.0.59/download"],
        strip_prefix = "syn-2.0.59",
        build_file = Label("@lowrisc_opentitan//third_party/rust/crates:BUILD.syn-2.0.59.bazel"),
    )
