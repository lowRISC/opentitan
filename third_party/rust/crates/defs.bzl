...
_NORMAL_DEPENDENCIES = {
    "third_party/rust": {
        _COMMON_CONDITION: {
            "aes": Label("@crate_index__aes-0.8.3//:aes"),
            "anstyle": Label("@crate_index__anstyle-1.0.4//:anstyle"),
            "anyhow": Label("@crate_index__anyhow-1.0.75//:anyhow"),
            "arrayvec": Label("@crate_index__arrayvec-0.7.4//:arrayvec"),
            "asn1": Label("@crate_index__asn1-0.15.5//:asn1"),
            "bitflags": Label("@crate_index__bitflags-2.4.0//:bitflags"),
            "bitvec": Label("@crate_index__bitvec-1.0.1//:bitvec"),
            "byteorder": Label("@crate_index__byteorder-1.5.0//:byteorder"),
            "chrono": Label("@crate_index__chrono-0.4.31//:chrono"),
            "clap": Label("@crate_index__clap-4.4.7//:clap"),
            "clap-num": Label("@crate_index__clap-num-1.0.2//:clap_num"),
            "const-oid": Label("@crate_index__const-oid-0.9.6//:const_oid"),
            "crc": Label("@crate_index__crc-3.0.1//:crc"),
            "cryptoki": Label("@crate_index__cryptoki-0.5.0//:cryptoki"),
            "cryptoki-sys": Label("@crate_index__cryptoki-sys-0.1.6//:cryptoki_sys"),
            "der": Label("@crate_index__der-0.7.8//:der"),
            "deser-hjson": Label("@crate_index__deser-hjson-2.1.0//:deser_hjson"),
            "directories": Label("@crate_index__directories-5.0.1//:directories"),
            "ecdsa": Label("@crate_index__ecdsa-0.16.9//:ecdsa"),
            "elf": Label("@crate_index__elf-0.7.2//:elf"),
            "elliptic-curve": Label("@crate_index__elliptic-curve-0.13.8//:elliptic_curve"),
            "embedded-hal": Label("@crate_index__embedded-hal-1.0.0//:embedded_hal"),
            "env_logger": Label("@crate_index__env_logger-0.10.0//:env_logger"),
            "erased-serde": Label("@crate_index__erased-serde-0.3.31//:erased_serde"),
            "foreign-types": Label("@crate_index__foreign-types-0.3.2//:foreign_types"),
            "ftdi": Label("@crate_index__ftdi-0.1.3//:ftdi"),
            "ftdi-embedded-hal": Label("@crate_index__ftdi-embedded-hal-0.22.0//:ftdi_embedded_hal"),
            "ftdi-mpsse": Label("@crate_index__ftdi-mpsse-0.1.1//:ftdi_mpsse"),
            "heck": Label("@crate_index__heck-0.4.1//:heck"),
            "hex": Label("@crate_index__hex-0.4.3//:hex"),
            "humantime": Label("@crate_index__humantime-2.1.0//:humantime"),
            ...
            "memchr": Label("@crate_index__memchr-2.6.4//:memchr"),
            "memoffset": Label("@crate_index__memoffset-0.9.0//:memoffset"),
            "mio": Label("@crate_index__mio-0.8.8//:mio"),
            "mio-signals": Label("@crate_index__mio-signals-0.2.0//:mio_signals"),
            "num-bigint-dig": Label("@crate_index__num-bigint-dig-0.8.4//:num_bigint_dig"),
            "num-traits": Label("@crate_index__num-traits-0.2.17//:num_traits"),
            "num_enum": Label("@crate_index__num_enum-0.7.0//:num_enum"),
            "object": Label("@crate_index__object-0.32.1//:object"),
            "once_cell": Label("@crate_index__once_cell-1.18.0//:once_cell"),
            "openssl": Label("@crate_index__openssl-0.10.64//:openssl"),
            "openssl-sys": Label("@crate_index__openssl-sys-0.9.102//:openssl_sys"),
            "p256": Label("@crate_index__p256-0.13.2//:p256"),
            "p384": Label("@crate_index__p384-0.13.0//:p384"),
            "pem-rfc7468": Label("@crate_index__pem-rfc7468-0.7.0//:pem_rfc7468"),
            "pest": Label("@crate_index__pest-2.7.3//:pest"),
            "proc-macro2": Label("@crate_index__proc-macro2-1.0.69//:proc_macro2"),
            "quote": Label("@crate_index__quote-1.0.33//:quote"),
            "rand": Label("@crate_index__rand-0.8.5//:rand"),
            "rand_chacha": Label("@crate_index__rand_chacha-0.3.1//:rand_chacha"),
            "regex": Label("@crate_index__regex-1.9.4//:regex"),
            "ring": Label("@crate_index__ring-0.16.20//:ring"),
            "rsa": Label("@crate_index__rsa-0.9.2//:rsa"),
            "rsa-der": Label("@crate_index__rsa-der-0.3.0//:rsa_der"),
            "rusb": Label("@crate_index__rusb-0.9.3//:rusb"),
            "rust-crypto": Label("@crate_index__rust-crypto-0.2.36//:crypto"),
            "rustix": Label("@crate_index__rustix-0.38.10//:rustix"),
            ...
            "serialport": Label("@crate_index__serialport-4.2.2//:serialport"),
            "sha2": Label("@crate_index__sha2-0.10.7//:sha2"),
            "sha3": Label("@crate_index__sha3-0.10.8//:sha3"),
            "shellwords": Label("@crate_index__shellwords-1.1.0//:shellwords"),
            "strum": Label("@crate_index__strum-0.25.0//:strum"),
            "syn": Label("@crate_index__syn-2.0.38//:syn"),
            "tar": Label("@crate_index__tar-0.4.40//:tar"),
            "tempfile": Label("@crate_index__tempfile-3.8.0//:tempfile"),
            "thiserror": Label("@crate_index__thiserror-1.0.49//:thiserror"),
            "tiny-keccak": Label("@crate_index__tiny-keccak-2.0.2//:tiny_keccak"),
            "typetag": Label("@crate_index__typetag-0.2.13//:typetag"),
            "zerocopy": Label("@crate_index__zerocopy-0.7.11//:zerocopy"),
            "zeroize": Label("@crate_index__zeroize-1.8.1//:zeroize"),
        },
    },
}
...
_NORMAL_DEV_DEPENDENCIES = {
    "third_party/rust": {
        _COMMON_CONDITION: {
            "base64ct": Label("@crate_index__base64ct-1.6.0//:base64ct"),
        },
    },
}
...
_PROC_MACRO_DEPENDENCIES = {
    "third_party/rust": {
        _COMMON_CONDITION: {
            "paste": Label("@crate_index__paste-1.0.14//:paste"),
            "pest_derive": Label("@crate_index__pest_derive-2.7.3//:pest_derive"),
        },
    },
}
...
_PROC_MACRO_DEV_DEPENDENCIES = {
    "third_party/rust": {
        _COMMON_CONDITION: {
            "indoc": Label("@crate_index__indoc-2.0.4//:indoc"),
        },
    },
}
...
_CONDITIONS = {
    ...
    "cfg(not(all(windows, target_env = \"msvc\")))": ["@rules_rust//rust/platform:aarch64-apple-darwin", "@rules_rust//rust/platform:aarch64-apple-ios", "@rules_rust//rust/platform:aarch64-apple-ios-sim", "@rules_rust//rust/platform:aarch64-fuchsia", "@rules_rust//rust/platform:aarch64-linux-android", "@rules_rust//rust/platform:aarch64-unknown-linux-gnu", "@rules_rust//rust/platform:aarch64-unknown-nixos-gnu", "@rules_rust//rust/platform:aarch64-unknown-nto-qnx710", "@rules_rust//rust/platform:arm-unknown-linux-gnueabi", "@rules_rust//rust/platform:armv7-linux-androideabi", "@rules_rust//rust/platform:armv7-unknown-linux-gnueabi", "@rules_rust//rust/platform:i686-apple-darwin", "@rules_rust//rust/platform:i686-linux-android", "@rules_rust//rust/platform:i686-unknown-freebsd", "@rules_rust//rust/platform:i686-unknown-linux-gnu", "@rules_rust//rust/platform:powerpc-unknown-linux-gnu", "@rules_rust//rust/platform:riscv32imc-unknown-none-elf", "@rules_rust//rust/platform:riscv64gc-unknown-none-elf", "@rules_rust//rust/platform:s390x-unknown-linux-gnu", "@rules_rust//rust/platform:thumbv7em-none-eabi", "@rules_rust//rust/platform:thumbv8m.main-none-eabi", "@rules_rust//rust/platform:wasm32-unknown-unknown", "@rules_rust//rust/platform:wasm32-wasi", "@rules_rust//rust/platform:x86_64-apple-darwin", "@rules_rust//rust/platform:x86_64-apple-ios", "@rules_rust//rust/platform:x86_64-fuchsia", "@rules_rust//rust/platform:x86_64-linux-android", "@rules_rust//rust/platform:x86_64-unknown-freebsd", "@rules_rust//rust/platform:x86_64-unknown-linux-gnu", "@rules_rust//rust/platform:x86_64-unknown-nixos-gnu", "@rules_rust//rust/platform:x86_64-unknown-none"],
...
def crate_repositories():
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.CoreFoundation-sys-0.1.4.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.IOKit-sys-0.1.5.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.addr2line-0.21.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.adler-1.0.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.aes-0.8.3.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.aho-corasick-1.0.5.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.ammonia-3.3.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.anstream-0.6.4.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.anstyle-1.0.4.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.anstyle-parse-0.2.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.anstyle-query-1.0.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.anstyle-wincon-3.0.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.anyhow-1.0.75.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.arrayvec-0.7.4.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.asn1-0.15.5.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.asn1_derive-0.15.5.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.autocfg-1.1.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.backtrace-0.3.69.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.base16ct-0.2.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.base64-0.21.5.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.base64ct-1.6.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.bitflags-2.4.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.bitvec-1.0.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.block-buffer-0.10.4.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.bstr-1.6.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.bumpalo-3.14.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.cc-1.0.83.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.chrono-0.4.31.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.cipher-0.4.4.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.clap-4.4.7.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.clap-num-1.0.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.clap_builder-4.4.7.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.clap_complete-4.4.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.clap_derive-4.4.7.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.clap_lex-0.6.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.colorchoice-1.0.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.console-0.15.7.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.const-oid-0.9.6.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.core-foundation-sys-0.8.4.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.cpufeatures-0.2.9.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.crc-3.0.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.crc-catalog-2.2.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.crc32fast-1.3.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.crunchy-0.2.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.crypto-bigint-0.5.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.crypto-common-0.1.6.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.cryptoki-0.5.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.cryptoki-sys-0.1.6.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.darling-0.20.3.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.darling_core-0.20.3.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.darling_macro-0.20.3.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.der-0.7.8.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.deranged-0.3.8.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.deser-hjson-2.1.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.digest-0.10.7.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.directories-5.0.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.ecdsa-0.16.9.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.elasticlunr-rs-3.0.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.elf-0.7.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.elliptic-curve-0.13.8.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.embedded-hal-0.2.7.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.embedded-hal-1.0.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.embedded-hal-nb-1.0.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.encode_unicode-0.3.6.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.env_logger-0.10.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.erased-serde-0.3.31.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.errno-0.3.5.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.fastrand-2.0.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.ff-0.13.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.filetime-0.2.22.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.flate2-1.0.28.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.foreign-types-0.3.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.foreign-types-shared-0.1.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.form_urlencoded-1.2.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.ftdi-0.1.3.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.ftdi-embedded-hal-0.22.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.ftdi-mpsse-0.1.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.fuchsia-cprng-0.1.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.funty-2.0.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.futf-0.1.5.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.gcc-0.3.55.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.generic-array-0.14.7.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.getrandom-0.2.10.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.gimli-0.28.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.group-0.13.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.handlebars-4.3.7.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.hashbrown-0.14.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.heck-0.4.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.hermit-abi-0.3.3.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.hex-0.4.3.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.hkdf-0.12.3.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.hmac-0.12.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.html5ever-0.26.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.humantime-2.1.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.humantime-serde-1.1.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.iana-time-zone-0.1.58.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.ident_case-1.0.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.idna-0.4.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.indexmap-2.0.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.indicatif-0.17.6.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.indoc-2.0.4.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.inout-0.1.3.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.instant-0.1.12.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.inventory-0.3.12.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.is-terminal-0.4.9.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.itoa-1.0.9.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.js-sys-0.3.64.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.keccak-0.1.5.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.lazy_static-1.4.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.libc-0.2.149.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.libftdi1-sys-1.1.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.libloading-0.7.4.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.libloading-0.8.3.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.libm-0.2.8.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.libudev-0.3.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.libudev-sys-0.1.4.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.libusb1-sys-0.6.4.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.linux-raw-sys-0.4.5.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.lock_api-0.4.10.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.mac-0.1.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.mach-0.1.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.mach2-0.4.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.maplit-1.0.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.markup5ever-0.11.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.mdbook-0.4.34.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.memchr-2.6.4.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.memoffset-0.9.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.miniz_oxide-0.7.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.mio-0.8.8.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.mio-signals-0.2.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.nb-0.1.3.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.nb-1.1.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.new_debug_unreachable-1.0.4.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.nix-0.26.4.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.normpath-1.1.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.num-bigint-0.4.4.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.num-bigint-dig-0.8.4.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.num-integer-0.1.45.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.num-iter-0.1.43.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.num-traits-0.2.17.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.num_enum-0.7.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.num_enum_derive-0.7.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.number_prefix-0.4.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.object-0.32.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.once_cell-1.18.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.opener-0.6.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.openssl-0.10.64.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.openssl-macros-0.1.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.openssl-sys-0.9.102.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.p256-0.13.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.p384-0.13.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.parking_lot-0.12.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.parking_lot_core-0.9.8.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.paste-1.0.14.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.pem-rfc7468-0.7.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.percent-encoding-2.3.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.pest-2.7.3.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.pest_derive-2.7.3.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.pest_generator-2.7.3.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.pest_meta-2.7.3.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.phf-0.10.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.phf_codegen-0.10.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.phf_generator-0.10.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.phf_shared-0.10.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.pkcs1-0.7.5.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.pkcs8-0.10.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.pkg-config-0.3.27.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.portable-atomic-1.4.3.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.ppv-lite86-0.2.17.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.precomputed-hash-0.1.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.primeorder-0.13.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.proc-macro-crate-1.3.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.proc-macro2-1.0.69.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.pulldown-cmark-0.9.3.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.quote-1.0.33.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.radium-0.7.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.rand-0.3.23.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.rand-0.4.6.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.rand_core-0.3.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.rand_core-0.4.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.rdrand-0.4.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.redox_syscall-0.2.16.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.redox_syscall-0.3.5.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.redox_users-0.4.3.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.regex-1.9.4.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.regex-automata-0.3.7.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.regex-syntax-0.7.5.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.rfc6979-0.4.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.rsa-0.9.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.rsa-der-0.3.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.rusb-0.9.3.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.rust-crypto-0.2.36.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.rustc-demangle-0.1.23.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.rustc-serialize-0.3.25.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.rustix-0.38.10.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.rustversion-1.0.14.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.ruzstd-0.4.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.ryu-1.0.15.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.sec1-0.7.3.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.secrecy-0.8.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.serde-1.0.189.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.serde_bytes-0.11.12.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.serde_derive-1.0.189.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.serde_json-1.0.107.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.serde_with-3.4.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.serde_with_macros-3.4.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.serialport-4.2.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.sha2-0.10.7.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.sha3-0.10.8.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.shellwords-1.1.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.shlex-1.1.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.signature-2.1.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.simple_asn1-0.6.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.siphasher-0.3.11.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.smallvec-1.11.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.spin-0.5.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.spki-0.7.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.static_assertions-1.1.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.string_cache-0.8.7.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.string_cache_codegen-0.5.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.strsim-0.10.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.strum-0.25.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.strum_macros-0.25.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.subtle-2.5.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.syn-1.0.109.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.syn-2.0.38.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.tap-1.0.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.tar-0.4.40.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.target-lexicon-0.12.11.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.tempfile-3.8.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.tendril-0.4.3.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.termcolor-1.2.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.thiserror-1.0.49.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.thiserror-core-1.0.38.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.thiserror-core-impl-1.0.38.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.thiserror-impl-1.0.49.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.time-0.1.45.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.time-0.3.28.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.time-core-0.1.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.time-macros-0.2.14.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.tiny-keccak-2.0.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.tinyvec-1.6.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.tinyvec_macros-0.1.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.toml-0.5.11.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.toml_datetime-0.6.3.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.toml_edit-0.19.14.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.topological-sort-0.2.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.twox-hash-1.6.3.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.typenum-1.17.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.typetag-0.2.13.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.typetag-impl-0.2.13.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.ucd-trie-0.1.6.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.unicase-2.7.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.unicode-bidi-0.3.13.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.unicode-ident-1.0.12.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.unicode-normalization-0.1.22.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.unicode-width-0.1.10.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.untrusted-0.7.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.url-2.4.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.utf-8-0.7.6.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.utf8parse-0.2.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.vcpkg-0.2.15.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.version_check-0.9.4.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.void-1.0.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.wasi-0.10.0+wasi-snapshot-preview1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.wasm-bindgen-0.2.87.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.wasm-bindgen-backend-0.2.87.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.wasm-bindgen-macro-0.2.87.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.wasm-bindgen-macro-support-0.2.87.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.wasm-bindgen-shared-0.2.87.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.web-sys-0.3.64.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.winapi-util-0.1.5.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.windows-core-0.51.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.windows-sys-0.45.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.windows-targets-0.42.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.windows_aarch64_gnullvm-0.42.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.windows_aarch64_msvc-0.42.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.windows_i686_gnu-0.42.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.windows_i686_msvc-0.42.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.windows_x86_64_gnu-0.42.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.windows_x86_64_gnullvm-0.42.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.windows_x86_64_msvc-0.42.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.winnow-0.5.15.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.wyz-0.5.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.xattr-1.0.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.zerocopy-0.7.11.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.zerocopy-derive-0.7.11.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/crates:BUILD.zeroize-1.8.1.bazel"),
    )
    ...
    return [
        ...
        struct(repo = "crate_index__cryptoki-0.5.0", is_dev_dep = False),
        struct(repo = "crate_index__cryptoki-sys-0.1.6", is_dev_dep = False),
        ...
        struct(repo = "crate_index__object-0.32.1", is_dev_dep = False),
        ...
        struct(repo = "crate_index__proc-macro2-1.0.69", is_dev_dep = False),
        ...
        struct(repo = "crate_index__rusb-0.9.3", is_dev_dep = False),
        ...
        struct(repo = "crate_index__syn-2.0.38", is_dev_dep = False),
