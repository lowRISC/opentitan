...
const top_darjeeling_alert_peripheral_t
  ...
  [kTopDarjeelingAlertIdAonTimerFatalFault] = kTopDarjeelingAlertPeripheralAonTimer,
  [kTopDarjeelingAlertIdSocProxyFatalAlertIntg] = kTopDarjeelingAlertPeripheralSocProxy,
  [kTopDarjeelingAlertIdSramCtrlRetFatalError] = kTopDarjeelingAlertPeripheralSramCtrlRet,
...
const top_darjeeling_plic_peripheral_t
  ...
  [kTopDarjeelingPlicIrqIdPwrmgrWakeup] = kTopDarjeelingPlicPeripheralPwrmgr,
  [kTopDarjeelingPlicIrqIdAonTimerWkupTimerExpired] = kTopDarjeelingPlicPeripheralAonTimer,
  [kTopDarjeelingPlicIrqIdAonTimerWdogTimerBark] = kTopDarjeelingPlicPeripheralAonTimer,
