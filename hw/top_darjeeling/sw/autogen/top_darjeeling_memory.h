 ...
 */
#define TOP_DARJEELING_RAM_CTN_BASE_ADDR 0x41000000

/**
 * Memory size for ram_ctn in top darjeeling.
 */
#define TOP_DARJEELING_RAM_CTN_SIZE_BYTES 0x100000
/**
 ...
 */
#define TOP_DARJEELING_ROM0_BASE_ADDR 0x8000
 ...
 */
#define TOP_DARJEELING_ROM1_BASE_ADDR 0x20000
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DARJEELING_I2C1_BASE_ADDR 0x31030000
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DARJEELING_I2C2_BASE_ADDR 0x31040000
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DARJEELING_USBDEV_BASE_ADDR 0x32010000
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DARJEELING_SYSRST_CTRL_AON_BASE_ADDR 0x31060000
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DARJEELING_ADC_CTRL_AON_BASE_ADDR 0x31070000
 ...
 */
#define TOP_DARJEELING_DMA_SIZE_BYTES 0x100
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_DARJEELING_MBX7_CORE_BASE_ADDR 0x22000700
 ...
 */
#define TOP_DARJEELING_MBX7_CORE_SIZE_BYTES 0x80
/**
