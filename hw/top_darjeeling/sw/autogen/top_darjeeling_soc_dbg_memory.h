...
#ifndef OPENTITAN_HW_TOP_DARJEELING_SW_AUTOGEN_TOP_SOC_DBG_MEMORY_H_
#define OPENTITAN_HW_TOP_DARJEELING_SW_AUTOGEN_TOP_SOC_DBG_MEMORY_H_
...
#endif  // OPENTITAN_HW_TOP_DARJEELING_SW_AUTOGEN_TOP_SOC_DBG_MEMORY_H_
