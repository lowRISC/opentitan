...
---------------|-----------------------|----------------|---------------
`NAlerts`      | 8 (248)               | 101    | Number of alert instances. Maximum number bounded by LFSR implementation that generates ping timing.
`NLpg`         | 1                     | 19       | Number of unique low-power groups as determined by topgen.
