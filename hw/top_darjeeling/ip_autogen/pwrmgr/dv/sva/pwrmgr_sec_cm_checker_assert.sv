...
(
  ...
  `OCAH_OT_ASSERT(RomIntgChkDisTrue_A,
  ...
  // inactive.
  `OCAH_OT_ASSERT(RomIntgChkDisFalse_A,
  ...
  `OCAH_OT_ASSERT(RomBlockCheckGoodState_A,
  ...
  `OCAH_OT_ASSERT(RomAllowCheckGoodState_A,
          rom_intg_chk_done == prim_mubi_pkg::MuBi4True &&
          fast_state == pwrmgr_pkg::FastPwrStateRomCheckDone |=>
  ...
  `OCAH_OT_ASSERT(RomBlockActiveState_A,
  ...
  // or Invalid.
  `OCAH_OT_ASSERT(RomAllowActiveState_A,
          (rom_intg_chk_good == prim_mubi_pkg::MuBi4True ||
           rom_intg_chk_dis == prim_mubi_pkg::MuBi4True) &&
          fast_state == pwrmgr_pkg::FastPwrStateRomCheckGood |=>
  ...
  `OCAH_OT_ASSERT(EscClkStopEscTimeout_A,
  ...
  `OCAH_OT_ASSERT(EscTimeoutStoppedByClReset_A,
          !rst_lc_ni |-> !esc_timeout, clk_i, reset_or_disable)

  // For testpoints sec_cm_esc_rx_clk_bkgn_chk, sec_cm_esc_rx_clk_local_esc.
  // If escalation timeout is detected a reset request will be generated.
  `OCAH_OT_ASSERT(EscTimeoutTriggersReset_A, esc_timeout |=> ##[1:3] slow_esc_rst_req,
  ...
  `OCAH_OT_ASSERT(RstreqChkEsctimeout_A,
          $rose(
              slow_esc_rst_req
  ...
  `OCAH_OT_ASSERT(RstreqChkFsmterm_A,
  ...
  `OCAH_OT_ASSERT(RstreqChkGlbesc_A,
  ...
  // should be asserted.
  `OCAH_OT_ASSERT(RstreqChkMainpd_A,
