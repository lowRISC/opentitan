...
#(
  ...
  logic [11:0][PowerDomains-1:0] cnsty_chk_errs;
  logic [11:0][PowerDomains-1:0] shadow_cnsty_chk_errs;

  // consistency sparse fsm errors
  logic [11:0][PowerDomains-1:0] fsm_errs;
  logic [11:0][PowerDomains-1:0] shadow_fsm_errs;
  ...
  rstmgr_leaf_rst #(
    ...
    .scan_rst_ni,
    .scanmode_i,
    .rst_en_o(rst_en_o.por_usb[Domain0Sel]),
    .leaf_rst_o(resets_o.rst_por_usb_n[Domain0Sel]),
    .err_o(cnsty_chk_errs[2][Domain0Sel]),
    .fsm_err_o(fsm_errs[2][Domain0Sel])
  );

  if (SecCheck) begin : gen_d0_por_usb_assert
  `ASSERT_PRIM_FSM_ERROR_TRIGGER_ALERT(
    D0PorUsbFsmCheck_A,
    u_d0_por_usb.gen_rst_chk.u_rst_chk.u_state_regs,
    alert_tx_o[0])
  end
