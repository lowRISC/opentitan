...
* [Simulation results](https://reports.opentitan.org/hw/top_darjeeling/ip_autogen/rstmgr/dv/latest/report.html)
...
```console
$ dvsim $REPO_TOP/hw/top_darjeeling/ip_autogen/rstmgr/dv/rstmgr_sim_cfg.hjson -i rstmgr_smoke
```
