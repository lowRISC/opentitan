...
interface rstmgr_rst_en_track_sva_if (
  ...
  `ASSERT(D0RstPorUsbEnTracksRstPorUsbActive_A,
          $fell(resets_i.rst_por_usb_n[Domain0Sel]) |-> ##[0:DELAY]
          reset_en_i.por_usb[Domain0Sel] == prim_mubi_pkg::MuBi4True,
          clk_usb_i,
          !rst_por_ni)

  `ASSERT(D0RstPorUsbEnTracksRstPorUsbInactive_A,
          $rose(resets_i.rst_por_usb_n[Domain0Sel]) |-> ##DELAY
          !resets_i.rst_por_usb_n[Domain0Sel] ||
          reset_en_i.por_usb[Domain0Sel] == prim_mubi_pkg::MuBi4False,
          clk_usb_i,
          !rst_por_ni)
  ...
  `ASSERT(DAonRstSysIoEnTracksRstSysIoActive_A,
          $fell(resets_i.rst_sys_io_n[DomainAonSel]) |-> ##[0:DELAY]
          reset_en_i.sys_io[DomainAonSel] == prim_mubi_pkg::MuBi4True,
          clk_io_i,
          !rst_por_ni)

  `ASSERT(DAonRstSysIoEnTracksRstSysIoInactive_A,
          $rose(resets_i.rst_sys_io_n[DomainAonSel]) |-> ##DELAY
          !resets_i.rst_sys_io_n[DomainAonSel] ||
          reset_en_i.sys_io[DomainAonSel] == prim_mubi_pkg::MuBi4False,
          clk_io_i,
          !rst_por_ni)
