...
CLKMGR = opentitan_ip(
    name = "clkmgr",
    hjson = "@lowrisc_opentitan//hw/top_darjeeling/ip_autogen/clkmgr/data:clkmgr.hjson",
    ipconfig = "@lowrisc_opentitan//hw/top_darjeeling/ip_autogen/clkmgr/data:top_darjeeling_clkmgr.ipconfig.hjson",
