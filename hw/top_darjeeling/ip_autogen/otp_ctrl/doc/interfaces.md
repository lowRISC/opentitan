...
| lc_rma_sw_rd_override_en | lc_ctrl_pkg::lc_tx                 | uni     | rcv   |       1 | SW read enable override enable coming from life cycle controller. This signal enables SW read access to (read-locked) partitions in the RMA state.                                                              |
