...
| keymgr_creator_root_key  | keymgr_dpe_pkg::keymgr_dpe_creator_root_key | uni     | req   |       1 | Key output to the key manager holding CREATOR_ROOT_KEY_SHARE0 and CREATOR_ROOT_KEY_SHARE1.                                                                                                                      |
