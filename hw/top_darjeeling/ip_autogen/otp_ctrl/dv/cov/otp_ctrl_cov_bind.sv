...
module otp_ctrl_cov_bind;
  ...
  `PART_MUBI_COV(rot_creator_identity, otp_ctrl_part_pkg::RotCreatorIdentityIdx)
  ...
  `PART_MUBI_COV(soc_fuses_cp, otp_ctrl_part_pkg::SocFusesCpIdx)
  `PART_MUBI_COV(soc_fuses_ft, otp_ctrl_part_pkg::SocFusesFtIdx)
  `PART_MUBI_COV(scratch_fuses, otp_ctrl_part_pkg::ScratchFusesIdx)
  `PART_MUBI_COV(hw_cfg0, otp_ctrl_part_pkg::HwCfg0Idx)
  `PART_MUBI_COV(hw_cfg1, otp_ctrl_part_pkg::HwCfg1Idx)
  `PART_MUBI_COV(hw_cfg2, otp_ctrl_part_pkg::HwCfg2Idx)
  ...
  `DAI_MUBI_COV(rot_creator_identity, otp_ctrl_part_pkg::RotCreatorIdentityIdx)
  ...
  `DAI_MUBI_COV(soc_fuses_cp, otp_ctrl_part_pkg::SocFusesCpIdx)
  `DAI_MUBI_COV(soc_fuses_ft, otp_ctrl_part_pkg::SocFusesFtIdx)
  `DAI_MUBI_COV(scratch_fuses, otp_ctrl_part_pkg::ScratchFusesIdx)
  `DAI_MUBI_COV(hw_cfg0, otp_ctrl_part_pkg::HwCfg0Idx)
  `DAI_MUBI_COV(hw_cfg1, otp_ctrl_part_pkg::HwCfg1Idx)
  `DAI_MUBI_COV(hw_cfg2, otp_ctrl_part_pkg::HwCfg2Idx)
