...
class otp_ctrl_env_cov extends cip_base_env_cov #(.CFG_T(otp_ctrl_env_cfg));
  ...
  function void collect_err_code_cov(int part_idx, bit [TL_DW-1:0] val,
    ...
    case (part_idx)
      ...
      OtpPartitionOwnershipSlotStateErrIdx: begin
        unbuf_err_code_cg_wrap[part_idx].unbuf_err_code_cg.sample(val);
      end
      OtpPartitionRotCreatorAuthErrIdx: begin
        unbuf_err_code_cg_wrap[part_idx].unbuf_err_code_cg.sample(val);
      end
      OtpPartitionRotOwnerAuthSlot0ErrIdx: begin
        unbuf_err_code_cg_wrap[part_idx].unbuf_err_code_cg.sample(val);
      end
      OtpPartitionRotOwnerAuthSlot1ErrIdx: begin
        unbuf_err_code_cg_wrap[part_idx].unbuf_err_code_cg.sample(val);
      end
      OtpPartitionPlatIntegAuthSlot0ErrIdx: begin
        unbuf_err_code_cg_wrap[part_idx].unbuf_err_code_cg.sample(val);
      end
      OtpPartitionPlatIntegAuthSlot1ErrIdx: begin
        unbuf_err_code_cg_wrap[part_idx].unbuf_err_code_cg.sample(val);
      end
      OtpPartitionPlatOwnerAuthSlot0ErrIdx: begin
        unbuf_err_code_cg_wrap[part_idx].unbuf_err_code_cg.sample(val);
      end
      OtpPartitionPlatOwnerAuthSlot1ErrIdx: begin
        unbuf_err_code_cg_wrap[part_idx].unbuf_err_code_cg.sample(val);
      end
      OtpPartitionPlatOwnerAuthSlot2ErrIdx: begin
        unbuf_err_code_cg_wrap[part_idx].unbuf_err_code_cg.sample(val);
      end
      OtpPartitionPlatOwnerAuthSlot3ErrIdx: begin
        unbuf_err_code_cg_wrap[part_idx].unbuf_err_code_cg.sample(val);
      end
      OtpPartitionExtNvmErrIdx: begin
        unbuf_err_code_cg_wrap[part_idx].unbuf_err_code_cg.sample(val);
      end
      OtpPartitionRomPatchErrIdx: begin
        unbuf_err_code_cg_wrap[part_idx].unbuf_err_code_cg.sample(val);
      end
      ...
      OtpPartitionSecret3ErrIdx: begin
        buf_err_code_cg_wrap[part_idx - NumPartUnbuf].buf_err_code_cg.sample(val);
      end
