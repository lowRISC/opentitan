...
module otp_ctrl_core_reg_top (
  ...
  logic partition_status_error_11_qs;
  logic partition_status_error_12_qs;
  logic partition_status_error_13_qs;
  logic partition_status_error_14_qs;
  logic partition_status_error_15_qs;
  logic partition_status_error_16_qs;
  logic partition_status_error_17_qs;
  logic partition_status_error_18_qs;
  logic partition_status_error_19_qs;
  logic partition_status_error_20_qs;
  logic partition_status_error_21_qs;
  logic err_code_0_re;
  ...
  prim_subreg_ext #(
    .DW    (1)
  ) u_partition_status_error_11 (
    .re     (partition_status_re),
    .we     (1'b0),
    .wd     ('0),
    .d      (hw2reg.partition_status[11].d),
    .qre    (),
    .qe     (),
    .q      (),
    .ds     (),
    .qs     (partition_status_error_11_qs)
  );

  //   F[error_12]: 12:12
  prim_subreg_ext #(
    .DW    (1)
  ) u_partition_status_error_12 (
    .re     (partition_status_re),
    .we     (1'b0),
    .wd     ('0),
    .d      (hw2reg.partition_status[12].d),
    .qre    (),
    .qe     (),
    .q      (),
    .ds     (),
    .qs     (partition_status_error_12_qs)
  );

  //   F[error_13]: 13:13
  prim_subreg_ext #(
    .DW    (1)
  ) u_partition_status_error_13 (
    .re     (partition_status_re),
    .we     (1'b0),
    .wd     ('0),
    .d      (hw2reg.partition_status[13].d),
    .qre    (),
    .qe     (),
    .q      (),
    .ds     (),
    .qs     (partition_status_error_13_qs)
  );

  //   F[error_14]: 14:14
  prim_subreg_ext #(
    .DW    (1)
  ) u_partition_status_error_14 (
    .re     (partition_status_re),
    .we     (1'b0),
    .wd     ('0),
    .d      (hw2reg.partition_status[14].d),
    .qre    (),
    .qe     (),
    .q      (),
    .ds     (),
    .qs     (partition_status_error_14_qs)
  );

  //   F[error_15]: 15:15
  prim_subreg_ext #(
    .DW    (1)
  ) u_partition_status_error_15 (
    .re     (partition_status_re),
    .we     (1'b0),
    .wd     ('0),
    .d      (hw2reg.partition_status[15].d),
    .qre    (),
    .qe     (),
    .q      (),
    .ds     (),
    .qs     (partition_status_error_15_qs)
  );

  //   F[error_16]: 16:16
  prim_subreg_ext #(
    .DW    (1)
  ) u_partition_status_error_16 (
    .re     (partition_status_re),
    .we     (1'b0),
    .wd     ('0),
    .d      (hw2reg.partition_status[16].d),
    .qre    (),
    .qe     (),
    .q      (),
    .ds     (),
    .qs     (partition_status_error_16_qs)
  );

  //   F[error_17]: 17:17
  prim_subreg_ext #(
    .DW    (1)
  ) u_partition_status_error_17 (
    .re     (partition_status_re),
    .we     (1'b0),
    .wd     ('0),
    .d      (hw2reg.partition_status[17].d),
    .qre    (),
    .qe     (),
    .q      (),
    .ds     (),
    .qs     (partition_status_error_17_qs)
  );

  //   F[error_18]: 18:18
  prim_subreg_ext #(
    .DW    (1)
  ) u_partition_status_error_18 (
    .re     (partition_status_re),
    .we     (1'b0),
    .wd     ('0),
    .d      (hw2reg.partition_status[18].d),
    .qre    (),
    .qe     (),
    .q      (),
    .ds     (),
    .qs     (partition_status_error_18_qs)
  );

  //   F[error_19]: 19:19
  prim_subreg_ext #(
    .DW    (1)
  ) u_partition_status_error_19 (
    .re     (partition_status_re),
    .we     (1'b0),
    .wd     ('0),
    .d      (hw2reg.partition_status[19].d),
    .qre    (),
    .qe     (),
    .q      (),
    .ds     (),
    .qs     (partition_status_error_19_qs)
  );

  //   F[error_20]: 20:20
  prim_subreg_ext #(
    .DW    (1)
  ) u_partition_status_error_20 (
    .re     (partition_status_re),
    .we     (1'b0),
    .wd     ('0),
    .d      (hw2reg.partition_status[20].d),
    .qre    (),
    .qe     (),
    .q      (),
    .ds     (),
    .qs     (partition_status_error_20_qs)
  );

  //   F[error_21]: 21:21
  prim_subreg_ext #(
    .DW    (1)
  ) u_partition_status_error_21 (
    .re     (partition_status_re),
    .we     (1'b0),
    .wd     ('0),
    .d      (hw2reg.partition_status[21].d),
    .qre    (),
    .qe     (),
    .q      (),
    .ds     (),
    .qs     (partition_status_error_21_qs)
  );
  ...
  always_comb begin
    ...
    unique case (1'b1)
      ...
      addr_hit[5]: begin
        ...
        reg_rdata_next[11] = partition_status_error_11_qs;
        reg_rdata_next[12] = partition_status_error_12_qs;
        reg_rdata_next[13] = partition_status_error_13_qs;
        reg_rdata_next[14] = partition_status_error_14_qs;
        reg_rdata_next[15] = partition_status_error_15_qs;
        reg_rdata_next[16] = partition_status_error_16_qs;
        reg_rdata_next[17] = partition_status_error_17_qs;
        reg_rdata_next[18] = partition_status_error_18_qs;
        reg_rdata_next[19] = partition_status_error_19_qs;
        reg_rdata_next[20] = partition_status_error_20_qs;
        reg_rdata_next[21] = partition_status_error_21_qs;
      end
