...
package otp_ctrl_reg_pkg;
  ...
  parameter int CreatorSwCfgRngHealthTestWindowsOffset = 308;
  parameter int CreatorSwCfgRngHealthTestWindowsSize = 4;
  parameter int CreatorSwCfgRngRepcntThresholdsOffset = 312;
  parameter int CreatorSwCfgRngRepcntThresholdsSize = 4;
  parameter int CreatorSwCfgRngRepcntsThresholdsOffset = 316;
  parameter int CreatorSwCfgRngRepcntsThresholdsSize = 4;
  parameter int CreatorSwCfgRngAdaptpHiThresholdsOffset = 320;
  parameter int CreatorSwCfgRngAdaptpHiThresholdsSize = 4;
  parameter int CreatorSwCfgRngAdaptpLoThresholdsOffset = 324;
  ...
  parameter int CreatorSwCfgRngAlertThresholdOffset = 348;
  parameter int CreatorSwCfgRngAlertThresholdSize = 4;
  parameter int CreatorSwCfgRngHealthConfigDigestOffset = 352;
  parameter int CreatorSwCfgRngHealthConfigDigestSize = 4;
  parameter int CreatorSwCfgSramKeyRenewEnOffset = 356;
