...
package otp_ctrl_reg_pkg;
  ...
  parameter int OwnerSwCfgSize = 648;
  ...
  parameter int OwnerSwCfgRomAlertAccumThreshOffset = 876;
  parameter int OwnerSwCfgRomAlertAccumThreshSize = 16;
  parameter int OwnerSwCfgRomAlertTimeoutCyclesOffset = 892;
  parameter int OwnerSwCfgRomAlertTimeoutCyclesSize = 16;
  parameter int OwnerSwCfgRomAlertPhaseCyclesOffset = 908;
  parameter int OwnerSwCfgRomAlertPhaseCyclesSize = 64;
  parameter int OwnerSwCfgRomAlertDigestProdOffset = 972;
  parameter int OwnerSwCfgRomAlertDigestProdSize = 4;
  parameter int OwnerSwCfgRomAlertDigestProdEndOffset = 976;
  parameter int OwnerSwCfgRomAlertDigestProdEndSize = 4;
  parameter int OwnerSwCfgRomAlertDigestDevOffset = 980;
  parameter int OwnerSwCfgRomAlertDigestDevSize = 4;
  parameter int OwnerSwCfgRomAlertDigestRmaOffset = 984;
  parameter int OwnerSwCfgRomAlertDigestRmaSize = 4;
  parameter int OwnerSwCfgRomWatchdogBiteThresholdCyclesOffset = 988;
  parameter int OwnerSwCfgRomWatchdogBiteThresholdCyclesSize = 4;
  parameter int OwnerSwCfgRomKeymgrRomExtMeasEnOffset = 992;
  parameter int OwnerSwCfgRomKeymgrRomExtMeasEnSize = 4;
  parameter int OwnerSwCfgManufStateOffset = 996;
  parameter int OwnerSwCfgManufStateSize = 4;
  parameter int OwnerSwCfgRomRstmgrInfoEnOffset = 1000;
  parameter int OwnerSwCfgRomRstmgrInfoEnSize = 4;
  parameter int OwnerSwCfgDigestOffset = 1024;
  parameter int OwnerSwCfgDigestSize = 8;
  parameter int OwnershipSlotStateOffset = 1032;
  parameter int OwnershipSlotStateSize = 48;
  parameter int OwnershipSlotStateRotOwnerAuthOffset = 1032;
  parameter int OwnershipSlotStateRotOwnerAuthSize = 16;
  parameter int OwnershipSlotStatePlatIntegAuthOffset = 1048;
  parameter int OwnershipSlotStatePlatIntegAuthSize = 16;
  parameter int OwnershipSlotStatePlatOwnerAuthOffset = 1064;
  parameter int OwnershipSlotStatePlatOwnerAuthSize = 16;
  parameter int RotCreatorAuthOffset = 1080;
  parameter int RotCreatorAuthSize = 1424;
  parameter int RotCreatorAuthNonRawMfwCodesignKeyOffset = 1080;
  parameter int RotCreatorAuthNonRawMfwCodesignKeySize = 160;
  parameter int RotCreatorAuthOwnershipStateOffset = 1240;
  parameter int RotCreatorAuthOwnershipStateSize = 4;
  parameter int RotCreatorAuthRom2PatchSigverifyKeyOffset = 1244;
  parameter int RotCreatorAuthRom2PatchSigverifyKeySize = 160;
  parameter int RotCreatorAuthKeymanifestKeyOffset = 1404;
  parameter int RotCreatorAuthKeymanifestKeySize = 160;
  parameter int RotCreatorAuthUnlock4xferKeyOffset = 1564;
  parameter int RotCreatorAuthUnlock4xferKeySize = 160;
  parameter int RotCreatorAuthIdentityCertOffset = 1724;
  parameter int RotCreatorAuthIdentityCertSize = 768;
  parameter int RotCreatorAuthDigestOffset = 2496;
  parameter int RotCreatorAuthDigestSize = 8;
  parameter int RotOwnerAuthSlot0Offset = 2504;
  parameter int RotOwnerAuthSlot0Size = 328;
  parameter int RotOwnerAuthSlot0KeymanifestKeyOffset = 2504;
  parameter int RotOwnerAuthSlot0KeymanifestKeySize = 160;
  parameter int RotOwnerAuthSlot0Unlock4xferKeyOffset = 2664;
  parameter int RotOwnerAuthSlot0Unlock4xferKeySize = 160;
  parameter int RotOwnerAuthSlot0DigestOffset = 2824;
  ...
  parameter int PlatIntegAuthSlot0Offset = 3160;
  parameter int PlatIntegAuthSlot0Size = 328;
  parameter int PlatIntegAuthSlot0KeymanifestKeyOffset = 3160;
  parameter int PlatIntegAuthSlot0KeymanifestKeySize = 160;
  parameter int PlatIntegAuthSlot0Unlock4xferKeyOffset = 3320;
  parameter int PlatIntegAuthSlot0Unlock4xferKeySize = 160;
  parameter int PlatIntegAuthSlot0DigestOffset = 3480;
  parameter int PlatIntegAuthSlot0DigestSize = 8;
  parameter int PlatIntegAuthSlot1Offset = 3488;
  parameter int PlatIntegAuthSlot1Size = 328;
  parameter int PlatIntegAuthSlot1KeymanifestKeyOffset = 3488;
  parameter int PlatIntegAuthSlot1KeymanifestKeySize = 160;
  parameter int PlatIntegAuthSlot1Unlock4xferKeyOffset = 3648;
  parameter int PlatIntegAuthSlot1Unlock4xferKeySize = 160;
  parameter int PlatIntegAuthSlot1DigestOffset = 3808;
  parameter int PlatIntegAuthSlot1DigestSize = 8;
  parameter int PlatOwnerAuthSlot0Offset = 3816;
  parameter int PlatOwnerAuthSlot0Size = 328;
  parameter int PlatOwnerAuthSlot0KeymanifestKeyOffset = 3816;
  parameter int PlatOwnerAuthSlot0KeymanifestKeySize = 160;
  parameter int PlatOwnerAuthSlot0Unlock4xferKeyOffset = 3976;
  parameter int PlatOwnerAuthSlot0Unlock4xferKeySize = 160;
  parameter int PlatOwnerAuthSlot0DigestOffset = 4136;
  parameter int PlatOwnerAuthSlot0DigestSize = 8;
  parameter int PlatOwnerAuthSlot1Offset = 4144;
  parameter int PlatOwnerAuthSlot1Size = 328;
  parameter int PlatOwnerAuthSlot1KeymanifestKeyOffset = 4144;
  parameter int PlatOwnerAuthSlot1KeymanifestKeySize = 160;
  parameter int PlatOwnerAuthSlot1Unlock4xferKeyOffset = 4304;
  parameter int PlatOwnerAuthSlot1Unlock4xferKeySize = 160;
  parameter int PlatOwnerAuthSlot1DigestOffset = 4464;
  parameter int PlatOwnerAuthSlot1DigestSize = 8;
  parameter int PlatOwnerAuthSlot2Offset = 4472;
  parameter int PlatOwnerAuthSlot2Size = 328;
  parameter int PlatOwnerAuthSlot2KeymanifestKeyOffset = 4472;
  parameter int PlatOwnerAuthSlot2KeymanifestKeySize = 160;
  parameter int PlatOwnerAuthSlot2Unlock4xferKeyOffset = 4632;
  parameter int PlatOwnerAuthSlot2Unlock4xferKeySize = 160;
  parameter int PlatOwnerAuthSlot2DigestOffset = 4792;
  parameter int PlatOwnerAuthSlot2DigestSize = 8;
  parameter int PlatOwnerAuthSlot3Offset = 4800;
  parameter int PlatOwnerAuthSlot3Size = 328;
  parameter int PlatOwnerAuthSlot3KeymanifestKeyOffset = 4800;
  parameter int PlatOwnerAuthSlot3KeymanifestKeySize = 160;
  parameter int PlatOwnerAuthSlot3Unlock4xferKeyOffset = 4960;
  parameter int PlatOwnerAuthSlot3Unlock4xferKeySize = 160;
  parameter int PlatOwnerAuthSlot3DigestOffset = 5120;
  parameter int PlatOwnerAuthSlot3DigestSize = 8;
  parameter int ExtNvmOffset = 5128;
  parameter int ExtNvmSize = 1024;
  parameter int ExtNvmAntireplayFreshnessCntOffset = 5128;
  parameter int ExtNvmAntireplayFreshnessCntSize = 1024;
  parameter int RomPatchOffset = 6152;
  parameter int RomPatchSize = 9768;
  parameter int RomPatchDataOffset = 6152;
  ...
  parameter int EnCsrngSwAppReadOffset = 15996;
  parameter int EnCsrngSwAppReadSize = 1;
  parameter int EnSramIfetchOffset = 15997;
