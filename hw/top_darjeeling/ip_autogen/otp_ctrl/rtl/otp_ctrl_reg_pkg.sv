...
package otp_ctrl_reg_pkg;
  ...
  parameter int CreatorSwCfgAstInitEnOffset = 196;
  parameter int CreatorSwCfgAstInitEnSize = 4;
  parameter int CreatorSwCfgOverridesOffset = 200;
  parameter int CreatorSwCfgOverridesSize = 32;
  parameter int CreatorSwCfgRomExtSkuOffset = 232;
  parameter int CreatorSwCfgRomExtSkuSize = 4;
  parameter int CreatorSwCfgSigverifyRsaModExpIbexEnOffset = 236;
  parameter int CreatorSwCfgSigverifyRsaModExpIbexEnSize = 4;
  parameter int CreatorSwCfgSigverifyRsaKeyEnOffset = 240;
  parameter int CreatorSwCfgSigverifyRsaKeyEnSize = 8;
  parameter int CreatorSwCfgSigverifySpxEnOffset = 248;
  parameter int CreatorSwCfgSigverifySpxEnSize = 4;
  parameter int CreatorSwCfgSigverifySpxKeyEnOffset = 252;
  parameter int CreatorSwCfgSigverifySpxKeyEnSize = 8;
  parameter int CreatorSwCfgFlashDataDefaultCfgOffset = 260;
  parameter int CreatorSwCfgFlashDataDefaultCfgSize = 4;
  parameter int CreatorSwCfgFlashInfoBootDataCfgOffset = 264;
  parameter int CreatorSwCfgFlashInfoBootDataCfgSize = 4;
  parameter int CreatorSwCfgFlashHwInfoCfgOverrideOffset = 268;
  parameter int CreatorSwCfgFlashHwInfoCfgOverrideSize = 4;
  parameter int CreatorSwCfgRngEnOffset = 272;
  parameter int CreatorSwCfgRngEnSize = 4;
  parameter int CreatorSwCfgJitterEnOffset = 276;
  parameter int CreatorSwCfgJitterEnSize = 4;
  parameter int CreatorSwCfgRetRamResetMaskOffset = 280;
  parameter int CreatorSwCfgRetRamResetMaskSize = 4;
  parameter int CreatorSwCfgManufStateOffset = 284;
  parameter int CreatorSwCfgManufStateSize = 4;
  parameter int CreatorSwCfgRomExecEnOffset = 288;
  parameter int CreatorSwCfgRomExecEnSize = 4;
  parameter int CreatorSwCfgCpuctrlOffset = 292;
  parameter int CreatorSwCfgCpuctrlSize = 4;
  parameter int CreatorSwCfgMinSecVerRomExtOffset = 296;
  parameter int CreatorSwCfgMinSecVerRomExtSize = 4;
  parameter int CreatorSwCfgMinSecVerBl0Offset = 300;
  parameter int CreatorSwCfgMinSecVerBl0Size = 4;
  parameter int CreatorSwCfgDefaultBootDataInProdEnOffset = 304;
  parameter int CreatorSwCfgDefaultBootDataInProdEnSize = 4;
  parameter int CreatorSwCfgRmaSpinEnOffset = 308;
  parameter int CreatorSwCfgRmaSpinEnSize = 4;
  parameter int CreatorSwCfgRmaSpinCyclesOffset = 312;
  parameter int CreatorSwCfgRmaSpinCyclesSize = 4;
  parameter int CreatorSwCfgRngRepcntThresholdsOffset = 316;
  parameter int CreatorSwCfgRngRepcntThresholdsSize = 4;
  parameter int CreatorSwCfgRngRepcntsThresholdsOffset = 320;
  parameter int CreatorSwCfgRngRepcntsThresholdsSize = 4;
  parameter int CreatorSwCfgRngAdaptpHiThresholdsOffset = 324;
  parameter int CreatorSwCfgRngAdaptpHiThresholdsSize = 4;
  parameter int CreatorSwCfgRngAdaptpLoThresholdsOffset = 328;
  parameter int CreatorSwCfgRngAdaptpLoThresholdsSize = 4;
  parameter int CreatorSwCfgRngBucketThresholdsOffset = 332;
  parameter int CreatorSwCfgRngBucketThresholdsSize = 4;
  parameter int CreatorSwCfgRngMarkovHiThresholdsOffset = 336;
  parameter int CreatorSwCfgRngMarkovHiThresholdsSize = 4;
  parameter int CreatorSwCfgRngMarkovLoThresholdsOffset = 340;
  parameter int CreatorSwCfgRngMarkovLoThresholdsSize = 4;
  parameter int CreatorSwCfgRngExthtHiThresholdsOffset = 344;
  parameter int CreatorSwCfgRngExthtHiThresholdsSize = 4;
  parameter int CreatorSwCfgRngExthtLoThresholdsOffset = 348;
  parameter int CreatorSwCfgRngExthtLoThresholdsSize = 4;
  parameter int CreatorSwCfgRngAlertThresholdOffset = 352;
  parameter int CreatorSwCfgRngAlertThresholdSize = 4;
  parameter int CreatorSwCfgRngHealthConfigDigestOffset = 356;
  parameter int CreatorSwCfgRngHealthConfigDigestSize = 4;
  parameter int CreatorSwCfgSramKeyRenewEnOffset = 360;
  ...
  parameter int CreatorSwCfgZerOffset = 376;
  ...
  parameter int OwnerSwCfgDigestOffset = 992;
  parameter int OwnerSwCfgDigestSize = 8;
  parameter int OwnerSwCfgZerOffset = 1000;
  parameter int OwnerSwCfgZerSize = 8;
  parameter int OwnershipSlotStateOffset = 1008;
  parameter int OwnershipSlotStateSize = 56;
  parameter int OwnershipSlotStateRotOwnerAuthOffset = 1008;
  parameter int OwnershipSlotStateRotOwnerAuthSize = 16;
  parameter int OwnershipSlotStatePlatIntegAuthOffset = 1024;
  parameter int OwnershipSlotStatePlatIntegAuthSize = 16;
  parameter int OwnershipSlotStatePlatOwnerAuthOffset = 1040;
  parameter int OwnershipSlotStatePlatOwnerAuthSize = 16;
  parameter int OwnershipSlotStateZerOffset = 1056;
  parameter int OwnershipSlotStateZerSize = 8;
  parameter int RotCreatorAuthOffset = 1064;
  parameter int RotCreatorAuthSize = 1432;
  ...
  parameter int RotCreatorAuthZerOffset = 2488;
  parameter int RotCreatorAuthZerSize = 8;
  parameter int RotOwnerAuthSlot0Offset = 2496;
  parameter int RotOwnerAuthSlot0Size = 336;
  parameter int RotOwnerAuthSlot0KeymanifestKeyOffset = 2496;
  parameter int RotOwnerAuthSlot0KeymanifestKeySize = 160;
  parameter int RotOwnerAuthSlot0Unlock4xferKeyOffset = 2656;
  parameter int RotOwnerAuthSlot0Unlock4xferKeySize = 160;
  parameter int RotOwnerAuthSlot0DigestOffset = 2816;
  parameter int RotOwnerAuthSlot0DigestSize = 8;
  parameter int RotOwnerAuthSlot0ZerOffset = 2824;
  parameter int RotOwnerAuthSlot0ZerSize = 8;
  parameter int RotOwnerAuthSlot1Offset = 2832;
  parameter int RotOwnerAuthSlot1Size = 336;
  parameter int RotOwnerAuthSlot1KeymanifestKeyOffset = 2832;
  parameter int RotOwnerAuthSlot1KeymanifestKeySize = 160;
  parameter int RotOwnerAuthSlot1Unlock4xferKeyOffset = 2992;
  parameter int RotOwnerAuthSlot1Unlock4xferKeySize = 160;
  parameter int RotOwnerAuthSlot1DigestOffset = 3152;
  parameter int RotOwnerAuthSlot1DigestSize = 8;
  parameter int RotOwnerAuthSlot1ZerOffset = 3160;
  parameter int RotOwnerAuthSlot1ZerSize = 8;
  parameter int PlatIntegAuthSlot0Offset = 3168;
  parameter int PlatIntegAuthSlot0Size = 336;
  parameter int PlatIntegAuthSlot0KeymanifestKeyOffset = 3168;
  parameter int PlatIntegAuthSlot0KeymanifestKeySize = 160;
  parameter int PlatIntegAuthSlot0Unlock4xferKeyOffset = 3328;
  parameter int PlatIntegAuthSlot0Unlock4xferKeySize = 160;
  parameter int PlatIntegAuthSlot0DigestOffset = 3488;
  parameter int PlatIntegAuthSlot0DigestSize = 8;
  parameter int PlatIntegAuthSlot0ZerOffset = 3496;
  parameter int PlatIntegAuthSlot0ZerSize = 8;
  parameter int PlatIntegAuthSlot1Offset = 3504;
  parameter int PlatIntegAuthSlot1Size = 336;
  parameter int PlatIntegAuthSlot1KeymanifestKeyOffset = 3504;
  parameter int PlatIntegAuthSlot1KeymanifestKeySize = 160;
  parameter int PlatIntegAuthSlot1Unlock4xferKeyOffset = 3664;
  parameter int PlatIntegAuthSlot1Unlock4xferKeySize = 160;
  parameter int PlatIntegAuthSlot1DigestOffset = 3824;
  parameter int PlatIntegAuthSlot1DigestSize = 8;
  parameter int PlatIntegAuthSlot1ZerOffset = 3832;
  parameter int PlatIntegAuthSlot1ZerSize = 8;
  parameter int PlatOwnerAuthSlot0Offset = 3840;
  parameter int PlatOwnerAuthSlot0Size = 336;
  parameter int PlatOwnerAuthSlot0KeymanifestKeyOffset = 3840;
  parameter int PlatOwnerAuthSlot0KeymanifestKeySize = 160;
  parameter int PlatOwnerAuthSlot0Unlock4xferKeyOffset = 4000;
  parameter int PlatOwnerAuthSlot0Unlock4xferKeySize = 160;
  parameter int PlatOwnerAuthSlot0DigestOffset = 4160;
  parameter int PlatOwnerAuthSlot0DigestSize = 8;
  parameter int PlatOwnerAuthSlot0ZerOffset = 4168;
  parameter int PlatOwnerAuthSlot0ZerSize = 8;
  parameter int PlatOwnerAuthSlot1Offset = 4176;
  parameter int PlatOwnerAuthSlot1Size = 336;
  parameter int PlatOwnerAuthSlot1KeymanifestKeyOffset = 4176;
  parameter int PlatOwnerAuthSlot1KeymanifestKeySize = 160;
  parameter int PlatOwnerAuthSlot1Unlock4xferKeyOffset = 4336;
  parameter int PlatOwnerAuthSlot1Unlock4xferKeySize = 160;
  parameter int PlatOwnerAuthSlot1DigestOffset = 4496;
  parameter int PlatOwnerAuthSlot1DigestSize = 8;
  parameter int PlatOwnerAuthSlot1ZerOffset = 4504;
  parameter int PlatOwnerAuthSlot1ZerSize = 8;
  parameter int PlatOwnerAuthSlot2Offset = 4512;
  parameter int PlatOwnerAuthSlot2Size = 336;
  parameter int PlatOwnerAuthSlot2KeymanifestKeyOffset = 4512;
  parameter int PlatOwnerAuthSlot2KeymanifestKeySize = 160;
  parameter int PlatOwnerAuthSlot2Unlock4xferKeyOffset = 4672;
  parameter int PlatOwnerAuthSlot2Unlock4xferKeySize = 160;
  parameter int PlatOwnerAuthSlot2DigestOffset = 4832;
  parameter int PlatOwnerAuthSlot2DigestSize = 8;
  parameter int PlatOwnerAuthSlot2ZerOffset = 4840;
  parameter int PlatOwnerAuthSlot2ZerSize = 8;
  parameter int PlatOwnerAuthSlot3Offset = 4848;
  parameter int PlatOwnerAuthSlot3Size = 336;
  parameter int PlatOwnerAuthSlot3KeymanifestKeyOffset = 4848;
  parameter int PlatOwnerAuthSlot3KeymanifestKeySize = 160;
  parameter int PlatOwnerAuthSlot3Unlock4xferKeyOffset = 5008;
  parameter int PlatOwnerAuthSlot3Unlock4xferKeySize = 160;
  parameter int PlatOwnerAuthSlot3DigestOffset = 5168;
  parameter int PlatOwnerAuthSlot3DigestSize = 8;
  parameter int PlatOwnerAuthSlot3ZerOffset = 5176;
  parameter int PlatOwnerAuthSlot3ZerSize = 8;
  parameter int ExtNvmOffset = 5184;
  parameter int ExtNvmSize = 1032;
  parameter int ExtNvmAntireplayFreshnessCntOffset = 5184;
  parameter int ExtNvmAntireplayFreshnessCntSize = 1024;
  parameter int ExtNvmZerOffset = 6208;
  parameter int ExtNvmZerSize = 8;
  parameter int RomPatchOffset = 6216;
  parameter int RomPatchSize = 9720;
  parameter int RomPatchDataOffset = 6216;
  parameter int RomPatchDataSize = 9192;
  parameter int RomPatchDigestOffset = 15920;
  parameter int RomPatchDigestSize = 8;
  parameter int RomPatchZerOffset = 15928;
  parameter int RomPatchZerSize = 8;
  parameter int HwCfg0Offset = 15936;
  parameter int HwCfg0Size = 80;
  parameter int DeviceIdOffset = 15936;
  parameter int DeviceIdSize = 32;
  parameter int ManufStateOffset = 15968;
  parameter int ManufStateSize = 32;
  parameter int HwCfg0DigestOffset = 16000;
  parameter int HwCfg0DigestSize = 8;
  parameter int HwCfg0ZerOffset = 16008;
  parameter int HwCfg0ZerSize = 8;
  parameter int HwCfg1Offset = 16016;
  parameter int HwCfg1Size = 24;
  parameter int SocDbgStateOffset = 16016;
  parameter int SocDbgStateSize = 4;
  parameter int EnCsrngSwAppReadOffset = 16020;
  parameter int EnCsrngSwAppReadSize = 1;
  parameter int EnSramIfetchOffset = 16021;
  parameter int EnSramIfetchSize = 1;
  parameter int HwCfg1DigestOffset = 16024;
  parameter int HwCfg1DigestSize = 8;
  parameter int HwCfg1ZerOffset = 16032;
