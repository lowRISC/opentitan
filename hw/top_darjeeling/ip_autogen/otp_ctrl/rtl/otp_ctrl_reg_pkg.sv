...
package otp_ctrl_reg_pkg;
  ...
  parameter int OwnerSwCfgSize = 616;
  ...
  parameter int OwnerSwCfgRomLocalAlertClassificationOffset = 784;
  parameter int OwnerSwCfgRomLocalAlertClassificationSize = 64;
  parameter int OwnerSwCfgRomAlertAccumThreshOffset = 848;
  parameter int OwnerSwCfgRomAlertAccumThreshSize = 16;
  parameter int OwnerSwCfgRomAlertTimeoutCyclesOffset = 864;
  parameter int OwnerSwCfgRomAlertTimeoutCyclesSize = 16;
  parameter int OwnerSwCfgRomAlertPhaseCyclesOffset = 880;
  parameter int OwnerSwCfgRomAlertPhaseCyclesSize = 64;
  parameter int OwnerSwCfgRomAlertDigestProdOffset = 944;
  parameter int OwnerSwCfgRomAlertDigestProdSize = 4;
  parameter int OwnerSwCfgRomAlertDigestProdEndOffset = 948;
  parameter int OwnerSwCfgRomAlertDigestProdEndSize = 4;
  parameter int OwnerSwCfgRomAlertDigestDevOffset = 952;
  parameter int OwnerSwCfgRomAlertDigestDevSize = 4;
  parameter int OwnerSwCfgRomAlertDigestRmaOffset = 956;
  parameter int OwnerSwCfgRomAlertDigestRmaSize = 4;
  parameter int OwnerSwCfgRomWatchdogBiteThresholdCyclesOffset = 960;
  parameter int OwnerSwCfgRomWatchdogBiteThresholdCyclesSize = 4;
  parameter int OwnerSwCfgRomKeymgrRomExtMeasEnOffset = 964;
  parameter int OwnerSwCfgRomKeymgrRomExtMeasEnSize = 4;
  parameter int OwnerSwCfgManufStateOffset = 968;
  parameter int OwnerSwCfgManufStateSize = 4;
  parameter int OwnerSwCfgRomRstmgrInfoEnOffset = 972;
  ...
  parameter int OwnershipSlotStateRotOwnerAuthOffset = 984;
  parameter int OwnershipSlotStateRotOwnerAuthSize = 16;
  parameter int OwnershipSlotStatePlatIntegAuthOffset = 1000;
  parameter int OwnershipSlotStatePlatIntegAuthSize = 16;
  parameter int OwnershipSlotStatePlatOwnerAuthOffset = 1016;
  parameter int OwnershipSlotStatePlatOwnerAuthSize = 16;
  parameter int RotCreatorAuthOffset = 1032;
  parameter int RotCreatorAuthSize = 1424;
  parameter int RotCreatorAuthNonRawMfwCodesignKeyOffset = 1032;
  parameter int RotCreatorAuthNonRawMfwCodesignKeySize = 160;
  parameter int RotCreatorAuthOwnershipStateOffset = 1192;
  parameter int RotCreatorAuthOwnershipStateSize = 4;
  parameter int RotCreatorAuthRom2PatchSigverifyKeyOffset = 1196;
  parameter int RotCreatorAuthRom2PatchSigverifyKeySize = 160;
  parameter int RotCreatorAuthKeymanifestKeyOffset = 1356;
  parameter int RotCreatorAuthKeymanifestKeySize = 160;
  parameter int RotCreatorAuthUnlock4xferKeyOffset = 1516;
  parameter int RotCreatorAuthUnlock4xferKeySize = 160;
  parameter int RotCreatorAuthIdentityCertOffset = 1676;
  parameter int RotCreatorAuthIdentityCertSize = 768;
  parameter int RotCreatorAuthDigestOffset = 2448;
  parameter int RotCreatorAuthDigestSize = 8;
  parameter int RotOwnerAuthSlot0Offset = 2456;
  parameter int RotOwnerAuthSlot0Size = 328;
  parameter int RotOwnerAuthSlot0KeymanifestKeyOffset = 2456;
  parameter int RotOwnerAuthSlot0KeymanifestKeySize = 160;
  parameter int RotOwnerAuthSlot0Unlock4xferKeyOffset = 2616;
  parameter int RotOwnerAuthSlot0Unlock4xferKeySize = 160;
  parameter int RotOwnerAuthSlot0DigestOffset = 2776;
  parameter int RotOwnerAuthSlot0DigestSize = 8;
  parameter int RotOwnerAuthSlot1Offset = 2784;
  parameter int RotOwnerAuthSlot1Size = 328;
  parameter int RotOwnerAuthSlot1KeymanifestKeyOffset = 2784;
  parameter int RotOwnerAuthSlot1KeymanifestKeySize = 160;
  parameter int RotOwnerAuthSlot1Unlock4xferKeyOffset = 2944;
  parameter int RotOwnerAuthSlot1Unlock4xferKeySize = 160;
  parameter int RotOwnerAuthSlot1DigestOffset = 3104;
  parameter int RotOwnerAuthSlot1DigestSize = 8;
  parameter int PlatIntegAuthSlot0Offset = 3112;
  parameter int PlatIntegAuthSlot0Size = 328;
  parameter int PlatIntegAuthSlot0KeymanifestKeyOffset = 3112;
  parameter int PlatIntegAuthSlot0KeymanifestKeySize = 160;
  parameter int PlatIntegAuthSlot0Unlock4xferKeyOffset = 3272;
  parameter int PlatIntegAuthSlot0Unlock4xferKeySize = 160;
  parameter int PlatIntegAuthSlot0DigestOffset = 3432;
  parameter int PlatIntegAuthSlot0DigestSize = 8;
  parameter int PlatIntegAuthSlot1Offset = 3440;
  parameter int PlatIntegAuthSlot1Size = 328;
  parameter int PlatIntegAuthSlot1KeymanifestKeyOffset = 3440;
  parameter int PlatIntegAuthSlot1KeymanifestKeySize = 160;
  parameter int PlatIntegAuthSlot1Unlock4xferKeyOffset = 3600;
  parameter int PlatIntegAuthSlot1Unlock4xferKeySize = 160;
  parameter int PlatIntegAuthSlot1DigestOffset = 3760;
  parameter int PlatIntegAuthSlot1DigestSize = 8;
  parameter int PlatOwnerAuthSlot0Offset = 3768;
  parameter int PlatOwnerAuthSlot0Size = 328;
  parameter int PlatOwnerAuthSlot0KeymanifestKeyOffset = 3768;
  parameter int PlatOwnerAuthSlot0KeymanifestKeySize = 160;
  parameter int PlatOwnerAuthSlot0Unlock4xferKeyOffset = 3928;
  parameter int PlatOwnerAuthSlot0Unlock4xferKeySize = 160;
  parameter int PlatOwnerAuthSlot0DigestOffset = 4088;
  parameter int PlatOwnerAuthSlot0DigestSize = 8;
  parameter int PlatOwnerAuthSlot1Offset = 4096;
  parameter int PlatOwnerAuthSlot1Size = 328;
  parameter int PlatOwnerAuthSlot1KeymanifestKeyOffset = 4096;
  parameter int PlatOwnerAuthSlot1KeymanifestKeySize = 160;
  parameter int PlatOwnerAuthSlot1Unlock4xferKeyOffset = 4256;
  parameter int PlatOwnerAuthSlot1Unlock4xferKeySize = 160;
  parameter int PlatOwnerAuthSlot1DigestOffset = 4416;
  parameter int PlatOwnerAuthSlot1DigestSize = 8;
  parameter int PlatOwnerAuthSlot2Offset = 4424;
  parameter int PlatOwnerAuthSlot2Size = 328;
  parameter int PlatOwnerAuthSlot2KeymanifestKeyOffset = 4424;
  parameter int PlatOwnerAuthSlot2KeymanifestKeySize = 160;
  parameter int PlatOwnerAuthSlot2Unlock4xferKeyOffset = 4584;
  parameter int PlatOwnerAuthSlot2Unlock4xferKeySize = 160;
  parameter int PlatOwnerAuthSlot2DigestOffset = 4744;
  parameter int PlatOwnerAuthSlot2DigestSize = 8;
  parameter int PlatOwnerAuthSlot3Offset = 4752;
  parameter int PlatOwnerAuthSlot3Size = 328;
  parameter int PlatOwnerAuthSlot3KeymanifestKeyOffset = 4752;
  parameter int PlatOwnerAuthSlot3KeymanifestKeySize = 160;
  parameter int PlatOwnerAuthSlot3Unlock4xferKeyOffset = 4912;
  parameter int PlatOwnerAuthSlot3Unlock4xferKeySize = 160;
  parameter int PlatOwnerAuthSlot3DigestOffset = 5072;
  parameter int PlatOwnerAuthSlot3DigestSize = 8;
  parameter int ExtNvmOffset = 5080;
  parameter int ExtNvmSize = 1024;
  parameter int ExtNvmAntireplayFreshnessCntOffset = 5080;
  parameter int ExtNvmAntireplayFreshnessCntSize = 1024;
  parameter int RomPatchOffset = 6104;
  parameter int RomPatchSize = 9880;
  parameter int RomPatchDataOffset = 6104;
  ...
  parameter logic [2:0] OTP_CTRL_ERR_CODE_0_DATA_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_1_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_1_DATA_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_2_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_2_DATA_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_3_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_3_DATA_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_4_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_4_DATA_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_5_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_5_DATA_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_6_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_6_DATA_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_7_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_7_DATA_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_8_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_8_DATA_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_9_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_9_DATA_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_10_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_10_DATA_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_11_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_11_DATA_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_12_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_12_DATA_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_13_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_13_DATA_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_14_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_14_DATA_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_15_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_15_DATA_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_16_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_16_DATA_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_17_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_17_DATA_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_18_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_18_DATA_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_19_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_19_DATA_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_20_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_20_DATA_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_21_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_21_DATA_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_22_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_22_DATA_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_23_RESVAL = 3'h 0;
  parameter logic [2:0] OTP_CTRL_ERR_CODE_23_DATA_RESVAL = 3'h 0;
