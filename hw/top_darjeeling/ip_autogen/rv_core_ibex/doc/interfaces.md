...
<!-- BEGIN CMDGEN util/regtool.py --interfaces ./hw/top_darjeeling/ip_autogen/rv_core_ibex/data/rv_core_ibex.hjson -->
...
`ram_cfg_icache_tag_i`  | `input`   | `prim_ram_1p_pkg::ram_1p_cfg_req_t [ICacheNWays-1:0]` | Incoming icache tag RAM configuration that is technology dependent.
`ram_cfg_icache_tag_o`  | `output`  | `prim_ram_1p_pkg::ram_1p_cfg_rsp_t [ICacheNWays-1:0]` | Outgoing icache tag RAM configuration response.
`ram_cfg_icache_data_i` | `input`   | `prim_ram_1p_pkg::ram_1p_cfg_req_t [ICacheNWays-1:0]` | Incoming icache data RAM configuration that is technology dependent.
`ram_cfg_icache_data_o` | `output`  | `prim_ram_1p_pkg::ram_1p_cfg_rsp_t [ICacheNWays-1:0]` | Outgoing icache data RAM configuration response.
