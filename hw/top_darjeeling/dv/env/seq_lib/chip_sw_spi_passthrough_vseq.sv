...
class chip_sw_spi_passthrough_vseq extends chip_sw_base_vseq;
  ...
  virtual task body();
    ...
    $assertoff(0, "tb.dut.top_darjeeling.darjeeling_pd_main.u_spi_device.u_readcmd.u_readsram.u_sram_fifo.DataKnown_A");
    $assertoff(0, "tb.dut.top_darjeeling.darjeeling_pd_main.u_spi_device.u_readcmd.u_readsram.u_fifo.DataKnown_A");
