...
class chip_sw_rv_core_ibex_lockstep_glitch_vseq extends chip_sw_base_vseq;
  ...
  task automatic inject_glitches();
    ...
    if (glitched_port_is_inp) begin
      if (glitch_lockstep_core) begin
        ...
        $assertoff(0, "tb.dut.top_darjeeling.darjeeling_pd_main.u_rv_core_ibex.u_core.gen_lockstep.u_ibex_lockstep");
      end else begin
        $assertoff(0, "tb.dut.top_darjeeling.darjeeling_pd_main.u_rv_core_ibex.u_core.u_ibex_core");
      end
    end
    ...
    if (!glitch_lockstep_core) begin
      case (port_name)
        ...
        "ic_data_rdata_i": begin
          $assertoff(0,
              "tb.dut.top_darjeeling.darjeeling_pd_main.u_xbar_main.tlul_assert_host_rv_core_ibex__corei.gen_device");
          $assertoff(0,
              "tb.dut.top_darjeeling.darjeeling_pd_main.u_xbar_main.tlul_assert_device_rom_ctrl0__rom.gen_host");
          $assertoff(0,
              "tb.dut.top_darjeeling.darjeeling_pd_main.u_xbar_main.tlul_assert_device_rom_ctrl1__rom.gen_host");
          $assertoff(0,
              "tb.dut.top_darjeeling.darjeeling_pd_main.u_xbar_main.tlul_assert_device_rv_dm__mem.gen_host");
          $assertoff(0,
              "tb.dut.top_darjeeling.darjeeling_pd_main.u_xbar_main.tlul_assert_device_sram_ctrl_main__ram.gen_host");
        end
        "data_req_o",
        "data_we_o",
        "data_be_o",
        ...
        "data_wdata_o": begin
          $assertoff(0,
              "tb.dut.top_darjeeling.darjeeling_pd_main.u_xbar_main.tlul_assert_host_rv_core_ibex__cored.gen_device");
        end
        ...
        "crash_dump_o": begin
          $assertoff(0, "tb.dut.top_darjeeling.darjeeling_pd_main.u_rv_core_ibex.u_core");
        end
        default: ;
      endcase
    end
  ...
  virtual task body();
    ...
    ibex_top_path = "tb.dut.top_darjeeling.darjeeling_pd_main.u_rv_core_ibex.u_core";
