...
`ifndef GATE_LEVEL
    ...
    $asserton(1, top_darjeeling.darjeeling_pd_aon.u_pwrmgr.u_slow_fsm.IntRstReq_A);
`endif
  endtask
...
`ifndef GATE_LEVEL
    ...
    if (!value) begin
      ...
      $assertoff(1, top_darjeeling.darjeeling_pd_aon.u_pwrmgr.u_slow_fsm.IntRstReq_A);
    end
