...
`endif
`define PD_MAIN_HIER          `DUT_HIER.top_darjeeling.darjeeling_pd_main
`define PD_AON_HIER           `DUT_HIER.top_darjeeling.darjeeling_pd_aon
...
`define RAM_MBOX_HIER         `PD_MAIN_HIER.u_sram_ctrl_mbox.u_prim_ram_1p_scr
