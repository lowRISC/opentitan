...
assign alert_if[58].alert_tx = `CHIP_HIER.u_sram_ctrl_mbox.alert_tx_o[0];
assign alert_if[59].alert_tx = `CHIP_HIER.u_rom_ctrl0.alert_tx_o[0];
assign alert_if[60].alert_tx = `CHIP_HIER.u_rom_ctrl1.alert_tx_o[0];
