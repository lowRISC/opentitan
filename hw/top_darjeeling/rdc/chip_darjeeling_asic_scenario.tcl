...
set_reset_scenario { \
  ...
  { top_darjeeling.u_pinmux_aon.dio_pad_attr_q[12].invert \
    { constraint { @t0 0 } } } \
  { top_darjeeling.u_spi_device.cio_sck_i { constraint { @t0 0 } } } \
...
set_reset_scenario { \
  ...
  { top_darjeeling.clkmgr_aon_clocks.clk_main_kmac       { constraint { @t0 0 } } } \
  ...
  { top_darjeeling.clkmgr_aon_clocks.clk_main_secure     { constraint { @t0 0 } } } \
  { top_darjeeling.clkmgr_aon_clocks.clk_io_div4_timers  { constraint { @t0 0 } } } \
...
# RSTMGR SW Resets
#set_reset_scenario { {{top_darjeeling.u_rstmgr_aon.u_ndm_sync.u_sync_2.gen_generic.u_impl_generic.q_o[0]} {reset  { @t0 1 } { #10 0}} }} -name Scenario8 -comment "functional reset"
set_reset_scenario { \
  {{top_darjeeling.u_rstmgr_aon.u_reg.u_sw_rst_ctrl_n_0.q[0]} {reset  { @t0 1 } { #2 0 } { #10 1}} } \
  {{top_darjeeling.u_rstmgr_aon.u_reg.u_sw_rst_ctrl_n_1.q[0]} {reset  { @t0 1 } { #2 0 } { #10 1}} } \
  {{top_darjeeling.u_rstmgr_aon.u_reg.u_sw_rst_ctrl_n_2.q[0]} {reset  { @t0 1 } { #2 0 } { #10 1}} } \
  {{top_darjeeling.u_rstmgr_aon.u_reg.u_sw_rst_ctrl_n_3.q[0]} {reset  { @t0 1 } { #2 0 } { #10 1}} } \
  {{top_darjeeling.u_rstmgr_aon.u_reg.u_sw_rst_ctrl_n_4.q[0]} {reset  { @t0 1 } { #2 0 } { #10 1}} } \
  {{top_darjeeling.u_rstmgr_aon.u_reg.u_sw_rst_ctrl_n_5.q[0]} {reset  { @t0 1 } { #2 0 } { #10 1}} } \
  {{top_darjeeling.u_rstmgr_aon.u_reg.u_sw_rst_ctrl_n_6.q[0]} {reset  { @t0 1 } { #2 0 } { #10 1}} } \
  {{top_darjeeling.u_rstmgr_aon.u_reg.u_sw_rst_ctrl_n_7.q[0]} {reset  { @t0 1 } { #2 0 } { #10 1}} } \
  { POR_N                               { constraint { @t0 1 } } } \
...
set_reset_scenario { \
  { {top_darjeeling.u_spi_device.u_reg.u_control_rst_rxfifo.q[0]} \
    {reset  { @t0 0 } { #10 1} { #4 0 }} } \
  { top_darjeeling.u_spi_device.u_reg.u_control_mode.q \
    {constraint { @t0 S } } } \
  { top_darjeeling.u_spi_device.rst_csb_buf {constraint { @t0 1 } } } \
  } -name SpidRstRxFifo -comment "SPI_DEVICE Async RX FIFO Functional Reset"
set_reset_scenario { \
  { {top_darjeeling.u_spi_device.u_reg.u_control_rst_txfifo.q[0]} \
    {reset  { @t0 0 } { #10 1} { #4 0 }} } \
  { top_darjeeling.u_spi_device.u_reg.u_control_mode.q \
    {constraint { @t0 S } } } \
  { top_darjeeling.u_spi_device.rst_csb_buf {constraint { @t0 1 } } } \
...
set_reset_scenario { \
 { {top_darjeeling.u_spi_device.rst_csb_buf} { reset { @t0 1 } { #10 0} } } \
 { u_ast.u_rglts_pdm_3p3v.vcaon_pok_h      { constraint { @t0 1 } } } \
 { top_darjeeling.u_spi_device.rst_ni        { constraint { @t0 1 } } } \
} -name RstSpidCsb -comment "SPI_DEVICE CSb Assertion"

# SPI_DEVICE TPM CSb Reset. SPID IP reset should be stable
set_reset_scenario { \
  { {top_darjeeling.u_spi_device.rst_tpm_csb_buf} \
    {reset { @t0 1} {#10 0}} } \
  { u_ast.u_rglts_pdm_3p3v.vcaon_pok_h { constraint { @t0 1 } } } \
  { POR_N                              { constraint { @t0 1 } } } \
  { top_darjeeling.u_spi_device.rst_ni   { constraint { @t0 1 } } } \
...
set_reset_scenario { \
  ...
  { top_darjeeling.u_rv_dm.dap.i_dmi_cdc.i_cdc_req.wvalid_i \
    { constraint { @t0 0 } } } \
  { top_darjeeling.u_rv_dm.dap.i_dmi_cdc.i_cdc_req.pending_q \
    { constraint { @t0 0 } } } \
  { top_darjeeling.u_rv_dm.dap.i_dmi_cdc.i_cdc_req.u_prim_sync_reqack.gen_rz_hs_protocol.src_fsm_q \
    { constraint { @t0 0 } } } \
  { POR_N                               { constraint { @t0 1 } } } \
  { u_ast.u_rglts_pdm_3p3v.vcaon_pok_h  { constraint { @t0 1 } } } \
  { u_ast.u_rglts_pdm_3p3v.vcmain_pok_h { constraint { @t0 1 } } } \
...
set_reset_scenario { \
  ...
  { top_darjeeling.u_lc_ctrl.u_dmi_jtag.i_dmi_cdc.i_cdc_req.u_prim_sync_reqack.gen_rz_hs_protocol.src_fsm_q \
    { constraint { @t0 0 } } } \
  { top_darjeeling.u_lc_ctrl.u_dmi_jtag.i_dmi_cdc.i_cdc_req.wvalid_i \
    { constraint { @t0 0 } } } \
  { top_darjeeling.u_lc_ctrl.u_dmi_jtag.i_dmi_cdc.i_cdc_req.pending_q \
    { constraint { @t0 0 } } } \
  { POR_N                               { constraint { @t0 1 } } } \
  { u_ast.u_rglts_pdm_3p3v.vcaon_pok_h  { constraint { @t0 1 } } } \
  { u_ast.u_rglts_pdm_3p3v.vcmain_pok_h { constraint { @t0 1 } } } \
