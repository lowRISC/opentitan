...
package top_darjeeling_pkg;
   ...
   */
  parameter int unsigned TOP_DARJEELING_SRAM_CTRL_RET_AON_RAM_BASE_ADDR = 32'h405FF000;
   ...
   */
  parameter int unsigned TOP_DARJEELING_RAM_RET_AON_BASE_ADDR = 32'h405ff000;
  ...
  typedef enum int unsigned {
    ...
    TopDarjeelingAlertPeripheralRomCtrl = 38,
    TopDarjeelingAlertPeripheralRvCoreIbex = 39,
  ...
  typedef enum int unsigned {
    ...
    TopDarjeelingAlertIdRomCtrlFatal = 58,
    TopDarjeelingAlertIdRvCoreIbexFatalSwErr = 59,
    TopDarjeelingAlertIdRvCoreIbexRecovSwErr = 60,
    TopDarjeelingAlertIdRvCoreIbexFatalHwErr = 61,
    TopDarjeelingAlertIdRvCoreIbexRecovHwErr = 62,
