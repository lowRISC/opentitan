...
package top_darjeeling_pkg;
  ...
  typedef enum int unsigned {
    ...
    TopDarjeelingAlertIdSramCtrlRetAonFatalError = 30,
    TopDarjeelingAlertIdFlashCtrlRecovErr = 31,
    TopDarjeelingAlertIdFlashCtrlFatalStdErr = 32,
    TopDarjeelingAlertIdFlashCtrlFatalErr = 33,
    TopDarjeelingAlertIdFlashCtrlFatalPrimFlashAlert = 34,
    TopDarjeelingAlertIdFlashCtrlRecovPrimFlashAlert = 35,
    ...
    TopDarjeelingAlertIdKeymgrRecovOperationErr = 45,
    TopDarjeelingAlertIdKeymgrFatalFaultErr = 46,
    ...
    TopDarjeelingAlertIdRvCoreIbexFatalSwErr = 58,
    TopDarjeelingAlertIdRvCoreIbexRecovSwErr = 59,
    TopDarjeelingAlertIdRvCoreIbexFatalHwErr = 60,
    TopDarjeelingAlertIdRvCoreIbexRecovHwErr = 61,
