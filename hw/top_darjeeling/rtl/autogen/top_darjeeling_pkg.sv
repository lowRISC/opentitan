...
package top_darjeeling_pkg;
  ...
  typedef enum int unsigned {
    ...
    TopDarjeelingAlertPeripheralPwrmgrAon = 11,
    TopDarjeelingAlertPeripheralRstmgrAon = 12,
    TopDarjeelingAlertPeripheralClkmgrAon = 13,
    TopDarjeelingAlertPeripheralSysrstCtrlAon = 14,
    TopDarjeelingAlertPeripheralAdcCtrlAon = 15,
    TopDarjeelingAlertPeripheralPinmuxAon = 16,
    TopDarjeelingAlertPeripheralAonTimerAon = 17,
    TopDarjeelingAlertPeripheralSensorCtrl = 18,
    TopDarjeelingAlertPeripheralSocProxy = 19,
    TopDarjeelingAlertPeripheralSramCtrlRetAon = 20,
    TopDarjeelingAlertPeripheralRvDm = 21,
    TopDarjeelingAlertPeripheralRvPlic = 22,
    TopDarjeelingAlertPeripheralAes = 23,
    TopDarjeelingAlertPeripheralHmac = 24,
    TopDarjeelingAlertPeripheralKmac = 25,
    TopDarjeelingAlertPeripheralOtbn = 26,
    TopDarjeelingAlertPeripheralKeymgrDpe = 27,
    TopDarjeelingAlertPeripheralCsrng = 28,
    TopDarjeelingAlertPeripheralEdn0 = 29,
    TopDarjeelingAlertPeripheralEdn1 = 30,
    TopDarjeelingAlertPeripheralSramCtrlMain = 31,
    TopDarjeelingAlertPeripheralSramCtrlMbox = 32,
    TopDarjeelingAlertPeripheralRomCtrl0 = 33,
    TopDarjeelingAlertPeripheralRomCtrl1 = 34,
    TopDarjeelingAlertPeripheralDma = 35,
    TopDarjeelingAlertPeripheralMbx0 = 36,
    TopDarjeelingAlertPeripheralMbx1 = 37,
    TopDarjeelingAlertPeripheralMbx2 = 38,
    TopDarjeelingAlertPeripheralMbx3 = 39,
    TopDarjeelingAlertPeripheralMbx4 = 40,
    TopDarjeelingAlertPeripheralMbx5 = 41,
    TopDarjeelingAlertPeripheralMbx6 = 42,
    TopDarjeelingAlertPeripheralMbx7 = 43,
    TopDarjeelingAlertPeripheralMbxJtag = 44,
    TopDarjeelingAlertPeripheralMbxPcie0 = 45,
    TopDarjeelingAlertPeripheralRvCoreIbex = 46,
  ...
  typedef enum int unsigned {
    ...
    TopDarjeelingAlertIdPwrmgrAonFatalFault = 17,
    TopDarjeelingAlertIdRstmgrAonFatalFault = 18,
    TopDarjeelingAlertIdRstmgrAonFatalCnstyFault = 19,
    TopDarjeelingAlertIdClkmgrAonRecovFault = 20,
    TopDarjeelingAlertIdClkmgrAonFatalFault = 21,
    TopDarjeelingAlertIdSysrstCtrlAonFatalFault = 22,
    TopDarjeelingAlertIdAdcCtrlAonFatalFault = 23,
    TopDarjeelingAlertIdPinmuxAonFatalFault = 24,
    TopDarjeelingAlertIdAonTimerAonFatalFault = 25,
    TopDarjeelingAlertIdSensorCtrlRecovAlert = 26,
    TopDarjeelingAlertIdSensorCtrlFatalAlert = 27,
    TopDarjeelingAlertIdSocProxyFatalAlertIntg = 28,
    TopDarjeelingAlertIdSocProxyFatalAlertExternal0 = 29,
    TopDarjeelingAlertIdSocProxyFatalAlertExternal1 = 30,
    TopDarjeelingAlertIdSocProxyFatalAlertExternal2 = 31,
    TopDarjeelingAlertIdSocProxyFatalAlertExternal3 = 32,
    TopDarjeelingAlertIdSocProxyRecovAlertExternal0 = 33,
    TopDarjeelingAlertIdSocProxyRecovAlertExternal1 = 34,
    TopDarjeelingAlertIdSocProxyRecovAlertExternal2 = 35,
    TopDarjeelingAlertIdSocProxyRecovAlertExternal3 = 36,
    TopDarjeelingAlertIdSramCtrlRetAonFatalError = 37,
    TopDarjeelingAlertIdRvDmFatalFault = 38,
    TopDarjeelingAlertIdRvPlicFatalFault = 39,
    TopDarjeelingAlertIdAesRecovCtrlUpdateErr = 40,
    TopDarjeelingAlertIdAesFatalFault = 41,
    TopDarjeelingAlertIdHmacFatalFault = 42,
    TopDarjeelingAlertIdKmacRecovOperationErr = 43,
    TopDarjeelingAlertIdKmacFatalFaultErr = 44,
    TopDarjeelingAlertIdOtbnFatal = 45,
    TopDarjeelingAlertIdOtbnRecov = 46,
    TopDarjeelingAlertIdKeymgrDpeRecovOperationErr = 47,
    TopDarjeelingAlertIdKeymgrDpeFatalFaultErr = 48,
    TopDarjeelingAlertIdCsrngRecovAlert = 49,
    TopDarjeelingAlertIdCsrngFatalAlert = 50,
    TopDarjeelingAlertIdEdn0RecovAlert = 51,
    TopDarjeelingAlertIdEdn0FatalAlert = 52,
    TopDarjeelingAlertIdEdn1RecovAlert = 53,
    TopDarjeelingAlertIdEdn1FatalAlert = 54,
    TopDarjeelingAlertIdSramCtrlMainFatalError = 55,
    TopDarjeelingAlertIdSramCtrlMboxFatalError = 56,
    TopDarjeelingAlertIdRomCtrl0Fatal = 57,
    TopDarjeelingAlertIdRomCtrl1Fatal = 58,
    TopDarjeelingAlertIdDmaFatalFault = 59,
    TopDarjeelingAlertIdMbx0FatalFault = 60,
    TopDarjeelingAlertIdMbx0RecovFault = 61,
    TopDarjeelingAlertIdMbx1FatalFault = 62,
    TopDarjeelingAlertIdMbx1RecovFault = 63,
    TopDarjeelingAlertIdMbx2FatalFault = 64,
    TopDarjeelingAlertIdMbx2RecovFault = 65,
    TopDarjeelingAlertIdMbx3FatalFault = 66,
    TopDarjeelingAlertIdMbx3RecovFault = 67,
    TopDarjeelingAlertIdMbx4FatalFault = 68,
    TopDarjeelingAlertIdMbx4RecovFault = 69,
    TopDarjeelingAlertIdMbx5FatalFault = 70,
    TopDarjeelingAlertIdMbx5RecovFault = 71,
    TopDarjeelingAlertIdMbx6FatalFault = 72,
    TopDarjeelingAlertIdMbx6RecovFault = 73,
    TopDarjeelingAlertIdMbx7FatalFault = 74,
    TopDarjeelingAlertIdMbx7RecovFault = 75,
    TopDarjeelingAlertIdMbxJtagFatalFault = 76,
    TopDarjeelingAlertIdMbxJtagRecovFault = 77,
    TopDarjeelingAlertIdMbxPcie0FatalFault = 78,
    TopDarjeelingAlertIdMbxPcie0RecovFault = 79,
    TopDarjeelingAlertIdRvCoreIbexFatalSwErr = 80,
    TopDarjeelingAlertIdRvCoreIbexRecovSwErr = 81,
    TopDarjeelingAlertIdRvCoreIbexFatalHwErr = 82,
    TopDarjeelingAlertIdRvCoreIbexRecovHwErr = 83,
