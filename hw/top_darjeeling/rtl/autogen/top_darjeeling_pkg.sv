...
package top_darjeeling_pkg;
  ...
  typedef enum int unsigned {
    ...
    TopDarjeelingAlertIdSocProxyRecovAlertExternal4 = 37,
    TopDarjeelingAlertIdSocProxyRecovAlertExternal5 = 38,
    TopDarjeelingAlertIdSocProxyRecovAlertExternal6 = 39,
    TopDarjeelingAlertIdSocProxyRecovAlertExternal7 = 40,
    TopDarjeelingAlertIdSramCtrlRetAonFatalError = 41,
    TopDarjeelingAlertIdRvDmFatalFault = 42,
    TopDarjeelingAlertIdRvPlicFatalFault = 43,
    TopDarjeelingAlertIdAesRecovCtrlUpdateErr = 44,
    TopDarjeelingAlertIdAesFatalFault = 45,
    TopDarjeelingAlertIdHmacFatalFault = 46,
    TopDarjeelingAlertIdKmacRecovOperationErr = 47,
    TopDarjeelingAlertIdKmacFatalFaultErr = 48,
    TopDarjeelingAlertIdOtbnFatal = 49,
    TopDarjeelingAlertIdOtbnRecov = 50,
    TopDarjeelingAlertIdKeymgrDpeRecovOperationErr = 51,
    TopDarjeelingAlertIdKeymgrDpeFatalFaultErr = 52,
    TopDarjeelingAlertIdCsrngRecovAlert = 53,
    TopDarjeelingAlertIdCsrngFatalAlert = 54,
    ...
    TopDarjeelingAlertIdDmaFatalFault = 63,
    TopDarjeelingAlertIdMbx0FatalFault = 64,
    TopDarjeelingAlertIdMbx0RecovFault = 65,
    TopDarjeelingAlertIdMbx1FatalFault = 66,
    TopDarjeelingAlertIdMbx1RecovFault = 67,
    TopDarjeelingAlertIdMbx2FatalFault = 68,
    TopDarjeelingAlertIdMbx2RecovFault = 69,
    TopDarjeelingAlertIdMbx3FatalFault = 70,
    TopDarjeelingAlertIdMbx3RecovFault = 71,
    TopDarjeelingAlertIdMbx4FatalFault = 72,
    TopDarjeelingAlertIdMbx4RecovFault = 73,
    TopDarjeelingAlertIdMbx5FatalFault = 74,
    TopDarjeelingAlertIdMbx5RecovFault = 75,
    TopDarjeelingAlertIdMbx6FatalFault = 76,
    TopDarjeelingAlertIdMbx6RecovFault = 77,
    TopDarjeelingAlertIdMbxJtagFatalFault = 78,
    TopDarjeelingAlertIdMbxJtagRecovFault = 79,
    TopDarjeelingAlertIdMbxPcie0FatalFault = 80,
    TopDarjeelingAlertIdMbxPcie0RecovFault = 81,
    TopDarjeelingAlertIdMbxPcie1FatalFault = 82,
    TopDarjeelingAlertIdMbxPcie1RecovFault = 83,
    TopDarjeelingAlertIdRvCoreIbexFatalSwErr = 84,
    TopDarjeelingAlertIdRvCoreIbexRecovSwErr = 85,
    TopDarjeelingAlertIdRvCoreIbexFatalHwErr = 86,
    TopDarjeelingAlertIdRvCoreIbexRecovHwErr = 87,
