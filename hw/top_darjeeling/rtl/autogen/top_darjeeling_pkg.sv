...
package top_darjeeling_pkg;
  ...
  typedef enum int unsigned {
    ...
    TopDarjeelingAlertPeripheralPwmAon = 20,
    TopDarjeelingAlertPeripheralPinmuxAon = 21,
    TopDarjeelingAlertPeripheralAonTimerAon = 22,
    TopDarjeelingAlertPeripheralSensorCtrl = 23,
  ...
  typedef enum int unsigned {
    ...
    TopDarjeelingAlertIdPwmAonFatalFault = 28,
    TopDarjeelingAlertIdPinmuxAonFatalFault = 29,
    TopDarjeelingAlertIdAonTimerAonFatalFault = 30,
    TopDarjeelingAlertIdSensorCtrlRecovAlert = 31,
    TopDarjeelingAlertIdSensorCtrlFatalAlert = 32,
