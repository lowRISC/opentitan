...
// pragma coverage on
  ...
  soc_proxy #(
    .AlertAsyncOn(alert_handler_reg_pkg::AsyncOn[51:23])
      ...
      .wkup_internal_req_o(pwrmgr_aon_wakeups[3]),
      .wkup_external_req_o(pwrmgr_aon_wakeups[4]),
  ...
  assign intr_vector = {
      intr_mbx_pcie1_mbx_error, // IDs [160 +: 1]
      intr_mbx_pcie1_mbx_abort, // IDs [159 +: 1]
      intr_mbx_pcie1_mbx_ready, // IDs [158 +: 1]
      intr_mbx_pcie0_mbx_error, // IDs [157 +: 1]
      intr_mbx_pcie0_mbx_abort, // IDs [156 +: 1]
      intr_mbx_pcie0_mbx_ready, // IDs [155 +: 1]
      intr_mbx_jtag_mbx_error, // IDs [154 +: 1]
      intr_mbx_jtag_mbx_abort, // IDs [153 +: 1]
      intr_mbx_jtag_mbx_ready, // IDs [152 +: 1]
      intr_mbx6_mbx_error, // IDs [151 +: 1]
      intr_mbx6_mbx_abort, // IDs [150 +: 1]
      intr_mbx6_mbx_ready, // IDs [149 +: 1]
      intr_mbx5_mbx_error, // IDs [148 +: 1]
      intr_mbx5_mbx_abort, // IDs [147 +: 1]
      intr_mbx5_mbx_ready, // IDs [146 +: 1]
      intr_mbx4_mbx_error, // IDs [145 +: 1]
      intr_mbx4_mbx_abort, // IDs [144 +: 1]
      intr_mbx4_mbx_ready, // IDs [143 +: 1]
      intr_mbx3_mbx_error, // IDs [142 +: 1]
      intr_mbx3_mbx_abort, // IDs [141 +: 1]
      intr_mbx3_mbx_ready, // IDs [140 +: 1]
      intr_mbx2_mbx_error, // IDs [139 +: 1]
      intr_mbx2_mbx_abort, // IDs [138 +: 1]
      intr_mbx2_mbx_ready, // IDs [137 +: 1]
      intr_mbx1_mbx_error, // IDs [136 +: 1]
      intr_mbx1_mbx_abort, // IDs [135 +: 1]
      intr_mbx1_mbx_ready, // IDs [134 +: 1]
      intr_mbx0_mbx_error, // IDs [133 +: 1]
      intr_mbx0_mbx_abort, // IDs [132 +: 1]
      intr_mbx0_mbx_ready, // IDs [131 +: 1]
      intr_ac_range_check_deny_cnt_reached, // IDs [130 +: 1]
      intr_dma_dma_error, // IDs [129 +: 1]
      intr_dma_dma_chunk_done, // IDs [128 +: 1]
      intr_dma_dma_done, // IDs [127 +: 1]
      intr_edn1_edn_fatal_err, // IDs [126 +: 1]
      intr_edn1_edn_cmd_req_done, // IDs [125 +: 1]
      intr_edn0_edn_fatal_err, // IDs [124 +: 1]
      intr_edn0_edn_cmd_req_done, // IDs [123 +: 1]
      intr_csrng_cs_fatal_err, // IDs [122 +: 1]
      intr_csrng_cs_hw_inst_exc, // IDs [121 +: 1]
      intr_csrng_cs_entropy_req, // IDs [120 +: 1]
      intr_csrng_cs_cmd_req_done, // IDs [119 +: 1]
      intr_keymgr_dpe_op_done, // IDs [118 +: 1]
      intr_otbn_done, // IDs [117 +: 1]
      intr_kmac_kmac_err, // IDs [116 +: 1]
      intr_kmac_fifo_empty, // IDs [115 +: 1]
      intr_kmac_kmac_done, // IDs [114 +: 1]
      intr_hmac_hmac_err, // IDs [113 +: 1]
      intr_hmac_fifo_empty, // IDs [112 +: 1]
      intr_hmac_hmac_done, // IDs [111 +: 1]
      intr_soc_proxy_external, // IDs [79 +: 32]
      intr_sensor_ctrl_init_status_change, // IDs [78 +: 1]
      intr_sensor_ctrl_io_status_change, // IDs [77 +: 1]
