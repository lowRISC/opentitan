...
// pragma coverage on
  ...
  soc_proxy #(
    .AlertAsyncOn(alert_handler_reg_pkg::AsyncOn[29:29])
      ...
      .soc_fatal_alert_req_i(soc_fatal_alert_req_i),
      .soc_fatal_alert_ack_o(soc_fatal_alert_ack_o),
      .soc_recov_alert_req_i(soc_recov_alert_req_i),
      .soc_recov_alert_ack_o(soc_recov_alert_ack_o),
  ...
  flash_ctrl #(
    .AlertAsyncOn(alert_handler_reg_pkg::AsyncOn[35:31]),
    ...
    .RdFifoDepth(FlashCtrlRdFifoDepth)
      ...
      // [32]: fatal_std_err
      // [33]: fatal_err
      // [34]: fatal_prim_flash_alert
      // [35]: recov_prim_flash_alert
      .alert_tx_o  ( alert_tx[35:31] ),
      .alert_rx_i  ( alert_rx[35:31] ),
