...
module top_darjeeling #(
  ...
  lc_ctrl_pkg::lc_tx_t       lc_ctrl_lc_rma_sw_rd_override_en;
...
// pragma coverage on
  ...
  otp_ctrl #(
    ...
    .RndCnstPartInvDefault(RndCnstOtpCtrlPartInvDefault)
      ...
      .lc_rma_sw_rd_override_en_i(lc_ctrl_lc_rma_sw_rd_override_en),
  ...
  lc_ctrl #(
    ...
    .EscPingCountWidth(AlertHandlerEscPingCountWidth)
      ...
      .lc_rma_sw_rd_override_en_o(lc_ctrl_lc_rma_sw_rd_override_en),
