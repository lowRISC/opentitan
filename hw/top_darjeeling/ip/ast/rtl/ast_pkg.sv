...
// Alerts
parameter int unsigned NumAlerts  = 14;
...
parameter int unsigned Es0Sel     = 11;
parameter int unsigned Es1Sel     = 12;
parameter int unsigned Es2Sel     = 13;
//
...
parameter int unsigned AstRegsNum       = 31;
...
parameter int unsigned SramCtrlMboxNumRamInst   = 1;
...
typedef struct packed {
  ...
  prim_ram_1p_pkg::ram_1p_cfg_req_t                                ctn_sram;
  ...
  prim_ram_1p_pkg::ram_1p_cfg_req_t [SramCtrlMboxNumRamInst-1:0]   sram_ctrl_mbox;
  prim_ram_1r1w_pkg::ram_1r1w_cfg_req_t                            spi_device_sys2spi;
  prim_ram_1r1w_pkg::ram_1r1w_cfg_req_t                            spi_device_spi2sys;
  prim_rom_pkg::rom_cfg_req_t                                      rom_ctrl0;
  prim_rom_pkg::rom_cfg_req_t                                      rom_ctrl1;
} ast_mem_cfg_req_t;
...
typedef struct packed {
  ...
  prim_ram_1p_pkg::ram_1p_cfg_rsp_t                                ctn_sram;
  ...
  prim_ram_1p_pkg::ram_1p_cfg_rsp_t [SramCtrlMboxNumRamInst-1:0]   sram_ctrl_mbox;
  prim_ram_1r1w_pkg::ram_1r1w_cfg_rsp_t                            spi_device_sys2spi;
  prim_ram_1r1w_pkg::ram_1r1w_cfg_rsp_t                            spi_device_spi2sys;
  prim_rom_pkg::rom_cfg_rsp_t                                      rom_ctrl0;
  prim_rom_pkg::rom_cfg_rsp_t                                      rom_ctrl1;
} ast_mem_cfg_rsp_t;
