...
module xbar_peri (
  ...
  assign tl_pwrmgr_aon_o = tl_s1n_26_ds_h2d[11];
  assign tl_s1n_26_ds_d2h[11] = tl_pwrmgr_aon_i;

  assign tl_rstmgr_aon_o = tl_s1n_26_ds_h2d[12];
  assign tl_s1n_26_ds_d2h[12] = tl_rstmgr_aon_i;

  assign tl_clkmgr_aon_o = tl_s1n_26_ds_h2d[13];
  assign tl_s1n_26_ds_d2h[13] = tl_clkmgr_aon_i;

  assign tl_pinmux_aon_o = tl_s1n_26_ds_h2d[14];
  assign tl_s1n_26_ds_d2h[14] = tl_pinmux_aon_i;

  assign tl_otp_ctrl__core_o = tl_s1n_26_ds_h2d[15];
  assign tl_s1n_26_ds_d2h[15] = tl_otp_ctrl__core_i;

  assign tl_otp_ctrl__prim_o = tl_s1n_26_ds_h2d[16];
  assign tl_s1n_26_ds_d2h[16] = tl_otp_ctrl__prim_i;

  assign tl_lc_ctrl_o = tl_s1n_26_ds_h2d[17];
  assign tl_s1n_26_ds_d2h[17] = tl_lc_ctrl_i;

  assign tl_alert_handler_o = tl_s1n_26_ds_h2d[18];
  assign tl_s1n_26_ds_d2h[18] = tl_alert_handler_i;

  assign tl_sram_ctrl_ret_aon__ram_o = tl_s1n_26_ds_h2d[19];
  assign tl_s1n_26_ds_d2h[19] = tl_sram_ctrl_ret_aon__ram_i;

  assign tl_sram_ctrl_ret_aon__regs_o = tl_s1n_26_ds_h2d[20];
  assign tl_s1n_26_ds_d2h[20] = tl_sram_ctrl_ret_aon__regs_i;

  assign tl_aon_timer_aon_o = tl_s1n_26_ds_h2d[21];
  assign tl_s1n_26_ds_d2h[21] = tl_aon_timer_aon_i;

  assign tl_adc_ctrl_aon_o = tl_s1n_26_ds_h2d[22];
  assign tl_s1n_26_ds_d2h[22] = tl_adc_ctrl_aon_i;

  assign tl_sysrst_ctrl_aon_o = tl_s1n_26_ds_h2d[23];
  assign tl_s1n_26_ds_d2h[23] = tl_sysrst_ctrl_aon_i;

  assign tl_pwm_aon_o = tl_s1n_26_ds_h2d[24];
  assign tl_s1n_26_ds_d2h[24] = tl_pwm_aon_i;
