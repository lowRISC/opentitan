...
module xbar_peri (
  ...
  output tlul_pkg::tl_h2d_t tl_socdbg_ctrl__core_o,
  input  tlul_pkg::tl_d2h_t tl_socdbg_ctrl__core_i,
  ...
  assign tl_lc_ctrl_o = tl_s1n_21_ds_h2d[12];
  assign tl_s1n_21_ds_d2h[12] = tl_lc_ctrl_i;
  ...
  assign tl_socdbg_ctrl__core_o = tl_s1n_21_ds_h2d[19];
  assign tl_s1n_21_ds_d2h[19] = tl_socdbg_ctrl__core_i;
  ...
  always_comb begin
    ...
    if ((tl_s1n_21_us_h2d.a_address &
      ...
      dev_sel_s1n_21 = 5'd18;
                  ...
                  ~(ADDR_MASK_SOCDBG_CTRL__CORE)) == ADDR_SPACE_SOCDBG_CTRL__CORE) begin
