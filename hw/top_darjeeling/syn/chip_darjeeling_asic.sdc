...
create_generated_clock -name LC_JTAG_TCK -source [get_ports IOR3] -divide_by 1 \
    [get_pins top_darjeeling/u_pinmux_aon/gen_hw_strap_sampling.u_pinmux_strap_sampling/u_pinmux_jtag_buf_lc/prim_clock_buf_tck/clk_o]
create_generated_clock -name RV_JTAG_TCK -source [get_ports IOR3] -divide_by 1 \
    [get_pins top_darjeeling/u_pinmux_aon/gen_hw_strap_sampling.u_pinmux_strap_sampling/u_pinmux_jtag_buf_rv/prim_clock_buf_tck/clk_o]
...
set_clock_sense -logical_stop_propagation -clock JTAG_TCK \
  [get_pins -leaf -filter "@pin_direction == out" -of_objects \
    [get_nets -segments -of_objects \
      [get_pins top_darjeeling/u_pinmux_aon/gen_hw_strap_sampling.u_pinmux_strap_sampling/u_pinmux_jtag_buf_dft/prim_clock_buf_tck/clk_o] \
    ] \
  ]
...
set_clock_sense -stop_propagation -clock JTAG_TCK \
  [get_pins -leaf -filter "@pin_direction == out" -of_objects \
    [get_nets -segments -of_objects \
      [get_pins top_darjeeling/u_pinmux_aon/gen_hw_strap_sampling.u_pinmux_strap_sampling/in_core_o[38]] \
    ] \
  ]
set_false_path -hold -from [get_clocks JTAG_TCK] \
  ...
  -through [get_pins -leaf -filter "@pin_direction == out" -of_objects \
    [get_nets -segments -of_objects \
      [get_pins top_darjeeling/u_pinmux_aon/gen_hw_strap_sampling.u_pinmux_strap_sampling/in_core_o*] \
    ] \
  ]
