...
set_rule_status -rule {S_NET_NO_WAVE} -expression {(Signal =~ "top_darjeeling.*.u_memory_2p*u_mem.gen_generic.u_impl_generic.*_rdata_o*")} -status {Waived} -comment {Signals from 2p memory}
