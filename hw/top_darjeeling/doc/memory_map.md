...
| pwrmgr         | default     | `0x30400000`   | `0x80`         | `0x20`         | pwrmgr                        |
| rstmgr         | default     | `0x30410000`   | `0x80`         | `0x20`         | rstmgr                        |
| clkmgr         | default     | `0x30420000`   | `0x40`         | `0x10`         | clkmgr                        |
| pinmux         | default     | `0x30460000`   | `0x800`        | `0x200`        | pinmux                        |
| aon_timer      | default     | `0x30470000`   | `0x40`         | `0x10`         | aon_timer                     |
| ast            | default     | `0x30480000`   | `0x400`        | `0x100`        | ast                           |
| soc_proxy      | core        | `0x22030000`   | `0x8`          | `0x2`          | core device on soc_proxy      |
| sram_ctrl_ret  | regs        | `0x30500000`   | `0x40`         | `0x10`         | regs device on sram_ctrl_ret  |
...
| keymgr_dpe     | default     | `0x21140000`   | `0x200`        | `0x80`         | keymgr_dpe                    |
...
| sram_ctrl_ret  | ram         | `0x30600000`   | `0x1000`       | `0x400`        |
