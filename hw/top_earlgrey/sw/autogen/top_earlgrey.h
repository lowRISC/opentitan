...
typedef enum top_earlgrey_plic_irq_id {
  ...
  kTopEarlgreyPlicIrqIdRvTimerTimerExpiredHart0Timer0 = 120, /**< rv_timer_timer_expired_hart0_timer0 */
  kTopEarlgreyPlicIrqIdOtpCtrlOtpOperationDone = 121, /**< otp_ctrl_otp_operation_done */
  kTopEarlgreyPlicIrqIdOtpCtrlOtpError = 122, /**< otp_ctrl_otp_error */
  kTopEarlgreyPlicIrqIdAlertHandlerClassa = 123, /**< alert_handler_classa */
  kTopEarlgreyPlicIrqIdAlertHandlerClassb = 124, /**< alert_handler_classb */
  kTopEarlgreyPlicIrqIdAlertHandlerClassc = 125, /**< alert_handler_classc */
  kTopEarlgreyPlicIrqIdAlertHandlerClassd = 126, /**< alert_handler_classd */
  kTopEarlgreyPlicIrqIdSpiHost0Error = 127, /**< spi_host0_error */
  kTopEarlgreyPlicIrqIdSpiHost0SpiEvent = 128, /**< spi_host0_spi_event */
  kTopEarlgreyPlicIrqIdSpiHost1Error = 129, /**< spi_host1_error */
  kTopEarlgreyPlicIrqIdSpiHost1SpiEvent = 130, /**< spi_host1_spi_event */
  kTopEarlgreyPlicIrqIdUsbdevPktReceived = 131, /**< usbdev_pkt_received */
  kTopEarlgreyPlicIrqIdUsbdevPktSent = 132, /**< usbdev_pkt_sent */
  kTopEarlgreyPlicIrqIdUsbdevDisconnected = 133, /**< usbdev_disconnected */
  kTopEarlgreyPlicIrqIdUsbdevHostLost = 134, /**< usbdev_host_lost */
  kTopEarlgreyPlicIrqIdUsbdevLinkReset = 135, /**< usbdev_link_reset */
  kTopEarlgreyPlicIrqIdUsbdevLinkSuspend = 136, /**< usbdev_link_suspend */
  kTopEarlgreyPlicIrqIdUsbdevLinkResume = 137, /**< usbdev_link_resume */
  kTopEarlgreyPlicIrqIdUsbdevAvOutEmpty = 138, /**< usbdev_av_out_empty */
  kTopEarlgreyPlicIrqIdUsbdevRxFull = 139, /**< usbdev_rx_full */
  kTopEarlgreyPlicIrqIdUsbdevAvOverflow = 140, /**< usbdev_av_overflow */
  kTopEarlgreyPlicIrqIdUsbdevLinkInErr = 141, /**< usbdev_link_in_err */
  kTopEarlgreyPlicIrqIdUsbdevRxCrcErr = 142, /**< usbdev_rx_crc_err */
  kTopEarlgreyPlicIrqIdUsbdevRxPidErr = 143, /**< usbdev_rx_pid_err */
  kTopEarlgreyPlicIrqIdUsbdevRxBitstuffErr = 144, /**< usbdev_rx_bitstuff_err */
  kTopEarlgreyPlicIrqIdUsbdevFrame = 145, /**< usbdev_frame */
  kTopEarlgreyPlicIrqIdUsbdevPowered = 146, /**< usbdev_powered */
  kTopEarlgreyPlicIrqIdUsbdevLinkOutErr = 147, /**< usbdev_link_out_err */
 ...
 */
enum {
  kDtDeviceIdBaseUnknown = 0,
  kDtDeviceCountUnknown = 0,
  kDtDeviceIdBaseUart = 1,
  kDtDeviceCountUart = 4,
  kDtDeviceIdBaseGpio = 5,
  kDtDeviceCountGpio = 1,
  kDtDeviceIdBaseSpiDevice = 6,
  kDtDeviceCountSpiDevice = 1,
  kDtDeviceIdBaseI2c = 7,
  kDtDeviceCountI2c = 3,
  kDtDeviceIdBasePattgen = 10,
  kDtDeviceCountPattgen = 1,
  kDtDeviceIdBaseRvTimer = 11,
  kDtDeviceCountRvTimer = 1,
  kDtDeviceIdBaseOtpCtrl = 12,
  kDtDeviceCountOtpCtrl = 1,
  kDtDeviceIdBaseLcCtrl = 13,
  kDtDeviceCountLcCtrl = 1,
  kDtDeviceIdBaseAlertHandler = 14,
  kDtDeviceCountAlertHandler = 1,
  kDtDeviceIdBaseSpiHost = 15,
  kDtDeviceCountSpiHost = 2,
  kDtDeviceIdBaseUsbdev = 17,
  kDtDeviceCountUsbdev = 1,
  kDtDeviceIdBasePwrmgr = 18,
  kDtDeviceCountPwrmgr = 1,
  kDtDeviceIdBaseRstmgr = 19,
  kDtDeviceCountRstmgr = 1,
  kDtDeviceIdBaseClkmgr = 20,
  kDtDeviceCountClkmgr = 1,
  kDtDeviceIdBaseSysrstCtrl = 21,
  kDtDeviceCountSysrstCtrl = 1,
  kDtDeviceIdBaseAdcCtrl = 22,
  kDtDeviceCountAdcCtrl = 1,
  kDtDeviceIdBasePwm = 23,
  kDtDeviceCountPwm = 1,
  kDtDeviceIdBasePinmux = 24,
  kDtDeviceCountPinmux = 1,
  kDtDeviceIdBaseAonTimer = 25,
  kDtDeviceCountAonTimer = 1,
  kDtDeviceIdBaseAst = 26,
  kDtDeviceCountAst = 1,
  kDtDeviceIdBaseSensorCtrl = 27,
  kDtDeviceCountSensorCtrl = 1,
  kDtDeviceIdBaseSramCtrl = 28,
  kDtDeviceCountSramCtrl = 2,
  kDtDeviceIdBaseFlashCtrl = 30,
  kDtDeviceCountFlashCtrl = 1,
  kDtDeviceIdBaseRvDm = 31,
  kDtDeviceCountRvDm = 1,
  kDtDeviceIdBaseRvPlic = 32,
  kDtDeviceCountRvPlic = 1,
  kDtDeviceIdBaseAes = 33,
  kDtDeviceCountAes = 1,
  kDtDeviceIdBaseHmac = 34,
  kDtDeviceCountHmac = 1,
  kDtDeviceIdBaseKmac = 35,
  kDtDeviceCountKmac = 1,
  kDtDeviceIdBaseOtbn = 36,
  kDtDeviceCountOtbn = 1,
  kDtDeviceIdBaseKeymgr = 37,
  kDtDeviceCountKeymgr = 1,
  kDtDeviceIdBaseCsrng = 38,
  kDtDeviceCountCsrng = 1,
  kDtDeviceIdBaseEntropySrc = 39,
  kDtDeviceCountEntropySrc = 1,
  kDtDeviceIdBaseEdn = 40,
  kDtDeviceCountEdn = 2,
  kDtDeviceIdBaseRomCtrl = 42,
  kDtDeviceCountRomCtrl = 1,
  kDtDeviceIdBaseRvCoreIbex = 43,
  kDtDeviceCountRvCoreIbex = 1,
};
