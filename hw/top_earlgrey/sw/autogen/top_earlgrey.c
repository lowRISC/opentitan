...
const top_earlgrey_plic_peripheral_t
    top_earlgrey_plic_interrupt_for_peripheral[80] = {
            ...
            [kTopEarlgreyPlicIrqIdUartTxWatermark] =
                kTopEarlgreyPlicPeripheralUart,
            [kTopEarlgreyPlicIrqIdUartRxWatermark] =
                kTopEarlgreyPlicPeripheralUart,
            [kTopEarlgreyPlicIrqIdUartTxEmpty] = kTopEarlgreyPlicPeripheralUart,
            [kTopEarlgreyPlicIrqIdUartRxOverflow] =
                kTopEarlgreyPlicPeripheralUart,
            [kTopEarlgreyPlicIrqIdUartRxFrameErr] =
                kTopEarlgreyPlicPeripheralUart,
            [kTopEarlgreyPlicIrqIdUartRxBreakErr] =
                kTopEarlgreyPlicPeripheralUart,
            [kTopEarlgreyPlicIrqIdUartRxTimeout] =
                kTopEarlgreyPlicPeripheralUart,
            [kTopEarlgreyPlicIrqIdUartRxParityErr] =
                kTopEarlgreyPlicPeripheralUart,
            [kTopEarlgreyPlicIrqIdSpiDeviceRxf] =
                kTopEarlgreyPlicPeripheralSpiDevice,
            [kTopEarlgreyPlicIrqIdSpiDeviceRxlvl] =
                kTopEarlgreyPlicPeripheralSpiDevice,
            [kTopEarlgreyPlicIrqIdSpiDeviceTxlvl] =
                kTopEarlgreyPlicPeripheralSpiDevice,
            [kTopEarlgreyPlicIrqIdSpiDeviceRxerr] =
                kTopEarlgreyPlicPeripheralSpiDevice,
            ...
            [kTopEarlgreyPlicIrqIdFlashCtrlOpDone] =
                kTopEarlgreyPlicPeripheralFlashCtrl,
            [kTopEarlgreyPlicIrqIdFlashCtrlOpError] =
                kTopEarlgreyPlicPeripheralFlashCtrl,
            ...
            [kTopEarlgreyPlicIrqIdAlertHandlerClassd] =
                kTopEarlgreyPlicPeripheralAlertHandler,
            [kTopEarlgreyPlicIrqIdNmiGenEsc0] =
                kTopEarlgreyPlicPeripheralNmiGen,
            [kTopEarlgreyPlicIrqIdNmiGenEsc1] =
                kTopEarlgreyPlicPeripheralNmiGen,
            [kTopEarlgreyPlicIrqIdNmiGenEsc2] =
                kTopEarlgreyPlicPeripheralNmiGen,
            [kTopEarlgreyPlicIrqIdNmiGenEsc3] =
                kTopEarlgreyPlicPeripheralNmiGen,
            ...
            [kTopEarlgreyPlicIrqIdUsbdevLinkResume] =
                kTopEarlgreyPlicPeripheralUsbdev,
            [kTopEarlgreyPlicIrqIdUsbdevAvEmpty] =
                kTopEarlgreyPlicPeripheralUsbdev,
