...
`ifndef GATE_LEVEL
    ...
    `DRIVE_CHIP_TL_DEVICE_IF(rram_ctrl__core, rram_ctrl, core_tl)
    `DRIVE_CHIP_TL_DEVICE_IF(rram_macro__prim, rram_macro, prim_tl)
    `DRIVE_CHIP_TL_DEVICE_IF(rram_ctrl__host, rram_ctrl, host_tl)
    ...
    `DRIVE_CHIP_TL_DEVICE_IF(pwm_aon, pwm_aon, tl, _pd_aon)
