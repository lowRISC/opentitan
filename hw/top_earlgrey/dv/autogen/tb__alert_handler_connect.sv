...
assign alert_if[20].alert_tx = `CHIP_HIER.u_sensor_ctrl_aon.alert_tx_o[0];
assign alert_if[21].alert_tx = `CHIP_HIER.u_sensor_ctrl_aon.alert_tx_o[1];
assign alert_if[22].alert_tx = `CHIP_HIER.u_sensor_ctrl_aon.alert_tx_o[2];
assign alert_if[23].alert_tx = `CHIP_HIER.u_sensor_ctrl_aon.alert_tx_o[3];
assign alert_if[24].alert_tx = `CHIP_HIER.u_sensor_ctrl_aon.alert_tx_o[4];
assign alert_if[25].alert_tx = `CHIP_HIER.u_sensor_ctrl_aon.alert_tx_o[5];
assign alert_if[26].alert_tx = `CHIP_HIER.u_sensor_ctrl_aon.alert_tx_o[6];
assign alert_if[27].alert_tx = `CHIP_HIER.u_sensor_ctrl_aon.alert_tx_o[7];
assign alert_if[28].alert_tx = `CHIP_HIER.u_sensor_ctrl_aon.alert_tx_o[8];
assign alert_if[29].alert_tx = `CHIP_HIER.u_sensor_ctrl_aon.alert_tx_o[9];
assign alert_if[30].alert_tx = `CHIP_HIER.u_sensor_ctrl_aon.alert_tx_o[10];
assign alert_if[31].alert_tx = `CHIP_HIER.u_sensor_ctrl_aon.alert_tx_o[11];
assign alert_if[32].alert_tx = `CHIP_HIER.u_sensor_ctrl_aon.alert_tx_o[12];
assign alert_if[33].alert_tx = `CHIP_HIER.u_sram_ctrl_ret_aon.alert_tx_o[0];
assign alert_if[34].alert_tx = `CHIP_HIER.u_sram_ctrl_ret_aon.alert_tx_o[1];
...
assign alert_if[39].alert_tx = `CHIP_HIER.u_aes.alert_tx_o[0];
assign alert_if[40].alert_tx = `CHIP_HIER.u_aes.alert_tx_o[1];
assign alert_if[41].alert_tx = `CHIP_HIER.u_hmac.alert_tx_o[0];
assign alert_if[42].alert_tx = `CHIP_HIER.u_kmac.alert_tx_o[0];
...
assign alert_if[51].alert_tx = `CHIP_HIER.u_sram_ctrl_main.alert_tx_o[1];
