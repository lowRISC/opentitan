...
assign alert_if[31].alert_tx = `CHIP_HIER.u_sram_ctrl_ret_aon.alert_tx_o[1];
...
assign alert_if[43].alert_tx = `CHIP_HIER.u_entropy_src.alert_tx_o[0];
assign alert_if[44].alert_tx = `CHIP_HIER.u_entropy_src.alert_tx_o[1];
assign alert_if[45].alert_tx = `CHIP_HIER.u_edn0.alert_tx_o[0];
assign alert_if[46].alert_tx = `CHIP_HIER.u_edn1.alert_tx_o[0];
assign alert_if[47].alert_tx = `CHIP_HIER.u_sram_ctrl_main.alert_tx_o[0];
assign alert_if[48].alert_tx = `CHIP_HIER.u_sram_ctrl_main.alert_tx_o[1];
assign alert_if[49].alert_tx = `CHIP_HIER.u_otbn.alert_tx_o[0];
assign alert_if[50].alert_tx = `CHIP_HIER.u_otbn.alert_tx_o[1];
assign alert_if[51].alert_tx = `CHIP_HIER.u_rom_ctrl.alert_tx_o[0];
