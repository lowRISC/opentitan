...
assign alert_if[22].alert_tx = `CHIP_HIER.u_sensor_ctrl_aon.alert_tx_o[11];
assign alert_if[23].alert_tx = `CHIP_HIER.u_sensor_ctrl_aon.alert_tx_o[12];
...
assign alert_if[29].alert_tx = `CHIP_HIER.u_flash_ctrl.alert_tx_o[3];
...
assign alert_if[34].alert_tx = `CHIP_HIER.u_keymgr.alert_tx_o[0];
assign alert_if[35].alert_tx = `CHIP_HIER.u_keymgr.alert_tx_o[1];
assign alert_if[36].alert_tx = `CHIP_HIER.u_csrng.alert_tx_o[0];
assign alert_if[37].alert_tx = `CHIP_HIER.u_entropy_src.alert_tx_o[0];
assign alert_if[38].alert_tx = `CHIP_HIER.u_entropy_src.alert_tx_o[1];
assign alert_if[39].alert_tx = `CHIP_HIER.u_edn0.alert_tx_o[0];
...
assign alert_if[42].alert_tx = `CHIP_HIER.u_sram_ctrl_main.alert_tx_o[1];
assign alert_if[43].alert_tx = `CHIP_HIER.u_otbn.alert_tx_o[0];
assign alert_if[44].alert_tx = `CHIP_HIER.u_otbn.alert_tx_o[1];
assign alert_if[45].alert_tx = `CHIP_HIER.u_rom_ctrl.alert_tx_o[0];
