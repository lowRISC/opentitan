...
assign alert_if[56].alert_tx = `CHIP_HIER.u_sram_ctrl_main.alert_tx_o[1];
assign alert_if[57].alert_tx = `CHIP_HIER.u_otbn.alert_tx_o[0];
assign alert_if[58].alert_tx = `CHIP_HIER.u_otbn.alert_tx_o[1];
