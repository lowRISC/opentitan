...
assign alert_if[23].alert_tx = `CHIP_HIER.u_hmac.alert_tx_o[0];
assign alert_if[24].alert_tx = `CHIP_HIER.u_kmac.alert_tx_o[0];
assign alert_if[25].alert_tx = `CHIP_HIER.u_keymgr.alert_tx_o[0];
assign alert_if[26].alert_tx = `CHIP_HIER.u_keymgr.alert_tx_o[1];
assign alert_if[27].alert_tx = `CHIP_HIER.u_csrng.alert_tx_o[0];
assign alert_if[28].alert_tx = `CHIP_HIER.u_entropy_src.alert_tx_o[0];
assign alert_if[29].alert_tx = `CHIP_HIER.u_entropy_src.alert_tx_o[1];
assign alert_if[30].alert_tx = `CHIP_HIER.u_edn0.alert_tx_o[0];
assign alert_if[31].alert_tx = `CHIP_HIER.u_edn1.alert_tx_o[0];
assign alert_if[32].alert_tx = `CHIP_HIER.u_sram_ctrl_main.alert_tx_o[0];
assign alert_if[33].alert_tx = `CHIP_HIER.u_sram_ctrl_main.alert_tx_o[1];
assign alert_if[34].alert_tx = `CHIP_HIER.u_otbn.alert_tx_o[0];
assign alert_if[35].alert_tx = `CHIP_HIER.u_otbn.alert_tx_o[1];
assign alert_if[36].alert_tx = `CHIP_HIER.u_rom_ctrl.alert_tx_o[0];
