...
assign alert_if[17].alert_tx = `CHIP_HIER.u_spi_host0.alert_tx_o[0];
assign alert_if[18].alert_tx = `CHIP_HIER.u_spi_host1.alert_tx_o[0];
assign alert_if[19].alert_tx = `CHIP_HIER.u_usbdev.alert_tx_o[0];
...
assign alert_if[22].alert_tx = `CHIP_HIER.u_rstmgr_aon.alert_tx_o[1];
assign alert_if[23].alert_tx = `CHIP_HIER.u_clkmgr_aon.alert_tx_o[0];
assign alert_if[24].alert_tx = `CHIP_HIER.u_clkmgr_aon.alert_tx_o[1];
assign alert_if[25].alert_tx = `CHIP_HIER.u_sysrst_ctrl_aon.alert_tx_o[0];
assign alert_if[26].alert_tx = `CHIP_HIER.u_adc_ctrl_aon.alert_tx_o[0];
assign alert_if[27].alert_tx = `CHIP_HIER.u_pwm_aon.alert_tx_o[0];
