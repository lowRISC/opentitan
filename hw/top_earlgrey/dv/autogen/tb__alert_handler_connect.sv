...
assign alert_if[28].alert_tx = `CHIP_HIER.u_sensor_ctrl.alert_tx_o[0];
assign alert_if[29].alert_tx = `CHIP_HIER.u_sensor_ctrl.alert_tx_o[1];
...
assign alert_if[41].alert_tx = `CHIP_HIER.u_keymgr.alert_tx_o[0];
assign alert_if[42].alert_tx = `CHIP_HIER.u_keymgr.alert_tx_o[1];
assign alert_if[43].alert_tx = `CHIP_HIER.u_csrng.alert_tx_o[0];
assign alert_if[44].alert_tx = `CHIP_HIER.u_csrng.alert_tx_o[1];
