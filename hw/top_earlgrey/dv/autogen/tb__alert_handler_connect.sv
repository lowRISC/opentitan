...
assign alert_if[23].alert_tx = `CHIP_HIER.u_clkmgr_aon.alert_tx_o[1];
assign alert_if[24].alert_tx = `CHIP_HIER.u_sysrst_ctrl_aon.alert_tx_o[0];
assign alert_if[25].alert_tx = `CHIP_HIER.u_adc_ctrl_aon.alert_tx_o[0];
assign alert_if[26].alert_tx = `CHIP_HIER.u_pwm_aon.alert_tx_o[0];
assign alert_if[27].alert_tx = `CHIP_HIER.u_pinmux_aon.alert_tx_o[0];
assign alert_if[28].alert_tx = `CHIP_HIER.u_aon_timer_aon.alert_tx_o[0];
assign alert_if[29].alert_tx = `CHIP_HIER.u_sensor_ctrl.alert_tx_o[0];
assign alert_if[30].alert_tx = `CHIP_HIER.u_sensor_ctrl.alert_tx_o[1];
