...
interface ast_ext_clk_if ();
  ...
  task automatic span_external_clock_active_window();
    `DV_WAIT(u_ast.u_ast_part_primary.u_ast_clks_byp_main.u_io_clk_byp_en.out_o == 1'b1,
    ...
    `DV_WAIT(u_ast.u_ast_part_primary.u_ast_clks_byp_main.u_io_clk_byp_en.out_o == 1'b0,
  ...
  function automatic logic is_ext_clk_in_use();
    return u_ast.u_ast_part_primary.u_ast_clks_byp_main.u_io_clk_byp_en.out_o;
  endfunction
