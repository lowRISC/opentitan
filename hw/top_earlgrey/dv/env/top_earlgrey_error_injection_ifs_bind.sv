...
`ifndef GATE_LEVEL
  ...
  bind tb.dut.top_earlgrey.earlgrey_pd_aon.u_clkmgr_aon.u_clk_main_aes_trans.u_idle_cnt prim_count_if
    prim_count_if(.*);
  ...
  bind tb.dut.top_earlgrey.earlgrey_pd_main.u_flash_ctrl.u_eflash.gen_flash_cores[1].u_core
