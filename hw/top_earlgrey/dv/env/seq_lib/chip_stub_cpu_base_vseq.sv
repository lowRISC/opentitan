  ...
  virtual task pre_start();
    ...
    if (cfg.jtag_riscv_map != null || cfg.m_jtag_riscv_agent_cfg.use_jtag_dmi == 1) begin
      ...
      if (select_jtag != JtagTapNone && select_jtag != from_plusarg) begin
        ...
        // If we aren't trying to override a value that has already been set, copy the value in
        // from_plusarg. If there was no plusarg, this will already equal select_jtag.
