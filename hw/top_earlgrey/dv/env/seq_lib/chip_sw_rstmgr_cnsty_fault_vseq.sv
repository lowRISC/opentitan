...
// This triggers a TopEarlgreyAlertIdRstmgrFatalCnstyFault fault and checks
...
class chip_sw_rstmgr_cnsty_fault_vseq extends chip_sw_fault_base_vseq;
  ...
  function void set_fault_parameters();
    if_path = "*rstmgr.u_d0_spi_host0.leaf_rst_path";
    alert_id = TopEarlgreyAlertIdRstmgrFatalCnstyFault;
  endfunction
endclass
