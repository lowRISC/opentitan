...
// top_earlgrey.earlgrey_pd_main.dft_strap_test_o in TEST_UNLOCKED* and RMA states.
...
class chip_tap_straps_vseq extends chip_sw_base_vseq;
  string path_dft_strap_test_o = "tb.dut.top_earlgrey.earlgrey_pd_main.dft_strap_test_o";
