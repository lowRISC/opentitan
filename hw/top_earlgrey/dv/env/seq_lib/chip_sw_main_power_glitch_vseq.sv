...
class chip_sw_main_power_glitch_vseq extends chip_sw_base_vseq;
  ...
  virtual task pre_start();
    ...
    $assertoff(1,"tb.dut.top_earlgrey_pd_aon.pwrmgr_rstreqs_sva_if.MainPwrRstOff_A");
    $assertoff(1,"tb.dut.top_earlgrey_pd_aon.pwrmgr_rstreqs_sva_if.MainPwrRstOn_A");
  endtask
