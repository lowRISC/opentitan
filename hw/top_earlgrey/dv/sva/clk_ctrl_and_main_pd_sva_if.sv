...
interface clk_ctrl_and_main_pd_sva_if (
  ...
  `OCAH_OT_ASSERT(CoreClkGlitchToValOff_A, $fell(por_d0_ni) |-> ##[0:1] !core_clk_val, clk_slow_i,
          reset_or_disable)
  `OCAH_OT_ASSERT(CoreClkGlitchToValOn_A, $rose(por_d0_ni) && core_clk_en |->
  ...
  `OCAH_OT_ASSERT(IoClkGlitchToValOff_A, $fell(por_d0_ni) |-> ##[0:1] !io_clk_val, clk_slow_i,
          reset_or_disable)
  `OCAH_OT_ASSERT(IoClkGlitchToValOn_A, $rose(por_d0_ni) && io_clk_en |-> `CLK_WAIT_BOUNDS io_clk_val,
          clk_slow_i, reset_or_disable)
  `OCAH_OT_ASSERT(UsbClkGlitchToValOff_A, $fell(por_d0_ni) |-> ##[0:5] !usb_clk_val, clk_slow_i,
          reset_or_disable)
  `OCAH_OT_ASSERT(UsbClkGlitchToValOn_A, $rose(por_d0_ni) && usb_clk_en |-> `CLK_WAIT_BOUNDS usb_clk_val,
          clk_slow_i, reset_or_disable)
  ...
  `OCAH_OT_ASSERT(CoreClkHandshakeOff_A, $fell(core_clk_en) |-> ##CLK_OFF_WAIT_CYCLES !core_clk_val,
          clk_slow_i, reset_or_disable)
  ...
  `OCAH_OT_ASSERT(IoClkHandshakeOff_A, $fell(io_clk_en) |-> ##CLK_OFF_WAIT_CYCLES !io_clk_val, clk_slow_i,
          reset_or_disable)
  ...
  `OCAH_OT_ASSERT(UsbClkHandshakeOff_A, $fell(usb_clk_en) |-> ##CLK_OFF_WAIT_CYCLES !usb_clk_val,
          clk_slow_i, reset_or_disable)
