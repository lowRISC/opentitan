...
OpenTitan Earl Grey is a secure microcontroller, based around a central [Ibex](https://github.com/lowrisc/ibex) RISC-V (`rv32imcb`) CPU core with a number of security, cryptographic, communication and utility peripherals and coprocessors.
Internal ROM, embedded Flash, SRAM and OTP memories exist within the SoC to meet the trust-model.
...
Peripherals used in Earl Grey have been developed as part of the OpenTitan project, and exist within the common repository.
We refer to these as [Hardware IP (HWIP)](../../../ip/README.md) blocks.
All peripherals are *Comportable*, which means they follow the [Comportability Guidelines](../../../../doc/contributing/hw/comportability/README.md) for lowRISC IP.
...
As Ibex pre-dates OpenTitan, it is developed as a standalone project in its own lowRISC [repository](https://github.com/lowrisc/ibex), and is [*vendored in*](../../../../doc/contributing/hw/vendor.md) to this repository for use within OpenTitan Earl Grey.
...
- `chip_earlgrey_cw310` for use in an FPGA
