...
For information on the taped out Earl Grey design, i.e., the first production OpenTitan silicon,
refer to the documentation for the [`earlgrey_1.0.0` branch](https://github.com/lowRISC/opentitan/tree/earlgrey_1.0.0)
[available here](https://opentitan.org/earlgrey_1.0.0/book/hw/top_earlgrey/index.html).
...
The Earl Grey top-level design is being generated by the integration tool, topgen
...
The main configuration for the Earl Grey top-level design is in `data/top_earlgrey.hjson`.
Users need to specify the list of peripherals, memories, crossbars, and the interrupts
