...
set_reset_scenario { \
  ...
  { top_earlgrey.u_pinmux_aon.gen_hw_strap_sampling.u_pinmux_strap_sampling.tap_strap_q { constraint { @t0 0 } } } \
} -name ScnAonPOK
...
## RV_DM
set_reset_scenario { \
  { top_earlgrey.u_pinmux_aon.gen_hw_strap_sampling.u_pinmux_strap_sampling.jtag_req.trst_n \
    { reset { @t0 1 } { #10 0 } { #10 1 } } } \
  { top_earlgrey.u_pinmux_aon.gen_hw_strap_sampling.u_pinmux_strap_sampling.tap_strap_q[1] { constraint { @t0 1 } } } \
  { top_earlgrey.u_pinmux_aon.gen_hw_strap_sampling.u_pinmux_strap_sampling.tap_strap_q[0] { constraint { @t0 0 } } } \
...
set_reset_scenario { \
  { top_earlgrey.u_pinmux_aon.gen_hw_strap_sampling.u_pinmux_strap_sampling.jtag_req.trst_n \
    { reset { @t0 1 } { #10 0 } { #10 1 } } } \
  { top_earlgrey.u_pinmux_aon.gen_hw_strap_sampling.u_pinmux_strap_sampling.tap_strap_q[1] { constraint { @t0 0 } } } \
  { top_earlgrey.u_pinmux_aon.gen_hw_strap_sampling.u_pinmux_strap_sampling.tap_strap_q[0] { constraint { @t0 1 } } } \
