...
set_reset_scenario { \
  ...
  { top_earlgrey.u_rv_dm.dap.i_dmi_cdc.i_cdc_req.u_prim_ot_sync_reqack.gen_rz_hs_protocol.dst_fsm_q \
    { constraint { @t0 0 } } } \
  { top_earlgrey.u_rv_dm.dap.i_dmi_cdc.i_cdc_req.wvalid_i \
    { constraint { @t0 0 } } } \
  { top_earlgrey.u_rv_dm.dap.i_dmi_cdc.i_cdc_req.pending_q \
    { constraint { @t0 0 } } } \
  { top_earlgrey.u_rv_dm.dap.i_dmi_cdc.i_cdc_req.u_prim_ot_sync_reqack.gen_rz_hs_protocol.src_fsm_q \
    { constraint { @t0 0 } } } \
  { POR_N                               { constraint { @t0 1 } } } \
  { u_ast.u_rglts_pdm_3p3v.vcaon_pok_h  { constraint { @t0 1 } } } \
  { u_ast.u_rglts_pdm_3p3v.vcmain_pok_h { constraint { @t0 1 } } } \
...
set_reset_scenario { \
  ...
  { top_earlgrey.u_lc_ctrl.u_dmi_jtag.i_dmi_cdc.i_cdc_req.u_prim_ot_sync_reqack.gen_rz_hs_protocol.dst_fsm_q \
    { constraint { @t0 0 } } } \
  { top_earlgrey.u_lc_ctrl.u_dmi_jtag.i_dmi_cdc.i_cdc_req.u_prim_ot_sync_reqack.gen_rz_hs_protocol.src_fsm_q \
    { constraint { @t0 0 } } } \
