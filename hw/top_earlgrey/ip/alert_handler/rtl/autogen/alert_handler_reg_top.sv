...
module alert_handler_reg_top (
  ...
  always_comb begin
    ...
    addr_hit[309] = (reg_addr == ALERT_HANDLER_CLASSA_PHASE0_CYC_SHADOWED_OFFSET);
    addr_hit[310] = (reg_addr == ALERT_HANDLER_CLASSA_PHASE1_CYC_SHADOWED_OFFSET);
    addr_hit[311] = (reg_addr == ALERT_HANDLER_CLASSA_PHASE2_CYC_SHADOWED_OFFSET);
    addr_hit[312] = (reg_addr == ALERT_HANDLER_CLASSA_PHASE3_CYC_SHADOWED_OFFSET);
    ...
    addr_hit[316] = (reg_addr == ALERT_HANDLER_CLASSB_CTRL_SHADOWED_OFFSET);
    ...
    addr_hit[320] = (reg_addr == ALERT_HANDLER_CLASSB_ACCUM_THRESH_SHADOWED_OFFSET);
    addr_hit[321] = (reg_addr == ALERT_HANDLER_CLASSB_TIMEOUT_CYC_SHADOWED_OFFSET);
    addr_hit[322] = (reg_addr == ALERT_HANDLER_CLASSB_PHASE0_CYC_SHADOWED_OFFSET);
    addr_hit[323] = (reg_addr == ALERT_HANDLER_CLASSB_PHASE1_CYC_SHADOWED_OFFSET);
    addr_hit[324] = (reg_addr == ALERT_HANDLER_CLASSB_PHASE2_CYC_SHADOWED_OFFSET);
    addr_hit[325] = (reg_addr == ALERT_HANDLER_CLASSB_PHASE3_CYC_SHADOWED_OFFSET);
    ...
    addr_hit[329] = (reg_addr == ALERT_HANDLER_CLASSC_CTRL_SHADOWED_OFFSET);
    ...
    addr_hit[333] = (reg_addr == ALERT_HANDLER_CLASSC_ACCUM_THRESH_SHADOWED_OFFSET);
    addr_hit[334] = (reg_addr == ALERT_HANDLER_CLASSC_TIMEOUT_CYC_SHADOWED_OFFSET);
  ...
  assign classa_phase0_cyc_shadowed_re = addr_hit[309] & reg_re & !reg_error;
  assign classa_phase0_cyc_shadowed_we = addr_hit[309] & reg_we & !reg_error;

  assign classa_phase0_cyc_shadowed_wd = reg_wdata[31:0];
  assign classa_phase1_cyc_shadowed_re = addr_hit[310] & reg_re & !reg_error;
  assign classa_phase1_cyc_shadowed_we = addr_hit[310] & reg_we & !reg_error;

  assign classa_phase1_cyc_shadowed_wd = reg_wdata[31:0];
  assign classa_phase2_cyc_shadowed_re = addr_hit[311] & reg_re & !reg_error;
  assign classa_phase2_cyc_shadowed_we = addr_hit[311] & reg_we & !reg_error;

  assign classa_phase2_cyc_shadowed_wd = reg_wdata[31:0];
  assign classa_phase3_cyc_shadowed_re = addr_hit[312] & reg_re & !reg_error;
  assign classa_phase3_cyc_shadowed_we = addr_hit[312] & reg_we & !reg_error;
  ...
  assign classb_ctrl_shadowed_re = addr_hit[316] & reg_re & !reg_error;
  assign classb_ctrl_shadowed_we = addr_hit[316] & reg_we & !reg_error;
  ...
  assign classb_accum_thresh_shadowed_re = addr_hit[320] & reg_re & !reg_error;
  assign classb_accum_thresh_shadowed_we = addr_hit[320] & reg_we & !reg_error;

  assign classb_accum_thresh_shadowed_wd = reg_wdata[15:0];
  assign classb_timeout_cyc_shadowed_re = addr_hit[321] & reg_re & !reg_error;
  assign classb_timeout_cyc_shadowed_we = addr_hit[321] & reg_we & !reg_error;

  assign classb_timeout_cyc_shadowed_wd = reg_wdata[31:0];
  assign classb_phase0_cyc_shadowed_re = addr_hit[322] & reg_re & !reg_error;
  assign classb_phase0_cyc_shadowed_we = addr_hit[322] & reg_we & !reg_error;

  assign classb_phase0_cyc_shadowed_wd = reg_wdata[31:0];
  assign classb_phase1_cyc_shadowed_re = addr_hit[323] & reg_re & !reg_error;
  assign classb_phase1_cyc_shadowed_we = addr_hit[323] & reg_we & !reg_error;

  assign classb_phase1_cyc_shadowed_wd = reg_wdata[31:0];
  assign classb_phase2_cyc_shadowed_re = addr_hit[324] & reg_re & !reg_error;
  assign classb_phase2_cyc_shadowed_we = addr_hit[324] & reg_we & !reg_error;

  assign classb_phase2_cyc_shadowed_wd = reg_wdata[31:0];
  assign classb_phase3_cyc_shadowed_re = addr_hit[325] & reg_re & !reg_error;
  assign classb_phase3_cyc_shadowed_we = addr_hit[325] & reg_we & !reg_error;
  ...
  assign classc_ctrl_shadowed_re = addr_hit[329] & reg_re & !reg_error;
  assign classc_ctrl_shadowed_we = addr_hit[329] & reg_we & !reg_error;
  ...
  assign classc_accum_thresh_shadowed_re = addr_hit[333] & reg_re & !reg_error;
  assign classc_accum_thresh_shadowed_we = addr_hit[333] & reg_we & !reg_error;

  assign classc_accum_thresh_shadowed_wd = reg_wdata[15:0];
  assign classc_timeout_cyc_shadowed_re = addr_hit[334] & reg_re & !reg_error;
  assign classc_timeout_cyc_shadowed_we = addr_hit[334] & reg_we & !reg_error;
