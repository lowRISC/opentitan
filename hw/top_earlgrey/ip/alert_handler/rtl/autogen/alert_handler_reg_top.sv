...
module alert_handler_reg_top (
  ...
  always_comb begin
    ...
    addr_hit[309] = (reg_addr == ALERT_HANDLER_CLASSA_CLR_OFFSET);
    ...
    addr_hit[313] = (reg_addr == ALERT_HANDLER_CLASSA_PHASE0_CYC_SHADOWED_OFFSET);
    addr_hit[314] = (reg_addr == ALERT_HANDLER_CLASSA_PHASE1_CYC_SHADOWED_OFFSET);
    addr_hit[315] = (reg_addr == ALERT_HANDLER_CLASSA_PHASE2_CYC_SHADOWED_OFFSET);
    addr_hit[316] = (reg_addr == ALERT_HANDLER_CLASSA_PHASE3_CYC_SHADOWED_OFFSET);
    addr_hit[317] = (reg_addr == ALERT_HANDLER_CLASSA_ESC_CNT_OFFSET);
    addr_hit[318] = (reg_addr == ALERT_HANDLER_CLASSA_STATE_OFFSET);
    addr_hit[319] = (reg_addr == ALERT_HANDLER_CLASSB_REGWEN_OFFSET);
    addr_hit[320] = (reg_addr == ALERT_HANDLER_CLASSB_CTRL_SHADOWED_OFFSET);
    addr_hit[321] = (reg_addr == ALERT_HANDLER_CLASSB_CLR_REGWEN_OFFSET);
    addr_hit[322] = (reg_addr == ALERT_HANDLER_CLASSB_CLR_OFFSET);
    addr_hit[323] = (reg_addr == ALERT_HANDLER_CLASSB_ACCUM_CNT_OFFSET);
    addr_hit[324] = (reg_addr == ALERT_HANDLER_CLASSB_ACCUM_THRESH_SHADOWED_OFFSET);
    addr_hit[325] = (reg_addr == ALERT_HANDLER_CLASSB_TIMEOUT_CYC_SHADOWED_OFFSET);
    addr_hit[326] = (reg_addr == ALERT_HANDLER_CLASSB_PHASE0_CYC_SHADOWED_OFFSET);
    addr_hit[327] = (reg_addr == ALERT_HANDLER_CLASSB_PHASE1_CYC_SHADOWED_OFFSET);
    addr_hit[328] = (reg_addr == ALERT_HANDLER_CLASSB_PHASE2_CYC_SHADOWED_OFFSET);
    addr_hit[329] = (reg_addr == ALERT_HANDLER_CLASSB_PHASE3_CYC_SHADOWED_OFFSET);
    addr_hit[330] = (reg_addr == ALERT_HANDLER_CLASSB_ESC_CNT_OFFSET);
    addr_hit[331] = (reg_addr == ALERT_HANDLER_CLASSB_STATE_OFFSET);
    addr_hit[332] = (reg_addr == ALERT_HANDLER_CLASSC_REGWEN_OFFSET);
    addr_hit[333] = (reg_addr == ALERT_HANDLER_CLASSC_CTRL_SHADOWED_OFFSET);
    addr_hit[334] = (reg_addr == ALERT_HANDLER_CLASSC_CLR_REGWEN_OFFSET);
    addr_hit[335] = (reg_addr == ALERT_HANDLER_CLASSC_CLR_OFFSET);
    addr_hit[336] = (reg_addr == ALERT_HANDLER_CLASSC_ACCUM_CNT_OFFSET);
    addr_hit[337] = (reg_addr == ALERT_HANDLER_CLASSC_ACCUM_THRESH_SHADOWED_OFFSET);
    addr_hit[338] = (reg_addr == ALERT_HANDLER_CLASSC_TIMEOUT_CYC_SHADOWED_OFFSET);
    addr_hit[339] = (reg_addr == ALERT_HANDLER_CLASSC_PHASE0_CYC_SHADOWED_OFFSET);
    addr_hit[340] = (reg_addr == ALERT_HANDLER_CLASSC_PHASE1_CYC_SHADOWED_OFFSET);
    addr_hit[341] = (reg_addr == ALERT_HANDLER_CLASSC_PHASE2_CYC_SHADOWED_OFFSET);
    addr_hit[342] = (reg_addr == ALERT_HANDLER_CLASSC_PHASE3_CYC_SHADOWED_OFFSET);
    addr_hit[343] = (reg_addr == ALERT_HANDLER_CLASSC_ESC_CNT_OFFSET);
    addr_hit[344] = (reg_addr == ALERT_HANDLER_CLASSC_STATE_OFFSET);
    addr_hit[345] = (reg_addr == ALERT_HANDLER_CLASSD_REGWEN_OFFSET);
    addr_hit[346] = (reg_addr == ALERT_HANDLER_CLASSD_CTRL_SHADOWED_OFFSET);
    addr_hit[347] = (reg_addr == ALERT_HANDLER_CLASSD_CLR_REGWEN_OFFSET);
    addr_hit[348] = (reg_addr == ALERT_HANDLER_CLASSD_CLR_OFFSET);
    addr_hit[349] = (reg_addr == ALERT_HANDLER_CLASSD_ACCUM_CNT_OFFSET);
    addr_hit[350] = (reg_addr == ALERT_HANDLER_CLASSD_ACCUM_THRESH_SHADOWED_OFFSET);
    addr_hit[351] = (reg_addr == ALERT_HANDLER_CLASSD_TIMEOUT_CYC_SHADOWED_OFFSET);
  ...
  assign classa_clr_we = addr_hit[309] & reg_we & !reg_error;
  ...
  assign classa_phase0_cyc_shadowed_re = addr_hit[313] & reg_re & !reg_error;
  assign classa_phase0_cyc_shadowed_we = addr_hit[313] & reg_we & !reg_error;

  assign classa_phase0_cyc_shadowed_wd = reg_wdata[31:0];
  assign classa_phase1_cyc_shadowed_re = addr_hit[314] & reg_re & !reg_error;
  assign classa_phase1_cyc_shadowed_we = addr_hit[314] & reg_we & !reg_error;

  assign classa_phase1_cyc_shadowed_wd = reg_wdata[31:0];
  assign classa_phase2_cyc_shadowed_re = addr_hit[315] & reg_re & !reg_error;
  assign classa_phase2_cyc_shadowed_we = addr_hit[315] & reg_we & !reg_error;

  assign classa_phase2_cyc_shadowed_wd = reg_wdata[31:0];
  assign classa_phase3_cyc_shadowed_re = addr_hit[316] & reg_re & !reg_error;
  assign classa_phase3_cyc_shadowed_we = addr_hit[316] & reg_we & !reg_error;

  assign classa_phase3_cyc_shadowed_wd = reg_wdata[31:0];
  assign classa_esc_cnt_re = addr_hit[317] & reg_re & !reg_error;
  assign classa_state_re = addr_hit[318] & reg_re & !reg_error;
  assign classb_regwen_we = addr_hit[319] & reg_we & !reg_error;

  assign classb_regwen_wd = reg_wdata[0];
  assign classb_ctrl_shadowed_re = addr_hit[320] & reg_re & !reg_error;
  assign classb_ctrl_shadowed_we = addr_hit[320] & reg_we & !reg_error;
  ...
  assign classb_clr_regwen_we = addr_hit[321] & reg_we & !reg_error;

  assign classb_clr_regwen_wd = reg_wdata[0];
  assign classb_clr_we = addr_hit[322] & reg_we & !reg_error;

  assign classb_clr_wd = reg_wdata[0];
  assign classb_accum_cnt_re = addr_hit[323] & reg_re & !reg_error;
  assign classb_accum_thresh_shadowed_re = addr_hit[324] & reg_re & !reg_error;
  assign classb_accum_thresh_shadowed_we = addr_hit[324] & reg_we & !reg_error;

  assign classb_accum_thresh_shadowed_wd = reg_wdata[15:0];
  assign classb_timeout_cyc_shadowed_re = addr_hit[325] & reg_re & !reg_error;
  assign classb_timeout_cyc_shadowed_we = addr_hit[325] & reg_we & !reg_error;

  assign classb_timeout_cyc_shadowed_wd = reg_wdata[31:0];
  assign classb_phase0_cyc_shadowed_re = addr_hit[326] & reg_re & !reg_error;
  assign classb_phase0_cyc_shadowed_we = addr_hit[326] & reg_we & !reg_error;

  assign classb_phase0_cyc_shadowed_wd = reg_wdata[31:0];
  assign classb_phase1_cyc_shadowed_re = addr_hit[327] & reg_re & !reg_error;
  assign classb_phase1_cyc_shadowed_we = addr_hit[327] & reg_we & !reg_error;

  assign classb_phase1_cyc_shadowed_wd = reg_wdata[31:0];
  assign classb_phase2_cyc_shadowed_re = addr_hit[328] & reg_re & !reg_error;
  assign classb_phase2_cyc_shadowed_we = addr_hit[328] & reg_we & !reg_error;

  assign classb_phase2_cyc_shadowed_wd = reg_wdata[31:0];
  assign classb_phase3_cyc_shadowed_re = addr_hit[329] & reg_re & !reg_error;
  assign classb_phase3_cyc_shadowed_we = addr_hit[329] & reg_we & !reg_error;

  assign classb_phase3_cyc_shadowed_wd = reg_wdata[31:0];
  assign classb_esc_cnt_re = addr_hit[330] & reg_re & !reg_error;
  assign classb_state_re = addr_hit[331] & reg_re & !reg_error;
  assign classc_regwen_we = addr_hit[332] & reg_we & !reg_error;

  assign classc_regwen_wd = reg_wdata[0];
  assign classc_ctrl_shadowed_re = addr_hit[333] & reg_re & !reg_error;
  assign classc_ctrl_shadowed_we = addr_hit[333] & reg_we & !reg_error;
  ...
  assign classc_clr_regwen_we = addr_hit[334] & reg_we & !reg_error;

  assign classc_clr_regwen_wd = reg_wdata[0];
  assign classc_clr_we = addr_hit[335] & reg_we & !reg_error;

  assign classc_clr_wd = reg_wdata[0];
  assign classc_accum_cnt_re = addr_hit[336] & reg_re & !reg_error;
  assign classc_accum_thresh_shadowed_re = addr_hit[337] & reg_re & !reg_error;
  assign classc_accum_thresh_shadowed_we = addr_hit[337] & reg_we & !reg_error;

  assign classc_accum_thresh_shadowed_wd = reg_wdata[15:0];
  assign classc_timeout_cyc_shadowed_re = addr_hit[338] & reg_re & !reg_error;
  assign classc_timeout_cyc_shadowed_we = addr_hit[338] & reg_we & !reg_error;

  assign classc_timeout_cyc_shadowed_wd = reg_wdata[31:0];
  assign classc_phase0_cyc_shadowed_re = addr_hit[339] & reg_re & !reg_error;
  assign classc_phase0_cyc_shadowed_we = addr_hit[339] & reg_we & !reg_error;

  assign classc_phase0_cyc_shadowed_wd = reg_wdata[31:0];
  assign classc_phase1_cyc_shadowed_re = addr_hit[340] & reg_re & !reg_error;
  assign classc_phase1_cyc_shadowed_we = addr_hit[340] & reg_we & !reg_error;

  assign classc_phase1_cyc_shadowed_wd = reg_wdata[31:0];
  assign classc_phase2_cyc_shadowed_re = addr_hit[341] & reg_re & !reg_error;
  assign classc_phase2_cyc_shadowed_we = addr_hit[341] & reg_we & !reg_error;

  assign classc_phase2_cyc_shadowed_wd = reg_wdata[31:0];
  assign classc_phase3_cyc_shadowed_re = addr_hit[342] & reg_re & !reg_error;
  assign classc_phase3_cyc_shadowed_we = addr_hit[342] & reg_we & !reg_error;

  assign classc_phase3_cyc_shadowed_wd = reg_wdata[31:0];
  assign classc_esc_cnt_re = addr_hit[343] & reg_re & !reg_error;
  assign classc_state_re = addr_hit[344] & reg_re & !reg_error;
  assign classd_regwen_we = addr_hit[345] & reg_we & !reg_error;

  assign classd_regwen_wd = reg_wdata[0];
  assign classd_ctrl_shadowed_re = addr_hit[346] & reg_re & !reg_error;
  assign classd_ctrl_shadowed_we = addr_hit[346] & reg_we & !reg_error;
  ...
  assign classd_clr_regwen_we = addr_hit[347] & reg_we & !reg_error;

  assign classd_clr_regwen_wd = reg_wdata[0];
  assign classd_clr_we = addr_hit[348] & reg_we & !reg_error;

  assign classd_clr_wd = reg_wdata[0];
  assign classd_accum_cnt_re = addr_hit[349] & reg_re & !reg_error;
  assign classd_accum_thresh_shadowed_re = addr_hit[350] & reg_re & !reg_error;
  assign classd_accum_thresh_shadowed_we = addr_hit[350] & reg_we & !reg_error;

  assign classd_accum_thresh_shadowed_wd = reg_wdata[15:0];
  assign classd_timeout_cyc_shadowed_re = addr_hit[351] & reg_re & !reg_error;
  assign classd_timeout_cyc_shadowed_we = addr_hit[351] & reg_we & !reg_error;
