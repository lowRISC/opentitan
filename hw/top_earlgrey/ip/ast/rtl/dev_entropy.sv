...
// Device Enable Sync
////////////////////////////////////
logic dev_en_es, dev_en_dev;

// Sync dev_en to ES clock
prim_flop_2sync #(
  .Width ( 1 ),
  .ResetValue ( 1'b0 )
) u_dev_en_es_sync (
...
// Entropy Rate
///////////////////////////////////////
logic fast_start, rate_pulse, rvalid;
...
always_ff @( posedge clk_dev_i, negedge rst_dev_ni ) begin
  if ( !rst_dev_ni ) begin
    ...
    fast_start <= 1'b0;
  end else if ( fast_start && rvalid ) begin
...
assign set_wdata_val =  dev_en_es && !wdata_val && dev_ack_i;
assign clr_wdata_val = !dev_en_es ||  wdata_val && wready_es_fe;
...
assign dev_wready_o = !wdata_val && dev_en_es;
