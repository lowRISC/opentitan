...
package tl_main_pkg;
  ...
  localparam logic [31:0] ADDR_MASK_RV_DM__REGS          = 32'h 0000007f;
  localparam logic [31:0] ADDR_MASK_RV_DM__MEM           = 32'h 00000fff;
  localparam logic [31:0] ADDR_MASK_ROM_CTRL__ROM        = 32'h 00007fff;
  localparam logic [31:0] ADDR_MASK_ROM_CTRL__REGS       = 32'h 000000ff;
  localparam logic [1:0][31:0] ADDR_MASK_PERI                 = {
    32'h 003fffff,
    32'h 001fffff
  };
  localparam logic [31:0] ADDR_MASK_SPI_HOST0            = 32'h 0000007f;
  localparam logic [31:0] ADDR_MASK_SPI_HOST1            = 32'h 0000007f;
  ...
  localparam logic [31:0] ADDR_MASK_ENTROPY_SRC          = 32'h 000001ff;
  localparam logic [31:0] ADDR_MASK_CSRNG                = 32'h 000000ff;
  localparam logic [31:0] ADDR_MASK_EDN0                 = 32'h 000000ff;
  localparam logic [31:0] ADDR_MASK_EDN1                 = 32'h 000000ff;
  localparam logic [31:0] ADDR_MASK_RV_PLIC              = 32'h 07ffffff;
  localparam logic [31:0] ADDR_MASK_OTBN                 = 32'h 0000ffff;
  localparam logic [31:0] ADDR_MASK_KEYMGR               = 32'h 000001ff;
  localparam logic [31:0] ADDR_MASK_RV_CORE_IBEX__CFG    = 32'h 000000ff;
  localparam logic [31:0] ADDR_MASK_SRAM_CTRL_MAIN__REGS = 32'h 0000007f;
