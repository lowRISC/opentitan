...
module xbar_main (
  ...
  tl_h2d_t tl_s1n_38_ds_h2d [14];
  tl_d2h_t tl_s1n_38_ds_d2h [14];

  // Create steering signal
  logic [3:0] dev_sel_s1n_38;
  ...
  assign tl_sm1_28_us_h2d[0] = tl_s1n_24_ds_h2d[5];
  assign tl_s1n_24_ds_d2h[5] = tl_sm1_28_us_d2h[0];

  assign tl_sm1_29_us_h2d[0] = tl_s1n_24_ds_h2d[6];
  assign tl_s1n_24_ds_d2h[6] = tl_sm1_29_us_d2h[0];

  assign tl_sm1_30_us_h2d[0] = tl_s1n_24_ds_h2d[7];
  assign tl_s1n_24_ds_d2h[7] = tl_sm1_30_us_d2h[0];

  assign tl_sm1_31_us_h2d[0] = tl_s1n_24_ds_h2d[8];
  assign tl_s1n_24_ds_d2h[8] = tl_sm1_31_us_d2h[0];

  assign tl_sm1_32_us_h2d[0] = tl_s1n_24_ds_h2d[9];
  assign tl_s1n_24_ds_d2h[9] = tl_sm1_32_us_d2h[0];

  assign tl_sm1_33_us_h2d[0] = tl_s1n_24_ds_h2d[10];
  assign tl_s1n_24_ds_d2h[10] = tl_sm1_33_us_d2h[0];

  assign tl_sm1_34_us_h2d[0] = tl_s1n_24_ds_h2d[11];
  assign tl_s1n_24_ds_d2h[11] = tl_sm1_34_us_d2h[0];

  assign tl_sm1_35_us_h2d[0] = tl_s1n_24_ds_h2d[12];
  assign tl_s1n_24_ds_d2h[12] = tl_sm1_35_us_d2h[0];

  assign tl_keymgr_o = tl_s1n_24_ds_h2d[13];
  assign tl_s1n_24_ds_d2h[13] = tl_keymgr_i;

  assign tl_sm1_36_us_h2d[0] = tl_s1n_24_ds_h2d[14];
  assign tl_s1n_24_ds_d2h[14] = tl_sm1_36_us_d2h[0];

  assign tl_sm1_37_us_h2d[0] = tl_s1n_24_ds_h2d[15];
  assign tl_s1n_24_ds_d2h[15] = tl_sm1_37_us_d2h[0];

  assign tl_sm1_20_us_h2d[2] = tl_s1n_38_ds_h2d[0];
  assign tl_s1n_38_ds_d2h[0] = tl_sm1_20_us_d2h[2];

  assign tl_sm1_22_us_h2d[2] = tl_s1n_38_ds_h2d[1];
  assign tl_s1n_38_ds_d2h[1] = tl_sm1_22_us_d2h[2];

  assign tl_sm1_23_us_h2d[2] = tl_s1n_38_ds_h2d[2];
  assign tl_s1n_38_ds_d2h[2] = tl_sm1_23_us_d2h[2];

  assign tl_sm1_26_us_h2d[1] = tl_s1n_38_ds_h2d[3];
  assign tl_s1n_38_ds_d2h[3] = tl_sm1_26_us_d2h[1];

  assign tl_sm1_28_us_h2d[1] = tl_s1n_38_ds_h2d[4];
  assign tl_s1n_38_ds_d2h[4] = tl_sm1_28_us_d2h[1];

  assign tl_sm1_29_us_h2d[1] = tl_s1n_38_ds_h2d[5];
  assign tl_s1n_38_ds_d2h[5] = tl_sm1_29_us_d2h[1];

  assign tl_sm1_30_us_h2d[1] = tl_s1n_38_ds_h2d[6];
  assign tl_s1n_38_ds_d2h[6] = tl_sm1_30_us_d2h[1];

  assign tl_sm1_31_us_h2d[1] = tl_s1n_38_ds_h2d[7];
  assign tl_s1n_38_ds_d2h[7] = tl_sm1_31_us_d2h[1];

  assign tl_sm1_32_us_h2d[1] = tl_s1n_38_ds_h2d[8];
  assign tl_s1n_38_ds_d2h[8] = tl_sm1_32_us_d2h[1];

  assign tl_sm1_33_us_h2d[1] = tl_s1n_38_ds_h2d[9];
  assign tl_s1n_38_ds_d2h[9] = tl_sm1_33_us_d2h[1];

  assign tl_sm1_34_us_h2d[1] = tl_s1n_38_ds_h2d[10];
  assign tl_s1n_38_ds_d2h[10] = tl_sm1_34_us_d2h[1];

  assign tl_sm1_35_us_h2d[1] = tl_s1n_38_ds_h2d[11];
  assign tl_s1n_38_ds_d2h[11] = tl_sm1_35_us_d2h[1];

  assign tl_sm1_36_us_h2d[1] = tl_s1n_38_ds_h2d[12];
  assign tl_s1n_38_ds_d2h[12] = tl_sm1_36_us_d2h[1];

  assign tl_sm1_37_us_h2d[1] = tl_s1n_38_ds_h2d[13];
  assign tl_s1n_38_ds_d2h[13] = tl_sm1_37_us_d2h[1];
  ...
  assign tl_aon_o = tl_asf_27_ds_h2d;
  assign tl_asf_27_ds_d2h = tl_aon_i;
  ...
  assign tl_kmac_o = tl_sm1_32_ds_h2d;
  assign tl_sm1_32_ds_d2h = tl_kmac_i;

  assign tl_rv_plic_o = tl_sm1_33_ds_h2d;
  assign tl_sm1_33_ds_d2h = tl_rv_plic_i;

  assign tl_alert_handler_o = tl_sm1_34_ds_h2d;
  assign tl_sm1_34_ds_d2h = tl_alert_handler_i;

  assign tl_nmi_gen_o = tl_sm1_35_ds_h2d;
  assign tl_sm1_35_ds_d2h = tl_nmi_gen_i;
  ...
  assign tl_s1n_38_us_h2d = tl_dm_sba_i;
  assign tl_dm_sba_o = tl_s1n_38_us_d2h;
  ...
  always_comb begin
    ...
    end else if ((tl_s1n_24_us_h2d.a_address & ~(ADDR_MASK_CSRNG)) == ADDR_SPACE_CSRNG) begin
      dev_sel_s1n_24 = 5'd14;

    end else if ((tl_s1n_24_us_h2d.a_address & ~(ADDR_MASK_ENTROPY_SRC)) == ADDR_SPACE_ENTROPY_SRC) begin
  ...
  always_comb begin
    // default steering to generate error response if address is not within the range
    dev_sel_s1n_38 = 4'd14;
    if ((tl_s1n_38_us_h2d.a_address & ~(ADDR_MASK_ROM)) == ADDR_SPACE_ROM) begin
      dev_sel_s1n_38 = 4'd0;

    end else if ((tl_s1n_38_us_h2d.a_address & ~(ADDR_MASK_RAM_MAIN)) == ADDR_SPACE_RAM_MAIN) begin
      dev_sel_s1n_38 = 4'd1;
    ...
    end else if ((tl_s1n_38_us_h2d.a_address & ~(ADDR_MASK_FLASH_CTRL)) == ADDR_SPACE_FLASH_CTRL) begin
      dev_sel_s1n_38 = 4'd5;

    end else if ((tl_s1n_38_us_h2d.a_address & ~(ADDR_MASK_AES)) == ADDR_SPACE_AES) begin
      dev_sel_s1n_38 = 4'd6;

    end else if ((tl_s1n_38_us_h2d.a_address & ~(ADDR_MASK_HMAC)) == ADDR_SPACE_HMAC) begin
      dev_sel_s1n_38 = 4'd7;

    end else if ((tl_s1n_38_us_h2d.a_address & ~(ADDR_MASK_KMAC)) == ADDR_SPACE_KMAC) begin
      dev_sel_s1n_38 = 4'd8;

    end else if ((tl_s1n_38_us_h2d.a_address & ~(ADDR_MASK_RV_PLIC)) == ADDR_SPACE_RV_PLIC) begin
      dev_sel_s1n_38 = 4'd9;

    end else if ((tl_s1n_38_us_h2d.a_address & ~(ADDR_MASK_ALERT_HANDLER)) == ADDR_SPACE_ALERT_HANDLER) begin
      dev_sel_s1n_38 = 4'd10;

    end else if ((tl_s1n_38_us_h2d.a_address & ~(ADDR_MASK_NMI_GEN)) == ADDR_SPACE_NMI_GEN) begin
      dev_sel_s1n_38 = 4'd11;

    end else if ((tl_s1n_38_us_h2d.a_address & ~(ADDR_MASK_CSRNG)) == ADDR_SPACE_CSRNG) begin
      dev_sel_s1n_38 = 4'd12;

    end else if ((tl_s1n_38_us_h2d.a_address & ~(ADDR_MASK_ENTROPY_SRC)) == ADDR_SPACE_ENTROPY_SRC) begin
      dev_sel_s1n_38 = 4'd13;
end
  end
