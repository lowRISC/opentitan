...
module xbar_main (
  ...
  tl_h2d_t tl_s1n_34_ds_h2d [12];
  tl_d2h_t tl_s1n_34_ds_d2h [12];
  ...
  assign tl_sm1_26_us_h2d[0] = tl_s1n_22_ds_h2d[5];
  assign tl_s1n_22_ds_d2h[5] = tl_sm1_26_us_d2h[0];

  assign tl_sm1_27_us_h2d[0] = tl_s1n_22_ds_h2d[6];
  assign tl_s1n_22_ds_d2h[6] = tl_sm1_27_us_d2h[0];

  assign tl_sm1_28_us_h2d[0] = tl_s1n_22_ds_h2d[7];
  assign tl_s1n_22_ds_d2h[7] = tl_sm1_28_us_d2h[0];

  assign tl_sm1_29_us_h2d[0] = tl_s1n_22_ds_h2d[8];
  assign tl_s1n_22_ds_d2h[8] = tl_sm1_29_us_d2h[0];

  assign tl_sm1_30_us_h2d[0] = tl_s1n_22_ds_h2d[9];
  assign tl_s1n_22_ds_d2h[9] = tl_sm1_30_us_d2h[0];

  assign tl_sm1_31_us_h2d[0] = tl_s1n_22_ds_h2d[10];
  assign tl_s1n_22_ds_d2h[10] = tl_sm1_31_us_d2h[0];

  assign tl_sm1_32_us_h2d[0] = tl_s1n_22_ds_h2d[11];
  assign tl_s1n_22_ds_d2h[11] = tl_sm1_32_us_d2h[0];

  assign tl_keymgr_o = tl_s1n_22_ds_h2d[12];
  assign tl_s1n_22_ds_d2h[12] = tl_keymgr_i;
  ...
  assign tl_sm1_26_us_h2d[1] = tl_s1n_34_ds_h2d[4];
  assign tl_s1n_34_ds_d2h[4] = tl_sm1_26_us_d2h[1];

  assign tl_sm1_27_us_h2d[1] = tl_s1n_34_ds_h2d[5];
  assign tl_s1n_34_ds_d2h[5] = tl_sm1_27_us_d2h[1];

  assign tl_sm1_28_us_h2d[1] = tl_s1n_34_ds_h2d[6];
  assign tl_s1n_34_ds_d2h[6] = tl_sm1_28_us_d2h[1];

  assign tl_sm1_29_us_h2d[1] = tl_s1n_34_ds_h2d[7];
  assign tl_s1n_34_ds_d2h[7] = tl_sm1_29_us_d2h[1];

  assign tl_sm1_30_us_h2d[1] = tl_s1n_34_ds_h2d[8];
  assign tl_s1n_34_ds_d2h[8] = tl_sm1_30_us_d2h[1];

  assign tl_sm1_31_us_h2d[1] = tl_s1n_34_ds_h2d[9];
  assign tl_s1n_34_ds_d2h[9] = tl_sm1_31_us_d2h[1];

  assign tl_sm1_32_us_h2d[1] = tl_s1n_34_ds_h2d[10];
  assign tl_s1n_34_ds_d2h[10] = tl_sm1_32_us_d2h[1];
  ...
  assign tl_aon_o = tl_asf_25_ds_h2d;
  assign tl_asf_25_ds_d2h = tl_aon_i;
  ...
  always_comb begin
    ...
    end else if (((tl_s1n_22_us_h2d.a_address <= (ADDR_MASK_PERI + ADDR_SPACE_PERI)) &&
       (tl_s1n_22_us_h2d.a_address >= ADDR_SPACE_PERI))) begin
      dev_sel_s1n_22 = 4'd4;

    end else if ((tl_s1n_22_us_h2d.a_address & ~(ADDR_MASK_AON)) == ADDR_SPACE_AON) begin
      dev_sel_s1n_22 = 4'd5;
    ...
    end else if ((tl_s1n_22_us_h2d.a_address & ~(ADDR_MASK_KEYMGR)) == ADDR_SPACE_KEYMGR) begin
      dev_sel_s1n_22 = 4'd12;

    end else if ((tl_s1n_22_us_h2d.a_address & ~(ADDR_MASK_CSRNG)) == ADDR_SPACE_CSRNG) begin
  ...
  always_comb begin
    ...
    end else if (((tl_s1n_34_us_h2d.a_address <= (ADDR_MASK_PERI + ADDR_SPACE_PERI)) &&
       (tl_s1n_34_us_h2d.a_address >= ADDR_SPACE_PERI))) begin
      dev_sel_s1n_34 = 4'd3;

    end else if ((tl_s1n_34_us_h2d.a_address & ~(ADDR_MASK_AON)) == ADDR_SPACE_AON) begin
      dev_sel_s1n_34 = 4'd4;
    ...
    end else if ((tl_s1n_34_us_h2d.a_address & ~(ADDR_MASK_CSRNG)) == ADDR_SPACE_CSRNG) begin
