...
module xbar_main (
  ...
  output tlul_pkg::tl_h2d_t tl_tlul2axi_o,
  input  tlul_pkg::tl_d2h_t tl_tlul2axi_i,
  ...
  tl_h2d_t tl_s1n_56_ds_h2d [24];
  tl_d2h_t tl_s1n_56_ds_d2h [24];

  // Create steering signal
  logic [4:0] dev_sel_s1n_56;
  ...
  assign tl_sm1_36_us_h2d[0] = tl_s1n_33_ds_h2d[4];
  assign tl_s1n_33_ds_d2h[4] = tl_sm1_36_us_d2h[0];

  assign tl_sm1_31_us_h2d[1] = tl_s1n_33_ds_h2d[5];
  assign tl_s1n_33_ds_d2h[5] = tl_sm1_31_us_d2h[1];

  assign tl_sm1_38_us_h2d[0] = tl_s1n_33_ds_h2d[6];
  assign tl_s1n_33_ds_d2h[6] = tl_sm1_38_us_d2h[0];

  assign tl_sm1_39_us_h2d[0] = tl_s1n_33_ds_h2d[7];
  assign tl_s1n_33_ds_d2h[7] = tl_sm1_39_us_d2h[0];

  assign tl_sm1_40_us_h2d[0] = tl_s1n_33_ds_h2d[8];
  assign tl_s1n_33_ds_d2h[8] = tl_sm1_40_us_d2h[0];

  assign tl_sm1_41_us_h2d[0] = tl_s1n_33_ds_h2d[9];
  assign tl_s1n_33_ds_d2h[9] = tl_sm1_41_us_d2h[0];

  assign tl_sm1_42_us_h2d[0] = tl_s1n_33_ds_h2d[10];
  assign tl_s1n_33_ds_d2h[10] = tl_sm1_42_us_d2h[0];

  assign tl_sm1_32_us_h2d[1] = tl_s1n_33_ds_h2d[11];
  assign tl_s1n_33_ds_d2h[11] = tl_sm1_32_us_d2h[1];

  assign tl_sm1_43_us_h2d[0] = tl_s1n_33_ds_h2d[12];
  assign tl_s1n_33_ds_d2h[12] = tl_sm1_43_us_d2h[0];

  assign tl_sm1_44_us_h2d[0] = tl_s1n_33_ds_h2d[13];
  assign tl_s1n_33_ds_d2h[13] = tl_sm1_44_us_d2h[0];

  assign tl_sm1_45_us_h2d[0] = tl_s1n_33_ds_h2d[14];
  assign tl_s1n_33_ds_d2h[14] = tl_sm1_45_us_d2h[0];

  assign tl_sm1_46_us_h2d[0] = tl_s1n_33_ds_h2d[15];
  assign tl_s1n_33_ds_d2h[15] = tl_sm1_46_us_d2h[0];

  assign tl_sm1_47_us_h2d[0] = tl_s1n_33_ds_h2d[16];
  assign tl_s1n_33_ds_d2h[16] = tl_sm1_47_us_d2h[0];

  assign tl_sm1_48_us_h2d[0] = tl_s1n_33_ds_h2d[17];
  assign tl_s1n_33_ds_d2h[17] = tl_sm1_48_us_d2h[0];

  assign tl_sm1_49_us_h2d[0] = tl_s1n_33_ds_h2d[18];
  assign tl_s1n_33_ds_d2h[18] = tl_sm1_49_us_d2h[0];

  assign tl_sm1_50_us_h2d[0] = tl_s1n_33_ds_h2d[19];
  assign tl_s1n_33_ds_d2h[19] = tl_sm1_50_us_d2h[0];

  assign tl_sm1_51_us_h2d[0] = tl_s1n_33_ds_h2d[20];
  assign tl_s1n_33_ds_d2h[20] = tl_sm1_51_us_d2h[0];

  assign tl_sm1_52_us_h2d[0] = tl_s1n_33_ds_h2d[21];
  assign tl_s1n_33_ds_d2h[21] = tl_sm1_52_us_d2h[0];

  assign tl_sm1_53_us_h2d[0] = tl_s1n_33_ds_h2d[22];
  assign tl_s1n_33_ds_d2h[22] = tl_sm1_53_us_d2h[0];

  assign tl_sm1_54_us_h2d[0] = tl_s1n_33_ds_h2d[23];
  assign tl_s1n_33_ds_d2h[23] = tl_sm1_54_us_d2h[0];

  assign tl_sm1_55_us_h2d[0] = tl_s1n_33_ds_h2d[24];
  assign tl_s1n_33_ds_d2h[24] = tl_sm1_55_us_d2h[0];

  assign tl_sm1_36_us_h2d[1] = tl_s1n_56_ds_h2d[0];
  assign tl_s1n_56_ds_d2h[0] = tl_sm1_36_us_d2h[1];

  assign tl_sm1_29_us_h2d[2] = tl_s1n_56_ds_h2d[1];
  assign tl_s1n_56_ds_d2h[1] = tl_sm1_29_us_d2h[2];

  assign tl_sm1_34_us_h2d[1] = tl_s1n_56_ds_h2d[2];
  assign tl_s1n_56_ds_d2h[2] = tl_sm1_34_us_d2h[1];

  assign tl_sm1_38_us_h2d[1] = tl_s1n_56_ds_h2d[3];
  assign tl_s1n_56_ds_d2h[3] = tl_sm1_38_us_d2h[1];

  assign tl_sm1_35_us_h2d[1] = tl_s1n_56_ds_h2d[4];
  assign tl_s1n_56_ds_d2h[4] = tl_sm1_35_us_d2h[1];

  assign tl_sm1_39_us_h2d[1] = tl_s1n_56_ds_h2d[5];
  assign tl_s1n_56_ds_d2h[5] = tl_sm1_39_us_d2h[1];

  assign tl_sm1_52_us_h2d[1] = tl_s1n_56_ds_h2d[6];
  assign tl_s1n_56_ds_d2h[6] = tl_sm1_52_us_d2h[1];

  assign tl_sm1_40_us_h2d[1] = tl_s1n_56_ds_h2d[7];
  assign tl_s1n_56_ds_d2h[7] = tl_sm1_40_us_d2h[1];

  assign tl_sm1_41_us_h2d[1] = tl_s1n_56_ds_h2d[8];
  assign tl_s1n_56_ds_d2h[8] = tl_sm1_41_us_d2h[1];

  assign tl_sm1_42_us_h2d[1] = tl_s1n_56_ds_h2d[9];
  assign tl_s1n_56_ds_d2h[9] = tl_sm1_42_us_d2h[1];

  assign tl_sm1_32_us_h2d[2] = tl_s1n_56_ds_h2d[10];
  assign tl_s1n_56_ds_d2h[10] = tl_sm1_32_us_d2h[2];

  assign tl_sm1_48_us_h2d[1] = tl_s1n_56_ds_h2d[11];
  assign tl_s1n_56_ds_d2h[11] = tl_sm1_48_us_d2h[1];

  assign tl_sm1_53_us_h2d[1] = tl_s1n_56_ds_h2d[12];
  assign tl_s1n_56_ds_d2h[12] = tl_sm1_53_us_d2h[1];

  assign tl_sm1_43_us_h2d[1] = tl_s1n_56_ds_h2d[13];
  assign tl_s1n_56_ds_d2h[13] = tl_sm1_43_us_d2h[1];

  assign tl_sm1_44_us_h2d[1] = tl_s1n_56_ds_h2d[14];
  assign tl_s1n_56_ds_d2h[14] = tl_sm1_44_us_d2h[1];

  assign tl_sm1_45_us_h2d[1] = tl_s1n_56_ds_h2d[15];
  assign tl_s1n_56_ds_d2h[15] = tl_sm1_45_us_d2h[1];

  assign tl_sm1_46_us_h2d[1] = tl_s1n_56_ds_h2d[16];
  assign tl_s1n_56_ds_d2h[16] = tl_sm1_46_us_d2h[1];

  assign tl_sm1_47_us_h2d[1] = tl_s1n_56_ds_h2d[17];
  assign tl_s1n_56_ds_d2h[17] = tl_sm1_47_us_d2h[1];

  assign tl_sm1_49_us_h2d[1] = tl_s1n_56_ds_h2d[18];
  assign tl_s1n_56_ds_d2h[18] = tl_sm1_49_us_d2h[1];

  assign tl_sm1_50_us_h2d[1] = tl_s1n_56_ds_h2d[19];
  assign tl_s1n_56_ds_d2h[19] = tl_sm1_50_us_d2h[1];

  assign tl_sm1_51_us_h2d[1] = tl_s1n_56_ds_h2d[20];
  assign tl_s1n_56_ds_d2h[20] = tl_sm1_51_us_d2h[1];

  assign tl_sm1_55_us_h2d[1] = tl_s1n_56_ds_h2d[21];
  assign tl_s1n_56_ds_d2h[21] = tl_sm1_55_us_d2h[1];

  assign tl_sm1_54_us_h2d[1] = tl_s1n_56_ds_h2d[22];
  assign tl_s1n_56_ds_d2h[22] = tl_sm1_54_us_d2h[1];

  assign tl_sm1_31_us_h2d[2] = tl_s1n_56_ds_h2d[23];
  assign tl_s1n_56_ds_d2h[23] = tl_sm1_31_us_d2h[2];
  ...
  assign tl_spi_host0_o = tl_sm1_39_ds_h2d;
  assign tl_sm1_39_ds_d2h = tl_spi_host0_i;

  assign tl_spi_host1_o = tl_sm1_40_ds_h2d;
  assign tl_sm1_40_ds_d2h = tl_spi_host1_i;
  ...
  assign tl_aes_o = tl_sm1_43_ds_h2d;
  assign tl_sm1_43_ds_d2h = tl_aes_i;

  assign tl_entropy_src_o = tl_sm1_44_ds_h2d;
  assign tl_sm1_44_ds_d2h = tl_entropy_src_i;

  assign tl_csrng_o = tl_sm1_45_ds_h2d;
  assign tl_sm1_45_ds_d2h = tl_csrng_i;

  assign tl_edn0_o = tl_sm1_46_ds_h2d;
  assign tl_sm1_46_ds_d2h = tl_edn0_i;

  assign tl_edn1_o = tl_sm1_47_ds_h2d;
  assign tl_sm1_47_ds_d2h = tl_edn1_i;

  assign tl_hmac_o = tl_sm1_48_ds_h2d;
  assign tl_sm1_48_ds_d2h = tl_hmac_i;

  assign tl_rv_plic_o = tl_sm1_49_ds_h2d;
  assign tl_sm1_49_ds_d2h = tl_rv_plic_i;

  assign tl_otbn_o = tl_sm1_50_ds_h2d;
  assign tl_sm1_50_ds_d2h = tl_otbn_i;

  assign tl_keymgr_o = tl_sm1_51_ds_h2d;
  assign tl_sm1_51_ds_d2h = tl_keymgr_i;

  assign tl_usbdev_o = tl_sm1_52_ds_h2d;
  assign tl_sm1_52_ds_d2h = tl_usbdev_i;

  assign tl_kmac_o = tl_sm1_53_ds_h2d;
  assign tl_sm1_53_ds_d2h = tl_kmac_i;

  assign tl_sram_ctrl_main__regs_o = tl_sm1_54_ds_h2d;
  assign tl_sm1_54_ds_d2h = tl_sram_ctrl_main__regs_i;

  assign tl_rv_core_ibex__cfg_o = tl_sm1_55_ds_h2d;
  assign tl_sm1_55_ds_d2h = tl_rv_core_ibex__cfg_i;

  assign tl_s1n_56_us_h2d = tl_rv_dm__sba_i;
  assign tl_rv_dm__sba_o = tl_s1n_56_us_d2h;
  ...
  always_comb begin
    ...
    if ((tl_s1n_33_us_h2d.a_address &
      ...
      ((tl_s1n_33_us_h2d.a_address <= (ADDR_MASK_TLUL2AXI[0] + ADDR_SPACE_TLUL2AXI[0])) &&
       (tl_s1n_33_us_h2d.a_address >= ADDR_SPACE_TLUL2AXI[0])) ||
      ((tl_s1n_33_us_h2d.a_address <= (ADDR_MASK_TLUL2AXI[1] + ADDR_SPACE_TLUL2AXI[1])) &&
       (tl_s1n_33_us_h2d.a_address >= ADDR_SPACE_TLUL2AXI[1]))
    ) begin
      dev_sel_s1n_33 = 5'd3;
  ...
  always_comb begin
    ...
    if ((tl_s1n_56_us_h2d.a_address &
      ...
      ((tl_s1n_56_us_h2d.a_address <= (ADDR_MASK_PERI[0] + ADDR_SPACE_PERI[0])) &&
       (tl_s1n_56_us_h2d.a_address >= ADDR_SPACE_PERI[0])) ||
      ((tl_s1n_56_us_h2d.a_address <= (ADDR_MASK_PERI[1] + ADDR_SPACE_PERI[1])) &&
       (tl_s1n_56_us_h2d.a_address >= ADDR_SPACE_PERI[1]))
    ) begin
      dev_sel_s1n_56 = 5'd3;

    end else if (
      ((tl_s1n_56_us_h2d.a_address <= (ADDR_MASK_TLUL2AXI[0] + ADDR_SPACE_TLUL2AXI[0])) &&
       (tl_s1n_56_us_h2d.a_address >= ADDR_SPACE_TLUL2AXI[0])) ||
      ((tl_s1n_56_us_h2d.a_address <= (ADDR_MASK_TLUL2AXI[1] + ADDR_SPACE_TLUL2AXI[1])) &&
       (tl_s1n_56_us_h2d.a_address >= ADDR_SPACE_TLUL2AXI[1]))
    ) begin
      dev_sel_s1n_56 = 5'd4;
      ...
      dev_sel_s1n_56 = 5'd9;
                  ...
                  ~(ADDR_MASK_FLASH_CTRL__MEM)) == ADDR_SPACE_FLASH_CTRL__MEM) begin
      dev_sel_s1n_56 = 5'd10;

    end else if ((tl_s1n_56_us_h2d.a_address &
                  ~(ADDR_MASK_HMAC)) == ADDR_SPACE_HMAC) begin
      dev_sel_s1n_56 = 5'd11;

    end else if ((tl_s1n_56_us_h2d.a_address &
                  ~(ADDR_MASK_KMAC)) == ADDR_SPACE_KMAC) begin
      dev_sel_s1n_56 = 5'd12;

    end else if ((tl_s1n_56_us_h2d.a_address &
                  ~(ADDR_MASK_AES)) == ADDR_SPACE_AES) begin
      dev_sel_s1n_56 = 5'd13;

    end else if ((tl_s1n_56_us_h2d.a_address &
                  ~(ADDR_MASK_ENTROPY_SRC)) == ADDR_SPACE_ENTROPY_SRC) begin
      dev_sel_s1n_56 = 5'd14;

    end else if ((tl_s1n_56_us_h2d.a_address &
                  ~(ADDR_MASK_CSRNG)) == ADDR_SPACE_CSRNG) begin
      dev_sel_s1n_56 = 5'd15;

    end else if ((tl_s1n_56_us_h2d.a_address &
                  ~(ADDR_MASK_EDN0)) == ADDR_SPACE_EDN0) begin
      dev_sel_s1n_56 = 5'd16;

    end else if ((tl_s1n_56_us_h2d.a_address &
                  ~(ADDR_MASK_EDN1)) == ADDR_SPACE_EDN1) begin
      dev_sel_s1n_56 = 5'd17;

    end else if ((tl_s1n_56_us_h2d.a_address &
                  ~(ADDR_MASK_RV_PLIC)) == ADDR_SPACE_RV_PLIC) begin
      dev_sel_s1n_56 = 5'd18;

    end else if ((tl_s1n_56_us_h2d.a_address &
                  ~(ADDR_MASK_OTBN)) == ADDR_SPACE_OTBN) begin
      dev_sel_s1n_56 = 5'd19;

    end else if ((tl_s1n_56_us_h2d.a_address &
                  ~(ADDR_MASK_KEYMGR)) == ADDR_SPACE_KEYMGR) begin
      dev_sel_s1n_56 = 5'd20;

    end else if ((tl_s1n_56_us_h2d.a_address &
                  ~(ADDR_MASK_RV_CORE_IBEX__CFG)) == ADDR_SPACE_RV_CORE_IBEX__CFG) begin
      dev_sel_s1n_56 = 5'd21;

    end else if ((tl_s1n_56_us_h2d.a_address &
                  ~(ADDR_MASK_SRAM_CTRL_MAIN__REGS)) == ADDR_SPACE_SRAM_CTRL_MAIN__REGS) begin
      dev_sel_s1n_56 = 5'd22;

    end else if ((tl_s1n_56_us_h2d.a_address &
                  ~(ADDR_MASK_SRAM_CTRL_MAIN__RAM)) == ADDR_SPACE_SRAM_CTRL_MAIN__RAM) begin
      dev_sel_s1n_56 = 5'd23;
end
  end
