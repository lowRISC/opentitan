...
module clkmgr import clkmgr_pkg::*; (
  ...
  prim_clock_gating_sync i_io_div4_cg (
    .clk_i(clk_io_div4_i),
  ...
  prim_flop_2sync #(
    .Width(1)
  ) i_clk_io_div4_peri_sw_en_sync (
    .clk_i(clk_io_div4_i),
    .rst_ni(rst_io_div4_ni),
    .d(reg2hw.clk_enables.clk_io_div4_peri_en.q),
    .q(clk_io_div4_peri_sw_en)
  );

  prim_clock_gating i_clk_io_div4_peri_cg (
    .clk_i(clk_io_div4_i),
  ...
  prim_flop_2sync #(
    .Width(1)
  ) i_clk_main_keymgr_hint_sync (
    .clk_i(clk_main_i),
    .rst_ni(rst_main_ni),
    .d(reg2hw.clk_hints.clk_main_keymgr_hint.q),
    .q(clk_main_keymgr_hint)
  );

  prim_clock_gating i_clk_main_keymgr_cg (
    .clk_i(clk_main_i),
    .en_i(clk_main_keymgr_en & clk_main_en),
    .test_en_i(dft_i.test_en),
  ...
  prim_flop_2sync #(
    .Width(1)
  ) i_clk_main_csrng_hint_sync (
    .clk_i(clk_main_i),
    .rst_ni(rst_main_ni),
    .d(reg2hw.clk_hints.clk_main_csrng_hint.q),
    .q(clk_main_csrng_hint)
  );

  prim_clock_gating i_clk_main_csrng_cg (
    .clk_i(clk_main_i),
    .en_i(clk_main_csrng_en & clk_main_en),
    .test_en_i(dft_i.test_en),
