...
module xbar_peri (
  ...
  assign tl_spi_host0_o = tl_s1n_29_ds_h2d[10];
  assign tl_s1n_29_ds_d2h[10] = tl_spi_host0_i;

  assign tl_spi_host1_o = tl_s1n_29_ds_h2d[11];
  assign tl_s1n_29_ds_d2h[11] = tl_spi_host1_i;

  assign tl_rv_timer_o = tl_s1n_29_ds_h2d[12];
  assign tl_s1n_29_ds_d2h[12] = tl_rv_timer_i;

  assign tl_usbdev_o = tl_s1n_29_ds_h2d[13];
  assign tl_s1n_29_ds_d2h[13] = tl_usbdev_i;

  assign tl_pwrmgr_aon_o = tl_s1n_29_ds_h2d[14];
  assign tl_s1n_29_ds_d2h[14] = tl_pwrmgr_aon_i;

  assign tl_rstmgr_aon_o = tl_s1n_29_ds_h2d[15];
  assign tl_s1n_29_ds_d2h[15] = tl_rstmgr_aon_i;

  assign tl_clkmgr_aon_o = tl_s1n_29_ds_h2d[16];
  assign tl_s1n_29_ds_d2h[16] = tl_clkmgr_aon_i;

  assign tl_pinmux_aon_o = tl_s1n_29_ds_h2d[17];
  assign tl_s1n_29_ds_d2h[17] = tl_pinmux_aon_i;

  assign tl_ram_ret_aon_o = tl_s1n_29_ds_h2d[18];
  assign tl_s1n_29_ds_d2h[18] = tl_ram_ret_aon_i;

  assign tl_otp_ctrl_o = tl_s1n_29_ds_h2d[19];
  assign tl_s1n_29_ds_d2h[19] = tl_otp_ctrl_i;

  assign tl_lc_ctrl_o = tl_s1n_29_ds_h2d[20];
  assign tl_s1n_29_ds_d2h[20] = tl_lc_ctrl_i;

  assign tl_sensor_ctrl_aon_o = tl_s1n_29_ds_h2d[21];
  assign tl_s1n_29_ds_d2h[21] = tl_sensor_ctrl_aon_i;

  assign tl_alert_handler_o = tl_s1n_29_ds_h2d[22];
  assign tl_s1n_29_ds_d2h[22] = tl_alert_handler_i;

  assign tl_ast_o = tl_s1n_29_ds_h2d[23];
  assign tl_s1n_29_ds_d2h[23] = tl_ast_i;

  assign tl_sram_ctrl_ret_aon_o = tl_s1n_29_ds_h2d[24];
  assign tl_s1n_29_ds_d2h[24] = tl_sram_ctrl_ret_aon_i;

  assign tl_aon_timer_aon_o = tl_s1n_29_ds_h2d[25];
  assign tl_s1n_29_ds_d2h[25] = tl_aon_timer_aon_i;

  assign tl_adc_ctrl_aon_o = tl_s1n_29_ds_h2d[26];
  assign tl_s1n_29_ds_d2h[26] = tl_adc_ctrl_aon_i;

  assign tl_sysrst_ctrl_aon_o = tl_s1n_29_ds_h2d[27];
  assign tl_s1n_29_ds_d2h[27] = tl_sysrst_ctrl_aon_i;
