...
module xbar_peri (
  ...
  assign tl_uart1_o = tl_s1n_12_ds_h2d[1];
  assign tl_s1n_12_ds_d2h[1] = tl_uart1_i;

  assign tl_uart2_o = tl_s1n_12_ds_h2d[2];
  assign tl_s1n_12_ds_d2h[2] = tl_uart2_i;

  assign tl_uart3_o = tl_s1n_12_ds_h2d[3];
  assign tl_s1n_12_ds_d2h[3] = tl_uart3_i;

  assign tl_gpio_o = tl_s1n_12_ds_h2d[4];
  assign tl_s1n_12_ds_d2h[4] = tl_gpio_i;

  assign tl_spi_device_o = tl_s1n_12_ds_h2d[5];
  assign tl_s1n_12_ds_d2h[5] = tl_spi_device_i;

  assign tl_rv_timer_o = tl_s1n_12_ds_h2d[6];
  assign tl_s1n_12_ds_d2h[6] = tl_rv_timer_i;

  assign tl_i2c0_o = tl_s1n_12_ds_h2d[7];
  assign tl_s1n_12_ds_d2h[7] = tl_i2c0_i;

  assign tl_i2c1_o = tl_s1n_12_ds_h2d[8];
  assign tl_s1n_12_ds_d2h[8] = tl_i2c1_i;

  assign tl_i2c2_o = tl_s1n_12_ds_h2d[9];
  assign tl_s1n_12_ds_d2h[9] = tl_i2c2_i;

  assign tl_pattgen_o = tl_s1n_12_ds_h2d[10];
  assign tl_s1n_12_ds_d2h[10] = tl_pattgen_i;
  ...
  always_comb begin
    ...
    end else if ((tl_s1n_12_us_h2d.a_address & ~(ADDR_MASK_UART1)) == ADDR_SPACE_UART1) begin
      dev_sel_s1n_12 = 4'd1;

    end else if ((tl_s1n_12_us_h2d.a_address & ~(ADDR_MASK_UART2)) == ADDR_SPACE_UART2) begin
      dev_sel_s1n_12 = 4'd2;

    end else if ((tl_s1n_12_us_h2d.a_address & ~(ADDR_MASK_UART3)) == ADDR_SPACE_UART3) begin
      dev_sel_s1n_12 = 4'd3;
    ...
    end else if ((tl_s1n_12_us_h2d.a_address & ~(ADDR_MASK_I2C0)) == ADDR_SPACE_I2C0) begin
      dev_sel_s1n_12 = 4'd7;

    end else if ((tl_s1n_12_us_h2d.a_address & ~(ADDR_MASK_I2C1)) == ADDR_SPACE_I2C1) begin
      dev_sel_s1n_12 = 4'd8;

    end else if ((tl_s1n_12_us_h2d.a_address & ~(ADDR_MASK_I2C2)) == ADDR_SPACE_I2C2) begin
      dev_sel_s1n_12 = 4'd9;

    end else if ((tl_s1n_12_us_h2d.a_address & ~(ADDR_MASK_PATTGEN)) == ADDR_SPACE_PATTGEN) begin
