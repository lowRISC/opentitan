...
module xbar_peri (
  ...
  output tlul_pkg::tl_h2d_t tl_i2c3_o,
  input  tlul_pkg::tl_d2h_t tl_i2c3_i,
  ...
  assign tl_i2c3_o = tl_s1n_29_ds_h2d[7];
  assign tl_s1n_29_ds_d2h[7] = tl_i2c3_i;

  assign tl_pattgen_o = tl_s1n_29_ds_h2d[8];
  assign tl_s1n_29_ds_d2h[8] = tl_pattgen_i;

  assign tl_gpio_o = tl_s1n_29_ds_h2d[9];
  assign tl_s1n_29_ds_d2h[9] = tl_gpio_i;

  assign tl_spi_device_o = tl_s1n_29_ds_h2d[10];
  assign tl_s1n_29_ds_d2h[10] = tl_spi_device_i;

  assign tl_rv_timer_o = tl_s1n_29_ds_h2d[11];
  assign tl_s1n_29_ds_d2h[11] = tl_rv_timer_i;
  ...
  assign tl_sensor_ctrl_aon_o = tl_s1n_29_ds_h2d[19];
  assign tl_s1n_29_ds_d2h[19] = tl_sensor_ctrl_aon_i;
  ...
  always_comb begin
    ...
    if ((tl_s1n_29_us_h2d.a_address &
      ...
      dev_sel_s1n_29 = 5'd6;
                  ...
                  ~(ADDR_MASK_I2C3)) == ADDR_SPACE_I2C3) begin
      dev_sel_s1n_29 = 5'd7;
