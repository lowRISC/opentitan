...
module xbar_peri (
  ...
  // Host interfaces
  input  tlul_ot_pkg::tl_h2d_t tl_main_i,
  output tlul_ot_pkg::tl_d2h_t tl_main_o,

  // Device interfaces
  output tlul_ot_pkg::tl_h2d_t tl_uart0_o,
  input  tlul_ot_pkg::tl_d2h_t tl_uart0_i,
  output tlul_ot_pkg::tl_h2d_t tl_uart1_o,
  input  tlul_ot_pkg::tl_d2h_t tl_uart1_i,
  output tlul_ot_pkg::tl_h2d_t tl_uart2_o,
  input  tlul_ot_pkg::tl_d2h_t tl_uart2_i,
  output tlul_ot_pkg::tl_h2d_t tl_uart3_o,
  input  tlul_ot_pkg::tl_d2h_t tl_uart3_i,
  output tlul_ot_pkg::tl_h2d_t tl_i2c0_o,
  input  tlul_ot_pkg::tl_d2h_t tl_i2c0_i,
  output tlul_ot_pkg::tl_h2d_t tl_i2c1_o,
  input  tlul_ot_pkg::tl_d2h_t tl_i2c1_i,
  output tlul_ot_pkg::tl_h2d_t tl_i2c2_o,
  input  tlul_ot_pkg::tl_d2h_t tl_i2c2_i,
  output tlul_ot_pkg::tl_h2d_t tl_pattgen_o,
  input  tlul_ot_pkg::tl_d2h_t tl_pattgen_i,
  output tlul_ot_pkg::tl_h2d_t tl_pwm_aon_o,
  input  tlul_ot_pkg::tl_d2h_t tl_pwm_aon_i,
  output tlul_ot_pkg::tl_h2d_t tl_gpio_o,
  input  tlul_ot_pkg::tl_d2h_t tl_gpio_i,
  output tlul_ot_pkg::tl_h2d_t tl_spi_device_o,
  input  tlul_ot_pkg::tl_d2h_t tl_spi_device_i,
  output tlul_ot_pkg::tl_h2d_t tl_rv_timer_o,
  input  tlul_ot_pkg::tl_d2h_t tl_rv_timer_i,
  output tlul_ot_pkg::tl_h2d_t tl_pwrmgr_aon_o,
  input  tlul_ot_pkg::tl_d2h_t tl_pwrmgr_aon_i,
  output tlul_ot_pkg::tl_h2d_t tl_rstmgr_aon_o,
  input  tlul_ot_pkg::tl_d2h_t tl_rstmgr_aon_i,
  output tlul_ot_pkg::tl_h2d_t tl_clkmgr_aon_o,
  input  tlul_ot_pkg::tl_d2h_t tl_clkmgr_aon_i,
  output tlul_ot_pkg::tl_h2d_t tl_pinmux_aon_o,
  input  tlul_ot_pkg::tl_d2h_t tl_pinmux_aon_i,
  output tlul_ot_pkg::tl_h2d_t tl_otp_ctrl__core_o,
  input  tlul_ot_pkg::tl_d2h_t tl_otp_ctrl__core_i,
  output tlul_ot_pkg::tl_h2d_t tl_otp_ctrl__prim_o,
  input  tlul_ot_pkg::tl_d2h_t tl_otp_ctrl__prim_i,
  output tlul_ot_pkg::tl_h2d_t tl_lc_ctrl_o,
  input  tlul_ot_pkg::tl_d2h_t tl_lc_ctrl_i,
  output tlul_ot_pkg::tl_h2d_t tl_sensor_ctrl_o,
  input  tlul_ot_pkg::tl_d2h_t tl_sensor_ctrl_i,
  output tlul_ot_pkg::tl_h2d_t tl_alert_handler_o,
  input  tlul_ot_pkg::tl_d2h_t tl_alert_handler_i,
  output tlul_ot_pkg::tl_h2d_t tl_sram_ctrl_ret_aon__regs_o,
  input  tlul_ot_pkg::tl_d2h_t tl_sram_ctrl_ret_aon__regs_i,
  output tlul_ot_pkg::tl_h2d_t tl_sram_ctrl_ret_aon__ram_o,
  input  tlul_ot_pkg::tl_d2h_t tl_sram_ctrl_ret_aon__ram_i,
  output tlul_ot_pkg::tl_h2d_t tl_aon_timer_aon_o,
  input  tlul_ot_pkg::tl_d2h_t tl_aon_timer_aon_i,
  output tlul_ot_pkg::tl_h2d_t tl_sysrst_ctrl_aon_o,
  input  tlul_ot_pkg::tl_d2h_t tl_sysrst_ctrl_aon_i,
  output tlul_ot_pkg::tl_h2d_t tl_adc_ctrl_aon_o,
  input  tlul_ot_pkg::tl_d2h_t tl_adc_ctrl_aon_i,
  output tlul_ot_pkg::tl_h2d_t tl_ast_o,
  input  tlul_ot_pkg::tl_d2h_t tl_ast_i,
