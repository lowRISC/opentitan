...
// for all the regsters, declare assertion
  ...
  logic [138:0] ip_d_fpv;
  for (genvar s = 0; s <= 138; s++) begin : gen_ip_d
  ...
  `ASSERT(ip4_rd_A, rd_P(10'h10, ip_d_fpv[138:128]))

  // define local fpv variable for the multi_reg
  logic [138:0] le_q_fpv;
  for (genvar s = 0; s <= 138; s++) begin : gen_le_q
    assign le_q_fpv[s] = 1 ?
  ...
  `ASSERT(le4_wr_A, wr_P(10'h24, le_q_fpv[138:128], 1, 'h7ff))
  `ASSERT(le4_rd_A, rd_P(10'h24, le_q_fpv[138:128]))
  ...
  `ASSERT(prio133_wr_A, wr_P(10'h23c, i_rv_plic.reg2hw.prio133.q, 1, 'h3))
  `ASSERT(prio133_rd_A, rd_P(10'h23c, i_rv_plic.reg2hw.prio133.q))

  `ASSERT(prio134_wr_A, wr_P(10'h240, i_rv_plic.reg2hw.prio134.q, 1, 'h3))
  `ASSERT(prio134_rd_A, rd_P(10'h240, i_rv_plic.reg2hw.prio134.q))

  `ASSERT(prio135_wr_A, wr_P(10'h244, i_rv_plic.reg2hw.prio135.q, 1, 'h3))
  `ASSERT(prio135_rd_A, rd_P(10'h244, i_rv_plic.reg2hw.prio135.q))

  `ASSERT(prio136_wr_A, wr_P(10'h248, i_rv_plic.reg2hw.prio136.q, 1, 'h3))
  `ASSERT(prio136_rd_A, rd_P(10'h248, i_rv_plic.reg2hw.prio136.q))

  `ASSERT(prio137_wr_A, wr_P(10'h24c, i_rv_plic.reg2hw.prio137.q, 1, 'h3))
  `ASSERT(prio137_rd_A, rd_P(10'h24c, i_rv_plic.reg2hw.prio137.q))

  `ASSERT(prio138_wr_A, wr_P(10'h250, i_rv_plic.reg2hw.prio138.q, 1, 'h3))
  `ASSERT(prio138_rd_A, rd_P(10'h250, i_rv_plic.reg2hw.prio138.q))

  // define local fpv variable for the multi_reg
  logic [138:0] ie0_q_fpv;
  for (genvar s = 0; s <= 138; s++) begin : gen_ie0_q
  ...
  `ASSERT(ie04_wr_A, wr_P(10'h310, ie0_q_fpv[138:128], 1, 'h7ff))
  `ASSERT(ie04_rd_A, rd_P(10'h310, ie0_q_fpv[138:128]))
