...
package pinmux_reg_pkg;
  ...
  parameter logic [7:0] PINMUX_DIO_OUT_SLEEP_VAL_OFFSET = 8'h 4c;
  parameter logic [7:0] PINMUX_WKUP_DETECTOR_EN_OFFSET = 8'h 50;
  parameter logic [7:0] PINMUX_WKUP_DETECTOR0_OFFSET = 8'h 54;
  parameter logic [7:0] PINMUX_WKUP_DETECTOR1_OFFSET = 8'h 58;
  parameter logic [7:0] PINMUX_WKUP_DETECTOR2_OFFSET = 8'h 5c;
  parameter logic [7:0] PINMUX_WKUP_DETECTOR3_OFFSET = 8'h 60;
  parameter logic [7:0] PINMUX_WKUP_DETECTOR4_OFFSET = 8'h 64;
  parameter logic [7:0] PINMUX_WKUP_DETECTOR5_OFFSET = 8'h 68;
  parameter logic [7:0] PINMUX_WKUP_DETECTOR6_OFFSET = 8'h 6c;
  parameter logic [7:0] PINMUX_WKUP_DETECTOR7_OFFSET = 8'h 70;
  parameter logic [7:0] PINMUX_WKUP_DETECTOR_CNT_TH0_OFFSET = 8'h 74;
  parameter logic [7:0] PINMUX_WKUP_DETECTOR_CNT_TH1_OFFSET = 8'h 78;
  parameter logic [7:0] PINMUX_WKUP_DETECTOR_PADSEL0_OFFSET = 8'h 7c;
  parameter logic [7:0] PINMUX_WKUP_DETECTOR_PADSEL1_OFFSET = 8'h 80;
  parameter logic [7:0] PINMUX_WKUP_CAUSE_OFFSET = 8'h 84;
  ...
  parameter logic [3:0] PINMUX_PERMIT [34] = '{
    ...
    4'b 0001, // index[21] PINMUX_WKUP_DETECTOR0
    4'b 0001, // index[22] PINMUX_WKUP_DETECTOR1
    4'b 0001, // index[23] PINMUX_WKUP_DETECTOR2
    4'b 0001, // index[24] PINMUX_WKUP_DETECTOR3
    4'b 0001, // index[25] PINMUX_WKUP_DETECTOR4
    4'b 0001, // index[26] PINMUX_WKUP_DETECTOR5
    4'b 0001, // index[27] PINMUX_WKUP_DETECTOR6
    4'b 0001, // index[28] PINMUX_WKUP_DETECTOR7
    4'b 1111, // index[29] PINMUX_WKUP_DETECTOR_CNT_TH0
    4'b 1111, // index[30] PINMUX_WKUP_DETECTOR_CNT_TH1
    4'b 1111, // index[31] PINMUX_WKUP_DETECTOR_PADSEL0
    4'b 0011, // index[32] PINMUX_WKUP_DETECTOR_PADSEL1
