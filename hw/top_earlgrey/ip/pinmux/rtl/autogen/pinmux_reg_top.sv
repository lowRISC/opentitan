...
module pinmux_reg_top (
  ...
  prim_subreg #(
    ...
    // from register interface (qualified with register enable)
    .we     (mio_periph_insel_59_we & mio_periph_insel_regwen_59_qs),
  ...
  prim_subreg #(
    ...
    // from register interface (qualified with register enable)
    .we     (mio_periph_insel_60_we & mio_periph_insel_regwen_60_qs),
  ...
  prim_subreg #(
    ...
    // from register interface (qualified with register enable)
    .we     (mio_periph_insel_61_we & mio_periph_insel_regwen_61_qs),
  ...
  prim_subreg #(
    ...
    // from register interface (qualified with register enable)
    .we     (mio_periph_insel_62_we & mio_periph_insel_regwen_62_qs),
  ...
  prim_subreg #(
    ...
    // from register interface (qualified with register enable)
    .we     (mio_periph_insel_63_we & mio_periph_insel_regwen_63_qs),
  ...
  prim_subreg #(
    ...
    // from register interface (qualified with register enable)
    .we     (mio_periph_insel_64_we & mio_periph_insel_regwen_64_qs),
  ...
  always_comb begin
    ...
    addr_hit[ 59] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_REGWEN_59_OFFSET);
    addr_hit[ 60] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_REGWEN_60_OFFSET);
    addr_hit[ 61] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_REGWEN_61_OFFSET);
    addr_hit[ 62] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_REGWEN_62_OFFSET);
    addr_hit[ 63] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_REGWEN_63_OFFSET);
    addr_hit[ 64] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_REGWEN_64_OFFSET);
    addr_hit[ 65] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_0_OFFSET);
    addr_hit[ 66] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_1_OFFSET);
    addr_hit[ 67] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_2_OFFSET);
    addr_hit[ 68] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_3_OFFSET);
    addr_hit[ 69] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_4_OFFSET);
    addr_hit[ 70] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_5_OFFSET);
    addr_hit[ 71] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_6_OFFSET);
    addr_hit[ 72] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_7_OFFSET);
    addr_hit[ 73] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_8_OFFSET);
    addr_hit[ 74] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_9_OFFSET);
    addr_hit[ 75] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_10_OFFSET);
    addr_hit[ 76] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_11_OFFSET);
    addr_hit[ 77] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_12_OFFSET);
    addr_hit[ 78] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_13_OFFSET);
    addr_hit[ 79] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_14_OFFSET);
    addr_hit[ 80] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_15_OFFSET);
    addr_hit[ 81] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_16_OFFSET);
    addr_hit[ 82] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_17_OFFSET);
    addr_hit[ 83] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_18_OFFSET);
    addr_hit[ 84] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_19_OFFSET);
    addr_hit[ 85] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_20_OFFSET);
    addr_hit[ 86] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_21_OFFSET);
    addr_hit[ 87] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_22_OFFSET);
    addr_hit[ 88] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_23_OFFSET);
    addr_hit[ 89] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_24_OFFSET);
    addr_hit[ 90] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_25_OFFSET);
    addr_hit[ 91] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_26_OFFSET);
    addr_hit[ 92] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_27_OFFSET);
    addr_hit[ 93] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_28_OFFSET);
    addr_hit[ 94] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_29_OFFSET);
    addr_hit[ 95] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_30_OFFSET);
    addr_hit[ 96] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_31_OFFSET);
    addr_hit[ 97] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_32_OFFSET);
    addr_hit[ 98] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_33_OFFSET);
    addr_hit[ 99] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_34_OFFSET);
    addr_hit[100] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_35_OFFSET);
    addr_hit[101] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_36_OFFSET);
    addr_hit[102] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_37_OFFSET);
    addr_hit[103] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_38_OFFSET);
    addr_hit[104] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_39_OFFSET);
    addr_hit[105] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_40_OFFSET);
    addr_hit[106] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_41_OFFSET);
    addr_hit[107] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_42_OFFSET);
    addr_hit[108] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_43_OFFSET);
    addr_hit[109] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_44_OFFSET);
    addr_hit[110] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_45_OFFSET);
    addr_hit[111] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_46_OFFSET);
    addr_hit[112] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_47_OFFSET);
    addr_hit[113] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_48_OFFSET);
    addr_hit[114] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_49_OFFSET);
    addr_hit[115] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_50_OFFSET);
    addr_hit[116] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_51_OFFSET);
    addr_hit[117] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_52_OFFSET);
    addr_hit[118] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_53_OFFSET);
    addr_hit[119] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_54_OFFSET);
    addr_hit[120] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_55_OFFSET);
    addr_hit[121] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_56_OFFSET);
    addr_hit[122] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_57_OFFSET);
    addr_hit[123] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_58_OFFSET);
    addr_hit[124] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_59_OFFSET);
    addr_hit[125] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_60_OFFSET);
    addr_hit[126] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_61_OFFSET);
    addr_hit[127] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_62_OFFSET);
    addr_hit[128] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_63_OFFSET);
    addr_hit[129] = (reg_addr == PINMUX_MIO_PERIPH_INSEL_64_OFFSET);
    addr_hit[130] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_0_OFFSET);
    addr_hit[131] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_1_OFFSET);
    addr_hit[132] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_2_OFFSET);
    addr_hit[133] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_3_OFFSET);
    addr_hit[134] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_4_OFFSET);
    addr_hit[135] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_5_OFFSET);
    addr_hit[136] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_6_OFFSET);
    addr_hit[137] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_7_OFFSET);
    addr_hit[138] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_8_OFFSET);
    addr_hit[139] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_9_OFFSET);
    addr_hit[140] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_10_OFFSET);
    addr_hit[141] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_11_OFFSET);
    addr_hit[142] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_12_OFFSET);
    addr_hit[143] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_13_OFFSET);
    addr_hit[144] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_14_OFFSET);
    addr_hit[145] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_15_OFFSET);
    addr_hit[146] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_16_OFFSET);
    addr_hit[147] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_17_OFFSET);
    addr_hit[148] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_18_OFFSET);
    addr_hit[149] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_19_OFFSET);
    addr_hit[150] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_20_OFFSET);
    addr_hit[151] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_21_OFFSET);
    addr_hit[152] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_22_OFFSET);
    addr_hit[153] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_23_OFFSET);
    addr_hit[154] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_24_OFFSET);
    addr_hit[155] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_25_OFFSET);
    addr_hit[156] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_26_OFFSET);
    addr_hit[157] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_27_OFFSET);
    addr_hit[158] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_28_OFFSET);
    addr_hit[159] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_29_OFFSET);
    addr_hit[160] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_30_OFFSET);
    addr_hit[161] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_31_OFFSET);
    addr_hit[162] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_32_OFFSET);
    addr_hit[163] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_33_OFFSET);
    addr_hit[164] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_34_OFFSET);
    addr_hit[165] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_35_OFFSET);
    addr_hit[166] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_36_OFFSET);
    addr_hit[167] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_37_OFFSET);
    addr_hit[168] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_38_OFFSET);
    addr_hit[169] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_39_OFFSET);
    addr_hit[170] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_40_OFFSET);
    addr_hit[171] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_41_OFFSET);
    addr_hit[172] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_42_OFFSET);
    addr_hit[173] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_43_OFFSET);
    addr_hit[174] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_44_OFFSET);
    addr_hit[175] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_45_OFFSET);
    addr_hit[176] = (reg_addr == PINMUX_MIO_OUTSEL_REGWEN_46_OFFSET);
    addr_hit[177] = (reg_addr == PINMUX_MIO_OUTSEL_0_OFFSET);
    addr_hit[178] = (reg_addr == PINMUX_MIO_OUTSEL_1_OFFSET);
    addr_hit[179] = (reg_addr == PINMUX_MIO_OUTSEL_2_OFFSET);
    addr_hit[180] = (reg_addr == PINMUX_MIO_OUTSEL_3_OFFSET);
    addr_hit[181] = (reg_addr == PINMUX_MIO_OUTSEL_4_OFFSET);
    addr_hit[182] = (reg_addr == PINMUX_MIO_OUTSEL_5_OFFSET);
    addr_hit[183] = (reg_addr == PINMUX_MIO_OUTSEL_6_OFFSET);
    addr_hit[184] = (reg_addr == PINMUX_MIO_OUTSEL_7_OFFSET);
    addr_hit[185] = (reg_addr == PINMUX_MIO_OUTSEL_8_OFFSET);
    addr_hit[186] = (reg_addr == PINMUX_MIO_OUTSEL_9_OFFSET);
    addr_hit[187] = (reg_addr == PINMUX_MIO_OUTSEL_10_OFFSET);
    addr_hit[188] = (reg_addr == PINMUX_MIO_OUTSEL_11_OFFSET);
    addr_hit[189] = (reg_addr == PINMUX_MIO_OUTSEL_12_OFFSET);
    addr_hit[190] = (reg_addr == PINMUX_MIO_OUTSEL_13_OFFSET);
    addr_hit[191] = (reg_addr == PINMUX_MIO_OUTSEL_14_OFFSET);
    addr_hit[192] = (reg_addr == PINMUX_MIO_OUTSEL_15_OFFSET);
    addr_hit[193] = (reg_addr == PINMUX_MIO_OUTSEL_16_OFFSET);
    addr_hit[194] = (reg_addr == PINMUX_MIO_OUTSEL_17_OFFSET);
    addr_hit[195] = (reg_addr == PINMUX_MIO_OUTSEL_18_OFFSET);
    addr_hit[196] = (reg_addr == PINMUX_MIO_OUTSEL_19_OFFSET);
    addr_hit[197] = (reg_addr == PINMUX_MIO_OUTSEL_20_OFFSET);
    addr_hit[198] = (reg_addr == PINMUX_MIO_OUTSEL_21_OFFSET);
    addr_hit[199] = (reg_addr == PINMUX_MIO_OUTSEL_22_OFFSET);
    addr_hit[200] = (reg_addr == PINMUX_MIO_OUTSEL_23_OFFSET);
    addr_hit[201] = (reg_addr == PINMUX_MIO_OUTSEL_24_OFFSET);
    addr_hit[202] = (reg_addr == PINMUX_MIO_OUTSEL_25_OFFSET);
    addr_hit[203] = (reg_addr == PINMUX_MIO_OUTSEL_26_OFFSET);
    addr_hit[204] = (reg_addr == PINMUX_MIO_OUTSEL_27_OFFSET);
    addr_hit[205] = (reg_addr == PINMUX_MIO_OUTSEL_28_OFFSET);
    addr_hit[206] = (reg_addr == PINMUX_MIO_OUTSEL_29_OFFSET);
    addr_hit[207] = (reg_addr == PINMUX_MIO_OUTSEL_30_OFFSET);
    addr_hit[208] = (reg_addr == PINMUX_MIO_OUTSEL_31_OFFSET);
    addr_hit[209] = (reg_addr == PINMUX_MIO_OUTSEL_32_OFFSET);
    addr_hit[210] = (reg_addr == PINMUX_MIO_OUTSEL_33_OFFSET);
    addr_hit[211] = (reg_addr == PINMUX_MIO_OUTSEL_34_OFFSET);
    addr_hit[212] = (reg_addr == PINMUX_MIO_OUTSEL_35_OFFSET);
    addr_hit[213] = (reg_addr == PINMUX_MIO_OUTSEL_36_OFFSET);
    addr_hit[214] = (reg_addr == PINMUX_MIO_OUTSEL_37_OFFSET);
    addr_hit[215] = (reg_addr == PINMUX_MIO_OUTSEL_38_OFFSET);
    addr_hit[216] = (reg_addr == PINMUX_MIO_OUTSEL_39_OFFSET);
    addr_hit[217] = (reg_addr == PINMUX_MIO_OUTSEL_40_OFFSET);
    addr_hit[218] = (reg_addr == PINMUX_MIO_OUTSEL_41_OFFSET);
    addr_hit[219] = (reg_addr == PINMUX_MIO_OUTSEL_42_OFFSET);
    addr_hit[220] = (reg_addr == PINMUX_MIO_OUTSEL_43_OFFSET);
    addr_hit[221] = (reg_addr == PINMUX_MIO_OUTSEL_44_OFFSET);
    addr_hit[222] = (reg_addr == PINMUX_MIO_OUTSEL_45_OFFSET);
    addr_hit[223] = (reg_addr == PINMUX_MIO_OUTSEL_46_OFFSET);
    addr_hit[224] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_0_OFFSET);
    addr_hit[225] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_1_OFFSET);
    addr_hit[226] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_2_OFFSET);
    addr_hit[227] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_3_OFFSET);
    addr_hit[228] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_4_OFFSET);
    addr_hit[229] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_5_OFFSET);
    addr_hit[230] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_6_OFFSET);
    addr_hit[231] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_7_OFFSET);
    addr_hit[232] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_8_OFFSET);
    addr_hit[233] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_9_OFFSET);
    addr_hit[234] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_10_OFFSET);
    addr_hit[235] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_11_OFFSET);
    addr_hit[236] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_12_OFFSET);
    addr_hit[237] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_13_OFFSET);
    addr_hit[238] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_14_OFFSET);
    addr_hit[239] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_15_OFFSET);
    addr_hit[240] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_16_OFFSET);
    addr_hit[241] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_17_OFFSET);
    addr_hit[242] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_18_OFFSET);
    addr_hit[243] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_19_OFFSET);
    addr_hit[244] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_20_OFFSET);
    addr_hit[245] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_21_OFFSET);
    addr_hit[246] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_22_OFFSET);
    addr_hit[247] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_23_OFFSET);
    addr_hit[248] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_24_OFFSET);
    addr_hit[249] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_25_OFFSET);
    addr_hit[250] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_26_OFFSET);
    addr_hit[251] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_27_OFFSET);
    addr_hit[252] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_28_OFFSET);
    addr_hit[253] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_29_OFFSET);
    addr_hit[254] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_30_OFFSET);
    addr_hit[255] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_31_OFFSET);
    addr_hit[256] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_32_OFFSET);
    addr_hit[257] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_33_OFFSET);
    addr_hit[258] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_34_OFFSET);
    addr_hit[259] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_35_OFFSET);
    addr_hit[260] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_36_OFFSET);
    addr_hit[261] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_37_OFFSET);
    addr_hit[262] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_38_OFFSET);
    addr_hit[263] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_39_OFFSET);
    addr_hit[264] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_40_OFFSET);
    addr_hit[265] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_41_OFFSET);
    addr_hit[266] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_42_OFFSET);
    addr_hit[267] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_43_OFFSET);
    addr_hit[268] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_44_OFFSET);
    addr_hit[269] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_45_OFFSET);
    addr_hit[270] = (reg_addr == PINMUX_MIO_PAD_ATTR_REGWEN_46_OFFSET);
    addr_hit[271] = (reg_addr == PINMUX_MIO_PAD_ATTR_0_OFFSET);
    addr_hit[272] = (reg_addr == PINMUX_MIO_PAD_ATTR_1_OFFSET);
    addr_hit[273] = (reg_addr == PINMUX_MIO_PAD_ATTR_2_OFFSET);
    addr_hit[274] = (reg_addr == PINMUX_MIO_PAD_ATTR_3_OFFSET);
    addr_hit[275] = (reg_addr == PINMUX_MIO_PAD_ATTR_4_OFFSET);
    addr_hit[276] = (reg_addr == PINMUX_MIO_PAD_ATTR_5_OFFSET);
    addr_hit[277] = (reg_addr == PINMUX_MIO_PAD_ATTR_6_OFFSET);
    addr_hit[278] = (reg_addr == PINMUX_MIO_PAD_ATTR_7_OFFSET);
    addr_hit[279] = (reg_addr == PINMUX_MIO_PAD_ATTR_8_OFFSET);
    addr_hit[280] = (reg_addr == PINMUX_MIO_PAD_ATTR_9_OFFSET);
    addr_hit[281] = (reg_addr == PINMUX_MIO_PAD_ATTR_10_OFFSET);
    addr_hit[282] = (reg_addr == PINMUX_MIO_PAD_ATTR_11_OFFSET);
    addr_hit[283] = (reg_addr == PINMUX_MIO_PAD_ATTR_12_OFFSET);
    addr_hit[284] = (reg_addr == PINMUX_MIO_PAD_ATTR_13_OFFSET);
    addr_hit[285] = (reg_addr == PINMUX_MIO_PAD_ATTR_14_OFFSET);
    addr_hit[286] = (reg_addr == PINMUX_MIO_PAD_ATTR_15_OFFSET);
    addr_hit[287] = (reg_addr == PINMUX_MIO_PAD_ATTR_16_OFFSET);
    addr_hit[288] = (reg_addr == PINMUX_MIO_PAD_ATTR_17_OFFSET);
    addr_hit[289] = (reg_addr == PINMUX_MIO_PAD_ATTR_18_OFFSET);
    addr_hit[290] = (reg_addr == PINMUX_MIO_PAD_ATTR_19_OFFSET);
    addr_hit[291] = (reg_addr == PINMUX_MIO_PAD_ATTR_20_OFFSET);
    addr_hit[292] = (reg_addr == PINMUX_MIO_PAD_ATTR_21_OFFSET);
    addr_hit[293] = (reg_addr == PINMUX_MIO_PAD_ATTR_22_OFFSET);
    addr_hit[294] = (reg_addr == PINMUX_MIO_PAD_ATTR_23_OFFSET);
    addr_hit[295] = (reg_addr == PINMUX_MIO_PAD_ATTR_24_OFFSET);
    addr_hit[296] = (reg_addr == PINMUX_MIO_PAD_ATTR_25_OFFSET);
    addr_hit[297] = (reg_addr == PINMUX_MIO_PAD_ATTR_26_OFFSET);
    addr_hit[298] = (reg_addr == PINMUX_MIO_PAD_ATTR_27_OFFSET);
    addr_hit[299] = (reg_addr == PINMUX_MIO_PAD_ATTR_28_OFFSET);
    addr_hit[300] = (reg_addr == PINMUX_MIO_PAD_ATTR_29_OFFSET);
    addr_hit[301] = (reg_addr == PINMUX_MIO_PAD_ATTR_30_OFFSET);
    addr_hit[302] = (reg_addr == PINMUX_MIO_PAD_ATTR_31_OFFSET);
    addr_hit[303] = (reg_addr == PINMUX_MIO_PAD_ATTR_32_OFFSET);
    addr_hit[304] = (reg_addr == PINMUX_MIO_PAD_ATTR_33_OFFSET);
    addr_hit[305] = (reg_addr == PINMUX_MIO_PAD_ATTR_34_OFFSET);
    addr_hit[306] = (reg_addr == PINMUX_MIO_PAD_ATTR_35_OFFSET);
    addr_hit[307] = (reg_addr == PINMUX_MIO_PAD_ATTR_36_OFFSET);
    addr_hit[308] = (reg_addr == PINMUX_MIO_PAD_ATTR_37_OFFSET);
    addr_hit[309] = (reg_addr == PINMUX_MIO_PAD_ATTR_38_OFFSET);
    addr_hit[310] = (reg_addr == PINMUX_MIO_PAD_ATTR_39_OFFSET);
    addr_hit[311] = (reg_addr == PINMUX_MIO_PAD_ATTR_40_OFFSET);
    addr_hit[312] = (reg_addr == PINMUX_MIO_PAD_ATTR_41_OFFSET);
    addr_hit[313] = (reg_addr == PINMUX_MIO_PAD_ATTR_42_OFFSET);
    addr_hit[314] = (reg_addr == PINMUX_MIO_PAD_ATTR_43_OFFSET);
    addr_hit[315] = (reg_addr == PINMUX_MIO_PAD_ATTR_44_OFFSET);
    addr_hit[316] = (reg_addr == PINMUX_MIO_PAD_ATTR_45_OFFSET);
    addr_hit[317] = (reg_addr == PINMUX_MIO_PAD_ATTR_46_OFFSET);
    addr_hit[318] = (reg_addr == PINMUX_DIO_PAD_ATTR_REGWEN_0_OFFSET);
    addr_hit[319] = (reg_addr == PINMUX_DIO_PAD_ATTR_REGWEN_1_OFFSET);
    addr_hit[320] = (reg_addr == PINMUX_DIO_PAD_ATTR_REGWEN_2_OFFSET);
    addr_hit[321] = (reg_addr == PINMUX_DIO_PAD_ATTR_REGWEN_3_OFFSET);
    addr_hit[322] = (reg_addr == PINMUX_DIO_PAD_ATTR_REGWEN_4_OFFSET);
    addr_hit[323] = (reg_addr == PINMUX_DIO_PAD_ATTR_REGWEN_5_OFFSET);
    addr_hit[324] = (reg_addr == PINMUX_DIO_PAD_ATTR_REGWEN_6_OFFSET);
    addr_hit[325] = (reg_addr == PINMUX_DIO_PAD_ATTR_REGWEN_7_OFFSET);
    addr_hit[326] = (reg_addr == PINMUX_DIO_PAD_ATTR_REGWEN_8_OFFSET);
    addr_hit[327] = (reg_addr == PINMUX_DIO_PAD_ATTR_REGWEN_9_OFFSET);
    addr_hit[328] = (reg_addr == PINMUX_DIO_PAD_ATTR_REGWEN_10_OFFSET);
    addr_hit[329] = (reg_addr == PINMUX_DIO_PAD_ATTR_REGWEN_11_OFFSET);
    addr_hit[330] = (reg_addr == PINMUX_DIO_PAD_ATTR_REGWEN_12_OFFSET);
    addr_hit[331] = (reg_addr == PINMUX_DIO_PAD_ATTR_REGWEN_13_OFFSET);
    addr_hit[332] = (reg_addr == PINMUX_DIO_PAD_ATTR_REGWEN_14_OFFSET);
    addr_hit[333] = (reg_addr == PINMUX_DIO_PAD_ATTR_REGWEN_15_OFFSET);
    addr_hit[334] = (reg_addr == PINMUX_DIO_PAD_ATTR_REGWEN_16_OFFSET);
    addr_hit[335] = (reg_addr == PINMUX_DIO_PAD_ATTR_REGWEN_17_OFFSET);
    addr_hit[336] = (reg_addr == PINMUX_DIO_PAD_ATTR_REGWEN_18_OFFSET);
    addr_hit[337] = (reg_addr == PINMUX_DIO_PAD_ATTR_REGWEN_19_OFFSET);
    addr_hit[338] = (reg_addr == PINMUX_DIO_PAD_ATTR_REGWEN_20_OFFSET);
    addr_hit[339] = (reg_addr == PINMUX_DIO_PAD_ATTR_REGWEN_21_OFFSET);
    addr_hit[340] = (reg_addr == PINMUX_DIO_PAD_ATTR_REGWEN_22_OFFSET);
    addr_hit[341] = (reg_addr == PINMUX_DIO_PAD_ATTR_0_OFFSET);
    addr_hit[342] = (reg_addr == PINMUX_DIO_PAD_ATTR_1_OFFSET);
    addr_hit[343] = (reg_addr == PINMUX_DIO_PAD_ATTR_2_OFFSET);
    addr_hit[344] = (reg_addr == PINMUX_DIO_PAD_ATTR_3_OFFSET);
    addr_hit[345] = (reg_addr == PINMUX_DIO_PAD_ATTR_4_OFFSET);
    addr_hit[346] = (reg_addr == PINMUX_DIO_PAD_ATTR_5_OFFSET);
    addr_hit[347] = (reg_addr == PINMUX_DIO_PAD_ATTR_6_OFFSET);
    addr_hit[348] = (reg_addr == PINMUX_DIO_PAD_ATTR_7_OFFSET);
    addr_hit[349] = (reg_addr == PINMUX_DIO_PAD_ATTR_8_OFFSET);
    addr_hit[350] = (reg_addr == PINMUX_DIO_PAD_ATTR_9_OFFSET);
    addr_hit[351] = (reg_addr == PINMUX_DIO_PAD_ATTR_10_OFFSET);
    addr_hit[352] = (reg_addr == PINMUX_DIO_PAD_ATTR_11_OFFSET);
    addr_hit[353] = (reg_addr == PINMUX_DIO_PAD_ATTR_12_OFFSET);
    addr_hit[354] = (reg_addr == PINMUX_DIO_PAD_ATTR_13_OFFSET);
    addr_hit[355] = (reg_addr == PINMUX_DIO_PAD_ATTR_14_OFFSET);
    addr_hit[356] = (reg_addr == PINMUX_DIO_PAD_ATTR_15_OFFSET);
    addr_hit[357] = (reg_addr == PINMUX_DIO_PAD_ATTR_16_OFFSET);
    addr_hit[358] = (reg_addr == PINMUX_DIO_PAD_ATTR_17_OFFSET);
    addr_hit[359] = (reg_addr == PINMUX_DIO_PAD_ATTR_18_OFFSET);
    addr_hit[360] = (reg_addr == PINMUX_DIO_PAD_ATTR_19_OFFSET);
    addr_hit[361] = (reg_addr == PINMUX_DIO_PAD_ATTR_20_OFFSET);
    addr_hit[362] = (reg_addr == PINMUX_DIO_PAD_ATTR_21_OFFSET);
    addr_hit[363] = (reg_addr == PINMUX_DIO_PAD_ATTR_22_OFFSET);
    addr_hit[364] = (reg_addr == PINMUX_MIO_PAD_SLEEP_STATUS_0_OFFSET);
    addr_hit[365] = (reg_addr == PINMUX_MIO_PAD_SLEEP_STATUS_1_OFFSET);
    addr_hit[366] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_0_OFFSET);
    addr_hit[367] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_1_OFFSET);
    addr_hit[368] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_2_OFFSET);
    ...
    addr_hit[372] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_6_OFFSET);
    addr_hit[373] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_7_OFFSET);
    addr_hit[374] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_8_OFFSET);
    addr_hit[375] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_9_OFFSET);
    addr_hit[376] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_10_OFFSET);
    addr_hit[377] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_11_OFFSET);
    addr_hit[378] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_12_OFFSET);
    addr_hit[379] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_13_OFFSET);
    addr_hit[380] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_14_OFFSET);
    addr_hit[381] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_15_OFFSET);
    addr_hit[382] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_16_OFFSET);
    addr_hit[383] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_17_OFFSET);
    addr_hit[384] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_18_OFFSET);
    addr_hit[385] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_19_OFFSET);
    addr_hit[386] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_20_OFFSET);
    addr_hit[387] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_21_OFFSET);
    addr_hit[388] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_22_OFFSET);
    addr_hit[389] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_23_OFFSET);
    addr_hit[390] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_24_OFFSET);
    addr_hit[391] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_25_OFFSET);
    addr_hit[392] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_26_OFFSET);
    addr_hit[393] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_27_OFFSET);
    addr_hit[394] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_28_OFFSET);
    addr_hit[395] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_29_OFFSET);
    addr_hit[396] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_30_OFFSET);
    addr_hit[397] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_31_OFFSET);
    addr_hit[398] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_32_OFFSET);
    addr_hit[399] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_33_OFFSET);
    addr_hit[400] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_34_OFFSET);
    addr_hit[401] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_35_OFFSET);
    addr_hit[402] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_36_OFFSET);
    addr_hit[403] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_37_OFFSET);
    addr_hit[404] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_38_OFFSET);
    addr_hit[405] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_39_OFFSET);
    addr_hit[406] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_40_OFFSET);
    addr_hit[407] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_41_OFFSET);
    addr_hit[408] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_42_OFFSET);
    addr_hit[409] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_43_OFFSET);
    addr_hit[410] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_44_OFFSET);
    addr_hit[411] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_45_OFFSET);
    addr_hit[412] = (reg_addr == PINMUX_MIO_PAD_SLEEP_REGWEN_46_OFFSET);
    addr_hit[413] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_0_OFFSET);
    addr_hit[414] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_1_OFFSET);
    addr_hit[415] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_2_OFFSET);
    addr_hit[416] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_3_OFFSET);
    addr_hit[417] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_4_OFFSET);
    addr_hit[418] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_5_OFFSET);
    addr_hit[419] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_6_OFFSET);
    addr_hit[420] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_7_OFFSET);
    addr_hit[421] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_8_OFFSET);
    addr_hit[422] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_9_OFFSET);
    addr_hit[423] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_10_OFFSET);
    addr_hit[424] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_11_OFFSET);
    addr_hit[425] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_12_OFFSET);
    addr_hit[426] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_13_OFFSET);
    addr_hit[427] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_14_OFFSET);
    addr_hit[428] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_15_OFFSET);
    addr_hit[429] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_16_OFFSET);
    addr_hit[430] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_17_OFFSET);
    addr_hit[431] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_18_OFFSET);
    addr_hit[432] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_19_OFFSET);
    addr_hit[433] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_20_OFFSET);
    addr_hit[434] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_21_OFFSET);
    addr_hit[435] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_22_OFFSET);
    addr_hit[436] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_23_OFFSET);
    addr_hit[437] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_24_OFFSET);
    addr_hit[438] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_25_OFFSET);
    addr_hit[439] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_26_OFFSET);
    addr_hit[440] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_27_OFFSET);
    addr_hit[441] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_28_OFFSET);
    addr_hit[442] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_29_OFFSET);
    addr_hit[443] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_30_OFFSET);
    addr_hit[444] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_31_OFFSET);
    addr_hit[445] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_32_OFFSET);
    addr_hit[446] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_33_OFFSET);
    addr_hit[447] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_34_OFFSET);
    addr_hit[448] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_35_OFFSET);
    addr_hit[449] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_36_OFFSET);
    addr_hit[450] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_37_OFFSET);
    addr_hit[451] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_38_OFFSET);
    addr_hit[452] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_39_OFFSET);
    addr_hit[453] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_40_OFFSET);
    addr_hit[454] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_41_OFFSET);
    addr_hit[455] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_42_OFFSET);
    addr_hit[456] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_43_OFFSET);
    addr_hit[457] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_44_OFFSET);
    addr_hit[458] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_45_OFFSET);
    addr_hit[459] = (reg_addr == PINMUX_MIO_PAD_SLEEP_EN_46_OFFSET);
    addr_hit[460] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_0_OFFSET);
    addr_hit[461] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_1_OFFSET);
    addr_hit[462] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_2_OFFSET);
    addr_hit[463] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_3_OFFSET);
    addr_hit[464] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_4_OFFSET);
    addr_hit[465] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_5_OFFSET);
    addr_hit[466] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_6_OFFSET);
    addr_hit[467] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_7_OFFSET);
    addr_hit[468] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_8_OFFSET);
    addr_hit[469] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_9_OFFSET);
    addr_hit[470] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_10_OFFSET);
    addr_hit[471] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_11_OFFSET);
    addr_hit[472] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_12_OFFSET);
    addr_hit[473] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_13_OFFSET);
    addr_hit[474] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_14_OFFSET);
    addr_hit[475] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_15_OFFSET);
    addr_hit[476] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_16_OFFSET);
    addr_hit[477] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_17_OFFSET);
    addr_hit[478] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_18_OFFSET);
    addr_hit[479] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_19_OFFSET);
    addr_hit[480] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_20_OFFSET);
    addr_hit[481] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_21_OFFSET);
    addr_hit[482] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_22_OFFSET);
    addr_hit[483] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_23_OFFSET);
    addr_hit[484] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_24_OFFSET);
    addr_hit[485] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_25_OFFSET);
    addr_hit[486] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_26_OFFSET);
    addr_hit[487] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_27_OFFSET);
    addr_hit[488] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_28_OFFSET);
    addr_hit[489] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_29_OFFSET);
    addr_hit[490] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_30_OFFSET);
    addr_hit[491] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_31_OFFSET);
    addr_hit[492] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_32_OFFSET);
    addr_hit[493] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_33_OFFSET);
    addr_hit[494] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_34_OFFSET);
    addr_hit[495] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_35_OFFSET);
    addr_hit[496] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_36_OFFSET);
    addr_hit[497] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_37_OFFSET);
    addr_hit[498] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_38_OFFSET);
    addr_hit[499] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_39_OFFSET);
    addr_hit[500] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_40_OFFSET);
    addr_hit[501] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_41_OFFSET);
    addr_hit[502] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_42_OFFSET);
    addr_hit[503] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_43_OFFSET);
    addr_hit[504] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_44_OFFSET);
    addr_hit[505] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_45_OFFSET);
    addr_hit[506] = (reg_addr == PINMUX_MIO_PAD_SLEEP_MODE_46_OFFSET);
    addr_hit[507] = (reg_addr == PINMUX_DIO_PAD_SLEEP_STATUS_OFFSET);
    addr_hit[508] = (reg_addr == PINMUX_DIO_PAD_SLEEP_REGWEN_0_OFFSET);
    addr_hit[509] = (reg_addr == PINMUX_DIO_PAD_SLEEP_REGWEN_1_OFFSET);
    addr_hit[510] = (reg_addr == PINMUX_DIO_PAD_SLEEP_REGWEN_2_OFFSET);
    addr_hit[511] = (reg_addr == PINMUX_DIO_PAD_SLEEP_REGWEN_3_OFFSET);
    addr_hit[512] = (reg_addr == PINMUX_DIO_PAD_SLEEP_REGWEN_4_OFFSET);
    addr_hit[513] = (reg_addr == PINMUX_DIO_PAD_SLEEP_REGWEN_5_OFFSET);
    addr_hit[514] = (reg_addr == PINMUX_DIO_PAD_SLEEP_REGWEN_6_OFFSET);
    addr_hit[515] = (reg_addr == PINMUX_DIO_PAD_SLEEP_REGWEN_7_OFFSET);
    addr_hit[516] = (reg_addr == PINMUX_DIO_PAD_SLEEP_REGWEN_8_OFFSET);
    addr_hit[517] = (reg_addr == PINMUX_DIO_PAD_SLEEP_REGWEN_9_OFFSET);
    addr_hit[518] = (reg_addr == PINMUX_DIO_PAD_SLEEP_REGWEN_10_OFFSET);
    addr_hit[519] = (reg_addr == PINMUX_DIO_PAD_SLEEP_REGWEN_11_OFFSET);
    addr_hit[520] = (reg_addr == PINMUX_DIO_PAD_SLEEP_REGWEN_12_OFFSET);
    addr_hit[521] = (reg_addr == PINMUX_DIO_PAD_SLEEP_REGWEN_13_OFFSET);
    addr_hit[522] = (reg_addr == PINMUX_DIO_PAD_SLEEP_REGWEN_14_OFFSET);
    addr_hit[523] = (reg_addr == PINMUX_DIO_PAD_SLEEP_REGWEN_15_OFFSET);
    addr_hit[524] = (reg_addr == PINMUX_DIO_PAD_SLEEP_REGWEN_16_OFFSET);
    addr_hit[525] = (reg_addr == PINMUX_DIO_PAD_SLEEP_REGWEN_17_OFFSET);
    addr_hit[526] = (reg_addr == PINMUX_DIO_PAD_SLEEP_REGWEN_18_OFFSET);
    addr_hit[527] = (reg_addr == PINMUX_DIO_PAD_SLEEP_REGWEN_19_OFFSET);
    addr_hit[528] = (reg_addr == PINMUX_DIO_PAD_SLEEP_REGWEN_20_OFFSET);
    addr_hit[529] = (reg_addr == PINMUX_DIO_PAD_SLEEP_REGWEN_21_OFFSET);
    addr_hit[530] = (reg_addr == PINMUX_DIO_PAD_SLEEP_REGWEN_22_OFFSET);
    addr_hit[531] = (reg_addr == PINMUX_DIO_PAD_SLEEP_EN_0_OFFSET);
    addr_hit[532] = (reg_addr == PINMUX_DIO_PAD_SLEEP_EN_1_OFFSET);
    addr_hit[533] = (reg_addr == PINMUX_DIO_PAD_SLEEP_EN_2_OFFSET);
    addr_hit[534] = (reg_addr == PINMUX_DIO_PAD_SLEEP_EN_3_OFFSET);
    addr_hit[535] = (reg_addr == PINMUX_DIO_PAD_SLEEP_EN_4_OFFSET);
    addr_hit[536] = (reg_addr == PINMUX_DIO_PAD_SLEEP_EN_5_OFFSET);
    addr_hit[537] = (reg_addr == PINMUX_DIO_PAD_SLEEP_EN_6_OFFSET);
    addr_hit[538] = (reg_addr == PINMUX_DIO_PAD_SLEEP_EN_7_OFFSET);
    addr_hit[539] = (reg_addr == PINMUX_DIO_PAD_SLEEP_EN_8_OFFSET);
    addr_hit[540] = (reg_addr == PINMUX_DIO_PAD_SLEEP_EN_9_OFFSET);
    addr_hit[541] = (reg_addr == PINMUX_DIO_PAD_SLEEP_EN_10_OFFSET);
    addr_hit[542] = (reg_addr == PINMUX_DIO_PAD_SLEEP_EN_11_OFFSET);
    addr_hit[543] = (reg_addr == PINMUX_DIO_PAD_SLEEP_EN_12_OFFSET);
    addr_hit[544] = (reg_addr == PINMUX_DIO_PAD_SLEEP_EN_13_OFFSET);
    addr_hit[545] = (reg_addr == PINMUX_DIO_PAD_SLEEP_EN_14_OFFSET);
    addr_hit[546] = (reg_addr == PINMUX_DIO_PAD_SLEEP_EN_15_OFFSET);
    addr_hit[547] = (reg_addr == PINMUX_DIO_PAD_SLEEP_EN_16_OFFSET);
    addr_hit[548] = (reg_addr == PINMUX_DIO_PAD_SLEEP_EN_17_OFFSET);
    addr_hit[549] = (reg_addr == PINMUX_DIO_PAD_SLEEP_EN_18_OFFSET);
    addr_hit[550] = (reg_addr == PINMUX_DIO_PAD_SLEEP_EN_19_OFFSET);
    addr_hit[551] = (reg_addr == PINMUX_DIO_PAD_SLEEP_EN_20_OFFSET);
    addr_hit[552] = (reg_addr == PINMUX_DIO_PAD_SLEEP_EN_21_OFFSET);
    addr_hit[553] = (reg_addr == PINMUX_DIO_PAD_SLEEP_EN_22_OFFSET);
    addr_hit[554] = (reg_addr == PINMUX_DIO_PAD_SLEEP_MODE_0_OFFSET);
    addr_hit[555] = (reg_addr == PINMUX_DIO_PAD_SLEEP_MODE_1_OFFSET);
    addr_hit[556] = (reg_addr == PINMUX_DIO_PAD_SLEEP_MODE_2_OFFSET);
    addr_hit[557] = (reg_addr == PINMUX_DIO_PAD_SLEEP_MODE_3_OFFSET);
    addr_hit[558] = (reg_addr == PINMUX_DIO_PAD_SLEEP_MODE_4_OFFSET);
    addr_hit[559] = (reg_addr == PINMUX_DIO_PAD_SLEEP_MODE_5_OFFSET);
    addr_hit[560] = (reg_addr == PINMUX_DIO_PAD_SLEEP_MODE_6_OFFSET);
    addr_hit[561] = (reg_addr == PINMUX_DIO_PAD_SLEEP_MODE_7_OFFSET);
    addr_hit[562] = (reg_addr == PINMUX_DIO_PAD_SLEEP_MODE_8_OFFSET);
    addr_hit[563] = (reg_addr == PINMUX_DIO_PAD_SLEEP_MODE_9_OFFSET);
    addr_hit[564] = (reg_addr == PINMUX_DIO_PAD_SLEEP_MODE_10_OFFSET);
    addr_hit[565] = (reg_addr == PINMUX_DIO_PAD_SLEEP_MODE_11_OFFSET);
    addr_hit[566] = (reg_addr == PINMUX_DIO_PAD_SLEEP_MODE_12_OFFSET);
    addr_hit[567] = (reg_addr == PINMUX_DIO_PAD_SLEEP_MODE_13_OFFSET);
    addr_hit[568] = (reg_addr == PINMUX_DIO_PAD_SLEEP_MODE_14_OFFSET);
    addr_hit[569] = (reg_addr == PINMUX_DIO_PAD_SLEEP_MODE_15_OFFSET);
    addr_hit[570] = (reg_addr == PINMUX_DIO_PAD_SLEEP_MODE_16_OFFSET);
    addr_hit[571] = (reg_addr == PINMUX_DIO_PAD_SLEEP_MODE_17_OFFSET);
    addr_hit[572] = (reg_addr == PINMUX_DIO_PAD_SLEEP_MODE_18_OFFSET);
    addr_hit[573] = (reg_addr == PINMUX_DIO_PAD_SLEEP_MODE_19_OFFSET);
    addr_hit[574] = (reg_addr == PINMUX_DIO_PAD_SLEEP_MODE_20_OFFSET);
    addr_hit[575] = (reg_addr == PINMUX_DIO_PAD_SLEEP_MODE_21_OFFSET);
    addr_hit[576] = (reg_addr == PINMUX_DIO_PAD_SLEEP_MODE_22_OFFSET);
    addr_hit[577] = (reg_addr == PINMUX_WKUP_DETECTOR_REGWEN_0_OFFSET);
    addr_hit[578] = (reg_addr == PINMUX_WKUP_DETECTOR_REGWEN_1_OFFSET);
    addr_hit[579] = (reg_addr == PINMUX_WKUP_DETECTOR_REGWEN_2_OFFSET);
    addr_hit[580] = (reg_addr == PINMUX_WKUP_DETECTOR_REGWEN_3_OFFSET);
    addr_hit[581] = (reg_addr == PINMUX_WKUP_DETECTOR_REGWEN_4_OFFSET);
    addr_hit[582] = (reg_addr == PINMUX_WKUP_DETECTOR_REGWEN_5_OFFSET);
    addr_hit[583] = (reg_addr == PINMUX_WKUP_DETECTOR_REGWEN_6_OFFSET);
    addr_hit[584] = (reg_addr == PINMUX_WKUP_DETECTOR_REGWEN_7_OFFSET);
    addr_hit[585] = (reg_addr == PINMUX_WKUP_DETECTOR_EN_0_OFFSET);
    addr_hit[586] = (reg_addr == PINMUX_WKUP_DETECTOR_EN_1_OFFSET);
    addr_hit[587] = (reg_addr == PINMUX_WKUP_DETECTOR_EN_2_OFFSET);
    addr_hit[588] = (reg_addr == PINMUX_WKUP_DETECTOR_EN_3_OFFSET);
    addr_hit[589] = (reg_addr == PINMUX_WKUP_DETECTOR_EN_4_OFFSET);
    addr_hit[590] = (reg_addr == PINMUX_WKUP_DETECTOR_EN_5_OFFSET);
    addr_hit[591] = (reg_addr == PINMUX_WKUP_DETECTOR_EN_6_OFFSET);
    addr_hit[592] = (reg_addr == PINMUX_WKUP_DETECTOR_EN_7_OFFSET);
    addr_hit[593] = (reg_addr == PINMUX_WKUP_DETECTOR_0_OFFSET);
    addr_hit[594] = (reg_addr == PINMUX_WKUP_DETECTOR_1_OFFSET);
    addr_hit[595] = (reg_addr == PINMUX_WKUP_DETECTOR_2_OFFSET);
    addr_hit[596] = (reg_addr == PINMUX_WKUP_DETECTOR_3_OFFSET);
    addr_hit[597] = (reg_addr == PINMUX_WKUP_DETECTOR_4_OFFSET);
    addr_hit[598] = (reg_addr == PINMUX_WKUP_DETECTOR_5_OFFSET);
    addr_hit[599] = (reg_addr == PINMUX_WKUP_DETECTOR_6_OFFSET);
    addr_hit[600] = (reg_addr == PINMUX_WKUP_DETECTOR_7_OFFSET);
    addr_hit[601] = (reg_addr == PINMUX_WKUP_DETECTOR_CNT_TH_0_OFFSET);
    addr_hit[602] = (reg_addr == PINMUX_WKUP_DETECTOR_CNT_TH_1_OFFSET);
    addr_hit[603] = (reg_addr == PINMUX_WKUP_DETECTOR_CNT_TH_2_OFFSET);
    ...
    addr_hit[607] = (reg_addr == PINMUX_WKUP_DETECTOR_CNT_TH_6_OFFSET);
    addr_hit[608] = (reg_addr == PINMUX_WKUP_DETECTOR_CNT_TH_7_OFFSET);
    addr_hit[609] = (reg_addr == PINMUX_WKUP_DETECTOR_PADSEL_0_OFFSET);
    addr_hit[610] = (reg_addr == PINMUX_WKUP_DETECTOR_PADSEL_1_OFFSET);
    addr_hit[611] = (reg_addr == PINMUX_WKUP_DETECTOR_PADSEL_2_OFFSET);
    addr_hit[612] = (reg_addr == PINMUX_WKUP_DETECTOR_PADSEL_3_OFFSET);
    addr_hit[613] = (reg_addr == PINMUX_WKUP_DETECTOR_PADSEL_4_OFFSET);
    addr_hit[614] = (reg_addr == PINMUX_WKUP_DETECTOR_PADSEL_5_OFFSET);
    addr_hit[615] = (reg_addr == PINMUX_WKUP_DETECTOR_PADSEL_6_OFFSET);
    addr_hit[616] = (reg_addr == PINMUX_WKUP_DETECTOR_PADSEL_7_OFFSET);
    addr_hit[617] = (reg_addr == PINMUX_WKUP_CAUSE_OFFSET);
  end
  ...
  always_comb begin
    ...
    if (addr_hit[603] && reg_we && (PINMUX_PERMIT[603] != (PINMUX_PERMIT[603] & reg_be))) wr_err = 1'b1 ;
    if (addr_hit[604] && reg_we && (PINMUX_PERMIT[604] != (PINMUX_PERMIT[604] & reg_be))) wr_err = 1'b1 ;
    if (addr_hit[605] && reg_we && (PINMUX_PERMIT[605] != (PINMUX_PERMIT[605] & reg_be))) wr_err = 1'b1 ;
    if (addr_hit[606] && reg_we && (PINMUX_PERMIT[606] != (PINMUX_PERMIT[606] & reg_be))) wr_err = 1'b1 ;
    if (addr_hit[607] && reg_we && (PINMUX_PERMIT[607] != (PINMUX_PERMIT[607] & reg_be))) wr_err = 1'b1 ;
    if (addr_hit[608] && reg_we && (PINMUX_PERMIT[608] != (PINMUX_PERMIT[608] & reg_be))) wr_err = 1'b1 ;
    if (addr_hit[609] && reg_we && (PINMUX_PERMIT[609] != (PINMUX_PERMIT[609] & reg_be))) wr_err = 1'b1 ;
    if (addr_hit[610] && reg_we && (PINMUX_PERMIT[610] != (PINMUX_PERMIT[610] & reg_be))) wr_err = 1'b1 ;
    if (addr_hit[611] && reg_we && (PINMUX_PERMIT[611] != (PINMUX_PERMIT[611] & reg_be))) wr_err = 1'b1 ;
    if (addr_hit[612] && reg_we && (PINMUX_PERMIT[612] != (PINMUX_PERMIT[612] & reg_be))) wr_err = 1'b1 ;
    if (addr_hit[613] && reg_we && (PINMUX_PERMIT[613] != (PINMUX_PERMIT[613] & reg_be))) wr_err = 1'b1 ;
    if (addr_hit[614] && reg_we && (PINMUX_PERMIT[614] != (PINMUX_PERMIT[614] & reg_be))) wr_err = 1'b1 ;
    if (addr_hit[615] && reg_we && (PINMUX_PERMIT[615] != (PINMUX_PERMIT[615] & reg_be))) wr_err = 1'b1 ;
    if (addr_hit[616] && reg_we && (PINMUX_PERMIT[616] != (PINMUX_PERMIT[616] & reg_be))) wr_err = 1'b1 ;
    if (addr_hit[617] && reg_we && (PINMUX_PERMIT[617] != (PINMUX_PERMIT[617] & reg_be))) wr_err = 1'b1 ;
  end
  ...
  assign mio_periph_insel_regwen_59_we = addr_hit[59] & reg_we & !reg_error;
  assign mio_periph_insel_regwen_59_wd = reg_wdata[0];

  assign mio_periph_insel_regwen_60_we = addr_hit[60] & reg_we & !reg_error;
  assign mio_periph_insel_regwen_60_wd = reg_wdata[0];

  assign mio_periph_insel_regwen_61_we = addr_hit[61] & reg_we & !reg_error;
  assign mio_periph_insel_regwen_61_wd = reg_wdata[0];

  assign mio_periph_insel_regwen_62_we = addr_hit[62] & reg_we & !reg_error;
  assign mio_periph_insel_regwen_62_wd = reg_wdata[0];

  assign mio_periph_insel_regwen_63_we = addr_hit[63] & reg_we & !reg_error;
  assign mio_periph_insel_regwen_63_wd = reg_wdata[0];

  assign mio_periph_insel_regwen_64_we = addr_hit[64] & reg_we & !reg_error;
  assign mio_periph_insel_regwen_64_wd = reg_wdata[0];

  assign mio_periph_insel_0_we = addr_hit[65] & reg_we & !reg_error;
  assign mio_periph_insel_0_wd = reg_wdata[5:0];

  assign mio_periph_insel_1_we = addr_hit[66] & reg_we & !reg_error;
  assign mio_periph_insel_1_wd = reg_wdata[5:0];

  assign mio_periph_insel_2_we = addr_hit[67] & reg_we & !reg_error;
  assign mio_periph_insel_2_wd = reg_wdata[5:0];

  assign mio_periph_insel_3_we = addr_hit[68] & reg_we & !reg_error;
  assign mio_periph_insel_3_wd = reg_wdata[5:0];

  assign mio_periph_insel_4_we = addr_hit[69] & reg_we & !reg_error;
  assign mio_periph_insel_4_wd = reg_wdata[5:0];

  assign mio_periph_insel_5_we = addr_hit[70] & reg_we & !reg_error;
  assign mio_periph_insel_5_wd = reg_wdata[5:0];

  assign mio_periph_insel_6_we = addr_hit[71] & reg_we & !reg_error;
  assign mio_periph_insel_6_wd = reg_wdata[5:0];

  assign mio_periph_insel_7_we = addr_hit[72] & reg_we & !reg_error;
  assign mio_periph_insel_7_wd = reg_wdata[5:0];

  assign mio_periph_insel_8_we = addr_hit[73] & reg_we & !reg_error;
  assign mio_periph_insel_8_wd = reg_wdata[5:0];

  assign mio_periph_insel_9_we = addr_hit[74] & reg_we & !reg_error;
  assign mio_periph_insel_9_wd = reg_wdata[5:0];

  assign mio_periph_insel_10_we = addr_hit[75] & reg_we & !reg_error;
  assign mio_periph_insel_10_wd = reg_wdata[5:0];

  assign mio_periph_insel_11_we = addr_hit[76] & reg_we & !reg_error;
  assign mio_periph_insel_11_wd = reg_wdata[5:0];

  assign mio_periph_insel_12_we = addr_hit[77] & reg_we & !reg_error;
  assign mio_periph_insel_12_wd = reg_wdata[5:0];

  assign mio_periph_insel_13_we = addr_hit[78] & reg_we & !reg_error;
  assign mio_periph_insel_13_wd = reg_wdata[5:0];

  assign mio_periph_insel_14_we = addr_hit[79] & reg_we & !reg_error;
  assign mio_periph_insel_14_wd = reg_wdata[5:0];

  assign mio_periph_insel_15_we = addr_hit[80] & reg_we & !reg_error;
  assign mio_periph_insel_15_wd = reg_wdata[5:0];

  assign mio_periph_insel_16_we = addr_hit[81] & reg_we & !reg_error;
  assign mio_periph_insel_16_wd = reg_wdata[5:0];

  assign mio_periph_insel_17_we = addr_hit[82] & reg_we & !reg_error;
  assign mio_periph_insel_17_wd = reg_wdata[5:0];

  assign mio_periph_insel_18_we = addr_hit[83] & reg_we & !reg_error;
  assign mio_periph_insel_18_wd = reg_wdata[5:0];

  assign mio_periph_insel_19_we = addr_hit[84] & reg_we & !reg_error;
  assign mio_periph_insel_19_wd = reg_wdata[5:0];

  assign mio_periph_insel_20_we = addr_hit[85] & reg_we & !reg_error;
  assign mio_periph_insel_20_wd = reg_wdata[5:0];

  assign mio_periph_insel_21_we = addr_hit[86] & reg_we & !reg_error;
  assign mio_periph_insel_21_wd = reg_wdata[5:0];

  assign mio_periph_insel_22_we = addr_hit[87] & reg_we & !reg_error;
  assign mio_periph_insel_22_wd = reg_wdata[5:0];

  assign mio_periph_insel_23_we = addr_hit[88] & reg_we & !reg_error;
  assign mio_periph_insel_23_wd = reg_wdata[5:0];

  assign mio_periph_insel_24_we = addr_hit[89] & reg_we & !reg_error;
  assign mio_periph_insel_24_wd = reg_wdata[5:0];

  assign mio_periph_insel_25_we = addr_hit[90] & reg_we & !reg_error;
  assign mio_periph_insel_25_wd = reg_wdata[5:0];

  assign mio_periph_insel_26_we = addr_hit[91] & reg_we & !reg_error;
  assign mio_periph_insel_26_wd = reg_wdata[5:0];

  assign mio_periph_insel_27_we = addr_hit[92] & reg_we & !reg_error;
  assign mio_periph_insel_27_wd = reg_wdata[5:0];

  assign mio_periph_insel_28_we = addr_hit[93] & reg_we & !reg_error;
  assign mio_periph_insel_28_wd = reg_wdata[5:0];

  assign mio_periph_insel_29_we = addr_hit[94] & reg_we & !reg_error;
  assign mio_periph_insel_29_wd = reg_wdata[5:0];

  assign mio_periph_insel_30_we = addr_hit[95] & reg_we & !reg_error;
  assign mio_periph_insel_30_wd = reg_wdata[5:0];

  assign mio_periph_insel_31_we = addr_hit[96] & reg_we & !reg_error;
  assign mio_periph_insel_31_wd = reg_wdata[5:0];

  assign mio_periph_insel_32_we = addr_hit[97] & reg_we & !reg_error;
  assign mio_periph_insel_32_wd = reg_wdata[5:0];

  assign mio_periph_insel_33_we = addr_hit[98] & reg_we & !reg_error;
  assign mio_periph_insel_33_wd = reg_wdata[5:0];

  assign mio_periph_insel_34_we = addr_hit[99] & reg_we & !reg_error;
  assign mio_periph_insel_34_wd = reg_wdata[5:0];

  assign mio_periph_insel_35_we = addr_hit[100] & reg_we & !reg_error;
  assign mio_periph_insel_35_wd = reg_wdata[5:0];

  assign mio_periph_insel_36_we = addr_hit[101] & reg_we & !reg_error;
  assign mio_periph_insel_36_wd = reg_wdata[5:0];

  assign mio_periph_insel_37_we = addr_hit[102] & reg_we & !reg_error;
  assign mio_periph_insel_37_wd = reg_wdata[5:0];

  assign mio_periph_insel_38_we = addr_hit[103] & reg_we & !reg_error;
  assign mio_periph_insel_38_wd = reg_wdata[5:0];

  assign mio_periph_insel_39_we = addr_hit[104] & reg_we & !reg_error;
  assign mio_periph_insel_39_wd = reg_wdata[5:0];

  assign mio_periph_insel_40_we = addr_hit[105] & reg_we & !reg_error;
  assign mio_periph_insel_40_wd = reg_wdata[5:0];

  assign mio_periph_insel_41_we = addr_hit[106] & reg_we & !reg_error;
  assign mio_periph_insel_41_wd = reg_wdata[5:0];

  assign mio_periph_insel_42_we = addr_hit[107] & reg_we & !reg_error;
  assign mio_periph_insel_42_wd = reg_wdata[5:0];

  assign mio_periph_insel_43_we = addr_hit[108] & reg_we & !reg_error;
  assign mio_periph_insel_43_wd = reg_wdata[5:0];

  assign mio_periph_insel_44_we = addr_hit[109] & reg_we & !reg_error;
  assign mio_periph_insel_44_wd = reg_wdata[5:0];

  assign mio_periph_insel_45_we = addr_hit[110] & reg_we & !reg_error;
  assign mio_periph_insel_45_wd = reg_wdata[5:0];

  assign mio_periph_insel_46_we = addr_hit[111] & reg_we & !reg_error;
  assign mio_periph_insel_46_wd = reg_wdata[5:0];

  assign mio_periph_insel_47_we = addr_hit[112] & reg_we & !reg_error;
  assign mio_periph_insel_47_wd = reg_wdata[5:0];

  assign mio_periph_insel_48_we = addr_hit[113] & reg_we & !reg_error;
  assign mio_periph_insel_48_wd = reg_wdata[5:0];

  assign mio_periph_insel_49_we = addr_hit[114] & reg_we & !reg_error;
  assign mio_periph_insel_49_wd = reg_wdata[5:0];

  assign mio_periph_insel_50_we = addr_hit[115] & reg_we & !reg_error;
  assign mio_periph_insel_50_wd = reg_wdata[5:0];

  assign mio_periph_insel_51_we = addr_hit[116] & reg_we & !reg_error;
  assign mio_periph_insel_51_wd = reg_wdata[5:0];

  assign mio_periph_insel_52_we = addr_hit[117] & reg_we & !reg_error;
  assign mio_periph_insel_52_wd = reg_wdata[5:0];

  assign mio_periph_insel_53_we = addr_hit[118] & reg_we & !reg_error;
  assign mio_periph_insel_53_wd = reg_wdata[5:0];

  assign mio_periph_insel_54_we = addr_hit[119] & reg_we & !reg_error;
  assign mio_periph_insel_54_wd = reg_wdata[5:0];

  assign mio_periph_insel_55_we = addr_hit[120] & reg_we & !reg_error;
  assign mio_periph_insel_55_wd = reg_wdata[5:0];

  assign mio_periph_insel_56_we = addr_hit[121] & reg_we & !reg_error;
  assign mio_periph_insel_56_wd = reg_wdata[5:0];

  assign mio_periph_insel_57_we = addr_hit[122] & reg_we & !reg_error;
  assign mio_periph_insel_57_wd = reg_wdata[5:0];

  assign mio_periph_insel_58_we = addr_hit[123] & reg_we & !reg_error;
  assign mio_periph_insel_58_wd = reg_wdata[5:0];

  assign mio_periph_insel_59_we = addr_hit[124] & reg_we & !reg_error;
  assign mio_periph_insel_59_wd = reg_wdata[5:0];

  assign mio_periph_insel_60_we = addr_hit[125] & reg_we & !reg_error;
  assign mio_periph_insel_60_wd = reg_wdata[5:0];

  assign mio_periph_insel_61_we = addr_hit[126] & reg_we & !reg_error;
  assign mio_periph_insel_61_wd = reg_wdata[5:0];

  assign mio_periph_insel_62_we = addr_hit[127] & reg_we & !reg_error;
  assign mio_periph_insel_62_wd = reg_wdata[5:0];

  assign mio_periph_insel_63_we = addr_hit[128] & reg_we & !reg_error;
  assign mio_periph_insel_63_wd = reg_wdata[5:0];

  assign mio_periph_insel_64_we = addr_hit[129] & reg_we & !reg_error;
  assign mio_periph_insel_64_wd = reg_wdata[5:0];

  assign mio_outsel_regwen_0_we = addr_hit[130] & reg_we & !reg_error;
  assign mio_outsel_regwen_0_wd = reg_wdata[0];

  assign mio_outsel_regwen_1_we = addr_hit[131] & reg_we & !reg_error;
  assign mio_outsel_regwen_1_wd = reg_wdata[0];

  assign mio_outsel_regwen_2_we = addr_hit[132] & reg_we & !reg_error;
  assign mio_outsel_regwen_2_wd = reg_wdata[0];

  assign mio_outsel_regwen_3_we = addr_hit[133] & reg_we & !reg_error;
  assign mio_outsel_regwen_3_wd = reg_wdata[0];

  assign mio_outsel_regwen_4_we = addr_hit[134] & reg_we & !reg_error;
  assign mio_outsel_regwen_4_wd = reg_wdata[0];

  assign mio_outsel_regwen_5_we = addr_hit[135] & reg_we & !reg_error;
  assign mio_outsel_regwen_5_wd = reg_wdata[0];

  assign mio_outsel_regwen_6_we = addr_hit[136] & reg_we & !reg_error;
  assign mio_outsel_regwen_6_wd = reg_wdata[0];

  assign mio_outsel_regwen_7_we = addr_hit[137] & reg_we & !reg_error;
  assign mio_outsel_regwen_7_wd = reg_wdata[0];

  assign mio_outsel_regwen_8_we = addr_hit[138] & reg_we & !reg_error;
  assign mio_outsel_regwen_8_wd = reg_wdata[0];

  assign mio_outsel_regwen_9_we = addr_hit[139] & reg_we & !reg_error;
  assign mio_outsel_regwen_9_wd = reg_wdata[0];

  assign mio_outsel_regwen_10_we = addr_hit[140] & reg_we & !reg_error;
  assign mio_outsel_regwen_10_wd = reg_wdata[0];

  assign mio_outsel_regwen_11_we = addr_hit[141] & reg_we & !reg_error;
  assign mio_outsel_regwen_11_wd = reg_wdata[0];

  assign mio_outsel_regwen_12_we = addr_hit[142] & reg_we & !reg_error;
  assign mio_outsel_regwen_12_wd = reg_wdata[0];

  assign mio_outsel_regwen_13_we = addr_hit[143] & reg_we & !reg_error;
  assign mio_outsel_regwen_13_wd = reg_wdata[0];

  assign mio_outsel_regwen_14_we = addr_hit[144] & reg_we & !reg_error;
  assign mio_outsel_regwen_14_wd = reg_wdata[0];

  assign mio_outsel_regwen_15_we = addr_hit[145] & reg_we & !reg_error;
  assign mio_outsel_regwen_15_wd = reg_wdata[0];

  assign mio_outsel_regwen_16_we = addr_hit[146] & reg_we & !reg_error;
  assign mio_outsel_regwen_16_wd = reg_wdata[0];

  assign mio_outsel_regwen_17_we = addr_hit[147] & reg_we & !reg_error;
  assign mio_outsel_regwen_17_wd = reg_wdata[0];

  assign mio_outsel_regwen_18_we = addr_hit[148] & reg_we & !reg_error;
  assign mio_outsel_regwen_18_wd = reg_wdata[0];

  assign mio_outsel_regwen_19_we = addr_hit[149] & reg_we & !reg_error;
  assign mio_outsel_regwen_19_wd = reg_wdata[0];

  assign mio_outsel_regwen_20_we = addr_hit[150] & reg_we & !reg_error;
  assign mio_outsel_regwen_20_wd = reg_wdata[0];

  assign mio_outsel_regwen_21_we = addr_hit[151] & reg_we & !reg_error;
  assign mio_outsel_regwen_21_wd = reg_wdata[0];

  assign mio_outsel_regwen_22_we = addr_hit[152] & reg_we & !reg_error;
  assign mio_outsel_regwen_22_wd = reg_wdata[0];

  assign mio_outsel_regwen_23_we = addr_hit[153] & reg_we & !reg_error;
  assign mio_outsel_regwen_23_wd = reg_wdata[0];

  assign mio_outsel_regwen_24_we = addr_hit[154] & reg_we & !reg_error;
  assign mio_outsel_regwen_24_wd = reg_wdata[0];

  assign mio_outsel_regwen_25_we = addr_hit[155] & reg_we & !reg_error;
  assign mio_outsel_regwen_25_wd = reg_wdata[0];

  assign mio_outsel_regwen_26_we = addr_hit[156] & reg_we & !reg_error;
  assign mio_outsel_regwen_26_wd = reg_wdata[0];

  assign mio_outsel_regwen_27_we = addr_hit[157] & reg_we & !reg_error;
  assign mio_outsel_regwen_27_wd = reg_wdata[0];

  assign mio_outsel_regwen_28_we = addr_hit[158] & reg_we & !reg_error;
  assign mio_outsel_regwen_28_wd = reg_wdata[0];

  assign mio_outsel_regwen_29_we = addr_hit[159] & reg_we & !reg_error;
  assign mio_outsel_regwen_29_wd = reg_wdata[0];

  assign mio_outsel_regwen_30_we = addr_hit[160] & reg_we & !reg_error;
  assign mio_outsel_regwen_30_wd = reg_wdata[0];

  assign mio_outsel_regwen_31_we = addr_hit[161] & reg_we & !reg_error;
  assign mio_outsel_regwen_31_wd = reg_wdata[0];

  assign mio_outsel_regwen_32_we = addr_hit[162] & reg_we & !reg_error;
  assign mio_outsel_regwen_32_wd = reg_wdata[0];

  assign mio_outsel_regwen_33_we = addr_hit[163] & reg_we & !reg_error;
  assign mio_outsel_regwen_33_wd = reg_wdata[0];

  assign mio_outsel_regwen_34_we = addr_hit[164] & reg_we & !reg_error;
  assign mio_outsel_regwen_34_wd = reg_wdata[0];

  assign mio_outsel_regwen_35_we = addr_hit[165] & reg_we & !reg_error;
  assign mio_outsel_regwen_35_wd = reg_wdata[0];

  assign mio_outsel_regwen_36_we = addr_hit[166] & reg_we & !reg_error;
  assign mio_outsel_regwen_36_wd = reg_wdata[0];

  assign mio_outsel_regwen_37_we = addr_hit[167] & reg_we & !reg_error;
  assign mio_outsel_regwen_37_wd = reg_wdata[0];

  assign mio_outsel_regwen_38_we = addr_hit[168] & reg_we & !reg_error;
  assign mio_outsel_regwen_38_wd = reg_wdata[0];

  assign mio_outsel_regwen_39_we = addr_hit[169] & reg_we & !reg_error;
  assign mio_outsel_regwen_39_wd = reg_wdata[0];

  assign mio_outsel_regwen_40_we = addr_hit[170] & reg_we & !reg_error;
  assign mio_outsel_regwen_40_wd = reg_wdata[0];

  assign mio_outsel_regwen_41_we = addr_hit[171] & reg_we & !reg_error;
  assign mio_outsel_regwen_41_wd = reg_wdata[0];

  assign mio_outsel_regwen_42_we = addr_hit[172] & reg_we & !reg_error;
  assign mio_outsel_regwen_42_wd = reg_wdata[0];

  assign mio_outsel_regwen_43_we = addr_hit[173] & reg_we & !reg_error;
  assign mio_outsel_regwen_43_wd = reg_wdata[0];

  assign mio_outsel_regwen_44_we = addr_hit[174] & reg_we & !reg_error;
  assign mio_outsel_regwen_44_wd = reg_wdata[0];

  assign mio_outsel_regwen_45_we = addr_hit[175] & reg_we & !reg_error;
  assign mio_outsel_regwen_45_wd = reg_wdata[0];

  assign mio_outsel_regwen_46_we = addr_hit[176] & reg_we & !reg_error;
  assign mio_outsel_regwen_46_wd = reg_wdata[0];

  assign mio_outsel_0_we = addr_hit[177] & reg_we & !reg_error;
  assign mio_outsel_0_wd = reg_wdata[6:0];

  assign mio_outsel_1_we = addr_hit[178] & reg_we & !reg_error;
  assign mio_outsel_1_wd = reg_wdata[6:0];

  assign mio_outsel_2_we = addr_hit[179] & reg_we & !reg_error;
  assign mio_outsel_2_wd = reg_wdata[6:0];

  assign mio_outsel_3_we = addr_hit[180] & reg_we & !reg_error;
  assign mio_outsel_3_wd = reg_wdata[6:0];

  assign mio_outsel_4_we = addr_hit[181] & reg_we & !reg_error;
  assign mio_outsel_4_wd = reg_wdata[6:0];

  assign mio_outsel_5_we = addr_hit[182] & reg_we & !reg_error;
  assign mio_outsel_5_wd = reg_wdata[6:0];

  assign mio_outsel_6_we = addr_hit[183] & reg_we & !reg_error;
  assign mio_outsel_6_wd = reg_wdata[6:0];

  assign mio_outsel_7_we = addr_hit[184] & reg_we & !reg_error;
  assign mio_outsel_7_wd = reg_wdata[6:0];

  assign mio_outsel_8_we = addr_hit[185] & reg_we & !reg_error;
  assign mio_outsel_8_wd = reg_wdata[6:0];

  assign mio_outsel_9_we = addr_hit[186] & reg_we & !reg_error;
  assign mio_outsel_9_wd = reg_wdata[6:0];

  assign mio_outsel_10_we = addr_hit[187] & reg_we & !reg_error;
  assign mio_outsel_10_wd = reg_wdata[6:0];

  assign mio_outsel_11_we = addr_hit[188] & reg_we & !reg_error;
  assign mio_outsel_11_wd = reg_wdata[6:0];

  assign mio_outsel_12_we = addr_hit[189] & reg_we & !reg_error;
  assign mio_outsel_12_wd = reg_wdata[6:0];

  assign mio_outsel_13_we = addr_hit[190] & reg_we & !reg_error;
  assign mio_outsel_13_wd = reg_wdata[6:0];

  assign mio_outsel_14_we = addr_hit[191] & reg_we & !reg_error;
  assign mio_outsel_14_wd = reg_wdata[6:0];

  assign mio_outsel_15_we = addr_hit[192] & reg_we & !reg_error;
  assign mio_outsel_15_wd = reg_wdata[6:0];

  assign mio_outsel_16_we = addr_hit[193] & reg_we & !reg_error;
  assign mio_outsel_16_wd = reg_wdata[6:0];

  assign mio_outsel_17_we = addr_hit[194] & reg_we & !reg_error;
  assign mio_outsel_17_wd = reg_wdata[6:0];

  assign mio_outsel_18_we = addr_hit[195] & reg_we & !reg_error;
  assign mio_outsel_18_wd = reg_wdata[6:0];

  assign mio_outsel_19_we = addr_hit[196] & reg_we & !reg_error;
  assign mio_outsel_19_wd = reg_wdata[6:0];

  assign mio_outsel_20_we = addr_hit[197] & reg_we & !reg_error;
  assign mio_outsel_20_wd = reg_wdata[6:0];

  assign mio_outsel_21_we = addr_hit[198] & reg_we & !reg_error;
  assign mio_outsel_21_wd = reg_wdata[6:0];

  assign mio_outsel_22_we = addr_hit[199] & reg_we & !reg_error;
  assign mio_outsel_22_wd = reg_wdata[6:0];

  assign mio_outsel_23_we = addr_hit[200] & reg_we & !reg_error;
  assign mio_outsel_23_wd = reg_wdata[6:0];

  assign mio_outsel_24_we = addr_hit[201] & reg_we & !reg_error;
  assign mio_outsel_24_wd = reg_wdata[6:0];

  assign mio_outsel_25_we = addr_hit[202] & reg_we & !reg_error;
  assign mio_outsel_25_wd = reg_wdata[6:0];

  assign mio_outsel_26_we = addr_hit[203] & reg_we & !reg_error;
  assign mio_outsel_26_wd = reg_wdata[6:0];

  assign mio_outsel_27_we = addr_hit[204] & reg_we & !reg_error;
  assign mio_outsel_27_wd = reg_wdata[6:0];

  assign mio_outsel_28_we = addr_hit[205] & reg_we & !reg_error;
  assign mio_outsel_28_wd = reg_wdata[6:0];

  assign mio_outsel_29_we = addr_hit[206] & reg_we & !reg_error;
  assign mio_outsel_29_wd = reg_wdata[6:0];

  assign mio_outsel_30_we = addr_hit[207] & reg_we & !reg_error;
  assign mio_outsel_30_wd = reg_wdata[6:0];

  assign mio_outsel_31_we = addr_hit[208] & reg_we & !reg_error;
  assign mio_outsel_31_wd = reg_wdata[6:0];

  assign mio_outsel_32_we = addr_hit[209] & reg_we & !reg_error;
  assign mio_outsel_32_wd = reg_wdata[6:0];

  assign mio_outsel_33_we = addr_hit[210] & reg_we & !reg_error;
  assign mio_outsel_33_wd = reg_wdata[6:0];

  assign mio_outsel_34_we = addr_hit[211] & reg_we & !reg_error;
  assign mio_outsel_34_wd = reg_wdata[6:0];

  assign mio_outsel_35_we = addr_hit[212] & reg_we & !reg_error;
  assign mio_outsel_35_wd = reg_wdata[6:0];

  assign mio_outsel_36_we = addr_hit[213] & reg_we & !reg_error;
  assign mio_outsel_36_wd = reg_wdata[6:0];

  assign mio_outsel_37_we = addr_hit[214] & reg_we & !reg_error;
  assign mio_outsel_37_wd = reg_wdata[6:0];

  assign mio_outsel_38_we = addr_hit[215] & reg_we & !reg_error;
  assign mio_outsel_38_wd = reg_wdata[6:0];

  assign mio_outsel_39_we = addr_hit[216] & reg_we & !reg_error;
  assign mio_outsel_39_wd = reg_wdata[6:0];

  assign mio_outsel_40_we = addr_hit[217] & reg_we & !reg_error;
  assign mio_outsel_40_wd = reg_wdata[6:0];

  assign mio_outsel_41_we = addr_hit[218] & reg_we & !reg_error;
  assign mio_outsel_41_wd = reg_wdata[6:0];

  assign mio_outsel_42_we = addr_hit[219] & reg_we & !reg_error;
  assign mio_outsel_42_wd = reg_wdata[6:0];

  assign mio_outsel_43_we = addr_hit[220] & reg_we & !reg_error;
  assign mio_outsel_43_wd = reg_wdata[6:0];

  assign mio_outsel_44_we = addr_hit[221] & reg_we & !reg_error;
  assign mio_outsel_44_wd = reg_wdata[6:0];

  assign mio_outsel_45_we = addr_hit[222] & reg_we & !reg_error;
  assign mio_outsel_45_wd = reg_wdata[6:0];

  assign mio_outsel_46_we = addr_hit[223] & reg_we & !reg_error;
  assign mio_outsel_46_wd = reg_wdata[6:0];

  assign mio_pad_attr_regwen_0_we = addr_hit[224] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_0_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_1_we = addr_hit[225] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_1_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_2_we = addr_hit[226] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_2_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_3_we = addr_hit[227] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_3_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_4_we = addr_hit[228] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_4_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_5_we = addr_hit[229] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_5_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_6_we = addr_hit[230] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_6_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_7_we = addr_hit[231] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_7_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_8_we = addr_hit[232] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_8_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_9_we = addr_hit[233] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_9_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_10_we = addr_hit[234] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_10_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_11_we = addr_hit[235] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_11_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_12_we = addr_hit[236] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_12_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_13_we = addr_hit[237] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_13_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_14_we = addr_hit[238] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_14_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_15_we = addr_hit[239] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_15_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_16_we = addr_hit[240] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_16_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_17_we = addr_hit[241] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_17_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_18_we = addr_hit[242] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_18_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_19_we = addr_hit[243] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_19_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_20_we = addr_hit[244] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_20_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_21_we = addr_hit[245] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_21_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_22_we = addr_hit[246] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_22_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_23_we = addr_hit[247] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_23_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_24_we = addr_hit[248] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_24_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_25_we = addr_hit[249] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_25_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_26_we = addr_hit[250] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_26_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_27_we = addr_hit[251] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_27_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_28_we = addr_hit[252] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_28_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_29_we = addr_hit[253] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_29_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_30_we = addr_hit[254] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_30_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_31_we = addr_hit[255] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_31_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_32_we = addr_hit[256] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_32_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_33_we = addr_hit[257] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_33_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_34_we = addr_hit[258] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_34_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_35_we = addr_hit[259] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_35_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_36_we = addr_hit[260] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_36_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_37_we = addr_hit[261] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_37_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_38_we = addr_hit[262] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_38_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_39_we = addr_hit[263] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_39_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_40_we = addr_hit[264] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_40_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_41_we = addr_hit[265] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_41_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_42_we = addr_hit[266] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_42_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_43_we = addr_hit[267] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_43_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_44_we = addr_hit[268] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_44_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_45_we = addr_hit[269] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_45_wd = reg_wdata[0];

  assign mio_pad_attr_regwen_46_we = addr_hit[270] & reg_we & !reg_error;
  assign mio_pad_attr_regwen_46_wd = reg_wdata[0];

  assign mio_pad_attr_0_we = addr_hit[271] & reg_we & !reg_error;
  assign mio_pad_attr_0_wd = reg_wdata[12:0];
  assign mio_pad_attr_0_re = addr_hit[271] & reg_re & !reg_error;

  assign mio_pad_attr_1_we = addr_hit[272] & reg_we & !reg_error;
  assign mio_pad_attr_1_wd = reg_wdata[12:0];
  assign mio_pad_attr_1_re = addr_hit[272] & reg_re & !reg_error;

  assign mio_pad_attr_2_we = addr_hit[273] & reg_we & !reg_error;
  assign mio_pad_attr_2_wd = reg_wdata[12:0];
  assign mio_pad_attr_2_re = addr_hit[273] & reg_re & !reg_error;

  assign mio_pad_attr_3_we = addr_hit[274] & reg_we & !reg_error;
  assign mio_pad_attr_3_wd = reg_wdata[12:0];
  assign mio_pad_attr_3_re = addr_hit[274] & reg_re & !reg_error;

  assign mio_pad_attr_4_we = addr_hit[275] & reg_we & !reg_error;
  assign mio_pad_attr_4_wd = reg_wdata[12:0];
  assign mio_pad_attr_4_re = addr_hit[275] & reg_re & !reg_error;

  assign mio_pad_attr_5_we = addr_hit[276] & reg_we & !reg_error;
  assign mio_pad_attr_5_wd = reg_wdata[12:0];
  assign mio_pad_attr_5_re = addr_hit[276] & reg_re & !reg_error;

  assign mio_pad_attr_6_we = addr_hit[277] & reg_we & !reg_error;
  assign mio_pad_attr_6_wd = reg_wdata[12:0];
  assign mio_pad_attr_6_re = addr_hit[277] & reg_re & !reg_error;

  assign mio_pad_attr_7_we = addr_hit[278] & reg_we & !reg_error;
  assign mio_pad_attr_7_wd = reg_wdata[12:0];
  assign mio_pad_attr_7_re = addr_hit[278] & reg_re & !reg_error;

  assign mio_pad_attr_8_we = addr_hit[279] & reg_we & !reg_error;
  assign mio_pad_attr_8_wd = reg_wdata[12:0];
  assign mio_pad_attr_8_re = addr_hit[279] & reg_re & !reg_error;

  assign mio_pad_attr_9_we = addr_hit[280] & reg_we & !reg_error;
  assign mio_pad_attr_9_wd = reg_wdata[12:0];
  assign mio_pad_attr_9_re = addr_hit[280] & reg_re & !reg_error;

  assign mio_pad_attr_10_we = addr_hit[281] & reg_we & !reg_error;
  assign mio_pad_attr_10_wd = reg_wdata[12:0];
  assign mio_pad_attr_10_re = addr_hit[281] & reg_re & !reg_error;

  assign mio_pad_attr_11_we = addr_hit[282] & reg_we & !reg_error;
  assign mio_pad_attr_11_wd = reg_wdata[12:0];
  assign mio_pad_attr_11_re = addr_hit[282] & reg_re & !reg_error;

  assign mio_pad_attr_12_we = addr_hit[283] & reg_we & !reg_error;
  assign mio_pad_attr_12_wd = reg_wdata[12:0];
  assign mio_pad_attr_12_re = addr_hit[283] & reg_re & !reg_error;

  assign mio_pad_attr_13_we = addr_hit[284] & reg_we & !reg_error;
  assign mio_pad_attr_13_wd = reg_wdata[12:0];
  assign mio_pad_attr_13_re = addr_hit[284] & reg_re & !reg_error;

  assign mio_pad_attr_14_we = addr_hit[285] & reg_we & !reg_error;
  assign mio_pad_attr_14_wd = reg_wdata[12:0];
  assign mio_pad_attr_14_re = addr_hit[285] & reg_re & !reg_error;

  assign mio_pad_attr_15_we = addr_hit[286] & reg_we & !reg_error;
  assign mio_pad_attr_15_wd = reg_wdata[12:0];
  assign mio_pad_attr_15_re = addr_hit[286] & reg_re & !reg_error;

  assign mio_pad_attr_16_we = addr_hit[287] & reg_we & !reg_error;
  assign mio_pad_attr_16_wd = reg_wdata[12:0];
  assign mio_pad_attr_16_re = addr_hit[287] & reg_re & !reg_error;

  assign mio_pad_attr_17_we = addr_hit[288] & reg_we & !reg_error;
  assign mio_pad_attr_17_wd = reg_wdata[12:0];
  assign mio_pad_attr_17_re = addr_hit[288] & reg_re & !reg_error;

  assign mio_pad_attr_18_we = addr_hit[289] & reg_we & !reg_error;
  assign mio_pad_attr_18_wd = reg_wdata[12:0];
  assign mio_pad_attr_18_re = addr_hit[289] & reg_re & !reg_error;

  assign mio_pad_attr_19_we = addr_hit[290] & reg_we & !reg_error;
  assign mio_pad_attr_19_wd = reg_wdata[12:0];
  assign mio_pad_attr_19_re = addr_hit[290] & reg_re & !reg_error;

  assign mio_pad_attr_20_we = addr_hit[291] & reg_we & !reg_error;
  assign mio_pad_attr_20_wd = reg_wdata[12:0];
  assign mio_pad_attr_20_re = addr_hit[291] & reg_re & !reg_error;

  assign mio_pad_attr_21_we = addr_hit[292] & reg_we & !reg_error;
  assign mio_pad_attr_21_wd = reg_wdata[12:0];
  assign mio_pad_attr_21_re = addr_hit[292] & reg_re & !reg_error;

  assign mio_pad_attr_22_we = addr_hit[293] & reg_we & !reg_error;
  assign mio_pad_attr_22_wd = reg_wdata[12:0];
  assign mio_pad_attr_22_re = addr_hit[293] & reg_re & !reg_error;

  assign mio_pad_attr_23_we = addr_hit[294] & reg_we & !reg_error;
  assign mio_pad_attr_23_wd = reg_wdata[12:0];
  assign mio_pad_attr_23_re = addr_hit[294] & reg_re & !reg_error;

  assign mio_pad_attr_24_we = addr_hit[295] & reg_we & !reg_error;
  assign mio_pad_attr_24_wd = reg_wdata[12:0];
  assign mio_pad_attr_24_re = addr_hit[295] & reg_re & !reg_error;

  assign mio_pad_attr_25_we = addr_hit[296] & reg_we & !reg_error;
  assign mio_pad_attr_25_wd = reg_wdata[12:0];
  assign mio_pad_attr_25_re = addr_hit[296] & reg_re & !reg_error;

  assign mio_pad_attr_26_we = addr_hit[297] & reg_we & !reg_error;
  assign mio_pad_attr_26_wd = reg_wdata[12:0];
  assign mio_pad_attr_26_re = addr_hit[297] & reg_re & !reg_error;

  assign mio_pad_attr_27_we = addr_hit[298] & reg_we & !reg_error;
  assign mio_pad_attr_27_wd = reg_wdata[12:0];
  assign mio_pad_attr_27_re = addr_hit[298] & reg_re & !reg_error;

  assign mio_pad_attr_28_we = addr_hit[299] & reg_we & !reg_error;
  assign mio_pad_attr_28_wd = reg_wdata[12:0];
  assign mio_pad_attr_28_re = addr_hit[299] & reg_re & !reg_error;

  assign mio_pad_attr_29_we = addr_hit[300] & reg_we & !reg_error;
  assign mio_pad_attr_29_wd = reg_wdata[12:0];
  assign mio_pad_attr_29_re = addr_hit[300] & reg_re & !reg_error;

  assign mio_pad_attr_30_we = addr_hit[301] & reg_we & !reg_error;
  assign mio_pad_attr_30_wd = reg_wdata[12:0];
  assign mio_pad_attr_30_re = addr_hit[301] & reg_re & !reg_error;

  assign mio_pad_attr_31_we = addr_hit[302] & reg_we & !reg_error;
  assign mio_pad_attr_31_wd = reg_wdata[12:0];
  assign mio_pad_attr_31_re = addr_hit[302] & reg_re & !reg_error;

  assign mio_pad_attr_32_we = addr_hit[303] & reg_we & !reg_error;
  assign mio_pad_attr_32_wd = reg_wdata[12:0];
  assign mio_pad_attr_32_re = addr_hit[303] & reg_re & !reg_error;

  assign mio_pad_attr_33_we = addr_hit[304] & reg_we & !reg_error;
  assign mio_pad_attr_33_wd = reg_wdata[12:0];
  assign mio_pad_attr_33_re = addr_hit[304] & reg_re & !reg_error;

  assign mio_pad_attr_34_we = addr_hit[305] & reg_we & !reg_error;
  assign mio_pad_attr_34_wd = reg_wdata[12:0];
  assign mio_pad_attr_34_re = addr_hit[305] & reg_re & !reg_error;

  assign mio_pad_attr_35_we = addr_hit[306] & reg_we & !reg_error;
  assign mio_pad_attr_35_wd = reg_wdata[12:0];
  assign mio_pad_attr_35_re = addr_hit[306] & reg_re & !reg_error;

  assign mio_pad_attr_36_we = addr_hit[307] & reg_we & !reg_error;
  assign mio_pad_attr_36_wd = reg_wdata[12:0];
  assign mio_pad_attr_36_re = addr_hit[307] & reg_re & !reg_error;

  assign mio_pad_attr_37_we = addr_hit[308] & reg_we & !reg_error;
  assign mio_pad_attr_37_wd = reg_wdata[12:0];
  assign mio_pad_attr_37_re = addr_hit[308] & reg_re & !reg_error;

  assign mio_pad_attr_38_we = addr_hit[309] & reg_we & !reg_error;
  assign mio_pad_attr_38_wd = reg_wdata[12:0];
  assign mio_pad_attr_38_re = addr_hit[309] & reg_re & !reg_error;

  assign mio_pad_attr_39_we = addr_hit[310] & reg_we & !reg_error;
  assign mio_pad_attr_39_wd = reg_wdata[12:0];
  assign mio_pad_attr_39_re = addr_hit[310] & reg_re & !reg_error;

  assign mio_pad_attr_40_we = addr_hit[311] & reg_we & !reg_error;
  assign mio_pad_attr_40_wd = reg_wdata[12:0];
  assign mio_pad_attr_40_re = addr_hit[311] & reg_re & !reg_error;

  assign mio_pad_attr_41_we = addr_hit[312] & reg_we & !reg_error;
  assign mio_pad_attr_41_wd = reg_wdata[12:0];
  assign mio_pad_attr_41_re = addr_hit[312] & reg_re & !reg_error;

  assign mio_pad_attr_42_we = addr_hit[313] & reg_we & !reg_error;
  assign mio_pad_attr_42_wd = reg_wdata[12:0];
  assign mio_pad_attr_42_re = addr_hit[313] & reg_re & !reg_error;

  assign mio_pad_attr_43_we = addr_hit[314] & reg_we & !reg_error;
  assign mio_pad_attr_43_wd = reg_wdata[12:0];
  assign mio_pad_attr_43_re = addr_hit[314] & reg_re & !reg_error;

  assign mio_pad_attr_44_we = addr_hit[315] & reg_we & !reg_error;
  assign mio_pad_attr_44_wd = reg_wdata[12:0];
  assign mio_pad_attr_44_re = addr_hit[315] & reg_re & !reg_error;

  assign mio_pad_attr_45_we = addr_hit[316] & reg_we & !reg_error;
  assign mio_pad_attr_45_wd = reg_wdata[12:0];
  assign mio_pad_attr_45_re = addr_hit[316] & reg_re & !reg_error;

  assign mio_pad_attr_46_we = addr_hit[317] & reg_we & !reg_error;
  assign mio_pad_attr_46_wd = reg_wdata[12:0];
  assign mio_pad_attr_46_re = addr_hit[317] & reg_re & !reg_error;

  assign dio_pad_attr_regwen_0_we = addr_hit[318] & reg_we & !reg_error;
  assign dio_pad_attr_regwen_0_wd = reg_wdata[0];

  assign dio_pad_attr_regwen_1_we = addr_hit[319] & reg_we & !reg_error;
  assign dio_pad_attr_regwen_1_wd = reg_wdata[0];

  assign dio_pad_attr_regwen_2_we = addr_hit[320] & reg_we & !reg_error;
  assign dio_pad_attr_regwen_2_wd = reg_wdata[0];

  assign dio_pad_attr_regwen_3_we = addr_hit[321] & reg_we & !reg_error;
  assign dio_pad_attr_regwen_3_wd = reg_wdata[0];

  assign dio_pad_attr_regwen_4_we = addr_hit[322] & reg_we & !reg_error;
  assign dio_pad_attr_regwen_4_wd = reg_wdata[0];

  assign dio_pad_attr_regwen_5_we = addr_hit[323] & reg_we & !reg_error;
  assign dio_pad_attr_regwen_5_wd = reg_wdata[0];

  assign dio_pad_attr_regwen_6_we = addr_hit[324] & reg_we & !reg_error;
  assign dio_pad_attr_regwen_6_wd = reg_wdata[0];

  assign dio_pad_attr_regwen_7_we = addr_hit[325] & reg_we & !reg_error;
  assign dio_pad_attr_regwen_7_wd = reg_wdata[0];

  assign dio_pad_attr_regwen_8_we = addr_hit[326] & reg_we & !reg_error;
  assign dio_pad_attr_regwen_8_wd = reg_wdata[0];

  assign dio_pad_attr_regwen_9_we = addr_hit[327] & reg_we & !reg_error;
  assign dio_pad_attr_regwen_9_wd = reg_wdata[0];

  assign dio_pad_attr_regwen_10_we = addr_hit[328] & reg_we & !reg_error;
  assign dio_pad_attr_regwen_10_wd = reg_wdata[0];

  assign dio_pad_attr_regwen_11_we = addr_hit[329] & reg_we & !reg_error;
  assign dio_pad_attr_regwen_11_wd = reg_wdata[0];

  assign dio_pad_attr_regwen_12_we = addr_hit[330] & reg_we & !reg_error;
  assign dio_pad_attr_regwen_12_wd = reg_wdata[0];

  assign dio_pad_attr_regwen_13_we = addr_hit[331] & reg_we & !reg_error;
  assign dio_pad_attr_regwen_13_wd = reg_wdata[0];

  assign dio_pad_attr_regwen_14_we = addr_hit[332] & reg_we & !reg_error;
  assign dio_pad_attr_regwen_14_wd = reg_wdata[0];

  assign dio_pad_attr_regwen_15_we = addr_hit[333] & reg_we & !reg_error;
  assign dio_pad_attr_regwen_15_wd = reg_wdata[0];

  assign dio_pad_attr_regwen_16_we = addr_hit[334] & reg_we & !reg_error;
  assign dio_pad_attr_regwen_16_wd = reg_wdata[0];

  assign dio_pad_attr_regwen_17_we = addr_hit[335] & reg_we & !reg_error;
  assign dio_pad_attr_regwen_17_wd = reg_wdata[0];

  assign dio_pad_attr_regwen_18_we = addr_hit[336] & reg_we & !reg_error;
  assign dio_pad_attr_regwen_18_wd = reg_wdata[0];

  assign dio_pad_attr_regwen_19_we = addr_hit[337] & reg_we & !reg_error;
  assign dio_pad_attr_regwen_19_wd = reg_wdata[0];

  assign dio_pad_attr_regwen_20_we = addr_hit[338] & reg_we & !reg_error;
  assign dio_pad_attr_regwen_20_wd = reg_wdata[0];

  assign dio_pad_attr_regwen_21_we = addr_hit[339] & reg_we & !reg_error;
  assign dio_pad_attr_regwen_21_wd = reg_wdata[0];

  assign dio_pad_attr_regwen_22_we = addr_hit[340] & reg_we & !reg_error;
  assign dio_pad_attr_regwen_22_wd = reg_wdata[0];

  assign dio_pad_attr_0_we = addr_hit[341] & reg_we & !reg_error;
  assign dio_pad_attr_0_wd = reg_wdata[12:0];
  assign dio_pad_attr_0_re = addr_hit[341] & reg_re & !reg_error;

  assign dio_pad_attr_1_we = addr_hit[342] & reg_we & !reg_error;
  assign dio_pad_attr_1_wd = reg_wdata[12:0];
  assign dio_pad_attr_1_re = addr_hit[342] & reg_re & !reg_error;

  assign dio_pad_attr_2_we = addr_hit[343] & reg_we & !reg_error;
  assign dio_pad_attr_2_wd = reg_wdata[12:0];
  assign dio_pad_attr_2_re = addr_hit[343] & reg_re & !reg_error;

  assign dio_pad_attr_3_we = addr_hit[344] & reg_we & !reg_error;
  assign dio_pad_attr_3_wd = reg_wdata[12:0];
  assign dio_pad_attr_3_re = addr_hit[344] & reg_re & !reg_error;

  assign dio_pad_attr_4_we = addr_hit[345] & reg_we & !reg_error;
  assign dio_pad_attr_4_wd = reg_wdata[12:0];
  assign dio_pad_attr_4_re = addr_hit[345] & reg_re & !reg_error;

  assign dio_pad_attr_5_we = addr_hit[346] & reg_we & !reg_error;
  assign dio_pad_attr_5_wd = reg_wdata[12:0];
  assign dio_pad_attr_5_re = addr_hit[346] & reg_re & !reg_error;

  assign dio_pad_attr_6_we = addr_hit[347] & reg_we & !reg_error;
  assign dio_pad_attr_6_wd = reg_wdata[12:0];
  assign dio_pad_attr_6_re = addr_hit[347] & reg_re & !reg_error;

  assign dio_pad_attr_7_we = addr_hit[348] & reg_we & !reg_error;
  assign dio_pad_attr_7_wd = reg_wdata[12:0];
  assign dio_pad_attr_7_re = addr_hit[348] & reg_re & !reg_error;

  assign dio_pad_attr_8_we = addr_hit[349] & reg_we & !reg_error;
  assign dio_pad_attr_8_wd = reg_wdata[12:0];
  assign dio_pad_attr_8_re = addr_hit[349] & reg_re & !reg_error;

  assign dio_pad_attr_9_we = addr_hit[350] & reg_we & !reg_error;
  assign dio_pad_attr_9_wd = reg_wdata[12:0];
  assign dio_pad_attr_9_re = addr_hit[350] & reg_re & !reg_error;

  assign dio_pad_attr_10_we = addr_hit[351] & reg_we & !reg_error;
  assign dio_pad_attr_10_wd = reg_wdata[12:0];
  assign dio_pad_attr_10_re = addr_hit[351] & reg_re & !reg_error;

  assign dio_pad_attr_11_we = addr_hit[352] & reg_we & !reg_error;
  assign dio_pad_attr_11_wd = reg_wdata[12:0];
  assign dio_pad_attr_11_re = addr_hit[352] & reg_re & !reg_error;

  assign dio_pad_attr_12_we = addr_hit[353] & reg_we & !reg_error;
  assign dio_pad_attr_12_wd = reg_wdata[12:0];
  assign dio_pad_attr_12_re = addr_hit[353] & reg_re & !reg_error;

  assign dio_pad_attr_13_we = addr_hit[354] & reg_we & !reg_error;
  assign dio_pad_attr_13_wd = reg_wdata[12:0];
  assign dio_pad_attr_13_re = addr_hit[354] & reg_re & !reg_error;

  assign dio_pad_attr_14_we = addr_hit[355] & reg_we & !reg_error;
  assign dio_pad_attr_14_wd = reg_wdata[12:0];
  assign dio_pad_attr_14_re = addr_hit[355] & reg_re & !reg_error;

  assign dio_pad_attr_15_we = addr_hit[356] & reg_we & !reg_error;
  assign dio_pad_attr_15_wd = reg_wdata[12:0];
  assign dio_pad_attr_15_re = addr_hit[356] & reg_re & !reg_error;

  assign dio_pad_attr_16_we = addr_hit[357] & reg_we & !reg_error;
  assign dio_pad_attr_16_wd = reg_wdata[12:0];
  assign dio_pad_attr_16_re = addr_hit[357] & reg_re & !reg_error;

  assign dio_pad_attr_17_we = addr_hit[358] & reg_we & !reg_error;
  assign dio_pad_attr_17_wd = reg_wdata[12:0];
  assign dio_pad_attr_17_re = addr_hit[358] & reg_re & !reg_error;

  assign dio_pad_attr_18_we = addr_hit[359] & reg_we & !reg_error;
  assign dio_pad_attr_18_wd = reg_wdata[12:0];
  assign dio_pad_attr_18_re = addr_hit[359] & reg_re & !reg_error;

  assign dio_pad_attr_19_we = addr_hit[360] & reg_we & !reg_error;
  assign dio_pad_attr_19_wd = reg_wdata[12:0];
  assign dio_pad_attr_19_re = addr_hit[360] & reg_re & !reg_error;

  assign dio_pad_attr_20_we = addr_hit[361] & reg_we & !reg_error;
  assign dio_pad_attr_20_wd = reg_wdata[12:0];
  assign dio_pad_attr_20_re = addr_hit[361] & reg_re & !reg_error;

  assign dio_pad_attr_21_we = addr_hit[362] & reg_we & !reg_error;
  assign dio_pad_attr_21_wd = reg_wdata[12:0];
  assign dio_pad_attr_21_re = addr_hit[362] & reg_re & !reg_error;

  assign dio_pad_attr_22_we = addr_hit[363] & reg_we & !reg_error;
  assign dio_pad_attr_22_wd = reg_wdata[12:0];
  assign dio_pad_attr_22_re = addr_hit[363] & reg_re & !reg_error;

  assign mio_pad_sleep_status_0_en_0_we = addr_hit[364] & reg_we & !reg_error;
  assign mio_pad_sleep_status_0_en_0_wd = reg_wdata[0];

  assign mio_pad_sleep_status_0_en_1_we = addr_hit[364] & reg_we & !reg_error;
  assign mio_pad_sleep_status_0_en_1_wd = reg_wdata[1];

  assign mio_pad_sleep_status_0_en_2_we = addr_hit[364] & reg_we & !reg_error;
  assign mio_pad_sleep_status_0_en_2_wd = reg_wdata[2];

  assign mio_pad_sleep_status_0_en_3_we = addr_hit[364] & reg_we & !reg_error;
  assign mio_pad_sleep_status_0_en_3_wd = reg_wdata[3];

  assign mio_pad_sleep_status_0_en_4_we = addr_hit[364] & reg_we & !reg_error;
  assign mio_pad_sleep_status_0_en_4_wd = reg_wdata[4];

  assign mio_pad_sleep_status_0_en_5_we = addr_hit[364] & reg_we & !reg_error;
  assign mio_pad_sleep_status_0_en_5_wd = reg_wdata[5];

  assign mio_pad_sleep_status_0_en_6_we = addr_hit[364] & reg_we & !reg_error;
  assign mio_pad_sleep_status_0_en_6_wd = reg_wdata[6];

  assign mio_pad_sleep_status_0_en_7_we = addr_hit[364] & reg_we & !reg_error;
  assign mio_pad_sleep_status_0_en_7_wd = reg_wdata[7];

  assign mio_pad_sleep_status_0_en_8_we = addr_hit[364] & reg_we & !reg_error;
  assign mio_pad_sleep_status_0_en_8_wd = reg_wdata[8];

  assign mio_pad_sleep_status_0_en_9_we = addr_hit[364] & reg_we & !reg_error;
  assign mio_pad_sleep_status_0_en_9_wd = reg_wdata[9];

  assign mio_pad_sleep_status_0_en_10_we = addr_hit[364] & reg_we & !reg_error;
  assign mio_pad_sleep_status_0_en_10_wd = reg_wdata[10];

  assign mio_pad_sleep_status_0_en_11_we = addr_hit[364] & reg_we & !reg_error;
  assign mio_pad_sleep_status_0_en_11_wd = reg_wdata[11];

  assign mio_pad_sleep_status_0_en_12_we = addr_hit[364] & reg_we & !reg_error;
  assign mio_pad_sleep_status_0_en_12_wd = reg_wdata[12];

  assign mio_pad_sleep_status_0_en_13_we = addr_hit[364] & reg_we & !reg_error;
  assign mio_pad_sleep_status_0_en_13_wd = reg_wdata[13];

  assign mio_pad_sleep_status_0_en_14_we = addr_hit[364] & reg_we & !reg_error;
  assign mio_pad_sleep_status_0_en_14_wd = reg_wdata[14];

  assign mio_pad_sleep_status_0_en_15_we = addr_hit[364] & reg_we & !reg_error;
  assign mio_pad_sleep_status_0_en_15_wd = reg_wdata[15];

  assign mio_pad_sleep_status_0_en_16_we = addr_hit[364] & reg_we & !reg_error;
  assign mio_pad_sleep_status_0_en_16_wd = reg_wdata[16];

  assign mio_pad_sleep_status_0_en_17_we = addr_hit[364] & reg_we & !reg_error;
  assign mio_pad_sleep_status_0_en_17_wd = reg_wdata[17];

  assign mio_pad_sleep_status_0_en_18_we = addr_hit[364] & reg_we & !reg_error;
  assign mio_pad_sleep_status_0_en_18_wd = reg_wdata[18];

  assign mio_pad_sleep_status_0_en_19_we = addr_hit[364] & reg_we & !reg_error;
  assign mio_pad_sleep_status_0_en_19_wd = reg_wdata[19];

  assign mio_pad_sleep_status_0_en_20_we = addr_hit[364] & reg_we & !reg_error;
  assign mio_pad_sleep_status_0_en_20_wd = reg_wdata[20];

  assign mio_pad_sleep_status_0_en_21_we = addr_hit[364] & reg_we & !reg_error;
  assign mio_pad_sleep_status_0_en_21_wd = reg_wdata[21];

  assign mio_pad_sleep_status_0_en_22_we = addr_hit[364] & reg_we & !reg_error;
  assign mio_pad_sleep_status_0_en_22_wd = reg_wdata[22];

  assign mio_pad_sleep_status_0_en_23_we = addr_hit[364] & reg_we & !reg_error;
  assign mio_pad_sleep_status_0_en_23_wd = reg_wdata[23];

  assign mio_pad_sleep_status_0_en_24_we = addr_hit[364] & reg_we & !reg_error;
  assign mio_pad_sleep_status_0_en_24_wd = reg_wdata[24];

  assign mio_pad_sleep_status_0_en_25_we = addr_hit[364] & reg_we & !reg_error;
  assign mio_pad_sleep_status_0_en_25_wd = reg_wdata[25];

  assign mio_pad_sleep_status_0_en_26_we = addr_hit[364] & reg_we & !reg_error;
  assign mio_pad_sleep_status_0_en_26_wd = reg_wdata[26];

  assign mio_pad_sleep_status_0_en_27_we = addr_hit[364] & reg_we & !reg_error;
  assign mio_pad_sleep_status_0_en_27_wd = reg_wdata[27];

  assign mio_pad_sleep_status_0_en_28_we = addr_hit[364] & reg_we & !reg_error;
  assign mio_pad_sleep_status_0_en_28_wd = reg_wdata[28];

  assign mio_pad_sleep_status_0_en_29_we = addr_hit[364] & reg_we & !reg_error;
  assign mio_pad_sleep_status_0_en_29_wd = reg_wdata[29];

  assign mio_pad_sleep_status_0_en_30_we = addr_hit[364] & reg_we & !reg_error;
  assign mio_pad_sleep_status_0_en_30_wd = reg_wdata[30];

  assign mio_pad_sleep_status_0_en_31_we = addr_hit[364] & reg_we & !reg_error;
  assign mio_pad_sleep_status_0_en_31_wd = reg_wdata[31];

  assign mio_pad_sleep_status_1_en_32_we = addr_hit[365] & reg_we & !reg_error;
  assign mio_pad_sleep_status_1_en_32_wd = reg_wdata[0];

  assign mio_pad_sleep_status_1_en_33_we = addr_hit[365] & reg_we & !reg_error;
  assign mio_pad_sleep_status_1_en_33_wd = reg_wdata[1];

  assign mio_pad_sleep_status_1_en_34_we = addr_hit[365] & reg_we & !reg_error;
  assign mio_pad_sleep_status_1_en_34_wd = reg_wdata[2];

  assign mio_pad_sleep_status_1_en_35_we = addr_hit[365] & reg_we & !reg_error;
  assign mio_pad_sleep_status_1_en_35_wd = reg_wdata[3];

  assign mio_pad_sleep_status_1_en_36_we = addr_hit[365] & reg_we & !reg_error;
  assign mio_pad_sleep_status_1_en_36_wd = reg_wdata[4];

  assign mio_pad_sleep_status_1_en_37_we = addr_hit[365] & reg_we & !reg_error;
  assign mio_pad_sleep_status_1_en_37_wd = reg_wdata[5];

  assign mio_pad_sleep_status_1_en_38_we = addr_hit[365] & reg_we & !reg_error;
  assign mio_pad_sleep_status_1_en_38_wd = reg_wdata[6];

  assign mio_pad_sleep_status_1_en_39_we = addr_hit[365] & reg_we & !reg_error;
  assign mio_pad_sleep_status_1_en_39_wd = reg_wdata[7];

  assign mio_pad_sleep_status_1_en_40_we = addr_hit[365] & reg_we & !reg_error;
  assign mio_pad_sleep_status_1_en_40_wd = reg_wdata[8];

  assign mio_pad_sleep_status_1_en_41_we = addr_hit[365] & reg_we & !reg_error;
  assign mio_pad_sleep_status_1_en_41_wd = reg_wdata[9];

  assign mio_pad_sleep_status_1_en_42_we = addr_hit[365] & reg_we & !reg_error;
  assign mio_pad_sleep_status_1_en_42_wd = reg_wdata[10];

  assign mio_pad_sleep_status_1_en_43_we = addr_hit[365] & reg_we & !reg_error;
  assign mio_pad_sleep_status_1_en_43_wd = reg_wdata[11];

  assign mio_pad_sleep_status_1_en_44_we = addr_hit[365] & reg_we & !reg_error;
  assign mio_pad_sleep_status_1_en_44_wd = reg_wdata[12];

  assign mio_pad_sleep_status_1_en_45_we = addr_hit[365] & reg_we & !reg_error;
  assign mio_pad_sleep_status_1_en_45_wd = reg_wdata[13];

  assign mio_pad_sleep_status_1_en_46_we = addr_hit[365] & reg_we & !reg_error;
  assign mio_pad_sleep_status_1_en_46_wd = reg_wdata[14];

  assign mio_pad_sleep_regwen_0_we = addr_hit[366] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_0_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_1_we = addr_hit[367] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_1_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_2_we = addr_hit[368] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_2_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_3_we = addr_hit[369] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_3_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_4_we = addr_hit[370] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_4_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_5_we = addr_hit[371] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_5_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_6_we = addr_hit[372] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_6_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_7_we = addr_hit[373] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_7_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_8_we = addr_hit[374] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_8_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_9_we = addr_hit[375] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_9_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_10_we = addr_hit[376] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_10_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_11_we = addr_hit[377] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_11_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_12_we = addr_hit[378] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_12_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_13_we = addr_hit[379] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_13_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_14_we = addr_hit[380] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_14_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_15_we = addr_hit[381] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_15_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_16_we = addr_hit[382] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_16_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_17_we = addr_hit[383] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_17_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_18_we = addr_hit[384] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_18_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_19_we = addr_hit[385] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_19_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_20_we = addr_hit[386] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_20_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_21_we = addr_hit[387] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_21_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_22_we = addr_hit[388] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_22_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_23_we = addr_hit[389] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_23_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_24_we = addr_hit[390] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_24_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_25_we = addr_hit[391] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_25_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_26_we = addr_hit[392] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_26_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_27_we = addr_hit[393] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_27_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_28_we = addr_hit[394] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_28_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_29_we = addr_hit[395] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_29_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_30_we = addr_hit[396] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_30_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_31_we = addr_hit[397] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_31_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_32_we = addr_hit[398] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_32_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_33_we = addr_hit[399] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_33_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_34_we = addr_hit[400] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_34_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_35_we = addr_hit[401] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_35_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_36_we = addr_hit[402] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_36_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_37_we = addr_hit[403] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_37_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_38_we = addr_hit[404] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_38_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_39_we = addr_hit[405] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_39_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_40_we = addr_hit[406] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_40_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_41_we = addr_hit[407] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_41_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_42_we = addr_hit[408] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_42_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_43_we = addr_hit[409] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_43_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_44_we = addr_hit[410] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_44_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_45_we = addr_hit[411] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_45_wd = reg_wdata[0];

  assign mio_pad_sleep_regwen_46_we = addr_hit[412] & reg_we & !reg_error;
  assign mio_pad_sleep_regwen_46_wd = reg_wdata[0];

  assign mio_pad_sleep_en_0_we = addr_hit[413] & reg_we & !reg_error;
  assign mio_pad_sleep_en_0_wd = reg_wdata[0];

  assign mio_pad_sleep_en_1_we = addr_hit[414] & reg_we & !reg_error;
  assign mio_pad_sleep_en_1_wd = reg_wdata[0];

  assign mio_pad_sleep_en_2_we = addr_hit[415] & reg_we & !reg_error;
  assign mio_pad_sleep_en_2_wd = reg_wdata[0];

  assign mio_pad_sleep_en_3_we = addr_hit[416] & reg_we & !reg_error;
  assign mio_pad_sleep_en_3_wd = reg_wdata[0];

  assign mio_pad_sleep_en_4_we = addr_hit[417] & reg_we & !reg_error;
  assign mio_pad_sleep_en_4_wd = reg_wdata[0];

  assign mio_pad_sleep_en_5_we = addr_hit[418] & reg_we & !reg_error;
  assign mio_pad_sleep_en_5_wd = reg_wdata[0];

  assign mio_pad_sleep_en_6_we = addr_hit[419] & reg_we & !reg_error;
  assign mio_pad_sleep_en_6_wd = reg_wdata[0];

  assign mio_pad_sleep_en_7_we = addr_hit[420] & reg_we & !reg_error;
  assign mio_pad_sleep_en_7_wd = reg_wdata[0];

  assign mio_pad_sleep_en_8_we = addr_hit[421] & reg_we & !reg_error;
  assign mio_pad_sleep_en_8_wd = reg_wdata[0];

  assign mio_pad_sleep_en_9_we = addr_hit[422] & reg_we & !reg_error;
  assign mio_pad_sleep_en_9_wd = reg_wdata[0];

  assign mio_pad_sleep_en_10_we = addr_hit[423] & reg_we & !reg_error;
  assign mio_pad_sleep_en_10_wd = reg_wdata[0];

  assign mio_pad_sleep_en_11_we = addr_hit[424] & reg_we & !reg_error;
  assign mio_pad_sleep_en_11_wd = reg_wdata[0];

  assign mio_pad_sleep_en_12_we = addr_hit[425] & reg_we & !reg_error;
  assign mio_pad_sleep_en_12_wd = reg_wdata[0];

  assign mio_pad_sleep_en_13_we = addr_hit[426] & reg_we & !reg_error;
  assign mio_pad_sleep_en_13_wd = reg_wdata[0];

  assign mio_pad_sleep_en_14_we = addr_hit[427] & reg_we & !reg_error;
  assign mio_pad_sleep_en_14_wd = reg_wdata[0];

  assign mio_pad_sleep_en_15_we = addr_hit[428] & reg_we & !reg_error;
  assign mio_pad_sleep_en_15_wd = reg_wdata[0];

  assign mio_pad_sleep_en_16_we = addr_hit[429] & reg_we & !reg_error;
  assign mio_pad_sleep_en_16_wd = reg_wdata[0];

  assign mio_pad_sleep_en_17_we = addr_hit[430] & reg_we & !reg_error;
  assign mio_pad_sleep_en_17_wd = reg_wdata[0];

  assign mio_pad_sleep_en_18_we = addr_hit[431] & reg_we & !reg_error;
  assign mio_pad_sleep_en_18_wd = reg_wdata[0];

  assign mio_pad_sleep_en_19_we = addr_hit[432] & reg_we & !reg_error;
  assign mio_pad_sleep_en_19_wd = reg_wdata[0];

  assign mio_pad_sleep_en_20_we = addr_hit[433] & reg_we & !reg_error;
  assign mio_pad_sleep_en_20_wd = reg_wdata[0];

  assign mio_pad_sleep_en_21_we = addr_hit[434] & reg_we & !reg_error;
  assign mio_pad_sleep_en_21_wd = reg_wdata[0];

  assign mio_pad_sleep_en_22_we = addr_hit[435] & reg_we & !reg_error;
  assign mio_pad_sleep_en_22_wd = reg_wdata[0];

  assign mio_pad_sleep_en_23_we = addr_hit[436] & reg_we & !reg_error;
  assign mio_pad_sleep_en_23_wd = reg_wdata[0];

  assign mio_pad_sleep_en_24_we = addr_hit[437] & reg_we & !reg_error;
  assign mio_pad_sleep_en_24_wd = reg_wdata[0];

  assign mio_pad_sleep_en_25_we = addr_hit[438] & reg_we & !reg_error;
  assign mio_pad_sleep_en_25_wd = reg_wdata[0];

  assign mio_pad_sleep_en_26_we = addr_hit[439] & reg_we & !reg_error;
  assign mio_pad_sleep_en_26_wd = reg_wdata[0];

  assign mio_pad_sleep_en_27_we = addr_hit[440] & reg_we & !reg_error;
  assign mio_pad_sleep_en_27_wd = reg_wdata[0];

  assign mio_pad_sleep_en_28_we = addr_hit[441] & reg_we & !reg_error;
  assign mio_pad_sleep_en_28_wd = reg_wdata[0];

  assign mio_pad_sleep_en_29_we = addr_hit[442] & reg_we & !reg_error;
  assign mio_pad_sleep_en_29_wd = reg_wdata[0];

  assign mio_pad_sleep_en_30_we = addr_hit[443] & reg_we & !reg_error;
  assign mio_pad_sleep_en_30_wd = reg_wdata[0];

  assign mio_pad_sleep_en_31_we = addr_hit[444] & reg_we & !reg_error;
  assign mio_pad_sleep_en_31_wd = reg_wdata[0];

  assign mio_pad_sleep_en_32_we = addr_hit[445] & reg_we & !reg_error;
  assign mio_pad_sleep_en_32_wd = reg_wdata[0];

  assign mio_pad_sleep_en_33_we = addr_hit[446] & reg_we & !reg_error;
  assign mio_pad_sleep_en_33_wd = reg_wdata[0];

  assign mio_pad_sleep_en_34_we = addr_hit[447] & reg_we & !reg_error;
  assign mio_pad_sleep_en_34_wd = reg_wdata[0];

  assign mio_pad_sleep_en_35_we = addr_hit[448] & reg_we & !reg_error;
  assign mio_pad_sleep_en_35_wd = reg_wdata[0];

  assign mio_pad_sleep_en_36_we = addr_hit[449] & reg_we & !reg_error;
  assign mio_pad_sleep_en_36_wd = reg_wdata[0];

  assign mio_pad_sleep_en_37_we = addr_hit[450] & reg_we & !reg_error;
  assign mio_pad_sleep_en_37_wd = reg_wdata[0];

  assign mio_pad_sleep_en_38_we = addr_hit[451] & reg_we & !reg_error;
  assign mio_pad_sleep_en_38_wd = reg_wdata[0];

  assign mio_pad_sleep_en_39_we = addr_hit[452] & reg_we & !reg_error;
  assign mio_pad_sleep_en_39_wd = reg_wdata[0];

  assign mio_pad_sleep_en_40_we = addr_hit[453] & reg_we & !reg_error;
  assign mio_pad_sleep_en_40_wd = reg_wdata[0];

  assign mio_pad_sleep_en_41_we = addr_hit[454] & reg_we & !reg_error;
  assign mio_pad_sleep_en_41_wd = reg_wdata[0];

  assign mio_pad_sleep_en_42_we = addr_hit[455] & reg_we & !reg_error;
  assign mio_pad_sleep_en_42_wd = reg_wdata[0];

  assign mio_pad_sleep_en_43_we = addr_hit[456] & reg_we & !reg_error;
  assign mio_pad_sleep_en_43_wd = reg_wdata[0];

  assign mio_pad_sleep_en_44_we = addr_hit[457] & reg_we & !reg_error;
  assign mio_pad_sleep_en_44_wd = reg_wdata[0];

  assign mio_pad_sleep_en_45_we = addr_hit[458] & reg_we & !reg_error;
  assign mio_pad_sleep_en_45_wd = reg_wdata[0];

  assign mio_pad_sleep_en_46_we = addr_hit[459] & reg_we & !reg_error;
  assign mio_pad_sleep_en_46_wd = reg_wdata[0];

  assign mio_pad_sleep_mode_0_we = addr_hit[460] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_0_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_1_we = addr_hit[461] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_1_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_2_we = addr_hit[462] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_2_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_3_we = addr_hit[463] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_3_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_4_we = addr_hit[464] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_4_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_5_we = addr_hit[465] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_5_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_6_we = addr_hit[466] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_6_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_7_we = addr_hit[467] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_7_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_8_we = addr_hit[468] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_8_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_9_we = addr_hit[469] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_9_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_10_we = addr_hit[470] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_10_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_11_we = addr_hit[471] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_11_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_12_we = addr_hit[472] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_12_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_13_we = addr_hit[473] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_13_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_14_we = addr_hit[474] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_14_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_15_we = addr_hit[475] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_15_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_16_we = addr_hit[476] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_16_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_17_we = addr_hit[477] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_17_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_18_we = addr_hit[478] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_18_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_19_we = addr_hit[479] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_19_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_20_we = addr_hit[480] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_20_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_21_we = addr_hit[481] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_21_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_22_we = addr_hit[482] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_22_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_23_we = addr_hit[483] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_23_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_24_we = addr_hit[484] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_24_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_25_we = addr_hit[485] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_25_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_26_we = addr_hit[486] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_26_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_27_we = addr_hit[487] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_27_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_28_we = addr_hit[488] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_28_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_29_we = addr_hit[489] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_29_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_30_we = addr_hit[490] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_30_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_31_we = addr_hit[491] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_31_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_32_we = addr_hit[492] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_32_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_33_we = addr_hit[493] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_33_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_34_we = addr_hit[494] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_34_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_35_we = addr_hit[495] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_35_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_36_we = addr_hit[496] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_36_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_37_we = addr_hit[497] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_37_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_38_we = addr_hit[498] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_38_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_39_we = addr_hit[499] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_39_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_40_we = addr_hit[500] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_40_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_41_we = addr_hit[501] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_41_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_42_we = addr_hit[502] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_42_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_43_we = addr_hit[503] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_43_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_44_we = addr_hit[504] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_44_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_45_we = addr_hit[505] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_45_wd = reg_wdata[1:0];

  assign mio_pad_sleep_mode_46_we = addr_hit[506] & reg_we & !reg_error;
  assign mio_pad_sleep_mode_46_wd = reg_wdata[1:0];

  assign dio_pad_sleep_status_en_0_we = addr_hit[507] & reg_we & !reg_error;
  assign dio_pad_sleep_status_en_0_wd = reg_wdata[0];

  assign dio_pad_sleep_status_en_1_we = addr_hit[507] & reg_we & !reg_error;
  assign dio_pad_sleep_status_en_1_wd = reg_wdata[1];

  assign dio_pad_sleep_status_en_2_we = addr_hit[507] & reg_we & !reg_error;
  assign dio_pad_sleep_status_en_2_wd = reg_wdata[2];

  assign dio_pad_sleep_status_en_3_we = addr_hit[507] & reg_we & !reg_error;
  assign dio_pad_sleep_status_en_3_wd = reg_wdata[3];

  assign dio_pad_sleep_status_en_4_we = addr_hit[507] & reg_we & !reg_error;
  assign dio_pad_sleep_status_en_4_wd = reg_wdata[4];

  assign dio_pad_sleep_status_en_5_we = addr_hit[507] & reg_we & !reg_error;
  assign dio_pad_sleep_status_en_5_wd = reg_wdata[5];

  assign dio_pad_sleep_status_en_6_we = addr_hit[507] & reg_we & !reg_error;
  assign dio_pad_sleep_status_en_6_wd = reg_wdata[6];

  assign dio_pad_sleep_status_en_7_we = addr_hit[507] & reg_we & !reg_error;
  assign dio_pad_sleep_status_en_7_wd = reg_wdata[7];

  assign dio_pad_sleep_status_en_8_we = addr_hit[507] & reg_we & !reg_error;
  assign dio_pad_sleep_status_en_8_wd = reg_wdata[8];

  assign dio_pad_sleep_status_en_9_we = addr_hit[507] & reg_we & !reg_error;
  assign dio_pad_sleep_status_en_9_wd = reg_wdata[9];

  assign dio_pad_sleep_status_en_10_we = addr_hit[507] & reg_we & !reg_error;
  assign dio_pad_sleep_status_en_10_wd = reg_wdata[10];

  assign dio_pad_sleep_status_en_11_we = addr_hit[507] & reg_we & !reg_error;
  assign dio_pad_sleep_status_en_11_wd = reg_wdata[11];

  assign dio_pad_sleep_status_en_12_we = addr_hit[507] & reg_we & !reg_error;
  assign dio_pad_sleep_status_en_12_wd = reg_wdata[12];

  assign dio_pad_sleep_status_en_13_we = addr_hit[507] & reg_we & !reg_error;
  assign dio_pad_sleep_status_en_13_wd = reg_wdata[13];

  assign dio_pad_sleep_status_en_14_we = addr_hit[507] & reg_we & !reg_error;
  assign dio_pad_sleep_status_en_14_wd = reg_wdata[14];

  assign dio_pad_sleep_status_en_15_we = addr_hit[507] & reg_we & !reg_error;
  assign dio_pad_sleep_status_en_15_wd = reg_wdata[15];

  assign dio_pad_sleep_status_en_16_we = addr_hit[507] & reg_we & !reg_error;
  assign dio_pad_sleep_status_en_16_wd = reg_wdata[16];

  assign dio_pad_sleep_status_en_17_we = addr_hit[507] & reg_we & !reg_error;
  assign dio_pad_sleep_status_en_17_wd = reg_wdata[17];

  assign dio_pad_sleep_status_en_18_we = addr_hit[507] & reg_we & !reg_error;
  assign dio_pad_sleep_status_en_18_wd = reg_wdata[18];

  assign dio_pad_sleep_status_en_19_we = addr_hit[507] & reg_we & !reg_error;
  assign dio_pad_sleep_status_en_19_wd = reg_wdata[19];

  assign dio_pad_sleep_status_en_20_we = addr_hit[507] & reg_we & !reg_error;
  assign dio_pad_sleep_status_en_20_wd = reg_wdata[20];

  assign dio_pad_sleep_status_en_21_we = addr_hit[507] & reg_we & !reg_error;
  assign dio_pad_sleep_status_en_21_wd = reg_wdata[21];

  assign dio_pad_sleep_status_en_22_we = addr_hit[507] & reg_we & !reg_error;
  assign dio_pad_sleep_status_en_22_wd = reg_wdata[22];

  assign dio_pad_sleep_regwen_0_we = addr_hit[508] & reg_we & !reg_error;
  assign dio_pad_sleep_regwen_0_wd = reg_wdata[0];

  assign dio_pad_sleep_regwen_1_we = addr_hit[509] & reg_we & !reg_error;
  assign dio_pad_sleep_regwen_1_wd = reg_wdata[0];

  assign dio_pad_sleep_regwen_2_we = addr_hit[510] & reg_we & !reg_error;
  assign dio_pad_sleep_regwen_2_wd = reg_wdata[0];

  assign dio_pad_sleep_regwen_3_we = addr_hit[511] & reg_we & !reg_error;
  assign dio_pad_sleep_regwen_3_wd = reg_wdata[0];

  assign dio_pad_sleep_regwen_4_we = addr_hit[512] & reg_we & !reg_error;
  assign dio_pad_sleep_regwen_4_wd = reg_wdata[0];

  assign dio_pad_sleep_regwen_5_we = addr_hit[513] & reg_we & !reg_error;
  assign dio_pad_sleep_regwen_5_wd = reg_wdata[0];

  assign dio_pad_sleep_regwen_6_we = addr_hit[514] & reg_we & !reg_error;
  assign dio_pad_sleep_regwen_6_wd = reg_wdata[0];

  assign dio_pad_sleep_regwen_7_we = addr_hit[515] & reg_we & !reg_error;
  assign dio_pad_sleep_regwen_7_wd = reg_wdata[0];

  assign dio_pad_sleep_regwen_8_we = addr_hit[516] & reg_we & !reg_error;
  assign dio_pad_sleep_regwen_8_wd = reg_wdata[0];

  assign dio_pad_sleep_regwen_9_we = addr_hit[517] & reg_we & !reg_error;
  assign dio_pad_sleep_regwen_9_wd = reg_wdata[0];

  assign dio_pad_sleep_regwen_10_we = addr_hit[518] & reg_we & !reg_error;
  assign dio_pad_sleep_regwen_10_wd = reg_wdata[0];

  assign dio_pad_sleep_regwen_11_we = addr_hit[519] & reg_we & !reg_error;
  assign dio_pad_sleep_regwen_11_wd = reg_wdata[0];

  assign dio_pad_sleep_regwen_12_we = addr_hit[520] & reg_we & !reg_error;
  assign dio_pad_sleep_regwen_12_wd = reg_wdata[0];

  assign dio_pad_sleep_regwen_13_we = addr_hit[521] & reg_we & !reg_error;
  assign dio_pad_sleep_regwen_13_wd = reg_wdata[0];

  assign dio_pad_sleep_regwen_14_we = addr_hit[522] & reg_we & !reg_error;
  assign dio_pad_sleep_regwen_14_wd = reg_wdata[0];

  assign dio_pad_sleep_regwen_15_we = addr_hit[523] & reg_we & !reg_error;
  assign dio_pad_sleep_regwen_15_wd = reg_wdata[0];

  assign dio_pad_sleep_regwen_16_we = addr_hit[524] & reg_we & !reg_error;
  assign dio_pad_sleep_regwen_16_wd = reg_wdata[0];

  assign dio_pad_sleep_regwen_17_we = addr_hit[525] & reg_we & !reg_error;
  assign dio_pad_sleep_regwen_17_wd = reg_wdata[0];

  assign dio_pad_sleep_regwen_18_we = addr_hit[526] & reg_we & !reg_error;
  assign dio_pad_sleep_regwen_18_wd = reg_wdata[0];

  assign dio_pad_sleep_regwen_19_we = addr_hit[527] & reg_we & !reg_error;
  assign dio_pad_sleep_regwen_19_wd = reg_wdata[0];

  assign dio_pad_sleep_regwen_20_we = addr_hit[528] & reg_we & !reg_error;
  assign dio_pad_sleep_regwen_20_wd = reg_wdata[0];

  assign dio_pad_sleep_regwen_21_we = addr_hit[529] & reg_we & !reg_error;
  assign dio_pad_sleep_regwen_21_wd = reg_wdata[0];

  assign dio_pad_sleep_regwen_22_we = addr_hit[530] & reg_we & !reg_error;
  assign dio_pad_sleep_regwen_22_wd = reg_wdata[0];

  assign dio_pad_sleep_en_0_we = addr_hit[531] & reg_we & !reg_error;
  assign dio_pad_sleep_en_0_wd = reg_wdata[0];

  assign dio_pad_sleep_en_1_we = addr_hit[532] & reg_we & !reg_error;
  assign dio_pad_sleep_en_1_wd = reg_wdata[0];

  assign dio_pad_sleep_en_2_we = addr_hit[533] & reg_we & !reg_error;
  assign dio_pad_sleep_en_2_wd = reg_wdata[0];

  assign dio_pad_sleep_en_3_we = addr_hit[534] & reg_we & !reg_error;
  assign dio_pad_sleep_en_3_wd = reg_wdata[0];

  assign dio_pad_sleep_en_4_we = addr_hit[535] & reg_we & !reg_error;
  assign dio_pad_sleep_en_4_wd = reg_wdata[0];

  assign dio_pad_sleep_en_5_we = addr_hit[536] & reg_we & !reg_error;
  assign dio_pad_sleep_en_5_wd = reg_wdata[0];

  assign dio_pad_sleep_en_6_we = addr_hit[537] & reg_we & !reg_error;
  assign dio_pad_sleep_en_6_wd = reg_wdata[0];

  assign dio_pad_sleep_en_7_we = addr_hit[538] & reg_we & !reg_error;
  assign dio_pad_sleep_en_7_wd = reg_wdata[0];

  assign dio_pad_sleep_en_8_we = addr_hit[539] & reg_we & !reg_error;
  assign dio_pad_sleep_en_8_wd = reg_wdata[0];

  assign dio_pad_sleep_en_9_we = addr_hit[540] & reg_we & !reg_error;
  assign dio_pad_sleep_en_9_wd = reg_wdata[0];

  assign dio_pad_sleep_en_10_we = addr_hit[541] & reg_we & !reg_error;
  assign dio_pad_sleep_en_10_wd = reg_wdata[0];

  assign dio_pad_sleep_en_11_we = addr_hit[542] & reg_we & !reg_error;
  assign dio_pad_sleep_en_11_wd = reg_wdata[0];

  assign dio_pad_sleep_en_12_we = addr_hit[543] & reg_we & !reg_error;
  assign dio_pad_sleep_en_12_wd = reg_wdata[0];

  assign dio_pad_sleep_en_13_we = addr_hit[544] & reg_we & !reg_error;
  assign dio_pad_sleep_en_13_wd = reg_wdata[0];

  assign dio_pad_sleep_en_14_we = addr_hit[545] & reg_we & !reg_error;
  assign dio_pad_sleep_en_14_wd = reg_wdata[0];

  assign dio_pad_sleep_en_15_we = addr_hit[546] & reg_we & !reg_error;
  assign dio_pad_sleep_en_15_wd = reg_wdata[0];

  assign dio_pad_sleep_en_16_we = addr_hit[547] & reg_we & !reg_error;
  assign dio_pad_sleep_en_16_wd = reg_wdata[0];

  assign dio_pad_sleep_en_17_we = addr_hit[548] & reg_we & !reg_error;
  assign dio_pad_sleep_en_17_wd = reg_wdata[0];

  assign dio_pad_sleep_en_18_we = addr_hit[549] & reg_we & !reg_error;
  assign dio_pad_sleep_en_18_wd = reg_wdata[0];

  assign dio_pad_sleep_en_19_we = addr_hit[550] & reg_we & !reg_error;
  assign dio_pad_sleep_en_19_wd = reg_wdata[0];

  assign dio_pad_sleep_en_20_we = addr_hit[551] & reg_we & !reg_error;
  assign dio_pad_sleep_en_20_wd = reg_wdata[0];

  assign dio_pad_sleep_en_21_we = addr_hit[552] & reg_we & !reg_error;
  assign dio_pad_sleep_en_21_wd = reg_wdata[0];

  assign dio_pad_sleep_en_22_we = addr_hit[553] & reg_we & !reg_error;
  assign dio_pad_sleep_en_22_wd = reg_wdata[0];

  assign dio_pad_sleep_mode_0_we = addr_hit[554] & reg_we & !reg_error;
  assign dio_pad_sleep_mode_0_wd = reg_wdata[1:0];

  assign dio_pad_sleep_mode_1_we = addr_hit[555] & reg_we & !reg_error;
  assign dio_pad_sleep_mode_1_wd = reg_wdata[1:0];

  assign dio_pad_sleep_mode_2_we = addr_hit[556] & reg_we & !reg_error;
  assign dio_pad_sleep_mode_2_wd = reg_wdata[1:0];

  assign dio_pad_sleep_mode_3_we = addr_hit[557] & reg_we & !reg_error;
  assign dio_pad_sleep_mode_3_wd = reg_wdata[1:0];

  assign dio_pad_sleep_mode_4_we = addr_hit[558] & reg_we & !reg_error;
  assign dio_pad_sleep_mode_4_wd = reg_wdata[1:0];

  assign dio_pad_sleep_mode_5_we = addr_hit[559] & reg_we & !reg_error;
  assign dio_pad_sleep_mode_5_wd = reg_wdata[1:0];

  assign dio_pad_sleep_mode_6_we = addr_hit[560] & reg_we & !reg_error;
  assign dio_pad_sleep_mode_6_wd = reg_wdata[1:0];

  assign dio_pad_sleep_mode_7_we = addr_hit[561] & reg_we & !reg_error;
  assign dio_pad_sleep_mode_7_wd = reg_wdata[1:0];

  assign dio_pad_sleep_mode_8_we = addr_hit[562] & reg_we & !reg_error;
  assign dio_pad_sleep_mode_8_wd = reg_wdata[1:0];

  assign dio_pad_sleep_mode_9_we = addr_hit[563] & reg_we & !reg_error;
  assign dio_pad_sleep_mode_9_wd = reg_wdata[1:0];

  assign dio_pad_sleep_mode_10_we = addr_hit[564] & reg_we & !reg_error;
  assign dio_pad_sleep_mode_10_wd = reg_wdata[1:0];

  assign dio_pad_sleep_mode_11_we = addr_hit[565] & reg_we & !reg_error;
  assign dio_pad_sleep_mode_11_wd = reg_wdata[1:0];

  assign dio_pad_sleep_mode_12_we = addr_hit[566] & reg_we & !reg_error;
  assign dio_pad_sleep_mode_12_wd = reg_wdata[1:0];

  assign dio_pad_sleep_mode_13_we = addr_hit[567] & reg_we & !reg_error;
  assign dio_pad_sleep_mode_13_wd = reg_wdata[1:0];

  assign dio_pad_sleep_mode_14_we = addr_hit[568] & reg_we & !reg_error;
  assign dio_pad_sleep_mode_14_wd = reg_wdata[1:0];

  assign dio_pad_sleep_mode_15_we = addr_hit[569] & reg_we & !reg_error;
  assign dio_pad_sleep_mode_15_wd = reg_wdata[1:0];

  assign dio_pad_sleep_mode_16_we = addr_hit[570] & reg_we & !reg_error;
  assign dio_pad_sleep_mode_16_wd = reg_wdata[1:0];

  assign dio_pad_sleep_mode_17_we = addr_hit[571] & reg_we & !reg_error;
  assign dio_pad_sleep_mode_17_wd = reg_wdata[1:0];

  assign dio_pad_sleep_mode_18_we = addr_hit[572] & reg_we & !reg_error;
  assign dio_pad_sleep_mode_18_wd = reg_wdata[1:0];

  assign dio_pad_sleep_mode_19_we = addr_hit[573] & reg_we & !reg_error;
  assign dio_pad_sleep_mode_19_wd = reg_wdata[1:0];

  assign dio_pad_sleep_mode_20_we = addr_hit[574] & reg_we & !reg_error;
  assign dio_pad_sleep_mode_20_wd = reg_wdata[1:0];

  assign dio_pad_sleep_mode_21_we = addr_hit[575] & reg_we & !reg_error;
  assign dio_pad_sleep_mode_21_wd = reg_wdata[1:0];

  assign dio_pad_sleep_mode_22_we = addr_hit[576] & reg_we & !reg_error;
  assign dio_pad_sleep_mode_22_wd = reg_wdata[1:0];

  assign wkup_detector_regwen_0_we = addr_hit[577] & reg_we & !reg_error;
  assign wkup_detector_regwen_0_wd = reg_wdata[0];

  assign wkup_detector_regwen_1_we = addr_hit[578] & reg_we & !reg_error;
  assign wkup_detector_regwen_1_wd = reg_wdata[0];

  assign wkup_detector_regwen_2_we = addr_hit[579] & reg_we & !reg_error;
  assign wkup_detector_regwen_2_wd = reg_wdata[0];

  assign wkup_detector_regwen_3_we = addr_hit[580] & reg_we & !reg_error;
  assign wkup_detector_regwen_3_wd = reg_wdata[0];

  assign wkup_detector_regwen_4_we = addr_hit[581] & reg_we & !reg_error;
  assign wkup_detector_regwen_4_wd = reg_wdata[0];

  assign wkup_detector_regwen_5_we = addr_hit[582] & reg_we & !reg_error;
  assign wkup_detector_regwen_5_wd = reg_wdata[0];

  assign wkup_detector_regwen_6_we = addr_hit[583] & reg_we & !reg_error;
  assign wkup_detector_regwen_6_wd = reg_wdata[0];

  assign wkup_detector_regwen_7_we = addr_hit[584] & reg_we & !reg_error;
  assign wkup_detector_regwen_7_wd = reg_wdata[0];

  assign wkup_detector_en_0_we = addr_hit[585] & reg_we & !reg_error;
  assign wkup_detector_en_0_wd = reg_wdata[0];

  assign wkup_detector_en_1_we = addr_hit[586] & reg_we & !reg_error;
  assign wkup_detector_en_1_wd = reg_wdata[0];

  assign wkup_detector_en_2_we = addr_hit[587] & reg_we & !reg_error;
  assign wkup_detector_en_2_wd = reg_wdata[0];

  assign wkup_detector_en_3_we = addr_hit[588] & reg_we & !reg_error;
  assign wkup_detector_en_3_wd = reg_wdata[0];

  assign wkup_detector_en_4_we = addr_hit[589] & reg_we & !reg_error;
  assign wkup_detector_en_4_wd = reg_wdata[0];

  assign wkup_detector_en_5_we = addr_hit[590] & reg_we & !reg_error;
  assign wkup_detector_en_5_wd = reg_wdata[0];

  assign wkup_detector_en_6_we = addr_hit[591] & reg_we & !reg_error;
  assign wkup_detector_en_6_wd = reg_wdata[0];

  assign wkup_detector_en_7_we = addr_hit[592] & reg_we & !reg_error;
  assign wkup_detector_en_7_wd = reg_wdata[0];

  assign wkup_detector_0_mode_0_we = addr_hit[593] & reg_we & !reg_error;
  assign wkup_detector_0_mode_0_wd = reg_wdata[2:0];

  assign wkup_detector_0_filter_0_we = addr_hit[593] & reg_we & !reg_error;
  assign wkup_detector_0_filter_0_wd = reg_wdata[3];

  assign wkup_detector_0_miodio_0_we = addr_hit[593] & reg_we & !reg_error;
  assign wkup_detector_0_miodio_0_wd = reg_wdata[4];

  assign wkup_detector_1_mode_1_we = addr_hit[594] & reg_we & !reg_error;
  assign wkup_detector_1_mode_1_wd = reg_wdata[2:0];

  assign wkup_detector_1_filter_1_we = addr_hit[594] & reg_we & !reg_error;
  assign wkup_detector_1_filter_1_wd = reg_wdata[3];

  assign wkup_detector_1_miodio_1_we = addr_hit[594] & reg_we & !reg_error;
  assign wkup_detector_1_miodio_1_wd = reg_wdata[4];

  assign wkup_detector_2_mode_2_we = addr_hit[595] & reg_we & !reg_error;
  assign wkup_detector_2_mode_2_wd = reg_wdata[2:0];

  assign wkup_detector_2_filter_2_we = addr_hit[595] & reg_we & !reg_error;
  assign wkup_detector_2_filter_2_wd = reg_wdata[3];

  assign wkup_detector_2_miodio_2_we = addr_hit[595] & reg_we & !reg_error;
  assign wkup_detector_2_miodio_2_wd = reg_wdata[4];

  assign wkup_detector_3_mode_3_we = addr_hit[596] & reg_we & !reg_error;
  assign wkup_detector_3_mode_3_wd = reg_wdata[2:0];

  assign wkup_detector_3_filter_3_we = addr_hit[596] & reg_we & !reg_error;
  assign wkup_detector_3_filter_3_wd = reg_wdata[3];

  assign wkup_detector_3_miodio_3_we = addr_hit[596] & reg_we & !reg_error;
  assign wkup_detector_3_miodio_3_wd = reg_wdata[4];

  assign wkup_detector_4_mode_4_we = addr_hit[597] & reg_we & !reg_error;
  assign wkup_detector_4_mode_4_wd = reg_wdata[2:0];

  assign wkup_detector_4_filter_4_we = addr_hit[597] & reg_we & !reg_error;
  assign wkup_detector_4_filter_4_wd = reg_wdata[3];

  assign wkup_detector_4_miodio_4_we = addr_hit[597] & reg_we & !reg_error;
  assign wkup_detector_4_miodio_4_wd = reg_wdata[4];

  assign wkup_detector_5_mode_5_we = addr_hit[598] & reg_we & !reg_error;
  assign wkup_detector_5_mode_5_wd = reg_wdata[2:0];

  assign wkup_detector_5_filter_5_we = addr_hit[598] & reg_we & !reg_error;
  assign wkup_detector_5_filter_5_wd = reg_wdata[3];

  assign wkup_detector_5_miodio_5_we = addr_hit[598] & reg_we & !reg_error;
  assign wkup_detector_5_miodio_5_wd = reg_wdata[4];

  assign wkup_detector_6_mode_6_we = addr_hit[599] & reg_we & !reg_error;
  assign wkup_detector_6_mode_6_wd = reg_wdata[2:0];

  assign wkup_detector_6_filter_6_we = addr_hit[599] & reg_we & !reg_error;
  assign wkup_detector_6_filter_6_wd = reg_wdata[3];

  assign wkup_detector_6_miodio_6_we = addr_hit[599] & reg_we & !reg_error;
  assign wkup_detector_6_miodio_6_wd = reg_wdata[4];

  assign wkup_detector_7_mode_7_we = addr_hit[600] & reg_we & !reg_error;
  assign wkup_detector_7_mode_7_wd = reg_wdata[2:0];

  assign wkup_detector_7_filter_7_we = addr_hit[600] & reg_we & !reg_error;
  assign wkup_detector_7_filter_7_wd = reg_wdata[3];

  assign wkup_detector_7_miodio_7_we = addr_hit[600] & reg_we & !reg_error;
  assign wkup_detector_7_miodio_7_wd = reg_wdata[4];

  assign wkup_detector_cnt_th_0_we = addr_hit[601] & reg_we & !reg_error;
  assign wkup_detector_cnt_th_0_wd = reg_wdata[7:0];

  assign wkup_detector_cnt_th_1_we = addr_hit[602] & reg_we & !reg_error;
  assign wkup_detector_cnt_th_1_wd = reg_wdata[7:0];

  assign wkup_detector_cnt_th_2_we = addr_hit[603] & reg_we & !reg_error;
  assign wkup_detector_cnt_th_2_wd = reg_wdata[7:0];

  assign wkup_detector_cnt_th_3_we = addr_hit[604] & reg_we & !reg_error;
  assign wkup_detector_cnt_th_3_wd = reg_wdata[7:0];

  assign wkup_detector_cnt_th_4_we = addr_hit[605] & reg_we & !reg_error;
  assign wkup_detector_cnt_th_4_wd = reg_wdata[7:0];

  assign wkup_detector_cnt_th_5_we = addr_hit[606] & reg_we & !reg_error;
  assign wkup_detector_cnt_th_5_wd = reg_wdata[7:0];

  assign wkup_detector_cnt_th_6_we = addr_hit[607] & reg_we & !reg_error;
  assign wkup_detector_cnt_th_6_wd = reg_wdata[7:0];

  assign wkup_detector_cnt_th_7_we = addr_hit[608] & reg_we & !reg_error;
  assign wkup_detector_cnt_th_7_wd = reg_wdata[7:0];

  assign wkup_detector_padsel_0_we = addr_hit[609] & reg_we & !reg_error;
  assign wkup_detector_padsel_0_wd = reg_wdata[5:0];

  assign wkup_detector_padsel_1_we = addr_hit[610] & reg_we & !reg_error;
  assign wkup_detector_padsel_1_wd = reg_wdata[5:0];

  assign wkup_detector_padsel_2_we = addr_hit[611] & reg_we & !reg_error;
  assign wkup_detector_padsel_2_wd = reg_wdata[5:0];

  assign wkup_detector_padsel_3_we = addr_hit[612] & reg_we & !reg_error;
  assign wkup_detector_padsel_3_wd = reg_wdata[5:0];

  assign wkup_detector_padsel_4_we = addr_hit[613] & reg_we & !reg_error;
  assign wkup_detector_padsel_4_wd = reg_wdata[5:0];

  assign wkup_detector_padsel_5_we = addr_hit[614] & reg_we & !reg_error;
  assign wkup_detector_padsel_5_wd = reg_wdata[5:0];

  assign wkup_detector_padsel_6_we = addr_hit[615] & reg_we & !reg_error;
  assign wkup_detector_padsel_6_wd = reg_wdata[5:0];

  assign wkup_detector_padsel_7_we = addr_hit[616] & reg_we & !reg_error;
  assign wkup_detector_padsel_7_wd = reg_wdata[5:0];

  assign wkup_cause_cause_0_we = addr_hit[617] & reg_we & !reg_error;
  assign wkup_cause_cause_0_wd = reg_wdata[0];
  assign wkup_cause_cause_0_re = addr_hit[617] & reg_re & !reg_error;

  assign wkup_cause_cause_1_we = addr_hit[617] & reg_we & !reg_error;
  assign wkup_cause_cause_1_wd = reg_wdata[1];
  assign wkup_cause_cause_1_re = addr_hit[617] & reg_re & !reg_error;

  assign wkup_cause_cause_2_we = addr_hit[617] & reg_we & !reg_error;
  assign wkup_cause_cause_2_wd = reg_wdata[2];
  assign wkup_cause_cause_2_re = addr_hit[617] & reg_re & !reg_error;

  assign wkup_cause_cause_3_we = addr_hit[617] & reg_we & !reg_error;
  assign wkup_cause_cause_3_wd = reg_wdata[3];
  assign wkup_cause_cause_3_re = addr_hit[617] & reg_re & !reg_error;

  assign wkup_cause_cause_4_we = addr_hit[617] & reg_we & !reg_error;
  assign wkup_cause_cause_4_wd = reg_wdata[4];
  assign wkup_cause_cause_4_re = addr_hit[617] & reg_re & !reg_error;

  assign wkup_cause_cause_5_we = addr_hit[617] & reg_we & !reg_error;
  assign wkup_cause_cause_5_wd = reg_wdata[5];
  assign wkup_cause_cause_5_re = addr_hit[617] & reg_re & !reg_error;

  assign wkup_cause_cause_6_we = addr_hit[617] & reg_we & !reg_error;
  assign wkup_cause_cause_6_wd = reg_wdata[6];
  assign wkup_cause_cause_6_re = addr_hit[617] & reg_re & !reg_error;

  assign wkup_cause_cause_7_we = addr_hit[617] & reg_we & !reg_error;
  assign wkup_cause_cause_7_wd = reg_wdata[7];
  assign wkup_cause_cause_7_re = addr_hit[617] & reg_re & !reg_error;
