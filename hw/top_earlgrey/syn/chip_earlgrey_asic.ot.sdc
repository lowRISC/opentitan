...
#leonids 03/06/2024 Update from Alex
...
set_false_path -from [get_clocks SPI_DEV_FAST_PASS_CLK] -through [get_cells top_earlgrey/u_sysrst_ctrl_aon/*] ; #TBD should be approved
