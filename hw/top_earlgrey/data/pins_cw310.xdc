...
set_property -dict { PACKAGE_PIN AE8 IOSTANDARD LVCMOS18 } [get_ports { SPI_HOST_D0 }];    #SDO (USR_SPI0DQ0)
set_property -dict { PACKAGE_PIN AE10 IOSTANDARD LVCMOS18 } [get_ports { SPI_HOST_D1 }];   #SDO (USR_SPI0DQ1)
