...
## LEDs
set_property -dict {PACKAGE_PIN T14 IOSTANDARD LVCMOS25} [get_ports IO_GP8]
set_property -dict {PACKAGE_PIN T15 IOSTANDARD LVCMOS25} [get_ports IO_GP9]
set_property -dict {PACKAGE_PIN T16 IOSTANDARD LVCMOS25} [get_ports IO_GP10]
set_property -dict {PACKAGE_PIN U16 IOSTANDARD LVCMOS25} [get_ports IO_GP11]
set_property -dict {PACKAGE_PIN V15 IOSTANDARD LVCMOS25} [get_ports IO_GP12]
set_property -dict {PACKAGE_PIN W16 IOSTANDARD LVCMOS25} [get_ports IO_GP13]
set_property -dict {PACKAGE_PIN W15 IOSTANDARD LVCMOS25} [get_ports IO_GP14]
set_property -dict {PACKAGE_PIN Y13 IOSTANDARD LVCMOS25} [get_ports IO_GP15]
...
## Switches
set_property -dict {PACKAGE_PIN E22 IOSTANDARD LVCMOS12} [get_ports IO_GP0]
set_property -dict {PACKAGE_PIN F21 IOSTANDARD LVCMOS12} [get_ports IO_GP1]
set_property -dict {PACKAGE_PIN G21 IOSTANDARD LVCMOS12} [get_ports IO_GP2]
set_property -dict {PACKAGE_PIN G22 IOSTANDARD LVCMOS12} [get_ports IO_GP3]
set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS12} [get_ports IO_GP4]
set_property -dict {PACKAGE_PIN J16 IOSTANDARD LVCMOS12} [get_ports IO_GP5]
set_property -dict {PACKAGE_PIN K13 IOSTANDARD LVCMOS12} [get_ports IO_GP6]
set_property -dict {PACKAGE_PIN M17 IOSTANDARD LVCMOS12} [get_ports IO_GP7]
...
## UART
set_property -dict {PACKAGE_PIN AA19 IOSTANDARD LVCMOS33} [get_ports IO_UTX]
set_property -dict {PACKAGE_PIN V18 IOSTANDARD LVCMOS33} [get_ports IO_URX]
...
set_property -dict {PACKAGE_PIN U20 IOSTANDARD LVCMOS33} [get_ports IO_DPS0]
set_property -dict {PACKAGE_PIN P14 IOSTANDARD LVCMOS33} [get_ports IO_DPS1]
set_property -dict {PACKAGE_PIN P15 IOSTANDARD LVCMOS33} [get_ports IO_DPS2]
set_property -dict {PACKAGE_PIN U17 IOSTANDARD LVCMOS33} [get_ports IO_DPS3]
set_property -dict {PACKAGE_PIN R17 IOSTANDARD LVCMOS33} [get_ports IO_DPS4]
set_property PACKAGE_PIN P16 [get_ports IO_DPS5]
set_property IOSTANDARD LVCMOS33 [get_ports IO_DPS5]
set_property PULLUP true [get_ports IO_DPS5]
set_property PACKAGE_PIN R18 [get_ports IO_DPS6]
set_property IOSTANDARD LVCMOS33 [get_ports IO_DPS6]
set_property PULLDOWN true [get_ports IO_DPS6]
set_property PACKAGE_PIN N14 [get_ports IO_DPS7]
set_property IOSTANDARD LVCMOS33 [get_ports IO_DPS7]
set_property PULLDOWN true [get_ports IO_DPS7]
