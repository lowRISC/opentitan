...
module alert_handler_reg_top (
  ...
  always_comb begin
    ...
    addr_hit[313] = (reg_addr == ALERT_HANDLER_CLASSA_CLR_SHADOWED_OFFSET);
    ...
    addr_hit[317] = (reg_addr == ALERT_HANDLER_CLASSA_CRASHDUMP_TRIGGER_SHADOWED_OFFSET);
    addr_hit[318] = (reg_addr == ALERT_HANDLER_CLASSA_PHASE0_CYC_SHADOWED_OFFSET);
    addr_hit[319] = (reg_addr == ALERT_HANDLER_CLASSA_PHASE1_CYC_SHADOWED_OFFSET);
    addr_hit[320] = (reg_addr == ALERT_HANDLER_CLASSA_PHASE2_CYC_SHADOWED_OFFSET);
    addr_hit[321] = (reg_addr == ALERT_HANDLER_CLASSA_PHASE3_CYC_SHADOWED_OFFSET);
    addr_hit[322] = (reg_addr == ALERT_HANDLER_CLASSA_ESC_CNT_OFFSET);
    addr_hit[323] = (reg_addr == ALERT_HANDLER_CLASSA_STATE_OFFSET);
    addr_hit[324] = (reg_addr == ALERT_HANDLER_CLASSB_REGWEN_OFFSET);
    addr_hit[325] = (reg_addr == ALERT_HANDLER_CLASSB_CTRL_SHADOWED_OFFSET);
    addr_hit[326] = (reg_addr == ALERT_HANDLER_CLASSB_CLR_REGWEN_OFFSET);
    addr_hit[327] = (reg_addr == ALERT_HANDLER_CLASSB_CLR_SHADOWED_OFFSET);
    addr_hit[328] = (reg_addr == ALERT_HANDLER_CLASSB_ACCUM_CNT_OFFSET);
    addr_hit[329] = (reg_addr == ALERT_HANDLER_CLASSB_ACCUM_THRESH_SHADOWED_OFFSET);
    addr_hit[330] = (reg_addr == ALERT_HANDLER_CLASSB_TIMEOUT_CYC_SHADOWED_OFFSET);
    addr_hit[331] = (reg_addr == ALERT_HANDLER_CLASSB_CRASHDUMP_TRIGGER_SHADOWED_OFFSET);
    addr_hit[332] = (reg_addr == ALERT_HANDLER_CLASSB_PHASE0_CYC_SHADOWED_OFFSET);
    addr_hit[333] = (reg_addr == ALERT_HANDLER_CLASSB_PHASE1_CYC_SHADOWED_OFFSET);
    addr_hit[334] = (reg_addr == ALERT_HANDLER_CLASSB_PHASE2_CYC_SHADOWED_OFFSET);
    addr_hit[335] = (reg_addr == ALERT_HANDLER_CLASSB_PHASE3_CYC_SHADOWED_OFFSET);
    addr_hit[336] = (reg_addr == ALERT_HANDLER_CLASSB_ESC_CNT_OFFSET);
    addr_hit[337] = (reg_addr == ALERT_HANDLER_CLASSB_STATE_OFFSET);
    addr_hit[338] = (reg_addr == ALERT_HANDLER_CLASSC_REGWEN_OFFSET);
    addr_hit[339] = (reg_addr == ALERT_HANDLER_CLASSC_CTRL_SHADOWED_OFFSET);
    addr_hit[340] = (reg_addr == ALERT_HANDLER_CLASSC_CLR_REGWEN_OFFSET);
    addr_hit[341] = (reg_addr == ALERT_HANDLER_CLASSC_CLR_SHADOWED_OFFSET);
    addr_hit[342] = (reg_addr == ALERT_HANDLER_CLASSC_ACCUM_CNT_OFFSET);
    addr_hit[343] = (reg_addr == ALERT_HANDLER_CLASSC_ACCUM_THRESH_SHADOWED_OFFSET);
    addr_hit[344] = (reg_addr == ALERT_HANDLER_CLASSC_TIMEOUT_CYC_SHADOWED_OFFSET);
    addr_hit[345] = (reg_addr == ALERT_HANDLER_CLASSC_CRASHDUMP_TRIGGER_SHADOWED_OFFSET);
    addr_hit[346] = (reg_addr == ALERT_HANDLER_CLASSC_PHASE0_CYC_SHADOWED_OFFSET);
    addr_hit[347] = (reg_addr == ALERT_HANDLER_CLASSC_PHASE1_CYC_SHADOWED_OFFSET);
    addr_hit[348] = (reg_addr == ALERT_HANDLER_CLASSC_PHASE2_CYC_SHADOWED_OFFSET);
    addr_hit[349] = (reg_addr == ALERT_HANDLER_CLASSC_PHASE3_CYC_SHADOWED_OFFSET);
    addr_hit[350] = (reg_addr == ALERT_HANDLER_CLASSC_ESC_CNT_OFFSET);
    addr_hit[351] = (reg_addr == ALERT_HANDLER_CLASSC_STATE_OFFSET);
    addr_hit[352] = (reg_addr == ALERT_HANDLER_CLASSD_REGWEN_OFFSET);
    addr_hit[353] = (reg_addr == ALERT_HANDLER_CLASSD_CTRL_SHADOWED_OFFSET);
    addr_hit[354] = (reg_addr == ALERT_HANDLER_CLASSD_CLR_REGWEN_OFFSET);
    addr_hit[355] = (reg_addr == ALERT_HANDLER_CLASSD_CLR_SHADOWED_OFFSET);
    addr_hit[356] = (reg_addr == ALERT_HANDLER_CLASSD_ACCUM_CNT_OFFSET);
    addr_hit[357] = (reg_addr == ALERT_HANDLER_CLASSD_ACCUM_THRESH_SHADOWED_OFFSET);
    addr_hit[358] = (reg_addr == ALERT_HANDLER_CLASSD_TIMEOUT_CYC_SHADOWED_OFFSET);
    addr_hit[359] = (reg_addr == ALERT_HANDLER_CLASSD_CRASHDUMP_TRIGGER_SHADOWED_OFFSET);
  ...
  assign classa_clr_shadowed_re = addr_hit[313] & reg_re & !reg_error;
  assign classa_clr_shadowed_we = addr_hit[313] & reg_we & !reg_error;
  ...
  assign classa_crashdump_trigger_shadowed_re = addr_hit[317] & reg_re & !reg_error;
  assign classa_crashdump_trigger_shadowed_we = addr_hit[317] & reg_we & !reg_error;

  assign classa_crashdump_trigger_shadowed_wd = reg_wdata[1:0];
  assign classa_phase0_cyc_shadowed_re = addr_hit[318] & reg_re & !reg_error;
  assign classa_phase0_cyc_shadowed_we = addr_hit[318] & reg_we & !reg_error;

  assign classa_phase0_cyc_shadowed_wd = reg_wdata[31:0];
  assign classa_phase1_cyc_shadowed_re = addr_hit[319] & reg_re & !reg_error;
  assign classa_phase1_cyc_shadowed_we = addr_hit[319] & reg_we & !reg_error;

  assign classa_phase1_cyc_shadowed_wd = reg_wdata[31:0];
  assign classa_phase2_cyc_shadowed_re = addr_hit[320] & reg_re & !reg_error;
  assign classa_phase2_cyc_shadowed_we = addr_hit[320] & reg_we & !reg_error;

  assign classa_phase2_cyc_shadowed_wd = reg_wdata[31:0];
  assign classa_phase3_cyc_shadowed_re = addr_hit[321] & reg_re & !reg_error;
  assign classa_phase3_cyc_shadowed_we = addr_hit[321] & reg_we & !reg_error;

  assign classa_phase3_cyc_shadowed_wd = reg_wdata[31:0];
  assign classa_esc_cnt_re = addr_hit[322] & reg_re & !reg_error;
  assign classa_state_re = addr_hit[323] & reg_re & !reg_error;
  assign classb_regwen_we = addr_hit[324] & reg_we & !reg_error;

  assign classb_regwen_wd = reg_wdata[0];
  assign classb_ctrl_shadowed_re = addr_hit[325] & reg_re & !reg_error;
  assign classb_ctrl_shadowed_we = addr_hit[325] & reg_we & !reg_error;
  ...
  assign classb_clr_regwen_we = addr_hit[326] & reg_we & !reg_error;

  assign classb_clr_regwen_wd = reg_wdata[0];
  assign classb_clr_shadowed_re = addr_hit[327] & reg_re & !reg_error;
  assign classb_clr_shadowed_we = addr_hit[327] & reg_we & !reg_error;

  assign classb_clr_shadowed_wd = reg_wdata[0];
  assign classb_accum_cnt_re = addr_hit[328] & reg_re & !reg_error;
  assign classb_accum_thresh_shadowed_re = addr_hit[329] & reg_re & !reg_error;
  assign classb_accum_thresh_shadowed_we = addr_hit[329] & reg_we & !reg_error;

  assign classb_accum_thresh_shadowed_wd = reg_wdata[15:0];
  assign classb_timeout_cyc_shadowed_re = addr_hit[330] & reg_re & !reg_error;
  assign classb_timeout_cyc_shadowed_we = addr_hit[330] & reg_we & !reg_error;

  assign classb_timeout_cyc_shadowed_wd = reg_wdata[31:0];
  assign classb_crashdump_trigger_shadowed_re = addr_hit[331] & reg_re & !reg_error;
  assign classb_crashdump_trigger_shadowed_we = addr_hit[331] & reg_we & !reg_error;

  assign classb_crashdump_trigger_shadowed_wd = reg_wdata[1:0];
  assign classb_phase0_cyc_shadowed_re = addr_hit[332] & reg_re & !reg_error;
  assign classb_phase0_cyc_shadowed_we = addr_hit[332] & reg_we & !reg_error;

  assign classb_phase0_cyc_shadowed_wd = reg_wdata[31:0];
  assign classb_phase1_cyc_shadowed_re = addr_hit[333] & reg_re & !reg_error;
  assign classb_phase1_cyc_shadowed_we = addr_hit[333] & reg_we & !reg_error;

  assign classb_phase1_cyc_shadowed_wd = reg_wdata[31:0];
  assign classb_phase2_cyc_shadowed_re = addr_hit[334] & reg_re & !reg_error;
  assign classb_phase2_cyc_shadowed_we = addr_hit[334] & reg_we & !reg_error;

  assign classb_phase2_cyc_shadowed_wd = reg_wdata[31:0];
  assign classb_phase3_cyc_shadowed_re = addr_hit[335] & reg_re & !reg_error;
  assign classb_phase3_cyc_shadowed_we = addr_hit[335] & reg_we & !reg_error;

  assign classb_phase3_cyc_shadowed_wd = reg_wdata[31:0];
  assign classb_esc_cnt_re = addr_hit[336] & reg_re & !reg_error;
  assign classb_state_re = addr_hit[337] & reg_re & !reg_error;
  assign classc_regwen_we = addr_hit[338] & reg_we & !reg_error;

  assign classc_regwen_wd = reg_wdata[0];
  assign classc_ctrl_shadowed_re = addr_hit[339] & reg_re & !reg_error;
  assign classc_ctrl_shadowed_we = addr_hit[339] & reg_we & !reg_error;
  ...
  assign classc_clr_regwen_we = addr_hit[340] & reg_we & !reg_error;

  assign classc_clr_regwen_wd = reg_wdata[0];
  assign classc_clr_shadowed_re = addr_hit[341] & reg_re & !reg_error;
  assign classc_clr_shadowed_we = addr_hit[341] & reg_we & !reg_error;

  assign classc_clr_shadowed_wd = reg_wdata[0];
  assign classc_accum_cnt_re = addr_hit[342] & reg_re & !reg_error;
  assign classc_accum_thresh_shadowed_re = addr_hit[343] & reg_re & !reg_error;
  assign classc_accum_thresh_shadowed_we = addr_hit[343] & reg_we & !reg_error;

  assign classc_accum_thresh_shadowed_wd = reg_wdata[15:0];
  assign classc_timeout_cyc_shadowed_re = addr_hit[344] & reg_re & !reg_error;
  assign classc_timeout_cyc_shadowed_we = addr_hit[344] & reg_we & !reg_error;

  assign classc_timeout_cyc_shadowed_wd = reg_wdata[31:0];
  assign classc_crashdump_trigger_shadowed_re = addr_hit[345] & reg_re & !reg_error;
  assign classc_crashdump_trigger_shadowed_we = addr_hit[345] & reg_we & !reg_error;

  assign classc_crashdump_trigger_shadowed_wd = reg_wdata[1:0];
  assign classc_phase0_cyc_shadowed_re = addr_hit[346] & reg_re & !reg_error;
  assign classc_phase0_cyc_shadowed_we = addr_hit[346] & reg_we & !reg_error;

  assign classc_phase0_cyc_shadowed_wd = reg_wdata[31:0];
  assign classc_phase1_cyc_shadowed_re = addr_hit[347] & reg_re & !reg_error;
  assign classc_phase1_cyc_shadowed_we = addr_hit[347] & reg_we & !reg_error;

  assign classc_phase1_cyc_shadowed_wd = reg_wdata[31:0];
  assign classc_phase2_cyc_shadowed_re = addr_hit[348] & reg_re & !reg_error;
  assign classc_phase2_cyc_shadowed_we = addr_hit[348] & reg_we & !reg_error;

  assign classc_phase2_cyc_shadowed_wd = reg_wdata[31:0];
  assign classc_phase3_cyc_shadowed_re = addr_hit[349] & reg_re & !reg_error;
  assign classc_phase3_cyc_shadowed_we = addr_hit[349] & reg_we & !reg_error;

  assign classc_phase3_cyc_shadowed_wd = reg_wdata[31:0];
  assign classc_esc_cnt_re = addr_hit[350] & reg_re & !reg_error;
  assign classc_state_re = addr_hit[351] & reg_re & !reg_error;
  assign classd_regwen_we = addr_hit[352] & reg_we & !reg_error;

  assign classd_regwen_wd = reg_wdata[0];
  assign classd_ctrl_shadowed_re = addr_hit[353] & reg_re & !reg_error;
  assign classd_ctrl_shadowed_we = addr_hit[353] & reg_we & !reg_error;
  ...
  assign classd_clr_regwen_we = addr_hit[354] & reg_we & !reg_error;

  assign classd_clr_regwen_wd = reg_wdata[0];
  assign classd_clr_shadowed_re = addr_hit[355] & reg_re & !reg_error;
  assign classd_clr_shadowed_we = addr_hit[355] & reg_we & !reg_error;

  assign classd_clr_shadowed_wd = reg_wdata[0];
  assign classd_accum_cnt_re = addr_hit[356] & reg_re & !reg_error;
  assign classd_accum_thresh_shadowed_re = addr_hit[357] & reg_re & !reg_error;
  assign classd_accum_thresh_shadowed_we = addr_hit[357] & reg_we & !reg_error;

  assign classd_accum_thresh_shadowed_wd = reg_wdata[15:0];
  assign classd_timeout_cyc_shadowed_re = addr_hit[358] & reg_re & !reg_error;
  assign classd_timeout_cyc_shadowed_we = addr_hit[358] & reg_we & !reg_error;

  assign classd_timeout_cyc_shadowed_wd = reg_wdata[31:0];
  assign classd_crashdump_trigger_shadowed_re = addr_hit[359] & reg_re & !reg_error;
  assign classd_crashdump_trigger_shadowed_we = addr_hit[359] & reg_we & !reg_error;
  ...
  always_comb begin
    ...
    reg_we_check[75] = alert_en_shadowed_0_gated_we;
    reg_we_check[76] = alert_en_shadowed_1_gated_we;
    reg_we_check[77] = alert_en_shadowed_2_gated_we;
    reg_we_check[78] = alert_en_shadowed_3_gated_we;
    reg_we_check[79] = alert_en_shadowed_4_gated_we;
    reg_we_check[80] = alert_en_shadowed_5_gated_we;
    reg_we_check[81] = alert_en_shadowed_6_gated_we;
    reg_we_check[82] = alert_en_shadowed_7_gated_we;
    reg_we_check[83] = alert_en_shadowed_8_gated_we;
    reg_we_check[84] = alert_en_shadowed_9_gated_we;
    reg_we_check[85] = alert_en_shadowed_10_gated_we;
    reg_we_check[86] = alert_en_shadowed_11_gated_we;
    reg_we_check[87] = alert_en_shadowed_12_gated_we;
    reg_we_check[88] = alert_en_shadowed_13_gated_we;
    reg_we_check[89] = alert_en_shadowed_14_gated_we;
    reg_we_check[90] = alert_en_shadowed_15_gated_we;
    reg_we_check[91] = alert_en_shadowed_16_gated_we;
    reg_we_check[92] = alert_en_shadowed_17_gated_we;
    reg_we_check[93] = alert_en_shadowed_18_gated_we;
    reg_we_check[94] = alert_en_shadowed_19_gated_we;
    reg_we_check[95] = alert_en_shadowed_20_gated_we;
    reg_we_check[96] = alert_en_shadowed_21_gated_we;
    reg_we_check[97] = alert_en_shadowed_22_gated_we;
    reg_we_check[98] = alert_en_shadowed_23_gated_we;
    reg_we_check[99] = alert_en_shadowed_24_gated_we;
    reg_we_check[100] = alert_en_shadowed_25_gated_we;
    reg_we_check[101] = alert_en_shadowed_26_gated_we;
    reg_we_check[102] = alert_en_shadowed_27_gated_we;
    reg_we_check[103] = alert_en_shadowed_28_gated_we;
    reg_we_check[104] = alert_en_shadowed_29_gated_we;
    reg_we_check[105] = alert_en_shadowed_30_gated_we;
    reg_we_check[106] = alert_en_shadowed_31_gated_we;
    reg_we_check[107] = alert_en_shadowed_32_gated_we;
    reg_we_check[108] = alert_en_shadowed_33_gated_we;
    reg_we_check[109] = alert_en_shadowed_34_gated_we;
    reg_we_check[110] = alert_en_shadowed_35_gated_we;
    reg_we_check[111] = alert_en_shadowed_36_gated_we;
    reg_we_check[112] = alert_en_shadowed_37_gated_we;
    reg_we_check[113] = alert_en_shadowed_38_gated_we;
    reg_we_check[114] = alert_en_shadowed_39_gated_we;
    reg_we_check[115] = alert_en_shadowed_40_gated_we;
    reg_we_check[116] = alert_en_shadowed_41_gated_we;
    reg_we_check[117] = alert_en_shadowed_42_gated_we;
    reg_we_check[118] = alert_en_shadowed_43_gated_we;
    reg_we_check[119] = alert_en_shadowed_44_gated_we;
    reg_we_check[120] = alert_en_shadowed_45_gated_we;
    reg_we_check[121] = alert_en_shadowed_46_gated_we;
    reg_we_check[122] = alert_en_shadowed_47_gated_we;
    reg_we_check[123] = alert_en_shadowed_48_gated_we;
    reg_we_check[124] = alert_en_shadowed_49_gated_we;
    reg_we_check[125] = alert_en_shadowed_50_gated_we;
    reg_we_check[126] = alert_en_shadowed_51_gated_we;
    reg_we_check[127] = alert_en_shadowed_52_gated_we;
    reg_we_check[128] = alert_en_shadowed_53_gated_we;
    reg_we_check[129] = alert_en_shadowed_54_gated_we;
    reg_we_check[130] = alert_en_shadowed_55_gated_we;
    reg_we_check[131] = alert_en_shadowed_56_gated_we;
    reg_we_check[132] = alert_en_shadowed_57_gated_we;
    reg_we_check[133] = alert_en_shadowed_58_gated_we;
    reg_we_check[134] = alert_en_shadowed_59_gated_we;
    reg_we_check[135] = alert_en_shadowed_60_gated_we;
    reg_we_check[136] = alert_en_shadowed_61_gated_we;
    reg_we_check[137] = alert_en_shadowed_62_gated_we;
    reg_we_check[138] = alert_en_shadowed_63_gated_we;
    reg_we_check[139] = alert_en_shadowed_64_gated_we;
    reg_we_check[140] = alert_en_shadowed_65_gated_we;
    reg_we_check[141] = alert_en_shadowed_66_gated_we;
    reg_we_check[142] = alert_en_shadowed_67_gated_we;
    reg_we_check[143] = alert_en_shadowed_68_gated_we;
    reg_we_check[144] = alert_class_shadowed_0_gated_we;
    reg_we_check[145] = alert_class_shadowed_1_gated_we;
    reg_we_check[146] = alert_class_shadowed_2_gated_we;
    reg_we_check[147] = alert_class_shadowed_3_gated_we;
    reg_we_check[148] = alert_class_shadowed_4_gated_we;
    reg_we_check[149] = alert_class_shadowed_5_gated_we;
    reg_we_check[150] = alert_class_shadowed_6_gated_we;
    reg_we_check[151] = alert_class_shadowed_7_gated_we;
    reg_we_check[152] = alert_class_shadowed_8_gated_we;
    reg_we_check[153] = alert_class_shadowed_9_gated_we;
    reg_we_check[154] = alert_class_shadowed_10_gated_we;
    reg_we_check[155] = alert_class_shadowed_11_gated_we;
    reg_we_check[156] = alert_class_shadowed_12_gated_we;
    reg_we_check[157] = alert_class_shadowed_13_gated_we;
    reg_we_check[158] = alert_class_shadowed_14_gated_we;
    reg_we_check[159] = alert_class_shadowed_15_gated_we;
    reg_we_check[160] = alert_class_shadowed_16_gated_we;
    reg_we_check[161] = alert_class_shadowed_17_gated_we;
    reg_we_check[162] = alert_class_shadowed_18_gated_we;
    reg_we_check[163] = alert_class_shadowed_19_gated_we;
    reg_we_check[164] = alert_class_shadowed_20_gated_we;
    reg_we_check[165] = alert_class_shadowed_21_gated_we;
    reg_we_check[166] = alert_class_shadowed_22_gated_we;
    reg_we_check[167] = alert_class_shadowed_23_gated_we;
    reg_we_check[168] = alert_class_shadowed_24_gated_we;
    reg_we_check[169] = alert_class_shadowed_25_gated_we;
    reg_we_check[170] = alert_class_shadowed_26_gated_we;
    reg_we_check[171] = alert_class_shadowed_27_gated_we;
    reg_we_check[172] = alert_class_shadowed_28_gated_we;
    reg_we_check[173] = alert_class_shadowed_29_gated_we;
    reg_we_check[174] = alert_class_shadowed_30_gated_we;
    reg_we_check[175] = alert_class_shadowed_31_gated_we;
    reg_we_check[176] = alert_class_shadowed_32_gated_we;
    reg_we_check[177] = alert_class_shadowed_33_gated_we;
    reg_we_check[178] = alert_class_shadowed_34_gated_we;
    reg_we_check[179] = alert_class_shadowed_35_gated_we;
    reg_we_check[180] = alert_class_shadowed_36_gated_we;
    reg_we_check[181] = alert_class_shadowed_37_gated_we;
    reg_we_check[182] = alert_class_shadowed_38_gated_we;
    reg_we_check[183] = alert_class_shadowed_39_gated_we;
    reg_we_check[184] = alert_class_shadowed_40_gated_we;
    reg_we_check[185] = alert_class_shadowed_41_gated_we;
    reg_we_check[186] = alert_class_shadowed_42_gated_we;
    reg_we_check[187] = alert_class_shadowed_43_gated_we;
    reg_we_check[188] = alert_class_shadowed_44_gated_we;
    reg_we_check[189] = alert_class_shadowed_45_gated_we;
    reg_we_check[190] = alert_class_shadowed_46_gated_we;
    reg_we_check[191] = alert_class_shadowed_47_gated_we;
    reg_we_check[192] = alert_class_shadowed_48_gated_we;
    reg_we_check[193] = alert_class_shadowed_49_gated_we;
    reg_we_check[194] = alert_class_shadowed_50_gated_we;
    reg_we_check[195] = alert_class_shadowed_51_gated_we;
    reg_we_check[196] = alert_class_shadowed_52_gated_we;
    reg_we_check[197] = alert_class_shadowed_53_gated_we;
    reg_we_check[198] = alert_class_shadowed_54_gated_we;
    reg_we_check[199] = alert_class_shadowed_55_gated_we;
    reg_we_check[200] = alert_class_shadowed_56_gated_we;
    reg_we_check[201] = alert_class_shadowed_57_gated_we;
    reg_we_check[202] = alert_class_shadowed_58_gated_we;
    reg_we_check[203] = alert_class_shadowed_59_gated_we;
    reg_we_check[204] = alert_class_shadowed_60_gated_we;
    reg_we_check[205] = alert_class_shadowed_61_gated_we;
    reg_we_check[206] = alert_class_shadowed_62_gated_we;
    reg_we_check[207] = alert_class_shadowed_63_gated_we;
    reg_we_check[208] = alert_class_shadowed_64_gated_we;
    reg_we_check[209] = alert_class_shadowed_65_gated_we;
    reg_we_check[210] = alert_class_shadowed_66_gated_we;
    reg_we_check[211] = alert_class_shadowed_67_gated_we;
    reg_we_check[212] = alert_class_shadowed_68_gated_we;
    reg_we_check[213] = alert_cause_0_we;
    reg_we_check[214] = alert_cause_1_we;
    reg_we_check[215] = alert_cause_2_we;
    reg_we_check[216] = alert_cause_3_we;
    reg_we_check[217] = alert_cause_4_we;
    reg_we_check[218] = alert_cause_5_we;
    reg_we_check[219] = alert_cause_6_we;
    reg_we_check[220] = alert_cause_7_we;
    reg_we_check[221] = alert_cause_8_we;
    reg_we_check[222] = alert_cause_9_we;
    reg_we_check[223] = alert_cause_10_we;
    reg_we_check[224] = alert_cause_11_we;
    reg_we_check[225] = alert_cause_12_we;
    reg_we_check[226] = alert_cause_13_we;
    reg_we_check[227] = alert_cause_14_we;
    reg_we_check[228] = alert_cause_15_we;
    reg_we_check[229] = alert_cause_16_we;
    reg_we_check[230] = alert_cause_17_we;
    reg_we_check[231] = alert_cause_18_we;
    reg_we_check[232] = alert_cause_19_we;
    reg_we_check[233] = alert_cause_20_we;
    reg_we_check[234] = alert_cause_21_we;
    reg_we_check[235] = alert_cause_22_we;
    reg_we_check[236] = alert_cause_23_we;
    reg_we_check[237] = alert_cause_24_we;
    reg_we_check[238] = alert_cause_25_we;
    reg_we_check[239] = alert_cause_26_we;
    reg_we_check[240] = alert_cause_27_we;
    reg_we_check[241] = alert_cause_28_we;
    reg_we_check[242] = alert_cause_29_we;
    reg_we_check[243] = alert_cause_30_we;
    reg_we_check[244] = alert_cause_31_we;
    reg_we_check[245] = alert_cause_32_we;
    reg_we_check[246] = alert_cause_33_we;
    reg_we_check[247] = alert_cause_34_we;
    reg_we_check[248] = alert_cause_35_we;
    reg_we_check[249] = alert_cause_36_we;
    reg_we_check[250] = alert_cause_37_we;
    reg_we_check[251] = alert_cause_38_we;
    reg_we_check[252] = alert_cause_39_we;
    reg_we_check[253] = alert_cause_40_we;
    reg_we_check[254] = alert_cause_41_we;
    reg_we_check[255] = alert_cause_42_we;
    reg_we_check[256] = alert_cause_43_we;
    reg_we_check[257] = alert_cause_44_we;
    reg_we_check[258] = alert_cause_45_we;
    reg_we_check[259] = alert_cause_46_we;
    reg_we_check[260] = alert_cause_47_we;
    reg_we_check[261] = alert_cause_48_we;
    reg_we_check[262] = alert_cause_49_we;
    reg_we_check[263] = alert_cause_50_we;
    reg_we_check[264] = alert_cause_51_we;
    reg_we_check[265] = alert_cause_52_we;
    reg_we_check[266] = alert_cause_53_we;
    reg_we_check[267] = alert_cause_54_we;
    reg_we_check[268] = alert_cause_55_we;
    reg_we_check[269] = alert_cause_56_we;
    reg_we_check[270] = alert_cause_57_we;
    reg_we_check[271] = alert_cause_58_we;
    reg_we_check[272] = alert_cause_59_we;
    reg_we_check[273] = alert_cause_60_we;
    reg_we_check[274] = alert_cause_61_we;
    reg_we_check[275] = alert_cause_62_we;
    reg_we_check[276] = alert_cause_63_we;
    reg_we_check[277] = alert_cause_64_we;
    reg_we_check[278] = alert_cause_65_we;
    reg_we_check[279] = alert_cause_66_we;
    reg_we_check[280] = alert_cause_67_we;
    reg_we_check[281] = alert_cause_68_we;
    reg_we_check[282] = loc_alert_regwen_0_we;
    reg_we_check[283] = loc_alert_regwen_1_we;
    reg_we_check[284] = loc_alert_regwen_2_we;
    reg_we_check[285] = loc_alert_regwen_3_we;
    reg_we_check[286] = loc_alert_regwen_4_we;
    reg_we_check[287] = loc_alert_regwen_5_we;
    reg_we_check[288] = loc_alert_regwen_6_we;
    reg_we_check[289] = loc_alert_en_shadowed_0_gated_we;
    reg_we_check[290] = loc_alert_en_shadowed_1_gated_we;
    reg_we_check[291] = loc_alert_en_shadowed_2_gated_we;
    reg_we_check[292] = loc_alert_en_shadowed_3_gated_we;
    reg_we_check[293] = loc_alert_en_shadowed_4_gated_we;
    reg_we_check[294] = loc_alert_en_shadowed_5_gated_we;
    reg_we_check[295] = loc_alert_en_shadowed_6_gated_we;
    reg_we_check[296] = loc_alert_class_shadowed_0_gated_we;
    reg_we_check[297] = loc_alert_class_shadowed_1_gated_we;
    reg_we_check[298] = loc_alert_class_shadowed_2_gated_we;
    reg_we_check[299] = loc_alert_class_shadowed_3_gated_we;
    reg_we_check[300] = loc_alert_class_shadowed_4_gated_we;
    reg_we_check[301] = loc_alert_class_shadowed_5_gated_we;
    reg_we_check[302] = loc_alert_class_shadowed_6_gated_we;
    reg_we_check[303] = loc_alert_cause_0_we;
    reg_we_check[304] = loc_alert_cause_1_we;
    reg_we_check[305] = loc_alert_cause_2_we;
    reg_we_check[306] = loc_alert_cause_3_we;
    reg_we_check[307] = loc_alert_cause_4_we;
    reg_we_check[308] = loc_alert_cause_5_we;
    reg_we_check[309] = loc_alert_cause_6_we;
    reg_we_check[310] = classa_regwen_we;
    reg_we_check[311] = classa_ctrl_shadowed_gated_we;
    reg_we_check[312] = classa_clr_regwen_we;
    reg_we_check[313] = classa_clr_shadowed_gated_we;
    reg_we_check[314] = 1'b0;
    reg_we_check[315] = classa_accum_thresh_shadowed_gated_we;
    reg_we_check[316] = classa_timeout_cyc_shadowed_gated_we;
    reg_we_check[317] = classa_crashdump_trigger_shadowed_gated_we;
    reg_we_check[318] = classa_phase0_cyc_shadowed_gated_we;
    reg_we_check[319] = classa_phase1_cyc_shadowed_gated_we;
    reg_we_check[320] = classa_phase2_cyc_shadowed_gated_we;
    reg_we_check[321] = classa_phase3_cyc_shadowed_gated_we;
    reg_we_check[322] = 1'b0;
    reg_we_check[323] = 1'b0;
    reg_we_check[324] = classb_regwen_we;
    reg_we_check[325] = classb_ctrl_shadowed_gated_we;
    reg_we_check[326] = classb_clr_regwen_we;
    reg_we_check[327] = classb_clr_shadowed_gated_we;
    reg_we_check[328] = 1'b0;
    reg_we_check[329] = classb_accum_thresh_shadowed_gated_we;
    reg_we_check[330] = classb_timeout_cyc_shadowed_gated_we;
    reg_we_check[331] = classb_crashdump_trigger_shadowed_gated_we;
    reg_we_check[332] = classb_phase0_cyc_shadowed_gated_we;
    reg_we_check[333] = classb_phase1_cyc_shadowed_gated_we;
    reg_we_check[334] = classb_phase2_cyc_shadowed_gated_we;
    reg_we_check[335] = classb_phase3_cyc_shadowed_gated_we;
    reg_we_check[336] = 1'b0;
    reg_we_check[337] = 1'b0;
    reg_we_check[338] = classc_regwen_we;
    reg_we_check[339] = classc_ctrl_shadowed_gated_we;
    reg_we_check[340] = classc_clr_regwen_we;
    reg_we_check[341] = classc_clr_shadowed_gated_we;
    reg_we_check[342] = 1'b0;
    reg_we_check[343] = classc_accum_thresh_shadowed_gated_we;
    reg_we_check[344] = classc_timeout_cyc_shadowed_gated_we;
    reg_we_check[345] = classc_crashdump_trigger_shadowed_gated_we;
    reg_we_check[346] = classc_phase0_cyc_shadowed_gated_we;
    reg_we_check[347] = classc_phase1_cyc_shadowed_gated_we;
    reg_we_check[348] = classc_phase2_cyc_shadowed_gated_we;
    reg_we_check[349] = classc_phase3_cyc_shadowed_gated_we;
    reg_we_check[350] = 1'b0;
    reg_we_check[351] = 1'b0;
    reg_we_check[352] = classd_regwen_we;
    reg_we_check[353] = classd_ctrl_shadowed_gated_we;
    reg_we_check[354] = classd_clr_regwen_we;
    reg_we_check[355] = classd_clr_shadowed_gated_we;
    reg_we_check[356] = 1'b0;
    reg_we_check[357] = classd_accum_thresh_shadowed_gated_we;
    reg_we_check[358] = classd_timeout_cyc_shadowed_gated_we;
    reg_we_check[359] = classd_crashdump_trigger_shadowed_gated_we;
    reg_we_check[360] = classd_phase0_cyc_shadowed_gated_we;
    reg_we_check[361] = classd_phase1_cyc_shadowed_gated_we;
    reg_we_check[362] = classd_phase2_cyc_shadowed_gated_we;
    reg_we_check[363] = classd_phase3_cyc_shadowed_gated_we;
