...
module alert_handler_esc_timer_assert_fpv import alert_handler_pkg::*; (
  ...
  `OCAH_OT_ASSERT(ClassDisabledNoEsc_A, esc_state_o == Idle && !en_i && !alert_handler_esc_timer.fsm_error
          |-> !esc_sig_req_o)
  `OCAH_OT_ASSERT(EscDisabledNoEsc_A, !esc_en_i[esc_sel] && !alert_handler_esc_timer.fsm_error |->
  ...
  `OCAH_OT_ASSERT(EscCntOut_A, alert_handler_esc_timer.u_prim_count.cnt_q[0] == esc_cnt_o)
