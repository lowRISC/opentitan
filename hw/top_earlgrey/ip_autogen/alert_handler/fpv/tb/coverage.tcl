...
assert -name FSMParasiticState::AlertSenderFSMParasiticState_A {!(i_prim_alert_sender.state_q inside  {3'b000, 3'b001, 3'b010, 3'b011, 3'b100, 3'b101, 3'b110}) ->  i_prim_alert_sender.state_d == Idle}

# For alert_receiver, this works slightly different. We should consider integrity failure and
# initialization request as well.
assert -name FSMParasiticState::AlertReceiverFSMParasiticState_A {!(i_prim_alert_receiver.state_q inside  {3'b000, 3'b001, 3'b010, 3'b011, 3'b100, 3'b101, 3'b110}) ->  i_prim_alert_receiver.state_d inside {Idle, InitReq}}
