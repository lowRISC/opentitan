...
class otp_ctrl_scoreboard #(type CFG_T = otp_ctrl_env_cfg)
  ...
  bit [TL_DW-1:0] exp_partition_status[1], partition_status_mask[1];
    ...
    if (addr inside {
      ...
      if (`gmv(ral.creator_sw_cfg_read_lock) == 0 ||
        ...
        if (addr inside {
          ...
          predict_err(OtpPartitionErrorIdx,
                      OtpPartitionCreatorSwCfgErrIdx,
                      OtpAccessError);
          custom_err = 1;
          if (cfg.en_cov) begin
      ...
      if (`gmv(ral.rot_creator_auth_codesign_read_lock) == 0 ||
        ...
        if (addr inside {
          ...
          predict_err(OtpPartitionErrorIdx,
                      OtpPartitionRotCreatorAuthCodesignErrIdx,
                      OtpAccessError);
          custom_err = 1;
          if (cfg.en_cov) begin
      ...
      if (`gmv(ral.rot_creator_auth_state_read_lock) == 0 ||
        ...
        if (addr inside {
          ...
          predict_err(OtpPartitionErrorIdx,
                      OtpPartitionRotCreatorAuthStateErrIdx,
                      OtpAccessError);
          custom_err = 1;
          if (cfg.en_cov) begin
