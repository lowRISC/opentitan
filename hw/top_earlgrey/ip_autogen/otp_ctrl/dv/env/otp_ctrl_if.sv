...
interface otp_ctrl_if(input clk_i, input rst_ni);
  ...
  lc_ctrl_pkg::lc_tx_t    lc_dft_en_i, lc_escalate_en_i, lc_check_byp_en_i,
                          ...
                          lc_seed_hw_rd_en_i, lc_rma_sw_rd_override_en_i;
  ...
  function automatic void drive_lc_rma_sw_rd_override_en(lc_ctrl_pkg::lc_tx_t val);
    lc_rma_sw_rd_override_en_i = val;
  endfunction
