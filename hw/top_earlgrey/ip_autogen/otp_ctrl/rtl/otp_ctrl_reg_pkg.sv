...
package otp_ctrl_reg_pkg;
  ...
  parameter int CreatorSwCfgRngAdaptpsThresholdsOffset = 364;
  parameter int CreatorSwCfgRngAdaptpsThresholdsSize = 4;
  parameter int CreatorSwCfgRngBucketThresholdsOffset = 368;
  parameter int CreatorSwCfgRngBucketThresholdsSize = 4;
  parameter int CreatorSwCfgRngMarkovHiThresholdsOffset = 372;
  parameter int CreatorSwCfgRngMarkovHiThresholdsSize = 4;
  parameter int CreatorSwCfgRngMarkovLoThresholdsOffset = 376;
  parameter int CreatorSwCfgRngMarkovLoThresholdsSize = 4;
  parameter int CreatorSwCfgRngExthtHiThresholdsOffset = 380;
  parameter int CreatorSwCfgRngExthtHiThresholdsSize = 4;
  parameter int CreatorSwCfgRngExthtLoThresholdsOffset = 384;
  parameter int CreatorSwCfgRngExthtLoThresholdsSize = 4;
  parameter int CreatorSwCfgRngBootAlertThresholdOffset = 388;
  parameter int CreatorSwCfgRngBootAlertThresholdSize = 4;
  parameter int CreatorSwCfgRngFipsAlertThresholdOffset = 392;
  parameter int CreatorSwCfgRngFipsAlertThresholdSize = 4;
  parameter int CreatorSwCfgRngBootConfigDigestOffset = 396;
  parameter int CreatorSwCfgRngBootConfigDigestSize = 4;
  parameter int CreatorSwCfgRngFipsConfigDigestOffset = 400;
  parameter int CreatorSwCfgRngFipsConfigDigestSize = 4;
  parameter int CreatorSwCfgSramKeyRenewAndInitEnOffset = 404;
  parameter int CreatorSwCfgSramKeyRenewAndInitEnSize = 4;
  parameter int CreatorSwCfgImmutableRomExtEnOffset = 408;
  parameter int CreatorSwCfgImmutableRomExtEnSize = 4;
  parameter int CreatorSwCfgImmutableRomExtStartOffsetOffset = 412;
  parameter int CreatorSwCfgImmutableRomExtStartOffsetSize = 4;
  parameter int CreatorSwCfgImmutableRomExtLengthOffset = 416;
  parameter int CreatorSwCfgImmutableRomExtLengthSize = 4;
  parameter int CreatorSwCfgImmutableRomExtSha256HashOffset = 420;
  ...
  parameter int OwnerSwCfgSize = 672;
  ...
  parameter int NvmAddrKeySeedOffset = 1784;
  parameter int NvmAddrKeySeedSize = 32;
  parameter int NvmDataKeySeedOffset = 1816;
