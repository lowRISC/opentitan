...
package otp_ctrl_reg_pkg;
  ...
  parameter int CreatorSwCfgSize = 400;
  ...
  parameter int CreatorSwCfgDigestOffset = 456;
  parameter int CreatorSwCfgDigestSize = 8;
  parameter int OwnerSwCfgOffset = 464;
  parameter int OwnerSwCfgSize = 680;
  parameter int OwnerSwCfgRomErrorReportingOffset = 464;
  parameter int OwnerSwCfgRomErrorReportingSize = 4;
  parameter int OwnerSwCfgRomBootstrapDisOffset = 468;
  parameter int OwnerSwCfgRomBootstrapDisSize = 4;
  parameter int OwnerSwCfgRomAlertClassEnOffset = 472;
  parameter int OwnerSwCfgRomAlertClassEnSize = 4;
  parameter int OwnerSwCfgRomAlertEscalationOffset = 476;
  parameter int OwnerSwCfgRomAlertEscalationSize = 4;
  parameter int OwnerSwCfgRomAlertClassificationOffset = 480;
  ...
  parameter int OwnerSwCfgRomKeymgrOtpMeasEnOffset = 980;
  ...
  parameter int OwnerSwCfgRomExtBootstrapEnOffset = 992;
  parameter int OwnerSwCfgRomExtBootstrapEnSize = 4;
  parameter int OwnerSwCfgRomSensorCtrlAlertCfgOffset = 996;
  parameter int OwnerSwCfgRomSensorCtrlAlertCfgSize = 12;
  parameter int OwnerSwCfgRomSramReadbackEnOffset = 1008;
  parameter int OwnerSwCfgRomSramReadbackEnSize = 4;
  parameter int OwnerSwCfgRomPreserveResetReasonEnOffset = 1012;
  parameter int OwnerSwCfgRomPreserveResetReasonEnSize = 4;
  parameter int OwnerSwCfgRomResetReasonCheckValueOffset = 1016;
  parameter int OwnerSwCfgRomResetReasonCheckValueSize = 4;
  parameter int OwnerSwCfgRomBannerEnOffset = 1020;
  parameter int OwnerSwCfgRomBannerEnSize = 4;
  parameter int OwnerSwCfgRomNvmEccExcHandlerEnOffset = 1024;
  parameter int OwnerSwCfgRomNvmEccExcHandlerEnSize = 4;
  parameter int OwnerSwCfgReservedOffset = 1028;
