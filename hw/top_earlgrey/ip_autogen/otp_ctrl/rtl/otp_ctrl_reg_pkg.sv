...
package otp_ctrl_reg_pkg;
  ...
  parameter int CreatorSwCfgSize = 1416;
  ...
  parameter int CreatorSwCfgDigestOffset = 1472;
  parameter int CreatorSwCfgDigestSize = 8;
  parameter int OwnerSwCfgOffset = 1480;
  parameter int OwnerSwCfgSize = 1688;
  parameter int OwnerSwCfgRomErrorReportingOffset = 1480;
  parameter int OwnerSwCfgRomErrorReportingSize = 4;
  parameter int OwnerSwCfgRomBootstrapDisOffset = 1484;
  parameter int OwnerSwCfgRomBootstrapDisSize = 4;
  parameter int OwnerSwCfgRomAlertClassEnOffset = 1488;
  parameter int OwnerSwCfgRomAlertClassEnSize = 4;
  parameter int OwnerSwCfgRomAlertEscalationOffset = 1492;
  parameter int OwnerSwCfgRomAlertEscalationSize = 4;
  parameter int OwnerSwCfgRomAlertClassificationOffset = 1496;
  parameter int OwnerSwCfgRomAlertClassificationSize = 320;
  parameter int OwnerSwCfgRomLocalAlertClassificationOffset = 1816;
  parameter int OwnerSwCfgRomLocalAlertClassificationSize = 64;
  parameter int OwnerSwCfgRomAlertAccumThreshOffset = 1880;
  parameter int OwnerSwCfgRomAlertAccumThreshSize = 16;
  parameter int OwnerSwCfgRomAlertTimeoutCyclesOffset = 1896;
  parameter int OwnerSwCfgRomAlertTimeoutCyclesSize = 16;
  parameter int OwnerSwCfgRomAlertPhaseCyclesOffset = 1912;
  parameter int OwnerSwCfgRomAlertPhaseCyclesSize = 64;
  parameter int OwnerSwCfgRomAlertDigestProdOffset = 1976;
  parameter int OwnerSwCfgRomAlertDigestProdSize = 4;
  parameter int OwnerSwCfgRomAlertDigestProdEndOffset = 1980;
  parameter int OwnerSwCfgRomAlertDigestProdEndSize = 4;
  parameter int OwnerSwCfgRomAlertDigestDevOffset = 1984;
  parameter int OwnerSwCfgRomAlertDigestDevSize = 4;
  parameter int OwnerSwCfgRomAlertDigestRmaOffset = 1988;
  parameter int OwnerSwCfgRomAlertDigestRmaSize = 4;
  parameter int OwnerSwCfgRomWatchdogBiteThresholdCyclesOffset = 1992;
  parameter int OwnerSwCfgRomWatchdogBiteThresholdCyclesSize = 4;
  parameter int OwnerSwCfgRomKeymgrOtpMeasEnOffset = 1996;
  parameter int OwnerSwCfgRomKeymgrOtpMeasEnSize = 4;
  parameter int OwnerSwCfgManufStateOffset = 2000;
  parameter int OwnerSwCfgManufStateSize = 4;
  parameter int OwnerSwCfgRomRstmgrInfoEnOffset = 2004;
  parameter int OwnerSwCfgRomRstmgrInfoEnSize = 4;
  parameter int OwnerSwCfgRomExtBootstrapEnOffset = 2008;
  parameter int OwnerSwCfgRomExtBootstrapEnSize = 4;
  parameter int OwnerSwCfgRomSensorCtrlAlertCfgOffset = 2012;
  parameter int OwnerSwCfgRomSensorCtrlAlertCfgSize = 12;
  parameter int OwnerSwCfgRomSramReadbackEnOffset = 2024;
  parameter int OwnerSwCfgRomSramReadbackEnSize = 4;
  parameter int OwnerSwCfgRomPreserveResetReasonEnOffset = 2028;
  parameter int OwnerSwCfgRomPreserveResetReasonEnSize = 4;
  parameter int OwnerSwCfgRomResetReasonCheckValueOffset = 2032;
  parameter int OwnerSwCfgRomResetReasonCheckValueSize = 4;
  parameter int OwnerSwCfgRomBannerEnOffset = 2036;
  parameter int OwnerSwCfgRomBannerEnSize = 4;
  parameter int OwnerSwCfgRomNvmEccExcHandlerEnOffset = 2040;
  parameter int OwnerSwCfgRomNvmEccExcHandlerEnSize = 4;
  parameter int OwnerSwCfgReservedOffset = 2044;
  parameter int OwnerSwCfgReservedSize = 96;
  parameter int OwnerSwCfgDigestOffset = 3160;
  parameter int OwnerSwCfgDigestSize = 8;
  parameter int RotCreatorAuthCodesignOffset = 3168;
  parameter int RotCreatorAuthCodesignSize = 472;
  parameter int RotCreatorAuthCodesignEcdsaKeyType0Offset = 3168;
  parameter int RotCreatorAuthCodesignEcdsaKeyType0Size = 4;
  parameter int RotCreatorAuthCodesignEcdsaKey0Offset = 3172;
  parameter int RotCreatorAuthCodesignEcdsaKey0Size = 64;
  parameter int RotCreatorAuthCodesignEcdsaKeyType1Offset = 3236;
  parameter int RotCreatorAuthCodesignEcdsaKeyType1Size = 4;
  parameter int RotCreatorAuthCodesignEcdsaKey1Offset = 3240;
  parameter int RotCreatorAuthCodesignEcdsaKey1Size = 64;
  parameter int RotCreatorAuthCodesignEcdsaKeyType2Offset = 3304;
  parameter int RotCreatorAuthCodesignEcdsaKeyType2Size = 4;
  parameter int RotCreatorAuthCodesignEcdsaKey2Offset = 3308;
  parameter int RotCreatorAuthCodesignEcdsaKey2Size = 64;
  parameter int RotCreatorAuthCodesignEcdsaKeyType3Offset = 3372;
  parameter int RotCreatorAuthCodesignEcdsaKeyType3Size = 4;
  parameter int RotCreatorAuthCodesignEcdsaKey3Offset = 3376;
  parameter int RotCreatorAuthCodesignEcdsaKey3Size = 64;
  parameter int RotCreatorAuthCodesignSpxKeyType0Offset = 3440;
  parameter int RotCreatorAuthCodesignSpxKeyType0Size = 4;
  parameter int RotCreatorAuthCodesignSpxKey0Offset = 3444;
  parameter int RotCreatorAuthCodesignSpxKey0Size = 32;
  parameter int RotCreatorAuthCodesignSpxKeyConfig0Offset = 3476;
  parameter int RotCreatorAuthCodesignSpxKeyConfig0Size = 4;
  parameter int RotCreatorAuthCodesignSpxKeyType1Offset = 3480;
  parameter int RotCreatorAuthCodesignSpxKeyType1Size = 4;
  parameter int RotCreatorAuthCodesignSpxKey1Offset = 3484;
  parameter int RotCreatorAuthCodesignSpxKey1Size = 32;
  parameter int RotCreatorAuthCodesignSpxKeyConfig1Offset = 3516;
  parameter int RotCreatorAuthCodesignSpxKeyConfig1Size = 4;
  parameter int RotCreatorAuthCodesignSpxKeyType2Offset = 3520;
  parameter int RotCreatorAuthCodesignSpxKeyType2Size = 4;
  parameter int RotCreatorAuthCodesignSpxKey2Offset = 3524;
  parameter int RotCreatorAuthCodesignSpxKey2Size = 32;
  parameter int RotCreatorAuthCodesignSpxKeyConfig2Offset = 3556;
  parameter int RotCreatorAuthCodesignSpxKeyConfig2Size = 4;
  parameter int RotCreatorAuthCodesignSpxKeyType3Offset = 3560;
  parameter int RotCreatorAuthCodesignSpxKeyType3Size = 4;
  parameter int RotCreatorAuthCodesignSpxKey3Offset = 3564;
  parameter int RotCreatorAuthCodesignSpxKey3Size = 32;
  parameter int RotCreatorAuthCodesignSpxKeyConfig3Offset = 3596;
  parameter int RotCreatorAuthCodesignSpxKeyConfig3Size = 4;
  parameter int RotCreatorAuthCodesignBlockSha2_256HashOffset = 3600;
  parameter int RotCreatorAuthCodesignBlockSha2_256HashSize = 32;
  parameter int RotCreatorAuthCodesignDigestOffset = 3632;
  parameter int RotCreatorAuthCodesignDigestSize = 8;
  parameter int RotCreatorAuthStateOffset = 3640;
  parameter int RotCreatorAuthStateSize = 40;
  parameter int RotCreatorAuthStateEcdsaKey0Offset = 3640;
  parameter int RotCreatorAuthStateEcdsaKey0Size = 4;
  parameter int RotCreatorAuthStateEcdsaKey1Offset = 3644;
  parameter int RotCreatorAuthStateEcdsaKey1Size = 4;
  parameter int RotCreatorAuthStateEcdsaKey2Offset = 3648;
  parameter int RotCreatorAuthStateEcdsaKey2Size = 4;
  parameter int RotCreatorAuthStateEcdsaKey3Offset = 3652;
  parameter int RotCreatorAuthStateEcdsaKey3Size = 4;
  parameter int RotCreatorAuthStateSpxKey0Offset = 3656;
  parameter int RotCreatorAuthStateSpxKey0Size = 4;
  parameter int RotCreatorAuthStateSpxKey1Offset = 3660;
  parameter int RotCreatorAuthStateSpxKey1Size = 4;
  parameter int RotCreatorAuthStateSpxKey2Offset = 3664;
  parameter int RotCreatorAuthStateSpxKey2Size = 4;
  parameter int RotCreatorAuthStateSpxKey3Offset = 3668;
  parameter int RotCreatorAuthStateSpxKey3Size = 4;
  parameter int RotCreatorAuthStateDigestOffset = 3672;
  parameter int RotCreatorAuthStateDigestSize = 8;
  parameter int HwCfg0Offset = 3680;
  parameter int HwCfg0Size = 72;
  parameter int DeviceIdOffset = 3680;
  parameter int DeviceIdSize = 32;
  parameter int ManufStateOffset = 3712;
  parameter int ManufStateSize = 32;
  parameter int HwCfg0DigestOffset = 3744;
  parameter int HwCfg0DigestSize = 8;
  parameter int HwCfg1Offset = 3752;
  parameter int HwCfg1Size = 16;
  parameter int EnSramIfetchOffset = 3752;
  parameter int EnSramIfetchSize = 1;
  parameter int EnCsrngSwAppReadOffset = 3753;
  parameter int EnCsrngSwAppReadSize = 1;
  parameter int DisRvDmLateDebugOffset = 3754;
  parameter int DisRvDmLateDebugSize = 1;
  parameter int HwCfg1DigestOffset = 3760;
  parameter int HwCfg1DigestSize = 8;
  parameter int Secret0Offset = 3768;
  parameter int Secret0Size = 48;
  parameter int TestUnlockTokenOffset = 3768;
  parameter int TestUnlockTokenSize = 16;
  parameter int TestExitTokenOffset = 3784;
  parameter int TestExitTokenSize = 16;
  parameter int Secret0DigestOffset = 3800;
  parameter int Secret0DigestSize = 8;
  parameter int Secret0ZerOffset = 3808;
  parameter int Secret0ZerSize = 8;
  parameter int Secret1Offset = 3816;
  parameter int Secret1Size = 96;
  parameter int NvmAddrKeySeedOffset = 3816;
  parameter int NvmAddrKeySeedSize = 32;
  parameter int NvmDataKeySeedOffset = 3848;
  parameter int NvmDataKeySeedSize = 32;
  parameter int SramDataKeySeedOffset = 3880;
  parameter int SramDataKeySeedSize = 16;
  parameter int Secret1DigestOffset = 3896;
  parameter int Secret1DigestSize = 8;
  parameter int Secret1ZerOffset = 3904;
  parameter int Secret1ZerSize = 8;
  parameter int Secret2Offset = 3912;
  parameter int Secret2Size = 96;
  parameter int RmaTokenOffset = 3912;
  parameter int RmaTokenSize = 16;
  parameter int CreatorRootKeyShare0Offset = 3928;
  parameter int CreatorRootKeyShare0Size = 32;
  parameter int CreatorRootKeyShare1Offset = 3960;
  parameter int CreatorRootKeyShare1Size = 32;
  parameter int Secret2DigestOffset = 3992;
  parameter int Secret2DigestSize = 8;
  parameter int Secret2ZerOffset = 4000;
