...
package otp_ctrl_reg_pkg;
  ...
  parameter int CreatorSwCfgFlashDataDefaultCfgOffset = 292;
  parameter int CreatorSwCfgFlashDataDefaultCfgSize = 4;
  parameter int CreatorSwCfgFlashInfoBootDataCfgOffset = 296;
  parameter int CreatorSwCfgFlashInfoBootDataCfgSize = 4;
  parameter int CreatorSwCfgFlashHwInfoCfgOverrideOffset = 300;
  ...
  parameter int OwnerSwCfgRomFlashEccExcHandlerEnOffset = 1024;
