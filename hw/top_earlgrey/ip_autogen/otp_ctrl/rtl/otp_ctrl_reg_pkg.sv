...
package otp_ctrl_reg_pkg;
  ...
  parameter int CreatorSwCfgRngHealthTestWindowsOffset = 288;
  parameter int CreatorSwCfgRngHealthTestWindowsSize = 4;
  parameter int CreatorSwCfgRngRepcntThresholdsOffset = 292;
  parameter int CreatorSwCfgRngRepcntThresholdsSize = 4;
  parameter int CreatorSwCfgRngRepcntsThresholdsOffset = 296;
  parameter int CreatorSwCfgRngRepcntsThresholdsSize = 4;
  parameter int CreatorSwCfgRngAdaptpHiThresholdsOffset = 300;
  parameter int CreatorSwCfgRngAdaptpHiThresholdsSize = 4;
  parameter int CreatorSwCfgRngAdaptpLoThresholdsOffset = 304;
  parameter int CreatorSwCfgRngAdaptpLoThresholdsSize = 4;
  parameter int CreatorSwCfgRngBucketThresholdsOffset = 308;
  parameter int CreatorSwCfgRngBucketThresholdsSize = 4;
  parameter int CreatorSwCfgRngMarkovHiThresholdsOffset = 312;
  parameter int CreatorSwCfgRngMarkovHiThresholdsSize = 4;
  parameter int CreatorSwCfgRngMarkovLoThresholdsOffset = 316;
  parameter int CreatorSwCfgRngMarkovLoThresholdsSize = 4;
  parameter int CreatorSwCfgRngExthtHiThresholdsOffset = 320;
  parameter int CreatorSwCfgRngExthtHiThresholdsSize = 4;
  parameter int CreatorSwCfgRngExthtLoThresholdsOffset = 324;
  parameter int CreatorSwCfgRngExthtLoThresholdsSize = 4;
  parameter int CreatorSwCfgRngAlertThresholdOffset = 328;
  parameter int CreatorSwCfgRngAlertThresholdSize = 4;
  parameter int CreatorSwCfgRngHealthConfigDigestOffset = 332;
  parameter int CreatorSwCfgRngHealthConfigDigestSize = 4;
  parameter int CreatorSwCfgSramKeyRenewEnOffset = 336;
  parameter int CreatorSwCfgSramKeyRenewEnSize = 4;
  parameter int CreatorSwCfgImmutableRomExtEnOffset = 340;
  parameter int CreatorSwCfgImmutableRomExtEnSize = 4;
  parameter int CreatorSwCfgImmutableRomExtStartOffsetOffset = 344;
  parameter int CreatorSwCfgImmutableRomExtStartOffsetSize = 4;
  parameter int CreatorSwCfgImmutableRomExtLengthOffset = 348;
  parameter int CreatorSwCfgImmutableRomExtLengthSize = 4;
  parameter int CreatorSwCfgImmutableRomExtSha256HashOffset = 352;
  parameter int CreatorSwCfgImmutableRomExtSha256HashSize = 32;
  parameter int CreatorSwCfgReservedOffset = 384;
