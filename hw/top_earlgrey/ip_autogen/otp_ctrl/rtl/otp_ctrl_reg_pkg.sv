...
package otp_ctrl_reg_pkg;
  ...
  typedef struct packed {
    ...
    otp_ctrl_hw2reg_partition_status_reg_t partition_status; // [754:744]
  ...
  parameter logic [CoreAw-1:0] OTP_CTRL_PARTITION_STATUS_OFFSET = 12'h 14;
  ...
  parameter logic [10:0] OTP_CTRL_PARTITION_STATUS_RESVAL = 11'h 0;
  ...
  parameter logic [0:0] OTP_CTRL_PARTITION_STATUS_ROT_CREATOR_AUTH_CODESIGN_ERROR_RESVAL = 1'h 0;
  parameter logic [0:0] OTP_CTRL_PARTITION_STATUS_ROT_CREATOR_AUTH_STATE_ERROR_RESVAL = 1'h 0;
  ...
  parameter logic [3:0] OTP_CTRL_CORE_PERMIT [57] = '{
    ...
    4'b 0011, // index[ 5] OTP_CTRL_PARTITION_STATUS
