...
module otp_ctrl_core_reg_top (
  ...
  logic partition_status_error_0_qs;
  logic partition_status_error_1_qs;
  logic partition_status_error_2_qs;
  logic partition_status_error_3_qs;
  logic partition_status_error_4_qs;
  logic partition_status_error_5_qs;
  logic partition_status_error_6_qs;
  logic partition_status_error_7_qs;
  logic partition_status_error_8_qs;
  logic partition_status_error_9_qs;
  logic partition_status_error_10_qs;
  logic err_code_0_re;
  ...
  // Subregister 0 of Multireg partition_status
  // R[partition_status]: V(True)
  //   F[error_0]: 0:0
  prim_subreg_ext #(
    .DW    (1)
  ) u_partition_status_error_0 (
    .re     (partition_status_re),
    .we     (1'b0),
    .wd     ('0),
    .d      (hw2reg.partition_status[0].d),
    .qre    (),
    .qe     (),
    .q      (),
    .ds     (),
    .qs     (partition_status_error_0_qs)
  );

  //   F[error_1]: 1:1
  prim_subreg_ext #(
    .DW    (1)
  ) u_partition_status_error_1 (
    .re     (partition_status_re),
    .we     (1'b0),
    .wd     ('0),
    .d      (hw2reg.partition_status[1].d),
    .qre    (),
    .qe     (),
    .q      (),
    .ds     (),
    .qs     (partition_status_error_1_qs)
  );

  //   F[error_2]: 2:2
  prim_subreg_ext #(
    .DW    (1)
  ) u_partition_status_error_2 (
    .re     (partition_status_re),
    .we     (1'b0),
    .wd     ('0),
    .d      (hw2reg.partition_status[2].d),
    .qre    (),
    .qe     (),
    .q      (),
    .ds     (),
    .qs     (partition_status_error_2_qs)
  );

  //   F[error_3]: 3:3
  prim_subreg_ext #(
    .DW    (1)
  ) u_partition_status_error_3 (
    .re     (partition_status_re),
    .we     (1'b0),
    .wd     ('0),
    .d      (hw2reg.partition_status[3].d),
    .qre    (),
    .qe     (),
    .q      (),
    .ds     (),
    .qs     (partition_status_error_3_qs)
  );

  //   F[error_4]: 4:4
  prim_subreg_ext #(
    .DW    (1)
  ) u_partition_status_error_4 (
    .re     (partition_status_re),
    .we     (1'b0),
    .wd     ('0),
    .d      (hw2reg.partition_status[4].d),
    .qre    (),
    .qe     (),
    .q      (),
    .ds     (),
    .qs     (partition_status_error_4_qs)
  );

  //   F[error_5]: 5:5
  prim_subreg_ext #(
    .DW    (1)
  ) u_partition_status_error_5 (
    .re     (partition_status_re),
    .we     (1'b0),
    .wd     ('0),
    .d      (hw2reg.partition_status[5].d),
    .qre    (),
    .qe     (),
    .q      (),
    .ds     (),
    .qs     (partition_status_error_5_qs)
  );

  //   F[error_6]: 6:6
  prim_subreg_ext #(
    .DW    (1)
  ) u_partition_status_error_6 (
    .re     (partition_status_re),
    .we     (1'b0),
    .wd     ('0),
    .d      (hw2reg.partition_status[6].d),
    .qre    (),
    .qe     (),
    .q      (),
    .ds     (),
    .qs     (partition_status_error_6_qs)
  );

  //   F[error_7]: 7:7
  prim_subreg_ext #(
    .DW    (1)
  ) u_partition_status_error_7 (
    .re     (partition_status_re),
    .we     (1'b0),
    .wd     ('0),
    .d      (hw2reg.partition_status[7].d),
    .qre    (),
    .qe     (),
    .q      (),
    .ds     (),
    .qs     (partition_status_error_7_qs)
  );

  //   F[error_8]: 8:8
  prim_subreg_ext #(
    .DW    (1)
  ) u_partition_status_error_8 (
    .re     (partition_status_re),
    .we     (1'b0),
    .wd     ('0),
    .d      (hw2reg.partition_status[8].d),
    .qre    (),
    .qe     (),
    .q      (),
    .ds     (),
    .qs     (partition_status_error_8_qs)
  );

  //   F[error_9]: 9:9
  prim_subreg_ext #(
    .DW    (1)
  ) u_partition_status_error_9 (
    .re     (partition_status_re),
    .we     (1'b0),
    .wd     ('0),
    .d      (hw2reg.partition_status[9].d),
    .qre    (),
    .qe     (),
    .q      (),
    .ds     (),
    .qs     (partition_status_error_9_qs)
  );

  //   F[error_10]: 10:10
  prim_subreg_ext #(
    .DW    (1)
  ) u_partition_status_error_10 (
    .re     (partition_status_re),
    .we     (1'b0),
    .wd     ('0),
    .d      (hw2reg.partition_status[10].d),
    .qre    (),
    .qe     (),
    .q      (),
    .ds     (),
    .qs     (partition_status_error_10_qs)
  );
  ...
  always_comb begin
    ...
    unique case (1'b1)
      ...
      addr_hit[5]: begin
        reg_rdata_next[0] = partition_status_error_0_qs;
        reg_rdata_next[1] = partition_status_error_1_qs;
        reg_rdata_next[2] = partition_status_error_2_qs;
        reg_rdata_next[3] = partition_status_error_3_qs;
        reg_rdata_next[4] = partition_status_error_4_qs;
        reg_rdata_next[5] = partition_status_error_5_qs;
        reg_rdata_next[6] = partition_status_error_6_qs;
        reg_rdata_next[7] = partition_status_error_7_qs;
        reg_rdata_next[8] = partition_status_error_8_qs;
        reg_rdata_next[9] = partition_status_error_9_qs;
        reg_rdata_next[10] = partition_status_error_10_qs;
      end
