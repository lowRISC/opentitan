...
#(
  ...
  `OCAH_OT_ASSERT_INIT(ScrmblKeyNotAllZero_A0, RndCnstScrmblKey0 != 0)
  `OCAH_OT_ASSERT_INIT(ScrmblKeyNotAllZero_A1, RndCnstScrmblKey1 != 0)
  `OCAH_OT_ASSERT_INIT(ScrmblKeyNotAllZero_A2, RndCnstScrmblKey2 != 0)
  `OCAH_OT_ASSERT_INIT(DigestConstNotAllZero_A0, RndCnstDigestConst0 != 0)
  `OCAH_OT_ASSERT_INIT(DigestIVNotAllZero_A0, RndCnstDigestIV0 != 0)
  `OCAH_OT_ASSERT_INIT(DigestConstNotAllZero_A1, RndCnstDigestConst1 != 0)
  `OCAH_OT_ASSERT_INIT(DigestIVNotAllZero_A1, RndCnstDigestIV1 != 0)
  `OCAH_OT_ASSERT_INIT(DigestConstNotAllZero_A2, RndCnstDigestConst2 != 0)
  `OCAH_OT_ASSERT_INIT(DigestIVNotAllZero_A2, RndCnstDigestIV2 != 0)
  `OCAH_OT_ASSERT_INIT(DigestConstNotAllZero_A3, RndCnstDigestConst3 != 0)
  `OCAH_OT_ASSERT_INIT(DigestIVNotAllZero_A3, RndCnstDigestIV3 != 0)
