...
| otp_ctrl.[`PARTITION_STATUS`](#PARTITION_STATUS)                                       | 0x14     |        4 | OTP partition status register for each partitions.                                                  |
...
| otp_ctrl.[`CHECK_TRIGGER_REGWEN`](#check_trigger_regwen)                               | 0x68     |        4 | Register write enable for !!CHECK_TRIGGER.                                                          |
| otp_ctrl.[`CHECK_TRIGGER`](#check_trigger)                                             | 0x6c     |        4 | Command register for direct accesses.                                                               |
| otp_ctrl.[`CHECK_REGWEN`](#check_regwen)                                               | 0x70     |        4 | Register write enable for !!INTEGRITY_CHECK_PERIOD and !!CONSISTENCY_CHECK_PERIOD.                  |
...
## PARTITION_STATUS
OTP partition status register for each partitions.
- Offset: `0x14`
- Reset default: `0x0`
- Reset mask: `0x7ff`
...
```wavejson
{"reg": [{"name": "ERROR_0", "bits": 1, "attr": ["ro"], "rotate": -90}, {"name": "ERROR_1", "bits": 1, "attr": ["ro"], "rotate": -90}, {"name": "ERROR_2", "bits": 1, "attr": ["ro"], "rotate": -90}, {"name": "ERROR_3", "bits": 1, "attr": ["ro"], "rotate": -90}, {"name": "ERROR_4", "bits": 1, "attr": ["ro"], "rotate": -90}, {"name": "ERROR_5", "bits": 1, "attr": ["ro"], "rotate": -90}, {"name": "ERROR_6", "bits": 1, "attr": ["ro"], "rotate": -90}, {"name": "ERROR_7", "bits": 1, "attr": ["ro"], "rotate": -90}, {"name": "ERROR_8", "bits": 1, "attr": ["ro"], "rotate": -90}, {"name": "ERROR_9", "bits": 1, "attr": ["ro"], "rotate": -90}, {"name": "ERROR_10", "bits": 1, "attr": ["ro"], "rotate": -90}, {"bits": 21}], "config": {"lanes": 1, "fontsize": 10, "vspace": 100}}
```

|  Bits  |  Type  |  Reset  | Name     | Description                                                                                                                                    |
|:------:|:------:|:-------:|:---------|:-----------------------------------------------------------------------------------------------------------------------------------------------|
| 31:11  |        |         |          | Reserved                                                                                                                                       |
|   10   |   ro   |   0x0   | ERROR_10 | Set to 1 if an error occurred in this partition. If set to 1, SW should check the [`ERR_CODE`](#err_code) register at the corresponding index. |
|   9    |   ro   |   0x0   | ERROR_9  | Set to 1 if an error occurred in this partition. If set to 1, SW should check the [`ERR_CODE`](#err_code) register at the corresponding index. |
|   8    |   ro   |   0x0   | ERROR_8  | Set to 1 if an error occurred in this partition. If set to 1, SW should check the [`ERR_CODE`](#err_code) register at the corresponding index. |
|   7    |   ro   |   0x0   | ERROR_7  | Set to 1 if an error occurred in this partition. If set to 1, SW should check the [`ERR_CODE`](#err_code) register at the corresponding index. |
|   6    |   ro   |   0x0   | ERROR_6  | Set to 1 if an error occurred in this partition. If set to 1, SW should check the [`ERR_CODE`](#err_code) register at the corresponding index. |
|   5    |   ro   |   0x0   | ERROR_5  | Set to 1 if an error occurred in this partition. If set to 1, SW should check the [`ERR_CODE`](#err_code) register at the corresponding index. |
|   4    |   ro   |   0x0   | ERROR_4  | Set to 1 if an error occurred in this partition. If set to 1, SW should check the [`ERR_CODE`](#err_code) register at the corresponding index. |
|   3    |   ro   |   0x0   | ERROR_3  | Set to 1 if an error occurred in this partition. If set to 1, SW should check the [`ERR_CODE`](#err_code) register at the corresponding index. |
|   2    |   ro   |   0x0   | ERROR_2  | Set to 1 if an error occurred in this partition. If set to 1, SW should check the [`ERR_CODE`](#err_code) register at the corresponding index. |
|   1    |   ro   |   0x0   | ERROR_1  | Set to 1 if an error occurred in this partition. If set to 1, SW should check the [`ERR_CODE`](#err_code) register at the corresponding index. |
|   0    |   ro   |   0x0   | ERROR_0  | Set to 1 if an error occurred in this partition. If set to 1, SW should check the [`ERR_CODE`](#err_code) register at the corresponding index. |
