...
| otp_ctrl.[`PARTITION_STATUS`](#partition_status)                                       | 0x14     |        4 | OTP partition status register.                                                                      |
...
|   0    |   ro   |   0x0   | PARTION_ERROR        | Set to 1 if an error occurred in any partition. If set to 1, SW should check the [`PARTITION_STATUS`](#partition_status) register to determine the failing partition. |

## PARTITION_STATUS
OTP partition status register.
- Offset: `0x14`
- Reset default: `0x0`
- Reset mask: `0x7ff`
