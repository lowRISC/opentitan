...
package top_earlgrey_rnd_cnst_pkg;
  ...
  parameter otp_ctrl_top_specific_pkg::lfsr_perm_t RndCnstOtpCtrlLfsrPerm = {
    240'h8C33_2400E685_60704B09_D6449961_A57915E7_25C3CD81_05214885_627CA6D3
  };
  ...
  parameter keymgr_pkg::seed_t RndCnstKeymgrKmacSeed = {
    256'h9E94DA72_0A712D7D_6B7326F3_102BA57A_B12F0C11_E464E613_088D6DF2_CC4352AA
  };

  // Compile-time random bits for generation seed when otbn destination selected
  parameter keymgr_pkg::seed_t RndCnstKeymgrOtbnSeed = {
    256'h62DF6B07_199EA6C6_782AD9BB_2E78FA04_C68991DE_3B57A9B6_1206E6C0_A2AFA6A3
  };
  ...
  parameter keymgr_pkg::seed_t RndCnstKeymgrNoneSeed = {
    256'h0237536D_C3E35040_DE9AC1A6_F2B35C99_FB71E1AA_AB3C2083_83ADF503_11FF71FD
  };
  ...
  parameter csrng_pkg::cs_keymgr_div_t RndCnstCsrngCsKeymgrDivNonProduction = {
    128'h46921923_A8CD8C6F_F98F9BDF_C2B205D8,
    256'h690DD355_00E5A51B_BA34A71D_81E9EB87_6B6F1996_B2BE4B58_DFCFB830_B9E25BDA
  };

  // Compile-time random bits for csrng state group diversification value
  parameter csrng_pkg::cs_keymgr_div_t RndCnstCsrngCsKeymgrDivProduction = {
    128'hA3E1AFFA_91806D01_A89BDF50_84C3F043,
    256'hFE74B4FF_850B4A6D_EA97774B_63EF1E13_CA69B8BB_7DAE3157_B7279A2B_D0F45178
  };
  ...
  parameter otp_ctrl_pkg::sram_key_t RndCnstSramCtrlSecSramKey = {
    128'h9DC3C99A_37868579_B46A8409_5EA98114
  };

  // Compile-time random reset value for SRAM scrambling nonce.
  parameter otp_ctrl_pkg::sram_nonce_t RndCnstSramCtrlSecSramNonce = {
    128'h0FF7F0C4_AD73D597_26774A37_E3356026
  };

  // Compile-time random bits for initial LFSR seed
  parameter sram_ctrl_pkg::lfsr_seed_t RndCnstSramCtrlSecLfsrSeed = {
    64'h6D52A2D9_C4901261
  };

  // Compile-time random permutation for LFSR output
  parameter sram_ctrl_pkg::lfsr_perm_t RndCnstSramCtrlSecLfsrPerm = {
    128'h0D5D7CBB_7BCAFA6C_691E10B4_781C9AB5,
    256'h8760453A_B33CDB08_ACCE098F_B899E941_50A25E57_59CDBD6C_490B7C6F_CE0129F0
  };
  ...
  parameter bit [63:0] RndCnstRomCtrlScrNonce = {
    64'h538F8AAE_68EC24DF
  };

  // Randomised constant used as a scrambling key for ROM data
  parameter bit [127:0] RndCnstRomCtrlScrKey = {
    128'h2D9B0706_58CB5B07_2BB74E79_DEA47A41
  };
  ...
  parameter ibex_pkg::lfsr_perm_t RndCnstRvCoreIbexLfsrPerm = {
    160'h12DA5DC7_06BC83C8_67F373C9_A1FADDAA_54762280
  };

  // Default icache scrambling key
  parameter logic [ibex_pkg::SCRAMBLE_KEY_W-1:0] RndCnstRvCoreIbexIbexKeyDefault = {
    128'hF7EDA1A0_7047F937_051A0574_61414B8B
  };

  // Default icache scrambling nonce
  parameter logic [ibex_pkg::SCRAMBLE_NONCE_W-1:0] RndCnstRvCoreIbexIbexNonceDefault = {
    64'h3587C6DE_71B92208
  };
