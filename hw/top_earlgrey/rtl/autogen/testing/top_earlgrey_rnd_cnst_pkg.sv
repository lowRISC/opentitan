...
package top_earlgrey_rnd_cnst_pkg;
  ...
  parameter otp_ctrl_top_specific_pkg::lfsr_perm_t RndCnstOtpCtrlLfsrPerm = {
    240'h2DB9_A0493142_7083D612_779888A7_4600C8C7_52135925_F9500D55_D168E064
  };

  // Compile-time random permutation for scrambling key/nonce register reset value
  parameter otp_ctrl_top_specific_pkg::scrmbl_key_init_t RndCnstOtpCtrlScrmblKeyInit = {
    256'hA7F8B17F_A88FEE02_E3F08642_23A2E23A_8CC31E2D_E5E578D4_3D2DCE49_E360CFB5
  };
  ...
  parameter lc_ctrl_pkg::lc_keymgr_div_t RndCnstLcCtrlLcKeymgrDivInvalid = {
    128'h94ACDDF1_70684F6E_AD2B7FEB_FE895523
  };
  ...
  parameter lc_ctrl_pkg::lc_keymgr_div_t RndCnstLcCtrlLcKeymgrDivTestUnlocked = {
    128'hD7BC4846_A485956C_7F904B9E_DED09B89
  };

  // Diversification value used for the DEV life cycle state.
  parameter lc_ctrl_pkg::lc_keymgr_div_t RndCnstLcCtrlLcKeymgrDivDev = {
    128'hA7543356_6F4963D9_DC27F3EC_B11CE3B8
  };

  // Diversification value used for the PROD/PROD_END life cycle states.
  parameter lc_ctrl_pkg::lc_keymgr_div_t RndCnstLcCtrlLcKeymgrDivProduction = {
    128'h7AAA7ABC_85920B18_81083AFF_7BDE18EA
  };

  // Diversification value used for the RMA life cycle state.
  parameter lc_ctrl_pkg::lc_keymgr_div_t RndCnstLcCtrlLcKeymgrDivRma = {
    128'hCFF85679_453DA77D_92A176B8_7118AF11
  };

  // Compile-time random bits used for invalid tokens in the token mux
  parameter lc_ctrl_pkg::lc_token_mux_t RndCnstLcCtrlInvalidTokens = {
    256'hCDBE78D6_7060615A_20B9C074_0F07969C_CD2D10A1_A6E7988F_A528AC03_2E0A6138,
    256'hCB8316FF_95C65CD7_A1A768B0_6E0106D6_0EDA0F1B_C67ADF85_BD9A56EA_088D33FF,
    256'hAA6A1155_AFB0169A_B2DE3973_D027EE30_B8F901F6_44EC7CD3_E56C8ED1_EC38739F,
    256'h1D0DEB7C_774199CF_6DD057F4_4C13E25C_7A5877BC_5242E6EE_63ECDF45_8AE6596E
  };
  ...
  parameter alert_handler_pkg::lfsr_perm_t RndCnstAlertHandlerLfsrPerm = {
    160'h0973A43F_9D7248BB_1CD76E05_0F7D801C_552A567B
  };
  ...
  parameter otp_ctrl_pkg::sram_key_t RndCnstSramCtrlRetAonSramKey = {
    128'h1FF0189B_04A4F7FB_A960FE09_8A4FB9D4
  };

  // Compile-time random reset value for SRAM scrambling nonce.
  parameter otp_ctrl_pkg::sram_nonce_t RndCnstSramCtrlRetAonSramNonce = {
    128'h69171B95_0E364B0D_AC546956_8E661498
  };

  // Compile-time random bits for initial LFSR seed
  parameter sram_ctrl_pkg::lfsr_seed_t RndCnstSramCtrlRetAonLfsrSeed = {
    64'hFD89197C_CAE8EA08
  };

  // Compile-time random permutation for LFSR output
  parameter sram_ctrl_pkg::lfsr_perm_t RndCnstSramCtrlRetAonLfsrPerm = {
    128'h8084A61E_3F7ACE53_82676E0D_70CA7224,
    256'hA0275A45_7C4E111E_DCBD456B_4A14622A_C6B81B5F_743F916C_FE57AB1B_2FC3B43F
  };
  ...
  parameter flash_ctrl_pkg::flash_key_t RndCnstFlashCtrlAddrKey = {
    128'h57C22C88_4ED49D87_A5B56BA7_353C5321
  };

  // Compile-time random bits for default data key
  parameter flash_ctrl_pkg::flash_key_t RndCnstFlashCtrlDataKey = {
    128'h42F50667_E220C5B7_24C3FDB6_D060653B
  };

  // Compile-time random bits for default seeds
  parameter flash_ctrl_top_specific_pkg::all_seeds_t RndCnstFlashCtrlAllSeeds = {
    256'h42A96F88_B574E4D3_814F5116_B3E6F3E3_31DA1182_DBC29C89_4F1800ED_ECF7B176,
    256'h82D2CE3D_B9B12E1A_F4339E1F_45164A41_8EBC5221_0D58DC65_508E869A_F565C1B8
  };
  ...
  parameter flash_ctrl_top_specific_pkg::lfsr_perm_t RndCnstFlashCtrlLfsrPerm = {
    160'h4412AADB_8CFB5E5E_E69B093C_706871C4_9D75CC46
  };
  ...
  parameter otp_ctrl_pkg::sram_key_t RndCnstSramCtrlMetaSramKey = {
    128'hC88224A4_41C4192A_BE1DC426_FEEE2C9B
  };

  // Compile-time random reset value for SRAM scrambling nonce.
  parameter otp_ctrl_pkg::sram_nonce_t RndCnstSramCtrlMetaSramNonce = {
    128'h1C8B34B1_A821AFE5_22E11C40_49D9B85F
  };
  ...
  parameter sram_ctrl_pkg::lfsr_perm_t RndCnstSramCtrlMetaLfsrPerm = {
    128'h1E9E0FD2_7066EB55_51413322_58A78867,
    256'h7EF98FDB_2EFB6F33_2DF18E03_0FC49285_1BC98BCD_49D26572_BC43160A_970A16AD
  };
