...
// pragma coverage on
  ...
  assign intr_vector = {
      ...
      intr_sensor_ctrl_aon_init_status_change, // IDs [154 +: 1]
      intr_sensor_ctrl_aon_io_status_change, // IDs [153 +: 1]
      intr_aon_timer_aon_wdog_timer_bark, // IDs [152 +: 1]
      intr_aon_timer_aon_wkup_timer_expired, // IDs [151 +: 1]
      intr_adc_ctrl_aon_match_done, // IDs [150 +: 1]
      intr_sysrst_ctrl_aon_event_detected, // IDs [149 +: 1]
      intr_pwrmgr_aon_wakeup, // IDs [148 +: 1]
      intr_usbdev_av_setup_empty, // IDs [147 +: 1]
      intr_usbdev_link_out_err, // IDs [146 +: 1]
      intr_usbdev_powered, // IDs [145 +: 1]
      intr_usbdev_frame, // IDs [144 +: 1]
      intr_usbdev_rx_bitstuff_err, // IDs [143 +: 1]
      intr_usbdev_rx_pid_err, // IDs [142 +: 1]
      intr_usbdev_rx_crc_err, // IDs [141 +: 1]
      intr_usbdev_link_in_err, // IDs [140 +: 1]
      intr_usbdev_av_overflow, // IDs [139 +: 1]
      intr_usbdev_rx_full, // IDs [138 +: 1]
      intr_usbdev_av_out_empty, // IDs [137 +: 1]
      intr_usbdev_link_resume, // IDs [136 +: 1]
      intr_usbdev_link_suspend, // IDs [135 +: 1]
      intr_usbdev_link_reset, // IDs [134 +: 1]
      intr_usbdev_host_lost, // IDs [133 +: 1]
      intr_usbdev_disconnected, // IDs [132 +: 1]
      intr_usbdev_pkt_sent, // IDs [131 +: 1]
      intr_usbdev_pkt_received, // IDs [130 +: 1]
      intr_spi_host1_spi_event, // IDs [129 +: 1]
      intr_spi_host1_error, // IDs [128 +: 1]
      intr_spi_host0_spi_event, // IDs [127 +: 1]
      intr_spi_host0_error, // IDs [126 +: 1]
      intr_alert_handler_classd, // IDs [125 +: 1]
      intr_alert_handler_classc, // IDs [124 +: 1]
      intr_alert_handler_classb, // IDs [123 +: 1]
      intr_alert_handler_classa, // IDs [122 +: 1]
      intr_otp_ctrl_otp_error, // IDs [121 +: 1]
      intr_otp_ctrl_otp_operation_done, // IDs [120 +: 1]
      intr_rv_timer_timer_expired_hart0_timer0, // IDs [119 +: 1]
      intr_pattgen_done_ch1, // IDs [118 +: 1]
      intr_pattgen_done_ch0, // IDs [117 +: 1]
      intr_i2c2_host_timeout, // IDs [116 +: 1]
      intr_i2c2_unexp_stop, // IDs [115 +: 1]
      intr_i2c2_acq_full, // IDs [114 +: 1]
      intr_i2c2_tx_overflow, // IDs [113 +: 1]
      intr_i2c2_tx_stretch, // IDs [112 +: 1]
      intr_i2c2_cmd_complete, // IDs [111 +: 1]
      intr_i2c2_sda_unstable, // IDs [110 +: 1]
      intr_i2c2_stretch_timeout, // IDs [109 +: 1]
      intr_i2c2_sda_interference, // IDs [108 +: 1]
      intr_i2c2_scl_interference, // IDs [107 +: 1]
      intr_i2c2_nak, // IDs [106 +: 1]
      intr_i2c2_rx_overflow, // IDs [105 +: 1]
      intr_i2c2_fmt_overflow, // IDs [104 +: 1]
      intr_i2c2_rx_threshold, // IDs [103 +: 1]
      intr_i2c2_fmt_threshold, // IDs [102 +: 1]
      intr_i2c1_host_timeout, // IDs [101 +: 1]
      intr_i2c1_unexp_stop, // IDs [100 +: 1]
      intr_i2c1_acq_full, // IDs [99 +: 1]
      intr_i2c1_tx_overflow, // IDs [98 +: 1]
      intr_i2c1_tx_stretch, // IDs [97 +: 1]
      intr_i2c1_cmd_complete, // IDs [96 +: 1]
      intr_i2c1_sda_unstable, // IDs [95 +: 1]
      intr_i2c1_stretch_timeout, // IDs [94 +: 1]
      intr_i2c1_sda_interference, // IDs [93 +: 1]
      intr_i2c1_scl_interference, // IDs [92 +: 1]
      intr_i2c1_nak, // IDs [91 +: 1]
      intr_i2c1_rx_overflow, // IDs [90 +: 1]
      intr_i2c1_fmt_overflow, // IDs [89 +: 1]
      intr_i2c1_rx_threshold, // IDs [88 +: 1]
      intr_i2c1_fmt_threshold, // IDs [87 +: 1]
      intr_i2c0_host_timeout, // IDs [86 +: 1]
      intr_i2c0_unexp_stop, // IDs [85 +: 1]
      intr_i2c0_acq_full, // IDs [84 +: 1]
      intr_i2c0_tx_overflow, // IDs [83 +: 1]
      intr_i2c0_tx_stretch, // IDs [82 +: 1]
      intr_i2c0_cmd_complete, // IDs [81 +: 1]
      ...
      intr_i2c0_rx_threshold, // IDs [73 +: 1]
      intr_i2c0_fmt_threshold, // IDs [72 +: 1]
      intr_spi_device_tpm_rdfifo_drop, // IDs [71 +: 1]
