...
// pragma coverage on
  ...
  assign intr_vector = {
      ...
      intr_usbdev_rx_bitstuff_err, // IDs [142 +: 1]
      intr_usbdev_rx_pid_err, // IDs [141 +: 1]
      intr_usbdev_rx_crc_err, // IDs [140 +: 1]
      ...
      intr_usbdev_host_lost, // IDs [132 +: 1]
      intr_usbdev_disconnected, // IDs [131 +: 1]
      intr_usbdev_pkt_sent, // IDs [130 +: 1]
      intr_usbdev_pkt_received, // IDs [129 +: 1]
      intr_spi_host1_spi_event, // IDs [128 +: 1]
      intr_spi_host1_error, // IDs [127 +: 1]
      intr_spi_host0_spi_event, // IDs [126 +: 1]
      intr_spi_host0_error, // IDs [125 +: 1]
      intr_alert_handler_classd, // IDs [124 +: 1]
      intr_alert_handler_classc, // IDs [123 +: 1]
      intr_alert_handler_classb, // IDs [122 +: 1]
      intr_alert_handler_classa, // IDs [121 +: 1]
      intr_otp_ctrl_otp_error, // IDs [120 +: 1]
      intr_otp_ctrl_otp_operation_done, // IDs [119 +: 1]
      intr_rv_timer_timer_expired_hart0_timer0, // IDs [118 +: 1]
      intr_pattgen_done_ch1, // IDs [117 +: 1]
      intr_pattgen_done_ch0, // IDs [116 +: 1]
      intr_i2c2_host_timeout, // IDs [115 +: 1]
      intr_i2c2_unexp_stop, // IDs [114 +: 1]
      intr_i2c2_acq_full, // IDs [113 +: 1]
      intr_i2c2_tx_overflow, // IDs [112 +: 1]
      intr_i2c2_tx_stretch, // IDs [111 +: 1]
      intr_i2c2_cmd_complete, // IDs [110 +: 1]
      intr_i2c2_sda_unstable, // IDs [109 +: 1]
      intr_i2c2_stretch_timeout, // IDs [108 +: 1]
      intr_i2c2_sda_interference, // IDs [107 +: 1]
      intr_i2c2_scl_interference, // IDs [106 +: 1]
      intr_i2c2_nak, // IDs [105 +: 1]
      intr_i2c2_rx_overflow, // IDs [104 +: 1]
      intr_i2c2_fmt_overflow, // IDs [103 +: 1]
      intr_i2c2_rx_threshold, // IDs [102 +: 1]
      intr_i2c2_fmt_threshold, // IDs [101 +: 1]
      intr_i2c1_host_timeout, // IDs [100 +: 1]
      intr_i2c1_unexp_stop, // IDs [99 +: 1]
      intr_i2c1_acq_full, // IDs [98 +: 1]
      intr_i2c1_tx_overflow, // IDs [97 +: 1]
      intr_i2c1_tx_stretch, // IDs [96 +: 1]
      intr_i2c1_cmd_complete, // IDs [95 +: 1]
      intr_i2c1_sda_unstable, // IDs [94 +: 1]
      intr_i2c1_stretch_timeout, // IDs [93 +: 1]
      intr_i2c1_sda_interference, // IDs [92 +: 1]
      intr_i2c1_scl_interference, // IDs [91 +: 1]
      intr_i2c1_nak, // IDs [90 +: 1]
      intr_i2c1_rx_overflow, // IDs [89 +: 1]
      intr_i2c1_fmt_overflow, // IDs [88 +: 1]
      intr_i2c1_rx_threshold, // IDs [87 +: 1]
      intr_i2c1_fmt_threshold, // IDs [86 +: 1]
      intr_i2c0_host_timeout, // IDs [85 +: 1]
      intr_i2c0_unexp_stop, // IDs [84 +: 1]
      intr_i2c0_acq_full, // IDs [83 +: 1]
      intr_i2c0_tx_overflow, // IDs [82 +: 1]
      intr_i2c0_tx_stretch, // IDs [81 +: 1]
      intr_i2c0_cmd_complete, // IDs [80 +: 1]
      intr_i2c0_sda_unstable, // IDs [79 +: 1]
      intr_i2c0_stretch_timeout, // IDs [78 +: 1]
      intr_i2c0_sda_interference, // IDs [77 +: 1]
      intr_i2c0_scl_interference, // IDs [76 +: 1]
      intr_i2c0_nak, // IDs [75 +: 1]
      intr_i2c0_rx_overflow, // IDs [74 +: 1]
      intr_i2c0_fmt_overflow, // IDs [73 +: 1]
      intr_i2c0_rx_threshold, // IDs [72 +: 1]
      intr_i2c0_fmt_threshold, // IDs [71 +: 1]
