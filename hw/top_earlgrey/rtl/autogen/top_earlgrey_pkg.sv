...
package top_earlgrey_pkg;
  ...
  typedef enum int unsigned {
    ...
    TopEarlgreyPlicIrqIdRramCtrlCorr1Err = 163,
    TopEarlgreyPlicIrqIdRramCtrlCorr2Err = 164,
    TopEarlgreyPlicIrqIdHmacHmacDone = 165,
    TopEarlgreyPlicIrqIdHmacFifoEmpty = 166,
    TopEarlgreyPlicIrqIdHmacHmacErr = 167,
    TopEarlgreyPlicIrqIdKmacKmacDone = 168,
    TopEarlgreyPlicIrqIdKmacFifoEmpty = 169,
    TopEarlgreyPlicIrqIdKmacKmacErr = 170,
    TopEarlgreyPlicIrqIdOtbnDone = 171,
    TopEarlgreyPlicIrqIdKeymgrDpeOpDone = 172,
    TopEarlgreyPlicIrqIdCsrngCsCmdReqDone = 173,
    TopEarlgreyPlicIrqIdCsrngCsEntropyReq = 174,
    TopEarlgreyPlicIrqIdCsrngCsHwInstExc = 175,
    TopEarlgreyPlicIrqIdCsrngCsFatalErr = 176,
