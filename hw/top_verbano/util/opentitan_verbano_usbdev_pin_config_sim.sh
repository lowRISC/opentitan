...
VERILATOR=build/lowrisc_systems_chip_verbano_verilator_0.1/sim-verilator/Vchip_verbano_verilator
...
# Expected output
EXPECT_USB=hw/top_verbano/util/opentitan_verbano_usbdev_expected-usb
EXPECT_UART=hw/top_verbano/util/opentitan_verbano_usbdev_expected-uart
