...
set_rule_status -rule {W_CNTL} -expression {(MultiClockDomains == "IO_DIV4_CLK::SPI_DEV_IN_CLK,SPI_DEV_PASSTHRU_IN_CLK") && (ReceivingFlop == "top_verbano.u_spi_device.u_spid_addr_4b.u_sys2spi_sync.u_sync_1.q_o[0]") && (Signal == "top_verbano.u_spi_device.u_reg.u_cfg_addr_4b_en.q[0]") && (Association == "Data") && (SyncDepth == "2") && (SyncFlop == "top_verbano.u_spi_device.u_spid_addr_4b.u_sys2spi_sync.u_sync_2.q_o[0]")} -status {Waived} -lastedit_user {root} -lastedit_time {Thursday, 24 March 2022 13:46:23 PDT} \
  -comment {addr_4b_en signal is static not a pulse signal. No intention of the bit value being changed.}
set_rule_status -rule {W_CNTL} -expression {(MultiClockDomains == "SPI_DEV_IN_CLK,SPI_DEV_PASSTHRU_IN_CLK::IO_DIV4_CLK") && (ReceivingFlop == "top_verbano.u_spi_device.u_spid_status.u_busy_sync.u_sync_1.q_o[0]") && (Signal == "top_verbano.u_spi_device.u_spid_status.sck_status_busy") && (Association == "Data") && (SyncDepth == "2") && (SyncFlop == "top_verbano.u_spi_device.u_spid_status.u_busy_sync.u_sync_2.q_o[0]")} -status {Waived} -lastedit_user {root} -lastedit_time {Thursday, 24 March 2022 13:55:28 PDT} \
  -comment {busy signal is set then stay. 2FF to SYS clock domain is fine}
set_rule_status -rule {W_CNTL} -expression {(MultiClockDomains == "IO_DIV4_CLK::SPI_DEV_IN_CLK,SPI_DEV_PASSTHRU_IN_CLK") && (ReceivingFlop == "top_verbano.u_spi_device.u_spid_status.u_busy_clr_sync.prim_flop_2sync.u_sync_1.q_o[0]") && (Signal == "top_verbano.u_spi_device.u_spid_status.u_busy_clr_sync.src_level") && (Association == "Data") && (SyncDepth == "2") && (SyncFlop == "top_verbano.u_spi_device.u_spid_status.u_busy_clr_sync.prim_flop_2sync.u_sync_2.q_o[0]")} -status {Waived} -lastedit_user {root} -lastedit_time {Thursday, 24 March 2022 14:02:56 PDT}
set_rule_status -rule {W_CNTL} -expression {(MultiClockDomains == "IO_DIV4_CLK::SPI_DEV_IN_CLK,SPI_DEV_PASSTHRU_IN_CLK") && (ReceivingFlop == "top_verbano.u_spi_device.u_spid_status.u_status_23_to_1_sync.u_sync_1.q_o[0]") && (Signal == "top_verbano.u_spi_device.u_spid_status.u_busy_sync.u_sync_2.q_o[0]") && (Association == "Blocked-Dangling") && (SyncDepth == "2") && (SyncFlop == "top_verbano.u_spi_device.u_spid_status.u_status_23_to_1_sync.u_sync_2.q_o[0]")} -status {Waived} -lastedit_user {root} -lastedit_time {Thursday, 24 March 2022 14:03:01 PDT}
set_rule_status -rule {W_CNTL} -expression {(MultiClockDomains == "SPI_DEV_IN_CLK,SPI_DEV_PASSTHRU_IN_CLK::IO_DIV4_CLK") && (ReceivingFlop == "top_verbano.u_spi_device.u_upload.u_payloadptr_clr_psync.prim_flop_2sync.u_sync_1.q_o[0]") && (Signal == "top_verbano.u_spi_device.u_upload.u_payloadptr_clr_psync.src_level") && (Association == "Data") && (SyncDepth == "2") && (SyncFlop == "top_verbano.u_spi_device.u_upload.u_payloadptr_clr_psync.prim_flop_2sync.u_sync_2.q_o[0]")} -status {Waived} -lastedit_user {root} -lastedit_time {Thursday, 24 March 2022 14:05:55 PDT}
set_rule_status -rule {W_INTERFACE} -expression {(ComponentClass == "DATA") && (ErrorType == "Uncontrolled-Tx-MASYNC") && (MultiClockDomains == "IO_DIV4_CLK::IO_DIV4_CLK,SPI_DEV_CLK,SPI_DEV_PASSTHRU_CLK") && (Signal == "top_verbano.u_spi_device.u_reg.u_rxf_ptr_rptr.q[12:2]")} -status {Waived} -lastedit_user {root} -lastedit_time {Thursday, 24 March 2022 14:11:36 PDT}
set_rule_status -rule {W_INTERFACE} -expression {(ComponentClass == "CNTL") && (ErrorType == "") && (MultiClockDomains == "SPI_DEV_IN_CLK,SPI_DEV_PASSTHRU_IN_CLK::IO_DIV4_CLK,SPI_DEV_CLK,SPI_DEV_PASSTHRU_CLK") && (Signal == "top_verbano.u_spi_device.u_fwmode.u_rx_fifo.fifo_wptr_gray_q[3:0]")} -status {Waived} -lastedit_user {root} -lastedit_time {Thursday, 24 March 2022 14:11:36 PDT}

set_rule_status -rule {W_DATA} -expression {(Signal == "top_verbano.u_spi_device.u_fwmode.u_rxf_ctrl.wptr[12:2]") && (ReceivingFlop == "top_verbano.u_spi_device.u_reg.u_intr_state_generic_rx_full.q[0]") && (MultiClockDomains == "IO_DIV2_CLK,IO_DIV4_CLK,SPI_DEV_IN_CLK,SPI_DEV_PASSTHRU_IN_CLK::IO_DIV4_CLK") && (Association == "None")} -status {Waived} -comment {tool doesn't recognize multiple spi clocks on the same domain}

set_rule_status -rule {W_DATA} -expression {(Signal == "top_verbano.u_spi_device.u_fwmode.u_rxf_ctrl.wptr[12:0]") && (ReceivingFlop == "top_verbano.u_spi_device.u_reg.u_intr_state_generic_rx_watermark.q[0]") && (MultiClockDomains == "IO_DIV2_CLK,IO_DIV4_CLK,SPI_DEV_IN_CLK,SPI_DEV_PASSTHRU_IN_CLK::IO_DIV4_CLK") && (Association == "None")} -status {Waived} -comment {included in waived paths : start signal and receiving signal (flop) have been reviewed and waived in the same error or other errors}
set_rule_status -rule {W_DATA} -expression {(Signal == "top_verbano.u_spi_device.u_fwmode.u_txf_ctrl.rptr[12:0]") && (ReceivingFlop == "top_verbano.u_spi_device.u_reg.u_intr_state_generic_tx_watermark.q[0]") && (MultiClockDomains == "IO_DIV2_CLK,IO_DIV4_CLK,SPI_DEV_IN_CLK,SPI_DEV_PASSTHRU_IN_CLK::IO_DIV4_CLK") && (Association == "None")} -status {Waived} -comment {tool doesn't recognize multiple spi clocks on the same domain}
set_rule_status -rule {W_DATA} -expression {(Signal == "top_verbano.u_spi_device.u_fwmode.u_rx_fifo.storage[7:0][7:0]") && (ReceivingFlop == "top_verbano.u_spi_device.u_fwmode.u_rx_fifo.rdata_o[7:0]")} -status {Waived} -comment {fwmode uses a special sequence to switch clock}
set_rule_status -rule {W_DATA} -expression {(Signal == "top_verbano.u_spi_device.u_fwmode.u_tx_fifo.storage[7:0][7:0]") && (ReceivingFlop == "top_verbano.u_spi_device.u_fwmode.u_tx_fifo.rdata_o[7:0]")} -status {Waived} -comment {fwmode uses a special sequence to switch clock}
set_rule_status -rule {W_DATA} -expression {(Signal == "top_verbano.u_spi_device.u_fwmode.u_rxf_ctrl.wptr[12:0]") && (ReceivingFlop == "top_verbano.u_spi_device.rxlvl") && (MultiClockDomains == "IO_DIV2_CLK,IO_DIV4_CLK,SPI_DEV_IN_CLK,SPI_DEV_PASSTHRU_IN_CLK::IO_DIV4_CLK") && (Association == "None")} -status {Waived} -status {Waived} -comment {fwmode uses a special sequence to switch clock}
set_rule_status -rule {W_DATA} -expression {(Signal == "top_verbano.u_spi_device.u_fwmode.u_txf_ctrl.rptr[12:0]") && (ReceivingFlop == "top_verbano.u_spi_device.txlvl") && (MultiClockDomains == "IO_DIV2_CLK,IO_DIV4_CLK,SPI_DEV_IN_CLK,SPI_DEV_PASSTHRU_IN_CLK::IO_DIV4_CLK") && (Association == "None")} -status {Waived} -status {Waived} -comment {fwmode uses a special sequence to switch clock}
set_rule_status -rule {W_DATA} -expression {(Signal == "top_verbano.u_spi_device.u_fwmode.u_rxf_ctrl.wptr[12:2]") && (ReceivingFlop == "top_verbano.u_spi_device.sram_rxf_full_q") && (MultiClockDomains == "IO_DIV2_CLK,IO_DIV4_CLK,SPI_DEV_IN_CLK,SPI_DEV_PASSTHRU_IN_CLK::IO_DIV4_CLK") && (Association == "None")} -status {Waived} -status {Waived} -comment {fwmode uses a special sequence to switch clock}
