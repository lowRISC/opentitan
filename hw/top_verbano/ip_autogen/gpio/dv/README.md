...
### Top level testbench
Top level testbench is located at `gpio/dv/tb/tb.sv`. It instantiates the GPIO DUT module `pio/rtl/gpio.sv`.
...
#### Assertions
* TLUL assertions: The `sva/gpio_bind.sv` binds the `tlul_assert` [assertions](../../../../ip/tlul/doc/TlulProtocolChecker.md) to the IP to ensure TileLink interface protocol compliance.
...
```console
$ $REPO_TOP/util/dvsim/dvsim.py $REPO_TOP/hw/top_verbano/ip_autogen/gpio/dv/gpio_sim_cfg.hjson -i gpio_smoke
```
