...
set UPF_ISO_LC_OFF_PORTS_CLAMP1 {
  top_verbano/u_aon_timer_aon/lc_escalate_en_i[3] \
  top_verbano/u_aon_timer_aon/lc_escalate_en_i[1] \
  top_verbano/u_pinmux_aon/lc_escalate_en_i[3]    \
  top_verbano/u_pinmux_aon/lc_escalate_en_i[1]    \
  top_verbano/u_pinmux_aon/lc_check_byp_en_i[3]   \
  top_verbano/u_pinmux_aon/lc_check_byp_en_i[1]   }
