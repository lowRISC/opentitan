...
if {$FOUNDRY_ROOT != ""} {
  ...
  set_max_delay 5 -from [get_pins top_verbano/u_usbdev/usbdev_impl/u_usb_fs_nb_pe/u_usb_fs_tx/u_*_flop/${FLOP_PATH}/Q] \
                  -to   [get_ports USB_*]
  set_max_delay 5 -from [get_ports USB_*] \
                  -to   [get_pins top_verbano/u_usbdev/i_usbdev_iomux/cdc_io_to_usb/gen_generic_u_impl_generic/u_sync_1/${FLOP_PATH}/D]
  ...
  set_max_delay ${MAX_USB_DELAY} -from [get_pins top_verbano/u_usbdev/usbdev_impl/u_usb_fs_nb_pe/u_usb_fs_tx/u_oe_flop/${FLOP_PATH}/Q*] \
  ...
  set_max_delay ${MAX_USB_DELAY} -from [get_pins top_verbano/u_usbdev/usbdev_impl/u_usb_fs_nb_pe/u_usb_fs_tx/u_usb_dp_o_flop/${FLOP_PATH}/Q*] \
                                 -to   [get_pins -hierarchical -filter "full_name =~ *u_dio_pad*usb_pad_wrap/u_pad_macro_PBIDIR_*/OE"]
  set_max_delay ${MAX_USB_DELAY} -from [get_pins top_verbano/u_usbdev/usbdev_impl/u_usb_fs_nb_pe/u_usb_fs_tx/u_usb_dp_o_flop/${FLOP_PATH}/Q*] \
  ...
  # dn output timing
  # note that there is a path to the OE as well due to virtual open drain emulation in the pad wrapper (although it is likely not being used for USB).
  set_max_delay ${MAX_USB_DELAY} -from [get_pins top_verbano/u_usbdev/usbdev_impl/u_usb_fs_nb_pe/u_usb_fs_tx/u_usb_dn_o_flop/${FLOP_PATH}/Q*] \
                                 -to   [get_pins -hierarchical -filter "full_name =~ *u_dio_pad*usb_pad_wrap/u_pad_macro_PBIDIR_*/OE"]
  set_max_delay ${MAX_USB_DELAY} -from [get_pins top_verbano/u_usbdev/usbdev_impl/u_usb_fs_nb_pe/u_usb_fs_tx/u_usb_dn_o_flop/${FLOP_PATH}/Q*] \
                                 -to  [get_pins -hierarchical -filter "full_name =~ *u_dio_pad*usb_pad_wrap/u_pad_macro_PBIDIR_*/A"]
...
set CLK_PATH top_verbano/u_clkmgr_aon/u_no_scan_io_div2_div
...
set CLK_PATH top_verbano/u_clkmgr_aon/u_no_scan_io_div4_div
...
set_max_delay -from ${IO_BANKS} -to ${IO_BANKS} -through [get_cells top_verbano/u_sysrst_ctrl_aon/*] ${SYSRST_MAXDELAY}
...
create_generated_clock -name LC_JTAG_TCK -source [get_ports IOR3] -divide_by 1 \
    [get_pins top_verbano/u_pinmux_aon/u_pinmux_strap_sampling/u_pinmux_jtag_buf_lc/prim_clock_buf_tck/clk_o] -master_clock JTAG_TCK -add
create_generated_clock -name RV_JTAG_TCK -source [get_ports IOR3] -divide_by 1 \
    [get_pins top_verbano/u_pinmux_aon/u_pinmux_strap_sampling/u_pinmux_jtag_buf_rv/prim_clock_buf_tck/clk_o] -master_clock JTAG_TCK -add

set LC_JTAG_TCK_INV_PIN \
  [get_pins -leaf -filter {@pin_direction == out} -of_objects \
    [get_nets -segments -of_objects \
      [get_pins top_verbano/u_lc_ctrl/u_dmi_jtag/i_dmi_jtag_tap/i_tck_inv/clk_no] \
    ] \
  ]
...
set RV_JTAG_TCK_INV_PIN \
  [get_pins -leaf -filter {@pin_direction == out} -of_objects \
    [get_nets -segments -of_objects \
      [get_pins top_verbano/u_rv_dm/dap/i_dmi_jtag_tap/i_tck_inv/clk_no] \
    ] \
  ]
...
set_clock_sense -stop_propagation -clock JTAG_TCK \
  [get_pins -leaf -filter "@pin_direction == out" -of_objects \
    [get_nets -segments -of_objects \
      [get_pins top_verbano/u_pinmux_aon/u_pinmux_strap_sampling/u_pinmux_jtag_buf_dft/prim_clock_buf_tck/clk_o] \
    ] \
  ]
} else {
...
set_clock_sense -stop_propagation -clock JTAG_TCK \
  [get_pins -leaf -filter "@pin_direction == out" -of_objects \
    [get_nets -segments -of_objects \
      [get_pins top_verbano/u_pinmux_aon/u_pinmux_strap_sampling/in_core_o[38]] \
    ] \
  ]
set_false_path -hold -from [get_clocks JTAG_TCK] \
  ...
  -through [get_pins -leaf -filter "@pin_direction == out" -of_objects \
    [get_nets -segments -of_objects \
      [get_pins top_verbano/u_pinmux_aon/u_pinmux_strap_sampling/in_core_o*] \
    ] \
  ]
...
create_generated_clock -name SPI_DEV_IN_CLK \
    ...
    [get_pins top_verbano/u_spi_device/u_clk_spi_in_buf/${CLK_PIN}] -master_clock SPI_DEV_CLK -add
create_generated_clock -name SPI_DEV_OUT_CLK \
    -source [get_ports ${SPI_DEV_CLK_PIN}] -divide_by 1 -invert \
    [get_pins top_verbano/u_spi_device/u_clk_spi_out_buf/${CLK_PIN}] -master_clock SPI_DEV_CLK -add
...
if { $synopsys_program_name eq "pt_shell" || $synopsys_program_name eq "icc2_shell" || $synopsys_program_name eq "dc_shell"  } {
set_clock_sense -stop_propagation [get_pins -leaf -of_objects top_verbano/u_spi_device/u_csb_buf/out_o[0]]
} else {
set_clock_sense -logical_stop_propagation [get_pins -leaf -of_objects [get_pins top_verbano/u_spi_device/u_csb_buf/out_o[0]]]
}
...
#set_ideal_network [get_pins top_verbano/u_spi_device/u_csb_rst_scan_mux/clk_o]
...
set_multicycle_path -hold -end 1 -from [get_clocks SPI_DEV_CLK] \
    -to [get_pins -leaf -filter "@pin_direction == in" -of_objects \
        [get_nets top_verbano/u_spi_device/u_passthrough/sck_gate_en]]
...
set_false_path -hold -from [get_clocks SPI_DEV_IN_CLK] \
    ...
    -through [get_pins -leaf -filter "@pin_direction == out" -of_objects \
               [get_nets -segments -of_objects \
                 [get_pins top_verbano/u_spi_device/u_spi_tpm/miso_o]]]
...
create_generated_clock -name SPI_DEV_HC_IN_CLK \
    -source [get_ports ${SPI_DEV_CLK_PIN}] -divide_by 1 \
    [get_pins top_verbano/u_spi_device/u_clk_spi_in_buf/${CLK_PIN}] -add -master_clock SPI_DEV_HC_CLK
create_generated_clock -name SPI_DEV_HC_OUT_CLK \
    -source [get_ports ${SPI_DEV_CLK_PIN}] -divide_by 1 -invert \
    [get_pins top_verbano/u_spi_device/u_clk_spi_out_buf/${CLK_PIN}] -add -master_clock SPI_DEV_HC_CLK
...
set_clock_sense -logical_stop_propagation [get_pins -leaf -of_objects top_verbano/u_spi_device/u_csb_buf/out_o[0]]
}
# CSB-clocked status bits to various negedge-triggered flops, especially in the
# serializer.
# Advance the hold edge by one cycle, since CSB changes nominally on the same
...
set_false_path -hold -from [get_clocks SPI_DEV_HC_IN_CLK] \
    ...
    -through [get_pins -leaf -filter "@pin_direction == out" -of_objects \
        [get_cells -filter "@is_sequential" top_verbano/u_spi_device/u_cmdparse/*]]

set_false_path -hold -from [get_clocks SPI_DEV_HC_IN_CLK] \
    -to [get_clocks SPI_DEV_HC_CLK] \
    -through [get_pins -leaf -filter "@pin_direction == out" -of_objects \
        [get_cells -filter "@is_sequential" top_verbano/u_spi_device/u_passthrough/cmd_info_reg_read_pipeline_mode*]]
...
create_generated_clock -name SPI_TPM_IN_CLK \
    ...
    [get_pins top_verbano/u_spi_device/u_clk_spi_in_buf/${CLK_PIN}]
create_generated_clock -name SPI_TPM_OUT_CLK \
    -source [get_ports ${SPI_DEV_CLK_PIN}] -divide_by 1 -invert \
    -master_clock SPI_TPM_CLK -add \
    [get_pins top_verbano/u_spi_device/u_clk_spi_out_buf/${CLK_PIN}]
...
set_multicycle_path -hold -end 1 -from [get_ports ${TPM_CSB_PORT}] \
    ...
    -through [get_pins -leaf -filter "@pin_direction == in" -of_objects \
        [get_nets -segments -of_objects \
            [get_pins top_verbano/u_spi_device/u_spi_tpm/rst_ni]]]
# Relax the hold time constraint for the passthrough clock gate. Really this is
# to accommodate the gate for the inverted clock, which isn't active for the
# modes used for these constraints. However, it would be an okay outcome if the
# filter result reached the gate before even the 7th clock edge got out.
...
set_false_path -from [get_clocks SPI_TPM_IN_CLK] \
    ...
    -through [get_pins -leaf -filter "@pin_direction == out" -of_objects \
               [get_nets -segments -of_objects \
                 [get_pins top_verbano/u_spi_device/u_p2s/data_valid_i]]]
set_false_path -from [get_clocks SPI_TPM_IN_CLK] \
    -to [get_ports ${SPI_DEV_DATA_PORTS}] \
    -through [get_pins -leaf -filter "@pin_direction == out" -of_objects \
               [get_nets -segments -of_objects \
                 [get_pins top_verbano/u_spi_device/u_p2s/data_i*]]]
set_false_path -from [get_clocks SPI_TPM_OUT_CLK] \
    -to [get_ports ${SPI_DEV_DATA_PORTS}] \
    -through [get_pins -leaf -filter "@pin_direction == out" -of_objects \
               [get_nets -segments -of_objects \
                 [get_pins top_verbano/u_spi_device/u_p2s/s_o*]]]
set_false_path -from [get_clocks SPI_TPM_OUT_CLK] \
    -to [get_ports ${SPI_DEV_DATA_PORTS}] \
    -through [get_pins -leaf -filter "@pin_direction == out" -of_objects \
               [get_nets -segments -of_objects \
                 [get_pins top_verbano/u_spi_device/u_p2s/s_en_o*]]]
set_false_path -from [get_clocks SPI_TPM_OUT_CLK] \
    -to [get_ports ${SPI_DEV_DATA_PORTS}] \
    -through [get_pins -leaf -filter "@pin_direction == out" -of_objects \
               [get_nets -segments -of_objects \
                 [get_pins top_verbano/u_spi_device/u_read_pipe_stg1/q_o*]]]
set_false_path -from [get_clocks SPI_TPM_OUT_CLK] \
    -to [get_ports ${SPI_DEV_DATA_PORTS}] \
    -through [get_pins -leaf -filter "@pin_direction == out" -of_objects \
               [get_nets -segments -of_objects \
                 [get_pins top_verbano/u_spi_device/u_read_en_pipe_stg1/q_o*]]]
set_false_path -from [get_clocks SPI_TPM_OUT_CLK] \
    -to [get_ports ${SPI_DEV_DATA_PORTS}] \
    -through [get_pins -leaf -filter "@pin_direction == out" -of_objects \
               [get_nets -segments -of_objects \
                 [get_pins top_verbano/u_spi_device/u_read_pipe_stg2/q_o*]]]
set_false_path -from [get_clocks SPI_TPM_OUT_CLK] \
    -to [get_ports ${SPI_DEV_DATA_PORTS}] \
    -through [get_pins -leaf -filter "@pin_direction == out" -of_objects \
               [get_nets -segments -of_objects \
                 [get_pins top_verbano/u_spi_device/u_read_en_pipe_stg2/q_o*]]]
...
set_false_path -from [get_clocks SPI_TPM_CLK] -through [get_pins -leaf -filter "@pin_direction == out" -of_objects [get_nets -segments -of_objects  [get_pins top_verbano/u_spi_device/u_s2p/data_valid_o]]]
set_false_path -from [get_clocks SPI_TPM_CLK] -through [get_pins -leaf -filter "@pin_direction == out" -of_objects [get_nets -segments -of_objects [get_pins top_verbano/u_spi_device/u_s2p/data_o*]]]
 set_false_path -from [get_clocks SPI_TPM_CLK] -to [get_pins -leaf -filter "@pin_direction == in" -of_objects [get_cells -filter "@is_sequential" top_verbano/u_spi_device/u_passthrough/*]]
...
set_false_path -from [get_clocks SPI_DEV_CLK] -through [get_cells top_verbano/u_sysrst_ctrl_aon/*]
set_false_path -from [get_clocks SPI_DEV_HC_CLK] -through [get_cells top_verbano/u_sysrst_ctrl_aon/*]
set_false_path -from [get_clocks SPI_HOST_CLK] -through [get_cells top_verbano/u_sysrst_ctrl_aon/*]
set_false_path -from [get_clocks SPI_DEV_FAST_PASS_CLK] -through [get_cells top_verbano/u_sysrst_ctrl_aon/*] ; #leonids updated based on interaction with Alex
...
set SPI_HOST1_SRC_CLK [get_pins top_verbano/u_spi_host1/u_spi_core/u_fsm/u_sck_flop/*/clk_i]
set SPI_HOST1_DIV_CLK [get_pins top_verbano/u_spi_host1/u_spi_core/u_fsm/u_sck_flop/*/q_o[0]]
...
set_case_analysis 0 top_verbano/u_pinmux_aon/u_reg/u_mio_outsel_9/q[0]
set_case_analysis 1 top_verbano/u_pinmux_aon/u_reg/u_mio_outsel_9/q[1]
set_case_analysis 1 top_verbano/u_pinmux_aon/u_reg/u_mio_outsel_9/q[2]
set_case_analysis 0 top_verbano/u_pinmux_aon/u_reg/u_mio_outsel_9/q[3]
set_case_analysis 1 top_verbano/u_pinmux_aon/u_reg/u_mio_outsel_9/q[4]
set_case_analysis 1 top_verbano/u_pinmux_aon/u_reg/u_mio_outsel_9/q[5]
set_case_analysis 0 top_verbano/u_pinmux_aon/u_reg/u_mio_outsel_9/q[6]

# SPI_HOST1 SD0 (MioOut 38 -> mux sel 41) drives IOB1 (MIO pad 10):
set_case_analysis 1 top_verbano/u_pinmux_aon/u_reg/u_mio_outsel_10/q[0]
set_case_analysis 0 top_verbano/u_pinmux_aon/u_reg/u_mio_outsel_10/q[1]
set_case_analysis 0 top_verbano/u_pinmux_aon/u_reg/u_mio_outsel_10/q[2]
set_case_analysis 1 top_verbano/u_pinmux_aon/u_reg/u_mio_outsel_10/q[3]
set_case_analysis 0 top_verbano/u_pinmux_aon/u_reg/u_mio_outsel_10/q[4]
set_case_analysis 1 top_verbano/u_pinmux_aon/u_reg/u_mio_outsel_10/q[5]
set_case_analysis 0 top_verbano/u_pinmux_aon/u_reg/u_mio_outsel_10/q[6]

# IOB2 (MIO pad 11 -> mux sel 13) drives SPI_HOST1 SD1 (MioIn 39):
set_case_analysis 1 top_verbano/u_pinmux_aon/u_reg/u_mio_periph_insel_39/q[0]
set_case_analysis 0 top_verbano/u_pinmux_aon/u_reg/u_mio_periph_insel_39/q[1]
set_case_analysis 1 top_verbano/u_pinmux_aon/u_reg/u_mio_periph_insel_39/q[2]
set_case_analysis 1 top_verbano/u_pinmux_aon/u_reg/u_mio_periph_insel_39/q[3]
set_case_analysis 0 top_verbano/u_pinmux_aon/u_reg/u_mio_periph_insel_39/q[4]
set_case_analysis 0 top_verbano/u_pinmux_aon/u_reg/u_mio_periph_insel_39/q[5]
...
set_case_analysis 1 top_verbano/u_pinmux_aon/u_reg/u_mio_outsel_12/q[0]
set_case_analysis 0 top_verbano/u_pinmux_aon/u_reg/u_mio_outsel_12/q[1]
set_case_analysis 1 top_verbano/u_pinmux_aon/u_reg/u_mio_outsel_12/q[2]
set_case_analysis 0 top_verbano/u_pinmux_aon/u_reg/u_mio_outsel_12/q[3]
set_case_analysis 1 top_verbano/u_pinmux_aon/u_reg/u_mio_outsel_12/q[4]
set_case_analysis 1 top_verbano/u_pinmux_aon/u_reg/u_mio_outsel_12/q[5]
set_case_analysis 0 top_verbano/u_pinmux_aon/u_reg/u_mio_outsel_12/q[6]
...
set_sense -stop_propagation  \
    ...
    [get_pins -leaf \
        -filter "@pin_direction == in and full_name =~ top_verbano/u_spi_device/u_passthrough/*" \
        -of_objects \
            [get_nets -segments -of_objects \
                [get_pins top_verbano/u_spi_device/u_passthrough/rst_ni] \
            ] \
    ]
set_sense -stop_propagation  \
...
set_disable_clock_gating_check [get_cells -of_objects [gpo top_verbano/u_spi_device/u_passthrough/passthrough_o_csb]]
...
# see chip_verbano_asic_check_only.sdc.
...
set_false_path -through [get_pins top_verbano/u_uart*/cio_rx_i] -through [get_pins top_verbano/u_uart*/cio_tx_o]
...
set_sense -stop_propagation top_verbano/u_spi_device/u_reg/u_control_mode/q_reg*/Q
set_sense -stop_propagation top_verbano/u_pinmux_aon/dio_pad_attr_q_reg_*__invert/Q
set_sense -stop_propagation top_verbano/u_pinmux_aon/dio_out_retreg_q_reg*/Q
set_sense -stop_propagation top_verbano/u_pinmux_aon/u_reg/u_dio_pad_sleep_status_en*/q_reg*/Q

set_false_path -from top_verbano/u_pinmux_aon/u_pinmux_strap_sampling/u_prim_lc_sync_lc_dft_en/gen_flops_u_prim_flop_2sync/gen_generic_u_impl_generic/u_sync_2/gen_techlib_u_impl_techlib/gen_flops*_u_size_only_reg/CK -to [get_ports IO*]
set_false_path -from top_verbano/u_pinmux_aon/u_pinmux_strap_sampling/u_prim_lc_sender_pinmux_hw_debug_en/gen_flops_u_prim_flop/u_secure_anchor_flop/gen_techlib_u_impl_techlib/gen_flops*_u_size_only_reg/CK -to [get_ports IO*]
set_false_path -from top_verbano/u_pinmux_aon/mio_pad_attr_q_reg_*input_disable/CK -to [get_ports IO*]
set_false_path -from top_verbano/u_pinmux_aon/u_pinmux_strap_sampling/tap_strap_q_reg*/CK -to [get_ports IO*]
set_false_path -from top_verbano/u_pinmux_aon/mio_pad_attr_q_reg*invert/CK -to [get_ports IO*]
set_false_path -from top_verbano/u_pinmux_aon/mio_pad_attr_q_reg*input_disable/CK -to [get_ports IO*]
set_false_path -from top_verbano/u_pinmux_aon/u_pinmux_strap_sampling/u_prim_lc_sender_pinmux_hw_debug_en/gen_flops_u_prim_flop/u_secure_anchor_flop/gen_techlib_u_impl_techlib/gen_flops_*u_size_only_reg/CK -to [get_ports IO*]
set_false_path -from top_verbano/u_pinmux_aon/u_pinmux_strap_sampling/u_prim_lc_sync_lc_dft_en/gen_flops_u_prim_flop_2sync/gen_generic_u_impl_generic/u_sync_2/gen_techlib_u_impl_techlib/gen_flops_*u_size_only_reg/CK -to [get_ports IO*]
set_false_path -from top_verbano/u_pinmux_aon/u_pinmux_strap_sampling/tap_strap_q_reg*/CK -to [get_ports IO*]
set_false_path -from top_verbano/u_pinmux_aon/dio_pad_attr_q_reg*input_disable/CK -to [get_ports IO*]

if { $synopsys_program_name  == "pt_shell" } {
  set_max_delay 5 -from [get_pins top_verbano/u_usbdev/usbdev_impl/u_usb_fs_nb_pe/u_usb_fs_tx/u_*_flop/${FLOP_PATH}/Q] \
                  -to   [get_ports USB_*] -probe
  set_max_delay 5 -from [get_ports USB_*] \
                  -to   [get_pins top_verbano/u_usbdev/i_usbdev_iomux/cdc_io_to_usb/gen_generic_u_impl_generic/u_sync_1/gen_techlib_u_impl_techlib/gen_flops_0__gen_reset_to_0_u_size_only_reg/D] -probe
  set_max_delay -from ${IO_BANKS} -to ${IO_BANKS} -through [get_cells top_verbano/u_sysrst_ctrl_aon/*] ${SYSRST_MAXDELAY} -probe
}
