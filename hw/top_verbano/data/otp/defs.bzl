...
EARLGREY_STD_OTP_OVERLAYS_WITHOUT_SECRET_PARTITIONS = EARLGREY_OTP_SIGVERIFY_FAKE_KEYS + [
    "@//hw/top_verbano/data/otp:otp_json_creator_sw_cfg",
    "@//hw/top_verbano/data/otp:otp_json_owner_sw_cfg",
    "@//hw/top_verbano/data/otp:otp_json_alert_digest_cfg",
    "@//hw/top_verbano/data/otp:otp_json_hw_cfg0",
    "@//hw/top_verbano/data/otp:otp_json_hw_cfg1",
]

# This is a set of overlays to generate a generic, standard OTP image.
# Additional overlays can be applied on top to further customize the OTP.
EARLGREY_STD_OTP_OVERLAYS = EARLGREY_STD_OTP_OVERLAYS_WITHOUT_SECRET_PARTITIONS + [
    "@//hw/top_verbano/data/otp:otp_json_secret0",
    "@//hw/top_verbano/data/otp:otp_json_secret1",
    "@//hw/top_verbano/data/otp:otp_json_secret2_unlocked",
]
