...
set_multicycle_path -hold -end 1 -from [get_clocks clk_spi] \
    -to [get_pins -filter "DIRECTION == IN && IS_LEAF" -of_objects \
        [get_nets -segments top_verbano/u_spi_device/u_passthrough/sck_gate_en]]
...
set spi_host_0_peri [get_pins top_verbano/u_clkmgr_aon/u_clk_io_peri_cg/gen_gate.u_bufgce/O]
