...
static const top_verbano_plic_target_t kHart = kTopVerbanoPlicTargetIbex0;
 ...
 * as the ISR.
 */
static volatile top_verbano_plic_peripheral_t peripheral_expected;
...
void ottf_external_isr(uint32_t *exc_info) {
  ...
  top_verbano_plic_peripheral_t peripheral = (top_verbano_plic_peripheral_t)
      top_verbano_plic_interrupt_for_peripheral[plic_irq_id];
  ...
  switch (peripheral) {
#if TEST_MIN_IRQ_PERIPHERAL <= 0 && 0 < TEST_MAX_IRQ_PERIPHERAL
    case kTopVerbanoPlicPeripheralAdcCtrlAon: {
      dif_adc_ctrl_irq_t irq =
          (dif_adc_ctrl_irq_t)(plic_irq_id -
                               (dif_rv_plic_irq_id_t)
                                   kTopVerbanoPlicIrqIdAdcCtrlAonMatchPending);
...
#if TEST_MIN_IRQ_PERIPHERAL <= 1 && 1 < TEST_MAX_IRQ_PERIPHERAL
    case kTopVerbanoPlicPeripheralAlertHandler: {
      dif_alert_handler_irq_t irq =
          (dif_alert_handler_irq_t)(plic_irq_id -
                                    (dif_rv_plic_irq_id_t)
                                        kTopVerbanoPlicIrqIdAlertHandlerClassa);
...
#if TEST_MIN_IRQ_PERIPHERAL <= 2 && 2 < TEST_MAX_IRQ_PERIPHERAL
    case kTopVerbanoPlicPeripheralAonTimerAon: {
      dif_aon_timer_irq_t irq =
          (dif_aon_timer_irq_t)(plic_irq_id -
                                (dif_rv_plic_irq_id_t)
                                    kTopVerbanoPlicIrqIdAonTimerAonWkupTimerExpired);
...
#if TEST_MIN_IRQ_PERIPHERAL <= 3 && 3 < TEST_MAX_IRQ_PERIPHERAL
    case kTopVerbanoPlicPeripheralCsrng: {
      dif_csrng_irq_t irq =
          (dif_csrng_irq_t)(plic_irq_id -
                            (dif_rv_plic_irq_id_t)
                                kTopVerbanoPlicIrqIdCsrngCsCmdReqDone);
...
#if TEST_MIN_IRQ_PERIPHERAL <= 4 && 4 < TEST_MAX_IRQ_PERIPHERAL
    case kTopVerbanoPlicPeripheralEdn0: {
      dif_edn_irq_t irq =
          (dif_edn_irq_t)(plic_irq_id -
                          (dif_rv_plic_irq_id_t)
                              kTopVerbanoPlicIrqIdEdn0EdnCmdReqDone);
...
#if TEST_MIN_IRQ_PERIPHERAL <= 4 && 4 < TEST_MAX_IRQ_PERIPHERAL
    case kTopVerbanoPlicPeripheralEdn1: {
      dif_edn_irq_t irq =
          (dif_edn_irq_t)(plic_irq_id -
                          (dif_rv_plic_irq_id_t)
                              kTopVerbanoPlicIrqIdEdn1EdnCmdReqDone);
      CHECK(irq == edn_irq_expected,
...
#if TEST_MIN_IRQ_PERIPHERAL <= 5 && 5 < TEST_MAX_IRQ_PERIPHERAL
    case kTopVerbanoPlicPeripheralEntropySrc: {
      dif_entropy_src_irq_t irq =
          (dif_entropy_src_irq_t)(plic_irq_id -
                                  (dif_rv_plic_irq_id_t)
                                      kTopVerbanoPlicIrqIdEntropySrcEsEntropyValid);
...
#if TEST_MIN_IRQ_PERIPHERAL <= 6 && 6 < TEST_MAX_IRQ_PERIPHERAL
    case kTopVerbanoPlicPeripheralFlashCtrl: {
      dif_flash_ctrl_irq_t irq =
          (dif_flash_ctrl_irq_t)(plic_irq_id -
                                 (dif_rv_plic_irq_id_t)
                                     kTopVerbanoPlicIrqIdFlashCtrlProgEmpty);
...
#if TEST_MIN_IRQ_PERIPHERAL <= 7 && 7 < TEST_MAX_IRQ_PERIPHERAL
    case kTopVerbanoPlicPeripheralGpio: {
      dif_gpio_irq_t irq =
          (dif_gpio_irq_t)(plic_irq_id -
                           (dif_rv_plic_irq_id_t)
                               kTopVerbanoPlicIrqIdGpioGpio0);
...
#if TEST_MIN_IRQ_PERIPHERAL <= 8 && 8 < TEST_MAX_IRQ_PERIPHERAL
    case kTopVerbanoPlicPeripheralHmac: {
      dif_hmac_irq_t irq =
          (dif_hmac_irq_t)(plic_irq_id -
                           (dif_rv_plic_irq_id_t)
                               kTopVerbanoPlicIrqIdHmacHmacDone);
...
#if TEST_MIN_IRQ_PERIPHERAL <= 9 && 9 < TEST_MAX_IRQ_PERIPHERAL
    case kTopVerbanoPlicPeripheralI2c0: {
      dif_i2c_irq_t irq =
          (dif_i2c_irq_t)(plic_irq_id -
                          (dif_rv_plic_irq_id_t)
                              kTopVerbanoPlicIrqIdI2c0FmtThreshold);
...
#if TEST_MIN_IRQ_PERIPHERAL <= 9 && 9 < TEST_MAX_IRQ_PERIPHERAL
    case kTopVerbanoPlicPeripheralI2c1: {
      dif_i2c_irq_t irq =
          (dif_i2c_irq_t)(plic_irq_id -
                          (dif_rv_plic_irq_id_t)
                              kTopVerbanoPlicIrqIdI2c1FmtThreshold);
      CHECK(irq == i2c_irq_expected,
...
#if TEST_MIN_IRQ_PERIPHERAL <= 9 && 9 < TEST_MAX_IRQ_PERIPHERAL
    case kTopVerbanoPlicPeripheralI2c2: {
      dif_i2c_irq_t irq =
          (dif_i2c_irq_t)(plic_irq_id -
                          (dif_rv_plic_irq_id_t)
                              kTopVerbanoPlicIrqIdI2c2FmtThreshold);
      CHECK(irq == i2c_irq_expected,
...
#if TEST_MIN_IRQ_PERIPHERAL <= 10 && 10 < TEST_MAX_IRQ_PERIPHERAL
    case kTopVerbanoPlicPeripheralKeymgr: {
      dif_keymgr_irq_t irq =
          (dif_keymgr_irq_t)(plic_irq_id -
                             (dif_rv_plic_irq_id_t)
                                 kTopVerbanoPlicIrqIdKeymgrOpDone);
...
#if TEST_MIN_IRQ_PERIPHERAL <= 11 && 11 < TEST_MAX_IRQ_PERIPHERAL
    case kTopVerbanoPlicPeripheralKmac: {
      dif_kmac_irq_t irq =
          (dif_kmac_irq_t)(plic_irq_id -
                           (dif_rv_plic_irq_id_t)
                               kTopVerbanoPlicIrqIdKmacKmacDone);
...
#if TEST_MIN_IRQ_PERIPHERAL <= 12 && 12 < TEST_MAX_IRQ_PERIPHERAL
    case kTopVerbanoPlicPeripheralOtbn: {
      dif_otbn_irq_t irq =
          (dif_otbn_irq_t)(plic_irq_id -
                           (dif_rv_plic_irq_id_t)
                               kTopVerbanoPlicIrqIdOtbnDone);
...
#if TEST_MIN_IRQ_PERIPHERAL <= 13 && 13 < TEST_MAX_IRQ_PERIPHERAL
    case kTopVerbanoPlicPeripheralOtpCtrl: {
      dif_otp_ctrl_irq_t irq =
          (dif_otp_ctrl_irq_t)(plic_irq_id -
                               (dif_rv_plic_irq_id_t)
                                   kTopVerbanoPlicIrqIdOtpCtrlOtpOperationDone);
...
#if TEST_MIN_IRQ_PERIPHERAL <= 14 && 14 < TEST_MAX_IRQ_PERIPHERAL
    case kTopVerbanoPlicPeripheralPattgen: {
      dif_pattgen_irq_t irq =
          (dif_pattgen_irq_t)(plic_irq_id -
                              (dif_rv_plic_irq_id_t)
                                  kTopVerbanoPlicIrqIdPattgenDoneCh0);
...
#if TEST_MIN_IRQ_PERIPHERAL <= 15 && 15 < TEST_MAX_IRQ_PERIPHERAL
    case kTopVerbanoPlicPeripheralPwrmgrAon: {
      dif_pwrmgr_irq_t irq =
          (dif_pwrmgr_irq_t)(plic_irq_id -
                             (dif_rv_plic_irq_id_t)
                                 kTopVerbanoPlicIrqIdPwrmgrAonWakeup);
...
#if TEST_MIN_IRQ_PERIPHERAL <= 16 && 16 < TEST_MAX_IRQ_PERIPHERAL
    case kTopVerbanoPlicPeripheralRvTimer: {
      dif_rv_timer_irq_t irq =
          (dif_rv_timer_irq_t)(plic_irq_id -
                               (dif_rv_plic_irq_id_t)
                                   kTopVerbanoPlicIrqIdRvTimerTimerExpiredHart0Timer0);
...
#if TEST_MIN_IRQ_PERIPHERAL <= 17 && 17 < TEST_MAX_IRQ_PERIPHERAL
    case kTopVerbanoPlicPeripheralSensorCtrlAon: {
      dif_sensor_ctrl_irq_t irq =
          (dif_sensor_ctrl_irq_t)(plic_irq_id -
                                  (dif_rv_plic_irq_id_t)
                                      kTopVerbanoPlicIrqIdSensorCtrlAonIoStatusChange);
...
#if TEST_MIN_IRQ_PERIPHERAL <= 18 && 18 < TEST_MAX_IRQ_PERIPHERAL
    case kTopVerbanoPlicPeripheralSpiDevice: {
      dif_spi_device_irq_t irq =
          (dif_spi_device_irq_t)(plic_irq_id -
                                 (dif_rv_plic_irq_id_t)
                                     kTopVerbanoPlicIrqIdSpiDeviceUploadCmdfifoNotEmpty);
...
#if TEST_MIN_IRQ_PERIPHERAL <= 19 && 19 < TEST_MAX_IRQ_PERIPHERAL
    case kTopVerbanoPlicPeripheralSpiHost0: {
      dif_spi_host_irq_t irq =
          (dif_spi_host_irq_t)(plic_irq_id -
                               (dif_rv_plic_irq_id_t)
                                   kTopVerbanoPlicIrqIdSpiHost0Error);
...
#if TEST_MIN_IRQ_PERIPHERAL <= 19 && 19 < TEST_MAX_IRQ_PERIPHERAL
    case kTopVerbanoPlicPeripheralSpiHost1: {
      dif_spi_host_irq_t irq =
          (dif_spi_host_irq_t)(plic_irq_id -
                               (dif_rv_plic_irq_id_t)
                                   kTopVerbanoPlicIrqIdSpiHost1Error);
      CHECK(irq == spi_host_irq_expected,
...
#if TEST_MIN_IRQ_PERIPHERAL <= 20 && 20 < TEST_MAX_IRQ_PERIPHERAL
    case kTopVerbanoPlicPeripheralSysrstCtrlAon: {
      dif_sysrst_ctrl_irq_t irq =
          (dif_sysrst_ctrl_irq_t)(plic_irq_id -
                                  (dif_rv_plic_irq_id_t)
                                      kTopVerbanoPlicIrqIdSysrstCtrlAonEventDetected);
...
#if TEST_MIN_IRQ_PERIPHERAL <= 21 && 21 < TEST_MAX_IRQ_PERIPHERAL
    case kTopVerbanoPlicPeripheralUart0: {
      dif_uart_irq_t irq =
          (dif_uart_irq_t)(plic_irq_id -
                           (dif_rv_plic_irq_id_t)
                               kTopVerbanoPlicIrqIdUart0TxWatermark);
...
#if TEST_MIN_IRQ_PERIPHERAL <= 21 && 21 < TEST_MAX_IRQ_PERIPHERAL
    case kTopVerbanoPlicPeripheralUart1: {
      dif_uart_irq_t irq =
          (dif_uart_irq_t)(plic_irq_id -
                           (dif_rv_plic_irq_id_t)
                               kTopVerbanoPlicIrqIdUart1TxWatermark);
      CHECK(irq == uart_irq_expected,
...
#if TEST_MIN_IRQ_PERIPHERAL <= 21 && 21 < TEST_MAX_IRQ_PERIPHERAL
    case kTopVerbanoPlicPeripheralUart2: {
      dif_uart_irq_t irq =
          (dif_uart_irq_t)(plic_irq_id -
                           (dif_rv_plic_irq_id_t)
                               kTopVerbanoPlicIrqIdUart2TxWatermark);
      CHECK(irq == uart_irq_expected,
...
#if TEST_MIN_IRQ_PERIPHERAL <= 21 && 21 < TEST_MAX_IRQ_PERIPHERAL
    case kTopVerbanoPlicPeripheralUart3: {
      dif_uart_irq_t irq =
          (dif_uart_irq_t)(plic_irq_id -
                           (dif_rv_plic_irq_id_t)
                               kTopVerbanoPlicIrqIdUart3TxWatermark);
      CHECK(irq == uart_irq_expected,
...
#if TEST_MIN_IRQ_PERIPHERAL <= 22 && 22 < TEST_MAX_IRQ_PERIPHERAL
    case kTopVerbanoPlicPeripheralUsbdev: {
      dif_usbdev_irq_t irq =
          (dif_usbdev_irq_t)(plic_irq_id -
                             (dif_rv_plic_irq_id_t)
                                 kTopVerbanoPlicIrqIdUsbdevPktReceived);
...
static void peripheral_irqs_trigger(void) {
...
#if TEST_MIN_IRQ_PERIPHERAL <= 0 && 0 < TEST_MAX_IRQ_PERIPHERAL
  peripheral_expected = kTopVerbanoPlicPeripheralAdcCtrlAon;
...
#if TEST_MIN_IRQ_PERIPHERAL <= 1 && 1 < TEST_MAX_IRQ_PERIPHERAL
  peripheral_expected = kTopVerbanoPlicPeripheralAlertHandler;
  ...
  // non-DV setups.
  if (kDeviceType == kDeviceSimDV) {
    peripheral_expected = kTopVerbanoPlicPeripheralAonTimerAon;
...
#if TEST_MIN_IRQ_PERIPHERAL <= 3 && 3 < TEST_MAX_IRQ_PERIPHERAL
  peripheral_expected = kTopVerbanoPlicPeripheralCsrng;
...
#if TEST_MIN_IRQ_PERIPHERAL <= 4 && 4 < TEST_MAX_IRQ_PERIPHERAL
  peripheral_expected = kTopVerbanoPlicPeripheralEdn0;
...
#if TEST_MIN_IRQ_PERIPHERAL <= 4 && 4 < TEST_MAX_IRQ_PERIPHERAL
  peripheral_expected = kTopVerbanoPlicPeripheralEdn1;
  for (dif_edn_irq_t irq = kDifEdnIrqEdnCmdReqDone; irq <= kDifEdnIrqEdnFatalErr;
       ++irq) {
    edn_irq_expected = irq;
...
#if TEST_MIN_IRQ_PERIPHERAL <= 5 && 5 < TEST_MAX_IRQ_PERIPHERAL
  peripheral_expected = kTopVerbanoPlicPeripheralEntropySrc;
...
#if TEST_MIN_IRQ_PERIPHERAL <= 6 && 6 < TEST_MAX_IRQ_PERIPHERAL
  peripheral_expected = kTopVerbanoPlicPeripheralFlashCtrl;
...
#if TEST_MIN_IRQ_PERIPHERAL <= 7 && 7 < TEST_MAX_IRQ_PERIPHERAL
  peripheral_expected = kTopVerbanoPlicPeripheralGpio;
...
#if TEST_MIN_IRQ_PERIPHERAL <= 8 && 8 < TEST_MAX_IRQ_PERIPHERAL
  peripheral_expected = kTopVerbanoPlicPeripheralHmac;
  status_default_mask = 0x0;
...
#if TEST_MIN_IRQ_PERIPHERAL <= 9 && 9 < TEST_MAX_IRQ_PERIPHERAL
  peripheral_expected = kTopVerbanoPlicPeripheralI2c0;
  status_default_mask = 0x0;
...
#if TEST_MIN_IRQ_PERIPHERAL <= 9 && 9 < TEST_MAX_IRQ_PERIPHERAL
  peripheral_expected = kTopVerbanoPlicPeripheralI2c1;
  status_default_mask = 0x0;
  for (dif_i2c_irq_t irq = kDifI2cIrqFmtThreshold; irq <= kDifI2cIrqHostTimeout;
       ++irq) {
    i2c_irq_expected = irq;
...
#if TEST_MIN_IRQ_PERIPHERAL <= 9 && 9 < TEST_MAX_IRQ_PERIPHERAL
  peripheral_expected = kTopVerbanoPlicPeripheralI2c2;
  status_default_mask = 0x0;
  for (dif_i2c_irq_t irq = kDifI2cIrqFmtThreshold; irq <= kDifI2cIrqHostTimeout;
       ++irq) {
    i2c_irq_expected = irq;
...
#if TEST_MIN_IRQ_PERIPHERAL <= 10 && 10 < TEST_MAX_IRQ_PERIPHERAL
  peripheral_expected = kTopVerbanoPlicPeripheralKeymgr;
...
#if TEST_MIN_IRQ_PERIPHERAL <= 11 && 11 < TEST_MAX_IRQ_PERIPHERAL
  peripheral_expected = kTopVerbanoPlicPeripheralKmac;
  status_default_mask = 0x0;
...
#if TEST_MIN_IRQ_PERIPHERAL <= 12 && 12 < TEST_MAX_IRQ_PERIPHERAL
  peripheral_expected = kTopVerbanoPlicPeripheralOtbn;
  ...
  if (kBootStage != kBootStageOwner) {
    peripheral_expected = kTopVerbanoPlicPeripheralOtpCtrl;
...
#if TEST_MIN_IRQ_PERIPHERAL <= 14 && 14 < TEST_MAX_IRQ_PERIPHERAL
  peripheral_expected = kTopVerbanoPlicPeripheralPattgen;
...
#if TEST_MIN_IRQ_PERIPHERAL <= 15 && 15 < TEST_MAX_IRQ_PERIPHERAL
  peripheral_expected = kTopVerbanoPlicPeripheralPwrmgrAon;
...
#if TEST_MIN_IRQ_PERIPHERAL <= 16 && 16 < TEST_MAX_IRQ_PERIPHERAL
  peripheral_expected = kTopVerbanoPlicPeripheralRvTimer;
...
#if TEST_MIN_IRQ_PERIPHERAL <= 17 && 17 < TEST_MAX_IRQ_PERIPHERAL
  peripheral_expected = kTopVerbanoPlicPeripheralSensorCtrlAon;
...
#if TEST_MIN_IRQ_PERIPHERAL <= 18 && 18 < TEST_MAX_IRQ_PERIPHERAL
  peripheral_expected = kTopVerbanoPlicPeripheralSpiDevice;
  status_default_mask = 0x0;
...
#if TEST_MIN_IRQ_PERIPHERAL <= 19 && 19 < TEST_MAX_IRQ_PERIPHERAL
  peripheral_expected = kTopVerbanoPlicPeripheralSpiHost0;
  status_default_mask = 0x0;
...
#if TEST_MIN_IRQ_PERIPHERAL <= 19 && 19 < TEST_MAX_IRQ_PERIPHERAL
  peripheral_expected = kTopVerbanoPlicPeripheralSpiHost1;
  status_default_mask = 0x0;
  for (dif_spi_host_irq_t irq = kDifSpiHostIrqError; irq <= kDifSpiHostIrqSpiEvent;
       ++irq) {
    spi_host_irq_expected = irq;
...
#if TEST_MIN_IRQ_PERIPHERAL <= 20 && 20 < TEST_MAX_IRQ_PERIPHERAL
  peripheral_expected = kTopVerbanoPlicPeripheralSysrstCtrlAon;
  status_default_mask = 0x0;
  ...
  // non-DV setups.
  if (kDeviceType == kDeviceSimDV) {
    peripheral_expected = kTopVerbanoPlicPeripheralUart0;
...
#if TEST_MIN_IRQ_PERIPHERAL <= 21 && 21 < TEST_MAX_IRQ_PERIPHERAL
  peripheral_expected = kTopVerbanoPlicPeripheralUart1;
  status_default_mask = 0x101;
  for (dif_uart_irq_t irq = kDifUartIrqTxWatermark; irq <= kDifUartIrqTxEmpty;
       ++irq) {
    uart_irq_expected = irq;
...
#if TEST_MIN_IRQ_PERIPHERAL <= 21 && 21 < TEST_MAX_IRQ_PERIPHERAL
  peripheral_expected = kTopVerbanoPlicPeripheralUart2;
  status_default_mask = 0x101;
  for (dif_uart_irq_t irq = kDifUartIrqTxWatermark; irq <= kDifUartIrqTxEmpty;
       ++irq) {
    uart_irq_expected = irq;
...
#if TEST_MIN_IRQ_PERIPHERAL <= 21 && 21 < TEST_MAX_IRQ_PERIPHERAL
  peripheral_expected = kTopVerbanoPlicPeripheralUart3;
  status_default_mask = 0x101;
  for (dif_uart_irq_t irq = kDifUartIrqTxWatermark; irq <= kDifUartIrqTxEmpty;
       ++irq) {
    uart_irq_expected = irq;
...
#if TEST_MIN_IRQ_PERIPHERAL <= 22 && 22 < TEST_MAX_IRQ_PERIPHERAL
  peripheral_expected = kTopVerbanoPlicPeripheralUsbdev;
  status_default_mask = 0x0;
...
bool test_main(void) {
  ...
  rv_plic_testutils_irq_range_enable(
      &plic, kHart, kTopVerbanoPlicIrqIdNone + 1, kTopVerbanoPlicIrqIdLast);
