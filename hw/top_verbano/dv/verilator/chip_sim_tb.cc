...
int main(int argc, char **argv) {
  ...
  std::string top_scope("TOP.chip_sim_tb.u_dut.top_verbano");
  ...
  // in chip_verbano_verilator.sv.  It must be at least 2 cycles of clk_aon.
  simctrl.SetInitialResetDelay(20000);
  simctrl.SetResetDuration(10);

  std::cout << "Simulation of OpenTitan Verbano" << std::endl
            << "=================================" << std::endl
            << std::endl;
