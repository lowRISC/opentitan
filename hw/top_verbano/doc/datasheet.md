# OpenTitan Verbano (Discrete Chip) Datasheet

# Overview

![Top Level Block Diagram](top_verbano_block_diagram.svg)

The OpenTitan Verbano chip is a low-power secure microcontroller that is designed for several use cases requiring hardware security.
...
The OpenTitan Verbano chip provides the following features:

<table>
<thead style='font-size:100%'>
  <tr>
    <th colspan="2">OpenTitan Verbano Features</th>
  </tr>
</thead>
...
For more detailed documentation including the pinout and system address map, see [OpenTitan Verbano Chip Specification](./design/README.md).
The [OpenTitan Verbano Chip DV Document](../dv/README.md) describes the chip-level DV environment and contains the chip-level test plan.
