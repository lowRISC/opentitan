...
filesets:
  files_dv:
    ...
    files:
      ...
      - model/gpio_model.sv: {is_include_file: true}
      ...
      - gpio_agent/gpio_data_agent_cfg.sv: {is_include_file: true}
      - gpio_agent/gpio_data_agent.sv: {is_include_file: true}
      - gpio_agent/gpio_data_driver.sv: {is_include_file: true}
      - gpio_agent/gpio_data_monitor.sv: {is_include_file: true}
