...
package ${module_instance_name}_env_pkg;
  ...
  `include "${module_instance_name}_agent/${module_instance_name}_data_driver.sv"
  `include "${module_instance_name}_agent/${module_instance_name}_data_monitor.sv"
  `include "${module_instance_name}_agent/${module_instance_name}_data_agent.sv"
