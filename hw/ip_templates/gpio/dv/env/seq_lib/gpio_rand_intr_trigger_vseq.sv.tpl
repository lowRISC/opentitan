...
// class : ${module_instance_name}_rand_intr_trigger_vseq
...
class ${module_instance_name}_rand_intr_trigger_vseq extends ${module_instance_name}_base_vseq;

  constraint num_trans_c {
    num_trans inside {[20:200]};
  }

  `uvm_object_utils(${module_instance_name}_rand_intr_trigger_vseq)
  `uvm_object_new
...
endclass : ${module_instance_name}_rand_intr_trigger_vseq
