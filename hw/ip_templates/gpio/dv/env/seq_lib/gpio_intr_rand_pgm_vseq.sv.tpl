...
// class : ${module_instance_name}_intr_rand_pgm_vseq
...
//      INTR_CTRL_EN_RISING
class ${module_instance_name}_intr_rand_pgm_vseq extends ${module_instance_name}_base_vseq;

  `uvm_object_utils(${module_instance_name}_intr_rand_pgm_vseq)
  `uvm_object_new
