...
// class : ${module_instance_name}_random_dout_din_vseq
...
class ${module_instance_name}_random_dout_din_vseq extends ${module_instance_name}_base_vseq;

  `uvm_object_utils(${module_instance_name}_random_dout_din_vseq)
  `uvm_object_new
...
endclass : ${module_instance_name}_random_dout_din_vseq
