...
class ${module_instance_name}_virtual_sequencer #(type CFG_T      = ${module_instance_name}_env_cfg,
                               type COV_T      = ${module_instance_name}_env_cov,
                               type ITEM_T     = uvm_sequence_item,
                               type RSP_ITEM_T = uvm_sequence_item) extends cip_base_virtual_sequencer #(CFG_T, COV_T);

  `uvm_component_param_utils(${module_instance_name}_virtual_sequencer #(CFG_T,
                                                      COV_T,
                                                      ITEM_T,
                                                      RSP_ITEM_T))
  ...
  function new(string name = "${module_instance_name}_virtual_sequencer", uvm_component parent = null);
