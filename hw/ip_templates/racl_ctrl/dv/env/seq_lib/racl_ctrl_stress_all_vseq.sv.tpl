...
task ${module_instance_name}_stress_all_vseq::body();
  fork
    super.body();
    begin
...
task ${module_instance_name}_stress_all_vseq::run_child(string child_vseq_name);
  ${module_instance_name}_base_vseq child;
