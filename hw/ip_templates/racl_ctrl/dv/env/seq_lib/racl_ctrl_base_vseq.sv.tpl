...
class ${module_instance_name}_base_vseq
  extends cip_base_vseq #(.RAL_T               (${module_instance_name}_reg_block),
...
function uvm_object ${module_instance_name}_base_vseq::clone();
  ${module_instance_name}_base_vseq ret;
...
task ${module_instance_name}_base_vseq::body();
...
task ${module_instance_name}_base_vseq::post_start();
  fork
    int_seq.request_end();
    ext_seq.request_end();
  join
...
function uvm_sequence ${module_instance_name}_base_vseq::create_seq_by_name(string name);
...
task ${module_instance_name}_base_vseq::clear_error_log();
