...
### V1
 ...
 Type         | Item                                  | Resolution  | Note/Collaterals
--------------|---------------------------------------|-------------|------------------
Documentation | [DV_DOC_DRAFT_COMPLETED][]            | Not Started | TODO: Link to DV document when it exists
Documentation | [TESTPLAN_COMPLETED][]                | Not Started | TODO: Link to DV document when it exists
