...
${"###"} Top level testbench
Top level testbench is located at `hw/top_${topname}/ip_autogen/clkmgr/dv/tb.sv`.
It instantiates the CLKMGR DUT module `hw/top_${topname}/ip_autogen/clkmgr/rtl/clkmgr.sv`.
In addition, it instantiates the following interfaces, connects them to the DUT and sets their handle into `uvm_config_db`:

* [Clock and reset interface](../../../../dv/sv/common_ifs/README.md)
* [TileLink host interface](../../../../dv/sv/tl_agent/README.md)
* CLKMGR IOs: `hw/top_${topname}/ip_autogen/clkmgr/dv/env/clkmgr_if.sv`
...
```systemverilog
  localparam int NUM_PERI = ${len(typed_clocks['sw_clks'])};
  localparam int NUM_TRANS = ${len(hint_names)};
