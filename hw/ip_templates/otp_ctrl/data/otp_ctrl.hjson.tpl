...
% endfor
  ...
  inter_signal_list: [
    ...
    { struct:  "lc_tx"
      type:    "uni"
      name:    "lc_rma_sw_rd_override_en"
      act:     "rcv"
      default: "lc_ctrl_pkg::Off"
      package: "lc_ctrl_pkg"
      desc:    '''
               SW read enable override enable coming from life cycle controller.
               This signal enables SW read access to (read-locked) partitions in the RMA state.
               '''
    }
    { struct:  "lc_tx"
      type:    "uni"
