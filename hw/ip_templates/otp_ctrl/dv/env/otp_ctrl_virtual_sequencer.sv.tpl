...
% if enable_nvm_key:
  push_pull_sequencer#(.DeviceDataWidth(NVM_DATA_SIZE)) nvm_data_pull_sequencer_h;
  push_pull_sequencer#(.DeviceDataWidth(NVM_DATA_SIZE)) nvm_addr_pull_sequencer_h;
% endif
