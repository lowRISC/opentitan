...
% endif
  ...
  parameter logic [SCRAMBLE_KEY_W-1:0]      RndCnstIbexKeyDefault       = RndCnstIbexKeyDefault,
  parameter logic [SCRAMBLE_NONCE_W-1:0]    RndCnstIbexNonceDefault     = RndCnstIbexNonceDefault,
