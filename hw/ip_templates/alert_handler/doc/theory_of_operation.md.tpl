...
```systemverilog
  typedef struct packed {
    ...
    // class state
    logic    [${n_classes-1}:0][AccuCntWidth-1:0] class_accum_cnt; // current accumulator value, per class.
    logic    [${n_classes-1}:0][EscCntWidth-1:0]  class_esc_cnt;   // current escalation counter value, per class.
    cstate_e [${n_classes-1}:0]                   class_esc_state; // current escalation protocol state, per class,
