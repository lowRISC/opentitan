      ...
      if(!cfg.under_reset) begin
        if (|gpio_i_driven === 1'b1) begin
          @(posedge cfg.straps_vif_inst.strap_en) begin
            ...
            // to allow the straps to be ready for sampling.
            cfg.clk_rst_vif.wait_clks(1);
            ...
            if (!first_strap_triggered) begin
              ...
              `DV_CHECK_CASE_EQ(gpio_i_driven,
              cfg.straps_vif_inst.straps_port_in.sampled_straps.data)
              // Check the register hw_straps_data_in_valid
              `DV_CHECK_CASE_EQ('b1,
              cfg.straps_vif_inst.straps_port_in.sampled_straps.valid)
