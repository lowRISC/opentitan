...
module gpio_reg_top
  ...
  assign inp_prd_cnt_val_0_re = racl_addr_hit_write[26] & reg_re & !reg_error;

  assign inp_prd_cnt_val_0_wd = '1;
  assign inp_prd_cnt_val_1_re = racl_addr_hit_write[27] & reg_re & !reg_error;

  assign inp_prd_cnt_val_1_wd = '1;
  assign inp_prd_cnt_val_2_re = racl_addr_hit_write[28] & reg_re & !reg_error;

  assign inp_prd_cnt_val_2_wd = '1;
  assign inp_prd_cnt_val_3_re = racl_addr_hit_write[29] & reg_re & !reg_error;

  assign inp_prd_cnt_val_3_wd = '1;
  assign inp_prd_cnt_val_4_re = racl_addr_hit_write[30] & reg_re & !reg_error;

  assign inp_prd_cnt_val_4_wd = '1;
  assign inp_prd_cnt_val_5_re = racl_addr_hit_write[31] & reg_re & !reg_error;

  assign inp_prd_cnt_val_5_wd = '1;
  assign inp_prd_cnt_val_6_re = racl_addr_hit_write[32] & reg_re & !reg_error;

  assign inp_prd_cnt_val_6_wd = '1;
  assign inp_prd_cnt_val_7_re = racl_addr_hit_write[33] & reg_re & !reg_error;
