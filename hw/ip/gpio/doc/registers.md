...
| gpio.[`HW_STRAPS_DATA_IN`](#hw_straps_data_in)             | 0x44     |        4 | GPIO input data that was sampled as straps when the block came out of reset. |
...
## HW_STRAPS_DATA_IN
GPIO input data that was sampled as straps when the block came out of reset.
...
- If the parameter is true then GPIO input data is sample after reset
on the first cycle where the strap_en_i input is high.
That sampled data is stored in this register.
- Offset: `0x44`
- Reset default: `0x0`
- Reset mask: `0xffffffff`
