...
module padring_assert (
  ...
  `ASSERT(MioIn_A,  mio_in_o[mio_sel] == mio_io[mio_sel] ^ mio_attr_i[mio_sel][0],
      clk_i, !rst_ni)

  `ASSERT(MioOutNormal_A, mio_oe_i[mio_sel] && !mio_attr_i[mio_sel][1] |->
      mio_output_value == mio_io[mio_sel], clk_i, !rst_ni)

  `ASSERT(MioOutOd0_A, mio_oe_i[mio_sel] && mio_attr_i[mio_sel][1] && !mio_output_value |->
      mio_io[mio_sel] == 1'b0, clk_i, !rst_ni)
  ...
  `ASSERT(MioOutOd1_A, mio_oe_i[mio_sel] && mio_attr_i[mio_sel][1] && mio_output_value |->
      ...
      mio_io[mio_sel] === 1'b1 ||
      mio_io[mio_sel] === 1'bz ||
      mio_io[mio_sel] === 1'bx, clk_i, !rst_ni)
  ...
  `ASSERT(DioIn_A,  dio_in_o[dio_sel] == dio_io[dio_sel] ^ dio_attr_i[dio_sel][0],
      clk_i, !rst_ni)

  `ASSERT(DioOutNormal_A, dio_oe_i[dio_sel] && !dio_attr_i[dio_sel][1] |->
      dio_output_value == dio_io[dio_sel], clk_i, !rst_ni)

  `ASSERT(DioOutOd0_A, dio_oe_i[dio_sel] && dio_attr_i[dio_sel][1] && !dio_output_value |->
      dio_io[dio_sel] == 1'b0, clk_i, !rst_ni)
  ...
  `ASSERT(DioOutOd1_A, dio_oe_i[dio_sel] && dio_attr_i[dio_sel][1] && dio_output_value |->
      ...
      dio_io[dio_sel] === 1'b1 ||
      dio_io[dio_sel] === 1'bz ||
      dio_io[dio_sel] === 1'bx, clk_i, !rst_ni)
