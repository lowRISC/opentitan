...
module padctrl_csr_assert_fpv import tlul_pkg::*; import padctrl_reg_pkg::*; (
  ...
  property r_wo_P(bit [5:0] addr, bit [DWidth-1:0] exp_data, bit [DWidth-1:0] mask,
      int lsb);
    logic [DWidth-1:0] id;
  ...
  `ASSERT(dio_pads0_wr_A, wr_ext_P(6'h4, dio_pads_q_fpv[29:0], u_reg.regen_qs, 'h3fffffff, 0))
  `ASSERT(dio_pads0_rd_A, rd_ext_P(6'h4, dio_pads_d_fpv[29:0], 'h3fffffff, 0))
  // assertions for register: dio_pads1
  `ASSERT(dio_pads1_wr_A, wr_ext_P(6'h8, dio_pads_q_fpv[39:30], u_reg.regen_qs, 'h3ff, 0))
