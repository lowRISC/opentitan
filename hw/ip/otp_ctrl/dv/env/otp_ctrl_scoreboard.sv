...
class otp_ctrl_scoreboard #(type CFG_T = otp_ctrl_env_cfg)
  ...
  virtual function bit [1:0] read_a_word_with_ecc(bit [TL_DW-1:0] dai_addr,
    ...
    prim_ot_secded_pkg::secded_22_16_t ecc_rd_data0 = cfg.mem_bkdr_util_h.ecc_read16(dai_addr);
    prim_ot_secded_pkg::secded_22_16_t ecc_rd_data1 = cfg.mem_bkdr_util_h.ecc_read16(dai_addr + 2);
