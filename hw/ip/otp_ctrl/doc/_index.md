...
`TimerLfsrSeed`             | (see RTL)             | (see RTL)    | Seed to be used for the internal 40bit partition check timer LFSR. This is a random netlist constant that needs to be regenerated by the silicon creator before the tapeout.
`TimerLfsrPerm`             | (see RTL)             | (see RTL)    | Permutation to be used for the internal 40bit partition check timer This is a random netlist constant that needs to be regenerated by the silicon creator before the tapeout.
