...
(
  ...
  assign otp_valid = reg2hw.direct_access_wdata[1].qe | reg2hw.direct_access_cmd.qe;
  ...
  prim_otp #(
    ...
    .rst_ni,
    // Test inerface
    .test_tl_i   ( tl_win_h2d    ),
    .test_tl_o   ( tl_win_d2h    ),
  ...
  always_comb begin : p_tie_off_or_connect
    ...
    hw2reg.xxx_token               = '0;
    hw2reg.test_unlock_token       = '0;
    hw2reg.test_exit_token         = '0;
    hw2reg.creator_root_key_share0 = '0;
    hw2reg.creator_root_key_share1 = '0;
    hw2reg.flash_addr_key          = '0;
    hw2reg.flash_data_key          = '0;
