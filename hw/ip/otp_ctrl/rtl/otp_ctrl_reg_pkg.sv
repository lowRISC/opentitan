...
package otp_ctrl_reg_pkg;
  ...
  parameter int CreatorSwCfgMinSecVerRomExtOffset = 272;
  parameter int CreatorSwCfgMinSecVerRomExtSize = 4;
  parameter int CreatorSwCfgMinSecVerBl0Offset = 276;
  parameter int CreatorSwCfgMinSecVerBl0Size = 4;
  parameter int CreatorSwCfgDefaultBootDataInProdEnOffset = 280;
  ...
  parameter int RomAlertClassEnOffset = 872;
  parameter int RomAlertClassEnSize = 4;
  parameter int RomAlertEscalationOffset = 876;
  parameter int RomAlertEscalationSize = 4;
  parameter int RomAlertClassificationOffset = 880;
  parameter int RomAlertClassificationSize = 320;
  parameter int RomLocalAlertClassificationOffset = 1200;
  parameter int RomLocalAlertClassificationSize = 64;
  parameter int RomAlertAccumThreshOffset = 1264;
  parameter int RomAlertAccumThreshSize = 16;
  parameter int RomAlertTimeoutCyclesOffset = 1280;
  parameter int RomAlertTimeoutCyclesSize = 16;
  parameter int RomAlertPhaseCyclesOffset = 1296;
  ...
  parameter int RomWatchdogBiteThresholdCyclesOffset = 1376;
  parameter int RomWatchdogBiteThresholdCyclesSize = 4;
  parameter int RomKeymgrRomExtMeasEnOffset = 1380;
