...
package otp_ctrl_reg_pkg;
  ...
  parameter int OwnerSwCfgRomBannerEnOffset = 1016;
  parameter int OwnerSwCfgRomBannerEnSize = 4;
  parameter int OwnerSwCfgRomFlashEccExcHandlerEnOffset = 1020;
  parameter int OwnerSwCfgRomFlashEccExcHandlerEnSize = 4;
  parameter int OwnerSwCfgRomMioSchmittEnOffset = 1024;
  parameter int OwnerSwCfgRomMioSchmittEnSize = 8;
  parameter int OwnerSwCfgRomDioSchmittEnOffset = 1032;
  parameter int OwnerSwCfgRomDioSchmittEnSize = 4;
