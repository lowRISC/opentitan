...
package otp_ctrl_reg_pkg;
  ...
  parameter int RomAlertClassificationSize = 192;
  parameter int RomAlertAccumThreshOffset = 980;
  parameter int RomAlertAccumThreshSize = 16;
  parameter int RomAlertTimeoutCyclesOffset = 996;
  parameter int RomAlertTimeoutCyclesSize = 16;
  parameter int RomAlertPhaseCyclesOffset = 1012;
