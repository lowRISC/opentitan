...
package otp_ctrl_reg_pkg;
  ...
  parameter int CreatorSwCfgSize = 416;
  ...
  parameter int CreatorSwCfgReservedOffset = 336;
  parameter int CreatorSwCfgReservedSize = 22;
  parameter int CreatorSwCfgDigestOffset = 472;
  parameter int CreatorSwCfgDigestSize = 8;
  parameter int OwnerSwCfgOffset = 480;
  parameter int OwnerSwCfgSize = 664;
  parameter int OwnerSwCfgRomErrorReportingOffset = 480;
  parameter int OwnerSwCfgRomErrorReportingSize = 4;
  parameter int OwnerSwCfgRomBootstrapDisOffset = 484;
  parameter int OwnerSwCfgRomBootstrapDisSize = 4;
  parameter int OwnerSwCfgRomAlertClassEnOffset = 488;
  parameter int OwnerSwCfgRomAlertClassEnSize = 4;
  parameter int OwnerSwCfgRomAlertEscalationOffset = 492;
  parameter int OwnerSwCfgRomAlertEscalationSize = 4;
  parameter int OwnerSwCfgRomAlertClassificationOffset = 496;
  ...
  parameter int OwnerSwCfgRomKeymgrOtpMeasEnOffset = 996;
  ...
  parameter int OwnerSwCfgRomExtBootstrapEnOffset = 1008;
  parameter int OwnerSwCfgRomExtBootstrapEnSize = 4;
  parameter int OwnerSwCfgRomSensorCtrlAlertCfgOffset = 1012;
