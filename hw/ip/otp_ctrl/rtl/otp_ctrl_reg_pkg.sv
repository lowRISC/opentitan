...
package otp_ctrl_reg_pkg;
  ...
  parameter int OwnerSwCfgRomAlertDigestProdOffset = 1364;
  parameter int OwnerSwCfgRomAlertDigestProdSize = 4;
  parameter int OwnerSwCfgRomAlertDigestProdEndOffset = 1368;
  parameter int OwnerSwCfgRomAlertDigestProdEndSize = 4;
  parameter int OwnerSwCfgRomAlertDigestDevOffset = 1372;
  parameter int OwnerSwCfgRomAlertDigestDevSize = 4;
  parameter int OwnerSwCfgRomAlertDigestRmaOffset = 1376;
  parameter int OwnerSwCfgRomAlertDigestRmaSize = 4;
  parameter int RomWatchdogBiteThresholdCyclesOffset = 1380;
  parameter int RomWatchdogBiteThresholdCyclesSize = 4;
  parameter int RomKeymgrRomExtMeasEnOffset = 1384;
  parameter int RomKeymgrRomExtMeasEnSize = 4;
  parameter int OwnerSwCfgManufStateOffset = 1388;
