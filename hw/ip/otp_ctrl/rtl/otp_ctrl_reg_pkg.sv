...
package otp_ctrl_reg_pkg;
  ...
  parameter int CreatorSwCfgSize = 432;
  ...
  parameter int CreatorSwCfgReservedSize = 22;
  parameter int CreatorSwCfgDigestOffset = 488;
  parameter int CreatorSwCfgDigestSize = 8;
  parameter int OwnerSwCfgOffset = 496;
  parameter int OwnerSwCfgSize = 648;
  parameter int OwnerSwCfgRomErrorReportingOffset = 496;
  parameter int OwnerSwCfgRomErrorReportingSize = 4;
  parameter int OwnerSwCfgRomBootstrapDisOffset = 500;
  parameter int OwnerSwCfgRomBootstrapDisSize = 4;
  parameter int OwnerSwCfgRomAlertClassEnOffset = 504;
  parameter int OwnerSwCfgRomAlertClassEnSize = 4;
  parameter int OwnerSwCfgRomAlertEscalationOffset = 508;
  parameter int OwnerSwCfgRomAlertEscalationSize = 4;
  parameter int OwnerSwCfgRomAlertClassificationOffset = 512;
  parameter int OwnerSwCfgRomAlertClassificationSize = 320;
  parameter int OwnerSwCfgRomLocalAlertClassificationOffset = 832;
  parameter int OwnerSwCfgRomLocalAlertClassificationSize = 64;
  parameter int OwnerSwCfgRomAlertAccumThreshOffset = 896;
  parameter int OwnerSwCfgRomAlertAccumThreshSize = 16;
  parameter int OwnerSwCfgRomAlertTimeoutCyclesOffset = 912;
  parameter int OwnerSwCfgRomAlertTimeoutCyclesSize = 16;
  parameter int OwnerSwCfgRomAlertPhaseCyclesOffset = 928;
  parameter int OwnerSwCfgRomAlertPhaseCyclesSize = 64;
  parameter int OwnerSwCfgRomAlertDigestProdOffset = 992;
  parameter int OwnerSwCfgRomAlertDigestProdSize = 4;
  parameter int OwnerSwCfgRomAlertDigestProdEndOffset = 996;
  parameter int OwnerSwCfgRomAlertDigestProdEndSize = 4;
  parameter int OwnerSwCfgRomAlertDigestDevOffset = 1000;
  parameter int OwnerSwCfgRomAlertDigestDevSize = 4;
  parameter int OwnerSwCfgRomAlertDigestRmaOffset = 1004;
  parameter int OwnerSwCfgRomAlertDigestRmaSize = 4;
  parameter int OwnerSwCfgRomWatchdogBiteThresholdCyclesOffset = 1008;
  parameter int OwnerSwCfgRomWatchdogBiteThresholdCyclesSize = 4;
  parameter int OwnerSwCfgRomKeymgrOtpMeasEnOffset = 1012;
  parameter int OwnerSwCfgRomKeymgrOtpMeasEnSize = 4;
  parameter int OwnerSwCfgManufStateOffset = 1016;
  parameter int OwnerSwCfgManufStateSize = 4;
  parameter int OwnerSwCfgRomRstmgrInfoEnOffset = 1020;
  parameter int OwnerSwCfgRomRstmgrInfoEnSize = 4;
  parameter int OwnerSwCfgRomExtBootstrapEnOffset = 1024;
  parameter int OwnerSwCfgRomExtBootstrapEnSize = 4;
  parameter int OwnerSwCfgRomSensorCtrlAlertCfgOffset = 1028;
  parameter int OwnerSwCfgRomSensorCtrlAlertCfgSize = 12;
  parameter int OwnerSwCfgRomSramReadbackEnOffset = 1040;
  parameter int OwnerSwCfgRomSramReadbackEnSize = 4;
  parameter int OwnerSwCfgRomPreserveResetReasonEnOffset = 1044;
  parameter int OwnerSwCfgRomPreserveResetReasonEnSize = 4;
  parameter int OwnerSwCfgRomResetReasonCheckValueOffset = 1048;
  parameter int OwnerSwCfgRomResetReasonCheckValueSize = 4;
  parameter int OwnerSwCfgRomBannerEnOffset = 1052;
  parameter int OwnerSwCfgRomBannerEnSize = 4;
  parameter int OwnerSwCfgRomFlashEccExcHandlerEnOffset = 1056;
