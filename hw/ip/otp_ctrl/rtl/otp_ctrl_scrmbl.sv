...
module otp_ctrl_scrmbl import otp_ctrl_pkg::*; (
  ...
  typedef enum logic [1:0] {SelEncDataOut,
                            SelDecDataOut,
                            SelDigestState,
                            SelDigestIV,
  ...
  typedef enum logic [1:0] {Idle, Decrypt, Encrypt, Digest} state_e;
  ...
  always_comb begin : p_fsm
    ...
    unique case (state_q)
      ...
      DecPass: begin
        data_state_sel  = DecDataOut;
        key_state_sel   = DecKeyOut;
      ...
      EncPass: begin
        data_state_sel  = EncDataOut;
        key_state_sel   = EncKeyOut;
        digest_state_en = 1'b1;
        key_state_en    = 1'b1;
        cnt_en          = 1'b1;
        if (cnt_q == NumPresentRounds-1) begin
