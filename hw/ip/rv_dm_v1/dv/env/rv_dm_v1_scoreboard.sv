...
class rv_dm_v1_scoreboard extends cip_base_scoreboard #(
    .CFG_T(rv_dm_v1_env_cfg),
    .RAL_T(rv_dm_v1_regs_reg_block),
    .COV_T(rv_dm_v1_env_cov)
  );
  `uvm_component_utils(rv_dm_v1_scoreboard)
  ...
  virtual task process_jtag_non_dmi_dtm_fifo();
    ...
    forever begin
      ...
      case (selected_dtm_csr.get_name())
        ...
        "dtmcs": begin
          // DMI traffic is internal to rv_dm_v1 module. The stimulus in jtag_dmi_reg_frontdoor reads
