...
// between sba_access_monitor and the rv_dm_v1_scoreboard. The former does SBA access related checks
...
class rv_dm_v1_sba_tl_access_vseq extends rv_dm_v1_base_vseq;
  `uvm_object_utils(rv_dm_v1_sba_tl_access_vseq)
  `uvm_object_new
  ...
  task body();
    ...
    cfg.rv_dm_v1_vif.disable_tlul_assert_host_sba_resp_svas = 1'b1;
...
class rv_dm_v1_delayed_resp_sba_tl_access_vseq extends rv_dm_v1_sba_tl_access_vseq;
  `uvm_object_utils(rv_dm_v1_delayed_resp_sba_tl_access_vseq)
  `uvm_object_new
...
// intg err.
class rv_dm_v1_bad_sba_tl_access_vseq extends rv_dm_v1_sba_tl_access_vseq;
  `uvm_object_utils(rv_dm_v1_bad_sba_tl_access_vseq)
  `uvm_object_new
...
// responses.
class rv_dm_v1_autoincr_sba_tl_access_vseq extends rv_dm_v1_sba_tl_access_vseq;
  `uvm_object_utils(rv_dm_v1_autoincr_sba_tl_access_vseq)
  `uvm_object_new
