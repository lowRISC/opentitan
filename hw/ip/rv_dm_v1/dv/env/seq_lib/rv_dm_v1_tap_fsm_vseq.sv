...
class rv_dm_v1_tap_fsm_vseq extends rv_dm_v1_base_vseq;
  `uvm_object_utils(rv_dm_v1_tap_fsm_vseq)
  ...
  task run_smoke();
    rv_dm_v1_smoke_vseq seq;
    `uvm_info(`gfn, "Starting rv_dm_v1_tap_fsm_vseq smoke test", UVM_LOW)
    `uvm_do(seq)
  endtask

endclass : rv_dm_v1_tap_fsm_vseq
