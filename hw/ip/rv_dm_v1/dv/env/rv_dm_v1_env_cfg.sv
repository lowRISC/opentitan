...
class rv_dm_v1_env_cfg extends cip_base_env_cfg #(.RAL_T(rv_dm_v1_regs_reg_block));

  // ext component cfgs
  virtual rv_dm_v1_if rv_dm_v1_vif;
  ...
  string mem_ral_name = "rv_dm_v1_mem_reg_block";

  `uvm_object_utils_begin(rv_dm_v1_env_cfg)
  ...
  virtual function void initialize(bit [31:0] csr_base_addr = '1);
    list_of_alerts = rv_dm_v1_env_pkg::LIST_OF_ALERTS;
    ...
    clk_freqs_mhz["rv_dm_v1_mem_reg_block"] = clk_freq_mhz;
