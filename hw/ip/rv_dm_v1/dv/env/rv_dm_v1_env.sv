...
class rv_dm_v1_env extends cip_base_env #(
    .CFG_T              (rv_dm_v1_env_cfg),
    .COV_T              (rv_dm_v1_env_cov),
    .VIRTUAL_SEQUENCER_T(rv_dm_v1_virtual_sequencer),
    .SCOREBOARD_T       (rv_dm_v1_scoreboard)
  );
  `uvm_component_utils(rv_dm_v1_env)
  ...
  function void build_phase(uvm_phase phase);
    ...
    // get vifs
    if (!uvm_config_db#(virtual rv_dm_v1_if)::get(this, "", "rv_dm_v1_vif", cfg.rv_dm_v1_vif)) begin
      `uvm_fatal(get_full_name(), "failed to get rv_dm_v1_vif from uvm_config_db")
    end
