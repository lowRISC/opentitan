...
module rv_dm_v1_mem_reg_top (
  ...
  // To HW
  output rv_dm_v1_reg_pkg::rv_dm_v1_mem_reg2hw_t reg2hw, // Write
  input  rv_dm_v1_reg_pkg::rv_dm_v1_mem_hw2reg_t hw2reg, // Read
