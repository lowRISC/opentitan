...
#(
  ...
  rv_dm_v1_reg_pkg::rv_dm_v1_regs_reg2hw_t regs_reg2hw;
  logic regs_intg_error, rom_intg_error;
  logic sba_gate_intg_error, rom_gate_intg_error;

  rv_dm_v1_regs_reg_top u_reg_regs (
    .clk_i,
    .rst_ni,
    .tl_i      (regs_tl_d_i    ),
    .tl_o      (regs_tl_d_o    ),
  ...
  // We are not instantiating the generated rv_dm_v1_mem_reg_top, since the registers are actually
  // implemented inside the vendored-in rv_dm_v1 module from the PULP project.
