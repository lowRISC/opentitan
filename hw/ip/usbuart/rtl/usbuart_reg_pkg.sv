...
package usbuart_reg_pkg;
  ...
  typedef struct packed {
    logic        q;
    logic        qe;
  } usbuart_reg2hw_alert_test_reg_t;
  ...
  // Register -> HW type
  typedef struct packed {
    usbuart_reg2hw_intr_state_reg_t intr_state; // [114:107]
    usbuart_reg2hw_intr_enable_reg_t intr_enable; // [106:99]
    usbuart_reg2hw_intr_test_reg_t intr_test; // [98:83]
    usbuart_reg2hw_alert_test_reg_t alert_test; // [82:81]
  ...
  parameter logic [BlockAw-1:0] USBUART_ALERT_TEST_OFFSET = 6'h c;
  parameter logic [BlockAw-1:0] USBUART_CTRL_OFFSET = 6'h 10;
  parameter logic [BlockAw-1:0] USBUART_STATUS_OFFSET = 6'h 14;
  parameter logic [BlockAw-1:0] USBUART_RDATA_OFFSET = 6'h 18;
  parameter logic [BlockAw-1:0] USBUART_WDATA_OFFSET = 6'h 1c;
  parameter logic [BlockAw-1:0] USBUART_FIFO_CTRL_OFFSET = 6'h 20;
  parameter logic [BlockAw-1:0] USBUART_FIFO_STATUS_OFFSET = 6'h 24;
  parameter logic [BlockAw-1:0] USBUART_OVRD_OFFSET = 6'h 28;
  parameter logic [BlockAw-1:0] USBUART_VAL_OFFSET = 6'h 2c;
  parameter logic [BlockAw-1:0] USBUART_TIMEOUT_CTRL_OFFSET = 6'h 30;
  parameter logic [BlockAw-1:0] USBUART_USBSTAT_OFFSET = 6'h 34;
  parameter logic [BlockAw-1:0] USBUART_USBPARAM_OFFSET = 6'h 38;
  ...
  parameter logic [0:0] USBUART_ALERT_TEST_RESVAL = 1'h 0;
  parameter logic [0:0] USBUART_ALERT_TEST_FATAL_FAULT_RESVAL = 1'h 0;
  ...
  parameter logic [3:0] USBUART_PERMIT [15] = '{
    ...
    4'b 0001, // index[ 3] USBUART_ALERT_TEST
    4'b 1111, // index[ 4] USBUART_CTRL
    4'b 0001, // index[ 5] USBUART_STATUS
    4'b 0001, // index[ 6] USBUART_RDATA
    4'b 0001, // index[ 7] USBUART_WDATA
    4'b 0001, // index[ 8] USBUART_FIFO_CTRL
    4'b 0111, // index[ 9] USBUART_FIFO_STATUS
    4'b 0001, // index[10] USBUART_OVRD
    4'b 0011, // index[11] USBUART_VAL
    4'b 1111, // index[12] USBUART_TIMEOUT_CTRL
