...
module usbdev_usbif #(
  ...
  assign std_write_d =
      out_ep_data_put & ((out_max_used_q < MaxPktSizeByte - 1) & (out_ep_put_addr[1:0] == 2'b11));
  ...
  assign mem_write_o =
      std_write_q | (~out_max_used_q[PktW] & (out_max_used_q[1:0] != 2'b11) & out_ep_acked);
  ...
  assign
      in_ep_data = in_ep_get_addr[1] ? (in_ep_get_addr[0] ? mem_rdata_i[31:24] : mem_rdata_i[23:16])
