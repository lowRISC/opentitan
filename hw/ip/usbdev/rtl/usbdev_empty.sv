...
#(
  ...
  assign tl_o = '0;
  assign alert_tx_o = '0;
  assign cio_usb_dp_o = 1'b0;
  assign cio_usb_dp_en_o = 1'b0;
  assign cio_usb_dn_o = 1'b0;
  assign cio_usb_dn_en_o = 1'b0;
  assign usb_tx_se0_o = 1'b0;
  assign usb_tx_d_o = 1'b0;
  assign usb_dp_pullup_o = 1'b0;
  assign usb_dn_pullup_o = 1'b0;
  assign usb_rx_enable_o = 1'b0;
  assign usb_tx_use_d_se0_o = 1'b0;
  assign usb_aon_suspend_req_o = 1'b0;
  assign usb_aon_wake_ack_o = 1'b0;
  assign usb_ref_val_o = 1'b0;
  assign usb_ref_pulse_o = 1'b0;
  assign intr_pkt_received_o = 1'b0;
  assign intr_pkt_sent_o = 1'b0;
  assign intr_powered_o = 1'b0;
  assign intr_disconnected_o = 1'b0;
  assign intr_host_lost_o = 1'b0;
  assign intr_link_reset_o = 1'b0;
  assign intr_link_suspend_o = 1'b0;
  assign intr_link_resume_o = 1'b0;
  assign intr_av_empty_o = 1'b0;
  assign intr_rx_full_o = 1'b0;
  assign intr_av_overflow_o = 1'b0;
  assign intr_link_in_err_o = 1'b0;
  assign intr_link_out_err_o = 1'b0;
  assign intr_rx_crc_err_o = 1'b0;
  assign intr_rx_pid_err_o = 1'b0;
  assign intr_rx_bitstuff_err_o = 1'b0;
  assign intr_frame_o = 1'b0;
   
  logic  unused;
  assign unused = clk_i & rst_ni & clk_aon_i & rst_aon_ni & ^ram_cfg_i & ^tl_i & ^alert_rx_i & cio_usb_dp_i & cio_usb_dn_i & usb_rx_d_i & cio_sense_i & usb_aon_bus_reset_i & usb_aon_sense_lost_i & usb_aon_wake_detect_active_i;
