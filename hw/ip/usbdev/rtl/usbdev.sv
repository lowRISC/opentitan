...
#(
  ...
  `OCAH_OT_ASSERT_KNOWN(USBTxDKnown_A, usb_tx_d_o)
  `OCAH_OT_ASSERT_KNOWN(CIODpKnown_A, cio_usb_dp_o)
  `OCAH_OT_ASSERT_KNOWN(CIODpEnKnown_A, cio_usb_dp_en_o)
  `OCAH_OT_ASSERT_KNOWN(CIODnKnown_A, cio_usb_dn_o)
  `OCAH_OT_ASSERT_KNOWN(CIODnEnKnown_A, cio_usb_dn_en_o)
  `OCAH_OT_ASSERT_KNOWN(USBTxSe0Known_A, usb_tx_se0_o)
  `OCAH_OT_ASSERT_KNOWN(USBDpPUKnown_A, usb_dp_pullup_o)
  `OCAH_OT_ASSERT_KNOWN(USBDnPUKnown_A, usb_dn_pullup_o)
  `OCAH_OT_ASSERT_KNOWN(USBRxEnableKnown_A, usb_rx_enable_o)
  `OCAH_OT_ASSERT_KNOWN(USBAonSuspendReqKnown_A, usb_aon_suspend_req_o)
  `OCAH_OT_ASSERT_KNOWN(USBAonWakeAckKnown_A, usb_aon_wake_ack_o)
  `OCAH_OT_ASSERT_KNOWN(USBRefValKnown_A, usb_ref_val_o, clk_i, !rst_ni)
  `OCAH_OT_ASSERT_KNOWN(USBRefPulseKnown_A, usb_ref_pulse_o, clk_i, !rst_ni)
  // Assert Known for alerts
  `OCAH_OT_ASSERT_KNOWN(AlertsKnown_A, alert_tx_o)
  //Interrupt signals
  `OCAH_OT_ASSERT_KNOWN(USBIntrPktRcvdKnown_A, intr_pkt_received_o)
  `OCAH_OT_ASSERT_KNOWN(USBIntrPktSentKnown_A, intr_pkt_sent_o)
  `OCAH_OT_ASSERT_KNOWN(USBIntrPwrdKnown_A, intr_powered_o)
  `OCAH_OT_ASSERT_KNOWN(USBIntrDisConKnown_A, intr_disconnected_o)
  `OCAH_OT_ASSERT_KNOWN(USBIntrHostLostKnown_A, intr_host_lost_o)
  `OCAH_OT_ASSERT_KNOWN(USBIntrLinkRstKnown_A, intr_link_reset_o)
  `OCAH_OT_ASSERT_KNOWN(USBIntrLinkSusKnown_A, intr_link_suspend_o)
  `OCAH_OT_ASSERT_KNOWN(USBIntrLinkResKnown_A, intr_link_resume_o)
  `OCAH_OT_ASSERT_KNOWN(USBIntrAvOutEmptyKnown_A, intr_av_out_empty_o)
  `OCAH_OT_ASSERT_KNOWN(USBIntrRxFullKnown_A, intr_rx_full_o)
  `OCAH_OT_ASSERT_KNOWN(USBIntrAvOverKnown_A, intr_av_overflow_o)
  `OCAH_OT_ASSERT_KNOWN(USBIntrLinkInErrKnown_A, intr_link_in_err_o)
  `OCAH_OT_ASSERT_KNOWN(USBIntrLinkOutErrKnown_A, intr_link_out_err_o)
  `OCAH_OT_ASSERT_KNOWN(USBIntrRxCrCErrKnown_A, intr_rx_crc_err_o)
  `OCAH_OT_ASSERT_KNOWN(USBIntrRxPidErrKnown_A, intr_rx_pid_err_o)
  `OCAH_OT_ASSERT_KNOWN(USBIntrRxBitstuffErrKnown_A, intr_rx_bitstuff_err_o)
  `OCAH_OT_ASSERT_KNOWN(USBIntrFrameKnown_A, intr_frame_o)
  `OCAH_OT_ASSERT_KNOWN(USBIntrAvSetupEmptyKnown_A, intr_av_setup_empty_o)
