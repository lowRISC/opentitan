...
module usbdev (
  ...
  assign rx_fifo_re = reg2hw.rxfifo.ep.re | reg2hw.rxfifo.setup.re | reg2hw.rxfifo.size.re |
      reg2hw.rxfifo.buffer.re;
  ...
  assign unused_rxfifo_q = {
    reg2hw.rxfifo.ep.q, reg2hw.rxfifo.setup.q, reg2hw.rxfifo.size.q, reg2hw.rxfifo.buffer.q
  };
  ...
  usbdev_flop_2syncpulse #(
      ...
      .d_i({
        ...
        usb_event_link_reset,
        usb_event_link_suspend,
        usb_event_host_lost,
        usb_event_connect
      }),
  ...
  assign usb_ref_val_d = usb_ref_pulse_o ?
      1'b1 : (!usb_link_active || usb_event_host_lost || usb_ref_disable) ? 1'b0 : usb_ref_val_q;
