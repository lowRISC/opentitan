...
module usbdev_reg_top (
  ...
  // R[out_data_toggle]: V(False)
  logic out_data_toggle_qe;
  logic [1:0] out_data_toggle_flds_we;
  prim_flop #(
    .Width(1),
    .ResetValue(0)
  ) u_out_data_toggle0_qe (
    .clk_i(clk_i),
    .rst_ni(rst_ni),
    .d_i(&out_data_toggle_flds_we),
    .q_o(out_data_toggle_qe)
  );
  //   F[status]: 11:0
  prim_subreg #(
    .DW      (12),
    ...
    // from internal hardware
    .de     (hw2reg.out_data_toggle.status.de),
  ...
  prim_subreg #(
    ...
    // from internal hardware
    .de     (hw2reg.out_data_toggle.mask.de),
  ...
  // R[in_data_toggle]: V(False)
  logic in_data_toggle_qe;
  logic [1:0] in_data_toggle_flds_we;
  prim_flop #(
    .Width(1),
    .ResetValue(0)
  ) u_in_data_toggle0_qe (
    .clk_i(clk_i),
    .rst_ni(rst_ni),
    .d_i(&in_data_toggle_flds_we),
    .q_o(in_data_toggle_qe)
  );
  //   F[status]: 11:0
  prim_subreg #(
    .DW      (12),
    ...
    // from internal hardware
    .de     (hw2reg.in_data_toggle.status.de),
  ...
  prim_subreg #(
    ...
    // from internal hardware
    .de     (hw2reg.in_data_toggle.mask.de),
