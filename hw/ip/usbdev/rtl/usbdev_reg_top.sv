...
module usbdev_reg_top (
  ...
  logic phy_config_we;
  logic phy_config_rx_single_ended_qs;
  logic phy_config_rx_single_ended_wd;
  ...
  //   F[rx_single_ended]: 0:0
  prim_subreg #(
    .DW      (1),
    .SwAccess(prim_subreg_pkg::SwAccessRW),
    .RESVAL  (1'h0)
  ) u_phy_config_rx_single_ended (
    .clk_i   (clk_i),
    .rst_ni  (rst_ni),

    // from register interface
    .we     (phy_config_we),
    .wd     (phy_config_rx_single_ended_wd),
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.phy_config.rx_single_ended.q),

    // to register interface (read)
    .qs     (phy_config_rx_single_ended_qs)
  );
  ...
  assign phy_config_rx_single_ended_wd = reg_wdata[0];
  ...
  always_comb begin
    ...
    unique case (1'b1)
      ...
      addr_hit[32]: begin
        reg_rdata_next[0] = phy_config_rx_single_ended_qs;
