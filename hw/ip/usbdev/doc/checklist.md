...
### V1
 ...
 Type         | Item                                  | Resolution  | Note/Collaterals
--------------|---------------------------------------|-------------|------------------
Documentation | [DV_PLAN_DRAFT_COMPLETED][]           | In Progress | [USB Device DV Plan]({{<relref "hw/ip/usbdev/doc/dv_plan" >}})
Documentation | [VERIFICATION_PLAN_COMPLETED][]       | In Progress | [USB Device Testplan]({{<relref "hw/ip/usbdev/doc/dv_plan/index.md#testplan" >}})
