...
#(// Random netlist constants
  ...
  always_comb begin : p_fsm
    ...
    // the lc_ctrl_v1_signal_decode submodule.
    ...
    unique case (fsm_state_q)
      ...
      // in the lc_ctrl_v1_signal_decode submodule.
      IdleSt: begin
        idle_o = 1'b1;
        ...
        // Only enter here if volatile RAW unlock is available and enabled.
          ...
          if (lc_state_q == LcStRaw &&
            ...
            // Transition invalid error is set by lc_ctrl_v1_state_transition module.
            fsm_state_d = PostTransSt;
          end
        // ----------- VOLATILE_TEST_UNLOCKED CODE SECTION END -----------
  ...
  lc_ctrl_v1_state_decode u_lc_ctrl_state_decode (
