...
#(
  ...
  lc_ctrl_v1_reg_pkg::lc_ctrl_v1_reg2hw_t reg2hw;
  lc_ctrl_v1_reg_pkg::lc_ctrl_v1_hw2reg_t hw2reg;
  ...
  lc_ctrl_v1_reg_pkg::lc_ctrl_v1_reg2hw_t tap_reg2hw;
  lc_ctrl_v1_reg_pkg::lc_ctrl_v1_hw2reg_t tap_hw2reg;

  lc_ctrl_v1_reg_top u_reg_tap (
    .clk_i,
    .rst_ni,
    .tl_i      ( tap_tl_h2d                  ),
    .tl_o      ( tap_tl_d2h                  ),
  ...
  // debug v0.13 specification to read and write the lc_ctrl_v1 CSRs:
  // https://github.com/riscv/riscv-debug-spec/blob/release/riscv-debug-release.pdf
  // The register addresses correspond to the byte offsets of the lc_ctrl_v1 CSRs, divided by 4.
  ...
  lc_ctrl_v1_kmac_if u_lc_ctrl_kmac_if (
    .clk_i,
    .rst_ni,
    .clk_kmac_i,
    .rst_kmac_ni,
