...
class lc_ctrl_v1_base_test extends cip_base_test #(
  .CFG_T(lc_ctrl_v1_env_cfg),
  .ENV_T(lc_ctrl_v1_env)
);

  `uvm_component_utils(lc_ctrl_v1_base_test)
  `uvm_component_new
  ...
  virtual function void add_message_demotes(dv_report_catcher catcher);
    ...
    msg = {
      ...
      "\s+register \"lc_ctrl_v1_reg_block.alert_test\" is being accessed"
    };
    catcher.add_change_sev("UVM/FLD/SET/BSY", msg, UVM_INFO);

  endfunction

endclass : lc_ctrl_v1_base_test
