...
package lc_ctrl_v1_dv_utils_pkg;
  // dep packages
  import uvm_pkg::*;
  import top_pkg::*;
  import dv_utils_pkg::*;
  ...
  parameter bit [15:0] A_VALUES[20] = '{
      lc_ctrl_v1_state_pkg::A0,
      lc_ctrl_v1_state_pkg::A1,
      lc_ctrl_v1_state_pkg::A2,
      lc_ctrl_v1_state_pkg::A3,
      lc_ctrl_v1_state_pkg::A4,
      lc_ctrl_v1_state_pkg::A5,
      lc_ctrl_v1_state_pkg::A6,
      lc_ctrl_v1_state_pkg::A7,
      lc_ctrl_v1_state_pkg::A8,
      lc_ctrl_v1_state_pkg::A9,
      lc_ctrl_v1_state_pkg::A10,
      lc_ctrl_v1_state_pkg::A11,
      lc_ctrl_v1_state_pkg::A12,
      lc_ctrl_v1_state_pkg::A13,
      lc_ctrl_v1_state_pkg::A14,
      lc_ctrl_v1_state_pkg::A15,
      lc_ctrl_v1_state_pkg::A16,
      lc_ctrl_v1_state_pkg::A17,
      lc_ctrl_v1_state_pkg::A18,
      lc_ctrl_v1_state_pkg::A19
  };

  parameter bit [15:0] B_VALUES[20] = '{
      lc_ctrl_v1_state_pkg::B0,
      lc_ctrl_v1_state_pkg::B1,
      lc_ctrl_v1_state_pkg::B2,
      lc_ctrl_v1_state_pkg::B3,
      lc_ctrl_v1_state_pkg::B4,
      lc_ctrl_v1_state_pkg::B5,
      lc_ctrl_v1_state_pkg::B6,
      lc_ctrl_v1_state_pkg::B7,
      lc_ctrl_v1_state_pkg::B8,
      lc_ctrl_v1_state_pkg::B9,
      lc_ctrl_v1_state_pkg::B10,
      lc_ctrl_v1_state_pkg::B11,
      lc_ctrl_v1_state_pkg::B12,
      lc_ctrl_v1_state_pkg::B13,
      lc_ctrl_v1_state_pkg::B14,
      lc_ctrl_v1_state_pkg::B15,
      lc_ctrl_v1_state_pkg::B16,
      lc_ctrl_v1_state_pkg::B17,
      lc_ctrl_v1_state_pkg::B18,
      lc_ctrl_v1_state_pkg::B19
  };

  parameter bit [15:0] C_VALUES[24] = '{
      lc_ctrl_v1_state_pkg::C0,
      lc_ctrl_v1_state_pkg::C1,
      lc_ctrl_v1_state_pkg::C2,
      lc_ctrl_v1_state_pkg::C3,
      lc_ctrl_v1_state_pkg::C4,
      lc_ctrl_v1_state_pkg::C5,
      lc_ctrl_v1_state_pkg::C6,
      lc_ctrl_v1_state_pkg::C7,
      lc_ctrl_v1_state_pkg::C8,
      lc_ctrl_v1_state_pkg::C9,
      lc_ctrl_v1_state_pkg::C10,
      lc_ctrl_v1_state_pkg::C11,
      lc_ctrl_v1_state_pkg::C12,
      lc_ctrl_v1_state_pkg::C13,
      lc_ctrl_v1_state_pkg::C14,
      lc_ctrl_v1_state_pkg::C15,
      lc_ctrl_v1_state_pkg::C16,
      lc_ctrl_v1_state_pkg::C17,
      lc_ctrl_v1_state_pkg::C18,
      lc_ctrl_v1_state_pkg::C19,
      lc_ctrl_v1_state_pkg::C20,
      lc_ctrl_v1_state_pkg::C21,
      lc_ctrl_v1_state_pkg::C22,
      lc_ctrl_v1_state_pkg::C23
  };

  parameter bit [15:0] D_VALUES[24] = '{
      lc_ctrl_v1_state_pkg::D0,
      lc_ctrl_v1_state_pkg::D1,
      lc_ctrl_v1_state_pkg::D2,
      lc_ctrl_v1_state_pkg::D3,
      lc_ctrl_v1_state_pkg::D4,
      lc_ctrl_v1_state_pkg::D5,
      lc_ctrl_v1_state_pkg::D6,
      lc_ctrl_v1_state_pkg::D7,
      lc_ctrl_v1_state_pkg::D8,
      lc_ctrl_v1_state_pkg::D9,
      lc_ctrl_v1_state_pkg::D10,
      lc_ctrl_v1_state_pkg::D11,
      lc_ctrl_v1_state_pkg::D12,
      lc_ctrl_v1_state_pkg::D13,
      lc_ctrl_v1_state_pkg::D14,
      lc_ctrl_v1_state_pkg::D15,
      lc_ctrl_v1_state_pkg::D16,
      lc_ctrl_v1_state_pkg::D17,
      lc_ctrl_v1_state_pkg::D18,
      lc_ctrl_v1_state_pkg::D19,
      lc_ctrl_v1_state_pkg::D20,
      lc_ctrl_v1_state_pkg::D21,
      lc_ctrl_v1_state_pkg::D22,
      lc_ctrl_v1_state_pkg::D23
  };
  ...
  function static lc_state_bin_t lc_state_to_bin(bit [LcStateWidth-1:0] val);
    ...
    for (int i = 0; i < $size(A_VALUES); i++) begin
      if (val[i*16+:16] == A_VALUES[i]) begin
        ...
        $fatal(0, "lc_ctrl_v1_dv_utils_pkg lc_state_to_bin: state %x not valid", val);
      end
    end
  endfunction
  ...
  function static lc_count_bin_t lc_count_to_bin(bit [LcCountWidth-1:0] val);
    ...
    for (int i = 0; i < $size(C_VALUES); i++) begin
      if (val[i*16+:16] == C_VALUES[i]) begin
        ...
        $fatal(0, "lc_ctrl_v1_dv_utils_pkg lc_count_to_bin: count %x not valid", val);
      end
    end
  endfunction
