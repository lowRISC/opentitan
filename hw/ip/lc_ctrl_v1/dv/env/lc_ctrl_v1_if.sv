...
interface lc_ctrl_v1_if (
  ...
  // Debug signals
  lc_ctrl_v1_env_pkg::lc_ctrl_v1_err_inj_t err_inj;
  lc_ctrl_v1_env_pkg::lc_ctrl_v1_test_phase_e test_phase;
  ...
  task automatic init(lc_state_e                     lc_state = LcStRaw,
    ...
    otp_i.count             = lc_cnt;
    otp_i.test_unlock_token = lc_ctrl_v1_env_pkg::get_random_token();
    otp_i.test_exit_token   = lc_ctrl_v1_env_pkg::get_random_token();
    otp_i.rma_token         = lc_ctrl_v1_env_pkg::get_random_token();
