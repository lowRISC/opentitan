...
class lc_ctrl_v1_env_cov extends cip_base_env_cov #(
  .CFG_T(lc_ctrl_v1_env_cfg)
);
  `uvm_component_utils(lc_ctrl_v1_env_cov)

  // the base class provides the following handles for use:
  // lc_ctrl_v1_env_cfg: cfg

  // Select error injections to mask for err_inj_cp
  const lc_ctrl_v1_err_inj_t ErrInjMask = '{post_trans_err: 1, default:0};
