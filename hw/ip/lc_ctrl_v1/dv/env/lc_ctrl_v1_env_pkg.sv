...
package lc_ctrl_v1_env_pkg;
  ...
  import lc_ctrl_v1_dv_utils_pkg::*;
  ...
  typedef struct packed {
    ...
    bit otp_prog_err;
    // OTP data to lc_ctrl_v1 has error bit set
    ...
    // Invalid LC fsm state - via force in lc_ctrl_v1_if
    bit lc_fsm_backdoor_err;
    // Invalid KMAC IF fsm state - via force in lc_ctrl_v1_if
    bit kmac_fsm_backdoor_err;
    // Invalid state - via force in lc_ctrl_v1_if
    bit state_backdoor_err;
    // Invalid count - via force in lc_ctrl_v1_if
  ...
  typedef virtual lc_ctrl_v1_if lc_ctrl_v1_vif;
  ...
  function automatic lc_ctrl_v1_state_pkg::lc_token_t get_random_token();
    `DV_CHECK_STD_RANDOMIZE_FATAL(get_random_token,, "lc_ctrl_v1_env_pkg");
  endfunction

  // package sources
  `include "lc_ctrl_v1_parameters_cfg.sv"
  `include "lc_ctrl_v1_env_cfg.sv"
  `include "lc_ctrl_v1_env_cov.sv"
  `include "lc_ctrl_v1_virtual_sequencer.sv"
  `include "lc_ctrl_v1_scoreboard.sv"
  `include "lc_ctrl_v1_env.sv"
  `include "lc_ctrl_v1_vseq_list.sv"
