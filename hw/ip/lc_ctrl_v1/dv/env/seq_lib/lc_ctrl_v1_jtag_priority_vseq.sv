...
class lc_ctrl_v1_jtag_priority_vseq extends lc_ctrl_v1_jtag_access_vseq;

  `uvm_object_utils(lc_ctrl_v1_jtag_priority_vseq)
  `uvm_object_new
    ...
    do begin
      ...
      fork
        ...
        begin : count_jtag_clks
          while (cfg.lc_ctrl_v1_vif.mutex_claim_jtag != 1) begin
        ...
        begin : count_tl_clks
          while (cfg.lc_ctrl_v1_vif.mutex_claim_tl != 1) begin
            cfg.clk_rst_vif.wait_clks(1);
            tl_clks++;
          end
        end : count_tl_clks
