...
class lc_ctrl_v1_jtag_access_vseq extends lc_ctrl_v1_base_vseq;

  // Who should claim the mutex
  rand lc_ctrl_v1_csr_intf_e mutex_owner_write, mutex_owner_read;
  ...
  uvm_reg_map m_map[lc_ctrl_v1_csr_intf_e];
  // Queue of register access specs
  reg_access_t m_reg_accesses[$];

  `uvm_object_utils(lc_ctrl_v1_jtag_access_vseq)
  `uvm_object_new
  ...
  virtual task drive_otp_i(bit rand_otp_i = 1);
    ...
    cfg.lc_ctrl_v1_vif.init(lc_state, lc_cnt);
  endtask
  ...
  virtual task body();
    ...
    repeat (num_trans) begin
      ...
      cfg.lc_ctrl_v1_vif.scan_rst_ni = scan_rst_ni;
  ...
  virtual task csr_write_mutex_claim;
    lc_ctrl_v1_csr_intf_e not_mutex_owner_write =
  ...
  virtual task csr_read_mutex_claim;
    lc_ctrl_v1_csr_intf_e not_mutex_owner_read =
  ...
  virtual task claim_mutex(lc_ctrl_v1_csr_intf_e sel);
  ...
  virtual task release_mutex(lc_ctrl_v1_csr_intf_e sel);
