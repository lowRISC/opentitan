...
class lc_ctrl_v1_common_vseq extends lc_ctrl_v1_base_vseq;
  `uvm_object_utils(lc_ctrl_v1_common_vseq)
  ...
  virtual task check_sec_cm_fi_resp(sec_cm_base_if_proxy if_proxy);
    ...
    dec_lc_state_e exp_lc_state_single = dec_lc_state(lc_state_e'(cfg.lc_ctrl_v1_vif.otp_i.state));
