...
class lc_ctrl_v1_claim_transition_if_vseq extends lc_ctrl_v1_smoke_vseq;
  `uvm_object_utils(lc_ctrl_v1_claim_transition_if_vseq)
...
endclass : lc_ctrl_v1_claim_transition_if_vseq
