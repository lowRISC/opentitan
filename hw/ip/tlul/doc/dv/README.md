...
* [Simulation results](https://reports.opentitan.org/hw/top_earlgrey/ip/xbar_main/dv/autogen/latest/report.html)
...
```console
$ dvsim $REPO_TOP/hw/$CHIP/ip/$XBAR_IP/dv/autogen/${XBAR_IP}_sim_cfg.hjson -i xbar_smoke
```
