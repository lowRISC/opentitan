...
module tlul_adapter_sram #(
  ...
  localparam int DataBitWidth = vbits(SramByte);

  localparam int WoffsetWidth = DataBitWidth - vbits(top_pkg::TL_DBW);
  ...
  if (top_pkg::TL_DW != SramDw) begin : gen_wordwidthadapt
    assign woffset = tl_i.a_address[DataBitWidth-1:vbits(top_pkg::TL_DBW)];
