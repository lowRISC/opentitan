...
### V1
 ...
 Type         | Item                                  | Resolution  | Note/Collaterals
--------------|---------------------------------------|-------------|------------------
Documentation | [DV_DOC_DRAFT_COMPLETED][]            | Done        | [PWM DV document]({{<relref "hw/ip/pwm/doc/dv" >}})
Documentation | [TESTPLAN_COMPLETED][]                | Done        | [PWM Testplan]({{<relref "hw/ip/pwm/doc/dv/index.md#testplan" >}})
