...
module ascon_reg_top (
  ...
  assign ctrl_shadowed_sideload_key_wd = reg_wdata[2];

  assign ctrl_shadowed_masked_ad_input_wd = reg_wdata[3];

  assign ctrl_shadowed_masked_msg_input_wd = reg_wdata[4];

  assign ctrl_shadowed_no_msg_wd = reg_wdata[5];

  assign ctrl_shadowed_no_ad_wd = reg_wdata[6];
  ...
  always_comb begin
    ...
    unique case (1'b1)
      ...
      addr_hit[37]: begin
        ...
        reg_rdata_next[2] = ctrl_shadowed_sideload_key_qs;
        reg_rdata_next[3] = ctrl_shadowed_masked_ad_input_qs;
        reg_rdata_next[4] = ctrl_shadowed_masked_msg_input_qs;
        reg_rdata_next[5] = ctrl_shadowed_no_msg_qs;
        reg_rdata_next[6] = ctrl_shadowed_no_ad_qs;
      end
