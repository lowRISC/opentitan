...
#(
  ...
  // FIXME
  logic unused_err_alert;
  assign unused_err_alert = intg_err_alert;
  ...
  logic unused_shadow_storage_err;
  logic unused_shadow_update_err;
  assign unused_shadow_storage_err = shadowed_storage_err;
  assign unused_shadow_update_err = shadowed_update_err;
