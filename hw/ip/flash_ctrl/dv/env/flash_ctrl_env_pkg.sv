...
package flash_ctrl_env_pkg;
  ...
  typedef struct packed {
    ...
    bit [flash_ctrl_pkg::BusAddrByteW-2:0] otf_addr; // addres for the ctrl interface per bank, 18:0
  } flash_op_t;
  ...
  localparam int unsigned FlashByteAddrWidth = flash_ctrl_pkg::BusAddrByteW - 1; // remove bank select
