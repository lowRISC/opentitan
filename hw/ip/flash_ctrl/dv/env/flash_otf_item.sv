...
class flash_otf_item extends uvm_object;
  ...
  function void scramble(bit[flash_phy_pkg::KeySize-1:0] addr_key, data_key,
  ...
  function void descramble(bit[flash_phy_pkg::KeySize-1:0] addr_key, data_key);
    bit[1:0] err72, err76;
    bit[flash_ctrl_pkg::BusAddrByteW-2:0] addr = cmd.addr;
