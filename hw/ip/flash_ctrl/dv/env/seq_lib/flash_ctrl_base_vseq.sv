...
class flash_ctrl_base_vseq extends cip_base_vseq #(
  ...
  // default info cfg
  flash_bank_mp_info_page_cfg_t defualt_info_page_cfg = '{default:1, scramble_en:0, ecc_en:0,
                                                          he_en:0};
  ...
  virtual task flash_ctrl_mp_region_cfg(uint index, flash_mp_region_cfg_t region_cfg = default_region_cfg);
    uvm_reg_data_t data;
    uvm_reg csr;
    //verilog_format: off
    data =
  ...
  virtual task flash_ctrl_mp_info_page_cfg(uint bank, uint info_part, uint page,
                                  flash_bank_mp_info_page_cfg_t page_cfg = defualt_info_page_cfg);
    uvm_reg_data_t data;
    uvm_reg csr;
