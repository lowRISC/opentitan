...
class flash_ctrl_info_part_access_vseq extends flash_ctrl_hw_sec_otp_vseq;
  ...
  task hw_info_cfg_update();
    ...
    cfg.ovrd_scr_dis = MuBi4True;//get_rand_mubi4_val(.t_weight(2), .f_weight(1), .other_weight(1));
    cfg.ovrd_ecc_dis = MuBi4False;//get_rand_mubi4_val(.t_weight(2), .f_weight(1), .other_weight(1));
