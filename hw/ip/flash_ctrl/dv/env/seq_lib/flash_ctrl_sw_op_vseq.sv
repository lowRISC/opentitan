...
class flash_ctrl_sw_op_vseq extends flash_ctrl_base_vseq;
  ...
  virtual function void configure_vseq();
    ...
    // DoNot enable access to any of the information partitions.
  ...
  task body();
    ...
    // Randmomize FLASH Operation
    `DV_CHECK_MEMBER_RANDOMIZE_FATAL(flash_op)

    // TEST SETUP

    bank               = 0;  // Bank 0
    flash_op.op        = flash_ctrl_pkg::FlashOpInvalid;  // Default Operation
