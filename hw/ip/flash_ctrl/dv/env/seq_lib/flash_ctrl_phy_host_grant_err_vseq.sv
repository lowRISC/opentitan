...
class flash_ctrl_phy_host_grant_err_vseq extends flash_ctrl_err_vseq;
  ...
  task run_error_event();
    ...
    string path1 = "tb.dut.u_eflash.gen_flash_cores[0].u_core.muxed_part";
    string path2 = "tb.dut.u_eflash.gen_flash_cores[0].u_core.ctrl_fsm_idle";
...
//          end
    ...
    csr_spinwait(.ptr(ral.fault_status.host_gnt_err), .exp_data(1'b1));
