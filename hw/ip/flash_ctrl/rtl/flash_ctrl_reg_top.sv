...
module flash_ctrl_reg_top (
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg0.rd_en0.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg0.prog_en0.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg0.erase_en0.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg0.base0.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg0.size0.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg1.rd_en1.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg1.prog_en1.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg1.erase_en1.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg1.base1.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg1.size1.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg2.rd_en2.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg2.prog_en2.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg2.erase_en2.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg2.base2.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg2.size2.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg3.rd_en3.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg3.prog_en3.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg3.erase_en3.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg3.base3.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg3.size3.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg4.rd_en4.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg4.prog_en4.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg4.erase_en4.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg4.base4.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg4.size4.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg5.rd_en5.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg5.prog_en5.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg5.erase_en5.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg5.base5.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg5.size5.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg6.rd_en6.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg6.prog_en6.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg6.erase_en6.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg6.base6.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg6.size6.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg7.rd_en7.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg7.prog_en7.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg7.erase_en7.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg7.base7.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_region_cfg7.size7.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_bank_cfg.erase_en0.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.mp_bank_cfg.erase_en1.q ),
