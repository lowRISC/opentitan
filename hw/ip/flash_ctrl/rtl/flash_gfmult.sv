...
//
//
// This design was sanity checked using pyfinite with 2^33 polynomial
...
module flash_gfmult #(
  ...
  parameter int StagesPerCycle = Width/2,
  ...
  function automatic logic [Width-1:0] gf_mult(
    input logic [StagesPerCycle-1:0][Width-1:0] matrix,
    input logic [StagesPerCycle-1:0] operand
  );
    logic [Width-1:0] mult_out;
