...
### V1
 ...
 Type         | Item                                  | Resolution  | Note/Collaterals
--------------|---------------------------------------|-------------|------------------
Documentation | [DV_DOC_DRAFT_COMPLETED][]            | Not Started | [SPI_HOST DV Plan]({{<relref "hw/ip/spi_host/doc/dv" >}})
Documentation | [DV_PLAN_COMPLETED][]                 | Not Started | [SPI_HOST Testplan]({{<relref "hw/ip/spi_host/doc/dv/index.md#dv_plan" >}})
