...
-->
This checklist is for [Hardware Stage]({{< relref "/doc/project/development_stages.md" >}}) transitions for the [SPI_HOST peripheral.]({{< relref "hw/ip/spi_host/doc" >}})
...
### V1
 ...
 Type         | Item                                  | Resolution  | Note/Collaterals
--------------|---------------------------------------|-------------|------------------
Documentation | [DV_DOC_DRAFT_COMPLETED][]            | Not Started | [SPI_HOST DV Plan]({{<relref "hw/ip/spi_host/doc/dv_plan" >}})
Documentation | [DV_PLAN_COMPLETED][]                 | Not Started | [SPI_HOST Testplan]({{<relref "hw/ip/spi_host/doc/dv_plan/index.md#testplan" >}})
