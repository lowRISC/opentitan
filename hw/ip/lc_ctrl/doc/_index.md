...
----------------------------|-----------------------|--------------|---------------
`LcKeymgrDivInvalid`        | (see RTL)             | (see RTL)    | Life cycle state group diversification value for keymgr. This is a random netlist constant that needs to be regenerated by the silicon creator before the tapeout.
`LcKeymgrDivTestDevRma`     | (see RTL)             | (see RTL)    | Life cycle state group diversification value for keymgr. This is a random netlist constant that needs to be regenerated by the silicon creator before the tapeout.
`LcKeymgrDivProduction`     | (see RTL)             | (see RTL)    | Life cycle state group diversification value for keymgr. This is a random netlist constant that needs to be regenerated by the silicon creator before the tapeout.
...
-------------------------|------------------|--------------------------------------|---------------
`jtag_req_i`             | `input`          | `jtag_pkg::jtag_req_t`               | JTAG input signals for life cycle TAP.
`jtag_req_o`             | `output`         | `jtag_pkg::jtag_rsp_t`               | JTAG output signals for life cycle TAP.
...
`lc_provision_wr_en_o`   | `output`         | `lc_tx_t`                            | [Multibit control signal]({{< relref "#life-cycle-decoded-outputs-and-controls" >}}).
`lc_provision_rd_en_o`   | `output`         | `lc_tx_t`                            | [Multibit control signal]({{< relref "#life-cycle-decoded-outputs-and-controls" >}}).
