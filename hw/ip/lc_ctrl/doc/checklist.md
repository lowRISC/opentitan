...
--------------|--------------------------------|-------------|------------------
Documentation | [SPEC_COMPLETE][]              | Not Started | [LC_CTRL Design Spec]({{<relref "hw/ip/lc_ctrl/doc" >}})
...
### V1
 ...
 Type         | Item                                  | Resolution  | Note/Collaterals
--------------|---------------------------------------|-------------|------------------
Documentation | [DV_PLAN_DRAFT_COMPLETED][]           | Not Started | [LC_CTRL DV Plan]({{<relref "hw/ip/lc_ctrl/doc/dv_plan" >}})
Documentation | [TESTPLAN_COMPLETED][]                | Not Started | [LC_CTRL Testplan]({{<relref "hw/ip/lc_ctrl/doc/dv_plan/index.md#testplan" >}})
