...
#(
  ...
  lc_tx_t lc_rma_sw_rd_override_en;
  ...
  prim_lc_sender u_prim_lc_sender_rma_sw_rd_override_en (
    .clk_i,
    .rst_ni,
    .lc_en_i(lc_rma_sw_rd_override_en),
    .lc_en_o(lc_rma_sw_rd_override_en_o)
  );
  ...
  `ASSERT(SignalsAreOffWhenNotEnabled_A,
      ...
      lc_tx_test_false_strict(lc_rma_sw_rd_override_en_o) &&
