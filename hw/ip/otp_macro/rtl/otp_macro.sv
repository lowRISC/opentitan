...
#(
  ...
  // Observability is too vendor specific so it is left to the vendor model to wire it up.
...
//  output logic [7:0]             otp_obs_o,
  ...
  // Test interfaces
  input                          otp_test_req_t test_i, //test_ctrl_i,
  output                         otp_test_rsp_t test_o, //logic [TestStatusWidth-1:0]      test_status_o,
