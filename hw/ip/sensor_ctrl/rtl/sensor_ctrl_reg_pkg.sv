...
package sensor_ctrl_reg_pkg;
  ...
  // Register Address
  parameter logic [12:0] SENSOR_CTRL_CFG_REGWEN_OFFSET = 13'h 0;
  parameter logic [12:0] SENSOR_CTRL_ACK_MODE_OFFSET = 13'h 4;
  parameter logic [12:0] SENSOR_CTRL_ALERT_STATE_OFFSET = 13'h 8;
  parameter logic [12:0] SENSOR_CTRL_STATUS_OFFSET = 13'h c;

  // Window parameter
  parameter logic [12:0] SENSOR_CTRL_AST_INTF_OFFSET = 13'h 1000;
  parameter logic [12:0] SENSOR_CTRL_AST_INTF_SIZE   = 13'h 400;
  ...
  parameter logic [3:0] SENSOR_CTRL_PERMIT [4] = '{
    4'b 0001, // index[0] SENSOR_CTRL_CFG_REGWEN
    4'b 0001, // index[1] SENSOR_CTRL_ACK_MODE
    4'b 0001, // index[2] SENSOR_CTRL_ALERT_STATE
    4'b 0001  // index[3] SENSOR_CTRL_STATUS
  };
endpackage
