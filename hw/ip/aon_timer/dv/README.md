...
Once it takes effect in the core (The scoreboard does back-door reads the values have propagated), the second part of the scoreboard will check that things behave correctly.
