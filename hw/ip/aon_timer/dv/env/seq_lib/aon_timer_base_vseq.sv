...
task aon_timer_base_vseq::aon_timer_shutdown();
  ...
  write_wkup_reg(ral.wkup_ctrl.enable, 1'b0, "tb.dut.u_reg.aon_wkup_ctrl_we");
  ...
  write_wkup_reg(ral.wdog_count, wdog_count, "tb.dut.u_reg.aon_wdog_count_we");
...
task aon_timer_base_vseq::aon_timer_init();
  ...
  // Register Write
  write_wkup_reg(ral.wkup_count_lo, 32'h0000_0000, "tb.dut.u_reg.aon_wkup_count_lo_we");
  write_wkup_reg(ral.wkup_count_hi, 32'h0000_0000, "tb.dut.u_reg.aon_wkup_count_hi_we");
  ...
  write_wkup_reg(ral.wkup_thold_lo, wkup_thold[31:0], "tb.dut.u_reg.aon_wkup_thold_lo_we");
  write_wkup_reg(ral.wkup_thold_hi, wkup_thold[63:32], "tb.dut.u_reg.aon_wkup_thold_hi_we");

  `uvm_info(`gfn, $sformatf("Writing 0x%0h to wdog_bark_thold", wdog_bark_thold), UVM_HIGH)
  write_wkup_reg(ral.wdog_bark_thold, wdog_bark_thold, "tb.dut.u_reg.aon_wdog_bark_thold_we");

  `uvm_info(`gfn, $sformatf("Writing 0x%0h to wdog_bite_thold", wdog_bite_thold), UVM_HIGH)
  write_wkup_reg(ral.wdog_bite_thold, wdog_bite_thold, "tb.dut.u_reg.aon_wdog_bite_thold_we");
