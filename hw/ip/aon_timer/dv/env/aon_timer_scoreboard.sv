...
function void aon_timer_scoreboard::update_timed_regs_independently(aon_timer_intr_timed_regs::
                                                                    timed_reg_e r, timers_e tmr);
  bfm_timed_regs_t new_regs;
  uvm_reg_data_t unpred_mask = timed_regs.timed[r].unpred_mask;
...
function void aon_timer_scoreboard::update_timed_regs_wdog();
  update_timed_regs_independently(.r(aon_timer_intr_timed_regs::TimedIntrStateWdogBark),
                                  .tmr(timers_e'(WDOG)));
