...
module entropy_src_reg_top (
  ...
  always_comb begin
    addr_hit = '0;
    addr_hit[ 0] = (reg_addr == ENTROPY_SRC_CIP_ID_OFFSET);
    addr_hit[ 1] = (reg_addr == ENTROPY_SRC_REVISION_OFFSET);
    addr_hit[ 2] = (reg_addr == ENTROPY_SRC_PARAMETER_BLOCK_TYPE_OFFSET);
    addr_hit[ 3] = (reg_addr == ENTROPY_SRC_PARAMETER_BLOCK_LENGTH_OFFSET);
    addr_hit[ 4] = (reg_addr == ENTROPY_SRC_NEXT_PARAMETER_BLOCK_OFFSET);
    addr_hit[ 5] = (reg_addr == ENTROPY_SRC_INTR_STATE_OFFSET);
    addr_hit[ 6] = (reg_addr == ENTROPY_SRC_INTR_ENABLE_OFFSET);
    addr_hit[ 7] = (reg_addr == ENTROPY_SRC_INTR_TEST_OFFSET);
    addr_hit[ 8] = (reg_addr == ENTROPY_SRC_ALERT_TEST_OFFSET);
    addr_hit[ 9] = (reg_addr == ENTROPY_SRC_ME_REGWEN_OFFSET);
    addr_hit[10] = (reg_addr == ENTROPY_SRC_SW_REGUPD_OFFSET);
    addr_hit[11] = (reg_addr == ENTROPY_SRC_REGWEN_OFFSET);
    addr_hit[12] = (reg_addr == ENTROPY_SRC_REV_OFFSET);
    addr_hit[13] = (reg_addr == ENTROPY_SRC_MODULE_ENABLE_OFFSET);
    addr_hit[14] = (reg_addr == ENTROPY_SRC_CONF_OFFSET);
    addr_hit[15] = (reg_addr == ENTROPY_SRC_ENTROPY_CONTROL_OFFSET);
    addr_hit[16] = (reg_addr == ENTROPY_SRC_ENTROPY_DATA_OFFSET);
    addr_hit[17] = (reg_addr == ENTROPY_SRC_HEALTH_TEST_WINDOWS_OFFSET);
    addr_hit[18] = (reg_addr == ENTROPY_SRC_REPCNT_THRESHOLDS_OFFSET);
    addr_hit[19] = (reg_addr == ENTROPY_SRC_REPCNTS_THRESHOLDS_OFFSET);
    addr_hit[20] = (reg_addr == ENTROPY_SRC_ADAPTP_HI_THRESHOLDS_OFFSET);
    addr_hit[21] = (reg_addr == ENTROPY_SRC_ADAPTP_LO_THRESHOLDS_OFFSET);
    addr_hit[22] = (reg_addr == ENTROPY_SRC_BUCKET_THRESHOLDS_OFFSET);
    addr_hit[23] = (reg_addr == ENTROPY_SRC_MARKOV_HI_THRESHOLDS_OFFSET);
    addr_hit[24] = (reg_addr == ENTROPY_SRC_MARKOV_LO_THRESHOLDS_OFFSET);
    addr_hit[25] = (reg_addr == ENTROPY_SRC_EXTHT_HI_THRESHOLDS_OFFSET);
    addr_hit[26] = (reg_addr == ENTROPY_SRC_EXTHT_LO_THRESHOLDS_OFFSET);
    addr_hit[27] = (reg_addr == ENTROPY_SRC_REPCNT_HI_WATERMARKS_OFFSET);
    addr_hit[28] = (reg_addr == ENTROPY_SRC_REPCNTS_HI_WATERMARKS_OFFSET);
    addr_hit[29] = (reg_addr == ENTROPY_SRC_ADAPTP_HI_WATERMARKS_OFFSET);
    addr_hit[30] = (reg_addr == ENTROPY_SRC_ADAPTP_LO_WATERMARKS_OFFSET);
    addr_hit[31] = (reg_addr == ENTROPY_SRC_EXTHT_HI_WATERMARKS_OFFSET);
    addr_hit[32] = (reg_addr == ENTROPY_SRC_EXTHT_LO_WATERMARKS_OFFSET);
    addr_hit[33] = (reg_addr == ENTROPY_SRC_BUCKET_HI_WATERMARKS_OFFSET);
    addr_hit[34] = (reg_addr == ENTROPY_SRC_MARKOV_HI_WATERMARKS_OFFSET);
    addr_hit[35] = (reg_addr == ENTROPY_SRC_MARKOV_LO_WATERMARKS_OFFSET);
    addr_hit[36] = (reg_addr == ENTROPY_SRC_REPCNT_TOTAL_FAILS_OFFSET);
    addr_hit[37] = (reg_addr == ENTROPY_SRC_REPCNTS_TOTAL_FAILS_OFFSET);
    addr_hit[38] = (reg_addr == ENTROPY_SRC_ADAPTP_HI_TOTAL_FAILS_OFFSET);
    addr_hit[39] = (reg_addr == ENTROPY_SRC_ADAPTP_LO_TOTAL_FAILS_OFFSET);
    addr_hit[40] = (reg_addr == ENTROPY_SRC_BUCKET_TOTAL_FAILS_OFFSET);
    addr_hit[41] = (reg_addr == ENTROPY_SRC_MARKOV_HI_TOTAL_FAILS_OFFSET);
    addr_hit[42] = (reg_addr == ENTROPY_SRC_MARKOV_LO_TOTAL_FAILS_OFFSET);
    addr_hit[43] = (reg_addr == ENTROPY_SRC_EXTHT_HI_TOTAL_FAILS_OFFSET);
    addr_hit[44] = (reg_addr == ENTROPY_SRC_EXTHT_LO_TOTAL_FAILS_OFFSET);
    addr_hit[45] = (reg_addr == ENTROPY_SRC_ALERT_THRESHOLD_OFFSET);
    addr_hit[46] = (reg_addr == ENTROPY_SRC_ALERT_SUMMARY_FAIL_COUNTS_OFFSET);
    addr_hit[47] = (reg_addr == ENTROPY_SRC_ALERT_FAIL_COUNTS_OFFSET);
    addr_hit[48] = (reg_addr == ENTROPY_SRC_EXTHT_FAIL_COUNTS_OFFSET);
    addr_hit[49] = (reg_addr == ENTROPY_SRC_FW_OV_CONTROL_OFFSET);
    addr_hit[50] = (reg_addr == ENTROPY_SRC_FW_OV_SHA3_START_OFFSET);
    addr_hit[51] = (reg_addr == ENTROPY_SRC_FW_OV_WR_FIFO_FULL_OFFSET);
    addr_hit[52] = (reg_addr == ENTROPY_SRC_FW_OV_RD_FIFO_OVERFLOW_OFFSET);
    addr_hit[53] = (reg_addr == ENTROPY_SRC_FW_OV_RD_DATA_OFFSET);
    addr_hit[54] = (reg_addr == ENTROPY_SRC_FW_OV_WR_DATA_OFFSET);
    addr_hit[55] = (reg_addr == ENTROPY_SRC_OBSERVE_FIFO_THRESH_OFFSET);
    addr_hit[56] = (reg_addr == ENTROPY_SRC_OBSERVE_FIFO_DEPTH_OFFSET);
    addr_hit[57] = (reg_addr == ENTROPY_SRC_DEBUG_STATUS_OFFSET);
    addr_hit[58] = (reg_addr == ENTROPY_SRC_RECOV_ALERT_STS_OFFSET);
    addr_hit[59] = (reg_addr == ENTROPY_SRC_ERR_CODE_OFFSET);
    addr_hit[60] = (reg_addr == ENTROPY_SRC_ERR_CODE_TEST_OFFSET);
    addr_hit[61] = (reg_addr == ENTROPY_SRC_MAIN_SM_STATE_OFFSET);
  end
  ...
  always_comb begin
    wr_err = (reg_we &
              ((addr_hit[ 0] & (|(ENTROPY_SRC_PERMIT[ 0] & ~reg_be))) |
               ...
               (addr_hit[57] & (|(ENTROPY_SRC_PERMIT[57] & ~reg_be))) |
               (addr_hit[58] & (|(ENTROPY_SRC_PERMIT[58] & ~reg_be))) |
               (addr_hit[59] & (|(ENTROPY_SRC_PERMIT[59] & ~reg_be))) |
               (addr_hit[60] & (|(ENTROPY_SRC_PERMIT[60] & ~reg_be))) |
               (addr_hit[61] & (|(ENTROPY_SRC_PERMIT[61] & ~reg_be)))));
  end
  ...
  assign me_regwen_we = addr_hit[9] & reg_we & !reg_error;

  assign me_regwen_wd = reg_wdata[0];
  assign sw_regupd_we = addr_hit[10] & reg_we & !reg_error;

  assign sw_regupd_wd = reg_wdata[0];
  assign module_enable_we = addr_hit[13] & reg_we & !reg_error;

  assign module_enable_wd = reg_wdata[3:0];
  assign conf_we = addr_hit[14] & reg_we & !reg_error;
  ...
  assign entropy_control_we = addr_hit[15] & reg_we & !reg_error;

  assign entropy_control_es_route_wd = reg_wdata[3:0];

  assign entropy_control_es_type_wd = reg_wdata[7:4];
  assign entropy_data_re = addr_hit[16] & reg_re & !reg_error;
  assign health_test_windows_we = addr_hit[17] & reg_we & !reg_error;

  assign health_test_windows_fips_window_wd = reg_wdata[15:0];

  assign health_test_windows_bypass_window_wd = reg_wdata[31:16];
  assign repcnt_thresholds_re = addr_hit[18] & reg_re & !reg_error;
  assign repcnt_thresholds_we = addr_hit[18] & reg_we & !reg_error;

  assign repcnt_thresholds_fips_thresh_wd = reg_wdata[15:0];

  assign repcnt_thresholds_bypass_thresh_wd = reg_wdata[31:16];
  assign repcnts_thresholds_re = addr_hit[19] & reg_re & !reg_error;
  assign repcnts_thresholds_we = addr_hit[19] & reg_we & !reg_error;

  assign repcnts_thresholds_fips_thresh_wd = reg_wdata[15:0];

  assign repcnts_thresholds_bypass_thresh_wd = reg_wdata[31:16];
  assign adaptp_hi_thresholds_re = addr_hit[20] & reg_re & !reg_error;
  assign adaptp_hi_thresholds_we = addr_hit[20] & reg_we & !reg_error;

  assign adaptp_hi_thresholds_fips_thresh_wd = reg_wdata[15:0];

  assign adaptp_hi_thresholds_bypass_thresh_wd = reg_wdata[31:16];
  assign adaptp_lo_thresholds_re = addr_hit[21] & reg_re & !reg_error;
  assign adaptp_lo_thresholds_we = addr_hit[21] & reg_we & !reg_error;

  assign adaptp_lo_thresholds_fips_thresh_wd = reg_wdata[15:0];

  assign adaptp_lo_thresholds_bypass_thresh_wd = reg_wdata[31:16];
  assign bucket_thresholds_re = addr_hit[22] & reg_re & !reg_error;
  assign bucket_thresholds_we = addr_hit[22] & reg_we & !reg_error;

  assign bucket_thresholds_fips_thresh_wd = reg_wdata[15:0];

  assign bucket_thresholds_bypass_thresh_wd = reg_wdata[31:16];
  assign markov_hi_thresholds_re = addr_hit[23] & reg_re & !reg_error;
  assign markov_hi_thresholds_we = addr_hit[23] & reg_we & !reg_error;

  assign markov_hi_thresholds_fips_thresh_wd = reg_wdata[15:0];

  assign markov_hi_thresholds_bypass_thresh_wd = reg_wdata[31:16];
  assign markov_lo_thresholds_re = addr_hit[24] & reg_re & !reg_error;
  assign markov_lo_thresholds_we = addr_hit[24] & reg_we & !reg_error;

  assign markov_lo_thresholds_fips_thresh_wd = reg_wdata[15:0];

  assign markov_lo_thresholds_bypass_thresh_wd = reg_wdata[31:16];
  assign extht_hi_thresholds_re = addr_hit[25] & reg_re & !reg_error;
  assign extht_hi_thresholds_we = addr_hit[25] & reg_we & !reg_error;

  assign extht_hi_thresholds_fips_thresh_wd = reg_wdata[15:0];

  assign extht_hi_thresholds_bypass_thresh_wd = reg_wdata[31:16];
  assign extht_lo_thresholds_re = addr_hit[26] & reg_re & !reg_error;
  assign extht_lo_thresholds_we = addr_hit[26] & reg_we & !reg_error;

  assign extht_lo_thresholds_fips_thresh_wd = reg_wdata[15:0];

  assign extht_lo_thresholds_bypass_thresh_wd = reg_wdata[31:16];
  assign repcnt_hi_watermarks_re = addr_hit[27] & reg_re & !reg_error;
  assign repcnts_hi_watermarks_re = addr_hit[28] & reg_re & !reg_error;
  assign adaptp_hi_watermarks_re = addr_hit[29] & reg_re & !reg_error;
  assign adaptp_lo_watermarks_re = addr_hit[30] & reg_re & !reg_error;
  assign extht_hi_watermarks_re = addr_hit[31] & reg_re & !reg_error;
  assign extht_lo_watermarks_re = addr_hit[32] & reg_re & !reg_error;
  assign bucket_hi_watermarks_re = addr_hit[33] & reg_re & !reg_error;
  assign markov_hi_watermarks_re = addr_hit[34] & reg_re & !reg_error;
  assign markov_lo_watermarks_re = addr_hit[35] & reg_re & !reg_error;
  assign repcnt_total_fails_re = addr_hit[36] & reg_re & !reg_error;
  assign repcnts_total_fails_re = addr_hit[37] & reg_re & !reg_error;
  assign adaptp_hi_total_fails_re = addr_hit[38] & reg_re & !reg_error;
  assign adaptp_lo_total_fails_re = addr_hit[39] & reg_re & !reg_error;
  assign bucket_total_fails_re = addr_hit[40] & reg_re & !reg_error;
  assign markov_hi_total_fails_re = addr_hit[41] & reg_re & !reg_error;
  assign markov_lo_total_fails_re = addr_hit[42] & reg_re & !reg_error;
  assign extht_hi_total_fails_re = addr_hit[43] & reg_re & !reg_error;
  assign extht_lo_total_fails_re = addr_hit[44] & reg_re & !reg_error;
  assign alert_threshold_we = addr_hit[45] & reg_we & !reg_error;

  assign alert_threshold_alert_threshold_wd = reg_wdata[15:0];

  assign alert_threshold_alert_threshold_inv_wd = reg_wdata[31:16];
  assign alert_summary_fail_counts_re = addr_hit[46] & reg_re & !reg_error;
  assign alert_fail_counts_re = addr_hit[47] & reg_re & !reg_error;
  assign extht_fail_counts_re = addr_hit[48] & reg_re & !reg_error;
  assign fw_ov_control_we = addr_hit[49] & reg_we & !reg_error;

  assign fw_ov_control_fw_ov_mode_wd = reg_wdata[3:0];

  assign fw_ov_control_fw_ov_entropy_insert_wd = reg_wdata[7:4];
  assign fw_ov_sha3_start_we = addr_hit[50] & reg_we & !reg_error;

  assign fw_ov_sha3_start_wd = reg_wdata[3:0];
  assign fw_ov_wr_fifo_full_re = addr_hit[51] & reg_re & !reg_error;
  assign fw_ov_rd_fifo_overflow_we = addr_hit[52] & reg_we & !reg_error;

  assign fw_ov_rd_fifo_overflow_wd = reg_wdata[0];
  assign fw_ov_rd_data_re = addr_hit[53] & reg_re & !reg_error;
  assign fw_ov_wr_data_we = addr_hit[54] & reg_we & !reg_error;

  assign fw_ov_wr_data_wd = reg_wdata[31:0];
  assign observe_fifo_thresh_we = addr_hit[55] & reg_we & !reg_error;

  assign observe_fifo_thresh_wd = reg_wdata[6:0];
  assign observe_fifo_depth_re = addr_hit[56] & reg_re & !reg_error;
  assign debug_status_re = addr_hit[57] & reg_re & !reg_error;
  assign recov_alert_sts_we = addr_hit[58] & reg_we & !reg_error;
  ...
  assign err_code_test_we = addr_hit[60] & reg_we & !reg_error;
  ...
  always_comb begin
    ...
    reg_we_check[9] = me_regwen_we;
    reg_we_check[10] = sw_regupd_we;
    reg_we_check[11] = 1'b0;
    reg_we_check[12] = 1'b0;
    reg_we_check[13] = module_enable_gated_we;
    reg_we_check[14] = conf_gated_we;
    reg_we_check[15] = entropy_control_gated_we;
    reg_we_check[16] = 1'b0;
    reg_we_check[17] = health_test_windows_gated_we;
    reg_we_check[18] = repcnt_thresholds_gated_we;
    reg_we_check[19] = repcnts_thresholds_gated_we;
    reg_we_check[20] = adaptp_hi_thresholds_gated_we;
    reg_we_check[21] = adaptp_lo_thresholds_gated_we;
    reg_we_check[22] = bucket_thresholds_gated_we;
    reg_we_check[23] = markov_hi_thresholds_gated_we;
    reg_we_check[24] = markov_lo_thresholds_gated_we;
    reg_we_check[25] = extht_hi_thresholds_gated_we;
    reg_we_check[26] = extht_lo_thresholds_gated_we;
    ...
    reg_we_check[45] = alert_threshold_gated_we;
    reg_we_check[46] = 1'b0;
    reg_we_check[47] = 1'b0;
    reg_we_check[48] = 1'b0;
    reg_we_check[49] = fw_ov_control_gated_we;
    reg_we_check[50] = fw_ov_sha3_start_we;
    reg_we_check[51] = 1'b0;
    reg_we_check[52] = fw_ov_rd_fifo_overflow_we;
    reg_we_check[53] = 1'b0;
    reg_we_check[54] = fw_ov_wr_data_we;
    reg_we_check[55] = observe_fifo_thresh_gated_we;
    reg_we_check[56] = 1'b0;
    reg_we_check[57] = 1'b0;
    reg_we_check[58] = recov_alert_sts_we;
    reg_we_check[59] = 1'b0;
    reg_we_check[60] = err_code_test_we;
