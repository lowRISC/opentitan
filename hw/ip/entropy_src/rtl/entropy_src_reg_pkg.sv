...
package entropy_src_reg_pkg;
  ...
  // Register -> HW type
  typedef struct packed {
    entropy_src_reg2hw_intr_state_reg_t intr_state; // [517:514]
    entropy_src_reg2hw_intr_enable_reg_t intr_enable; // [513:510]
    entropy_src_reg2hw_intr_test_reg_t intr_test; // [509:502]
    entropy_src_reg2hw_alert_test_reg_t alert_test; // [501:498]
    entropy_src_reg2hw_conf_reg_t conf; // [497:486]
    entropy_src_reg2hw_entropy_control_reg_t entropy_control; // [485:484]
    entropy_src_reg2hw_entropy_data_reg_t entropy_data; // [483:451]
    entropy_src_reg2hw_health_test_windows_reg_t health_test_windows; // [450:419]
    entropy_src_reg2hw_repcnt_thresholds_reg_t repcnt_thresholds; // [418:385]
    entropy_src_reg2hw_repcnts_thresholds_reg_t repcnts_thresholds; // [384:351]
    entropy_src_reg2hw_adaptp_hi_thresholds_reg_t adaptp_hi_thresholds; // [350:317]
    entropy_src_reg2hw_adaptp_lo_thresholds_reg_t adaptp_lo_thresholds; // [316:283]
    entropy_src_reg2hw_bucket_thresholds_reg_t bucket_thresholds; // [282:249]
    entropy_src_reg2hw_markov_hi_thresholds_reg_t markov_hi_thresholds; // [248:215]
    entropy_src_reg2hw_markov_lo_thresholds_reg_t markov_lo_thresholds; // [214:181]
    entropy_src_reg2hw_extht_hi_thresholds_reg_t extht_hi_thresholds; // [180:147]
    entropy_src_reg2hw_extht_lo_thresholds_reg_t extht_lo_thresholds; // [146:113]
    entropy_src_reg2hw_alert_threshold_reg_t alert_threshold; // [112:81]
    entropy_src_reg2hw_fw_ov_control_reg_t fw_ov_control; // [80:79]
