...
package entropy_src_reg_pkg;
  ...
  // HW -> register type
  typedef struct packed {
    entropy_src_hw2reg_intr_state_reg_t intr_state; // [1067:1060]
    entropy_src_hw2reg_regwen_reg_t regwen; // [1059:1058]
    entropy_src_hw2reg_entropy_data_reg_t entropy_data; // [1057:1026]
    entropy_src_hw2reg_repcnt_thresholds_reg_t repcnt_thresholds; // [1025:994]
    entropy_src_hw2reg_repcnts_thresholds_reg_t repcnts_thresholds; // [993:962]
    entropy_src_hw2reg_adaptp_hi_thresholds_reg_t adaptp_hi_thresholds; // [961:930]
    entropy_src_hw2reg_adaptp_lo_thresholds_reg_t adaptp_lo_thresholds; // [929:898]
    entropy_src_hw2reg_bucket_thresholds_reg_t bucket_thresholds; // [897:866]
    entropy_src_hw2reg_markov_hi_thresholds_reg_t markov_hi_thresholds; // [865:834]
    entropy_src_hw2reg_markov_lo_thresholds_reg_t markov_lo_thresholds; // [833:802]
    entropy_src_hw2reg_extht_hi_thresholds_reg_t extht_hi_thresholds; // [801:770]
    entropy_src_hw2reg_extht_lo_thresholds_reg_t extht_lo_thresholds; // [769:738]
    entropy_src_hw2reg_repcnt_hi_watermarks_reg_t repcnt_hi_watermarks; // [737:706]
    entropy_src_hw2reg_repcnts_hi_watermarks_reg_t repcnts_hi_watermarks; // [705:674]
    entropy_src_hw2reg_adaptp_hi_watermarks_reg_t adaptp_hi_watermarks; // [673:642]
    entropy_src_hw2reg_adaptp_lo_watermarks_reg_t adaptp_lo_watermarks; // [641:610]
    entropy_src_hw2reg_extht_hi_watermarks_reg_t extht_hi_watermarks; // [609:578]
    entropy_src_hw2reg_extht_lo_watermarks_reg_t extht_lo_watermarks; // [577:546]
    entropy_src_hw2reg_bucket_hi_watermarks_reg_t bucket_hi_watermarks; // [545:514]
    entropy_src_hw2reg_markov_hi_watermarks_reg_t markov_hi_watermarks; // [513:482]
    entropy_src_hw2reg_markov_lo_watermarks_reg_t markov_lo_watermarks; // [481:450]
    entropy_src_hw2reg_repcnt_total_fails_reg_t repcnt_total_fails; // [449:418]
    entropy_src_hw2reg_repcnts_total_fails_reg_t repcnts_total_fails; // [417:386]
    entropy_src_hw2reg_adaptp_hi_total_fails_reg_t adaptp_hi_total_fails; // [385:354]
    entropy_src_hw2reg_adaptp_lo_total_fails_reg_t adaptp_lo_total_fails; // [353:322]
    entropy_src_hw2reg_bucket_total_fails_reg_t bucket_total_fails; // [321:290]
    entropy_src_hw2reg_markov_hi_total_fails_reg_t markov_hi_total_fails; // [289:258]
    entropy_src_hw2reg_markov_lo_total_fails_reg_t markov_lo_total_fails; // [257:226]
    entropy_src_hw2reg_extht_hi_total_fails_reg_t extht_hi_total_fails; // [225:194]
    entropy_src_hw2reg_extht_lo_total_fails_reg_t extht_lo_total_fails; // [193:162]
    entropy_src_hw2reg_alert_summary_fail_counts_reg_t alert_summary_fail_counts; // [161:146]
    entropy_src_hw2reg_alert_fail_counts_reg_t alert_fail_counts; // [145:118]
    entropy_src_hw2reg_extht_fail_counts_reg_t extht_fail_counts; // [117:110]
    entropy_src_hw2reg_fw_ov_wr_fifo_full_reg_t fw_ov_wr_fifo_full; // [109:109]
    entropy_src_hw2reg_fw_ov_rd_fifo_overflow_reg_t fw_ov_rd_fifo_overflow; // [108:107]
    entropy_src_hw2reg_fw_ov_rd_data_reg_t fw_ov_rd_data; // [106:75]
    entropy_src_hw2reg_observe_fifo_depth_reg_t observe_fifo_depth; // [74:68]
    entropy_src_hw2reg_debug_status_reg_t debug_status; // [67:56]
    entropy_src_hw2reg_recov_alert_sts_reg_t recov_alert_sts; // [55:30]
