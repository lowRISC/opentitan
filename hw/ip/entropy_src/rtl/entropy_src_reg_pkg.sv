...
package entropy_src_reg_pkg;
  ...
  // Register -> HW type
  typedef struct packed {
    entropy_src_reg2hw_intr_state_reg_t intr_state; // [534:532]
    entropy_src_reg2hw_intr_enable_reg_t intr_enable; // [531:529]
    entropy_src_reg2hw_intr_test_reg_t intr_test; // [528:523]
  ...
  // HW -> register type
  typedef struct packed {
    entropy_src_hw2reg_intr_state_reg_t intr_state; // [1037:1032]
