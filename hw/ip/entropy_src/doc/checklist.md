...
### V1
 ...
 Type         | Item                                  | Resolution  | Note/Collaterals
--------------|---------------------------------------|-------------|------------------
Documentation | [DV_PLAN_DRAFT_COMPLETED][]           | Not Started | [ENTROPY_SRC DV Plan]({{<relref "hw/ip/entropy_src/doc/dv_plan" >}})
Documentation | [TESTPLAN_COMPLETED][]                | Not Started | [ENTROPY_SRC Testplan]({{<relref "hw/ip/entropy_src/doc/dv_plan/index.md#testplan" >}})
