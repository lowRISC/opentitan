...
--------------|--------------------------------|-------------|------------------
Documentation | [SPEC_COMPLETE][]              | Not Started | [ENTROPY_SRC Design Spec]({{<relref "hw/ip/entropy_src/doc" >}})
...
### V1
 ...
 Type         | Item                                  | Resolution  | Note/Collaterals
--------------|---------------------------------------|-------------|------------------
Documentation | [DV_PLAN_DRAFT_COMPLETED][]           | Done        | [ENTROPY_SRC DV Plan]({{<relref "hw/ip/entropy_src/doc/dv_plan" >}})
Documentation | [VERIFICATION_PLAN_COMPLETED][]       | In Progress | [ENTROPY_SRC Testplan]({{<relref "hw/ip/entropy_src/doc/dv_plan/index.md#testplan" >}})
