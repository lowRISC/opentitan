...
This checklist is for [Hardware Stage](../../../../doc/project_governance/development_stages.md) transitions for the [CHERIoT peripheral.](../README.md)
...
--------------|--------------------------------|-------------|------------------
Documentation | [SPEC_COMPLETE][]              | Done        | [CHERIoT Design Spec](../README.md)
Documentation | [CSR_DEFINED][]                | Done        | [CHERIoT Registers](registers.md).
RTL           | [CLKRST_CONNECTED][]           | Done        |
RTL           | [IP_TOP][]                     | Done        |
RTL           | [IP_INSTANTIABLE][]            | Not Started | Instantiated in `top_earlgrey`; clean top-level elaboration not yet verified.
RTL           | [PHYSICAL_MACROS_DEFINED_80][] | N/A         |
RTL           | [FUNC_IMPLEMENTED][]           | Done        |
RTL           | [ASSERT_KNOWN_ADDED][]         | Done        |
Code Quality  | [LINT_SETUP][]                 | Done        | Linting using Verilator in-place
Security      | [SEC_CM_SCOPED][]              | Not Started | Lockstep of the CHERIoT subsystem, end-to-end integrity between CHERIoT, Ibex, and the memory endpoints specified.
...
Documentation | [BLOCK_DIAGRAM][]         | Done        | [Block diagram](theory_of_operation.md#block-diagram)
Documentation | [DOC_INTERFACE][]         | Done        | [Hardware Interfaces](interfaces.md)
...
### D2S
 ...
 Type         | Item                         | Resolution  | Note/Collaterals
--------------|------------------------------|-------------|------------------
Security      | [SEC_CM_ASSETS_LISTED][]     | Done        | [cheriot.hjson](../data/cheriot.hjson)
...
### V1
 ...
 Type         | Item                                  | Resolution  | Note/Collaterals
--------------|---------------------------------------|-------------|------------------
Documentation | [DV_DOC_DRAFT_COMPLETED][]            | Not Started | Template present [CHERIOT DV document](../dv/README.md)
Documentation | [TESTPLAN_COMPLETED][]                | Not Started | Template present [Testplan](../data/cheriot_testplan.hjson)
Testbench     | [TB_TOP_CREATED][]                    | Done        | [tb.sv](../dv/tb.sv)
...
Tests         | [SIM_CSR_MEM_TEST_SUITE_PASSING][]    | Not Started | `mem_tests` is not imported as `revbm` has no registers and no RAL memory to walk.
