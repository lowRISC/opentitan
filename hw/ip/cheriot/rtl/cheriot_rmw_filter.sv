...
module cheriot_rmw_filter #(
  ...
  assign tag_up_to_date = tl_d_i.d_data[bit_sel_q] == tag_q;
  ...
  always_comb begin : proc_rmw_fsm
    ...
    unique case(state_q)
      ...
      // done with the RMW operation and can return to pass-through.
      WriteBackAck: begin
        ack_write_back = 1'b1;
  ...
  always_comb begin : proc_tl_muxing
    ...
    // the modified upstream write request, to check whether the corresponding
