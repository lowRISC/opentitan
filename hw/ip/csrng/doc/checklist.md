...
### V1
 ...
 Type         | Item                                  | Resolution  | Note/Collaterals
--------------|---------------------------------------|-------------|------------------
Documentation | [DV_PLAN_DRAFT_COMPLETED][]           | Not Started | [CSRNG DV Plan]({{<relref "hw/ip/csrng/doc/dv_plan" >}})
Documentation | [TESTPLAN_COMPLETED][]                | Not Started | [CSRNG Testplan]({{<relref "hw/ip/csrng/doc/dv_plan/index.md#testplan" >}})
