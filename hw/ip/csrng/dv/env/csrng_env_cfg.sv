...
class csrng_env_cfg extends cip_base_env_cfg #(.RAL_T(csrng_reg_block));
  ...
  // ext component cfgs
  rand push_pull_agent_cfg#(.DataWidth(CSRNG_DATA_WIDTH))   m_entropy_src_agent_cfg;
  ...
  virtual function void initialize(bit [31:0] csr_base_addr = '1);
    ...
    m_entropy_src_agent_cfg = push_pull_agent_cfg#(.DataWidth(CSRNG_DATA_WIDTH))::type_id::create("m_entropy_src_agent_cfg");
