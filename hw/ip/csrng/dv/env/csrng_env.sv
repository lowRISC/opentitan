...
class csrng_env extends cip_base_env #(
  ...
  push_pull_agent#(.DataWidth(CSRNG_DATA_WIDTH))   m_entropy_src_agent;
  ...
  function void build_phase(uvm_phase phase);
    ...
    // create components
    m_entropy_src_agent = push_pull_agent#(.DataWidth(CSRNG_DATA_WIDTH))::type_id::create("m_entropy_src_agent", this);
    uvm_config_db#(push_pull_agent_cfg#(.DataWidth(CSRNG_DATA_WIDTH)))::set(this,
    ...
    if (!uvm_config_db#(virtual pins_if)::get(this, "", "efuse_sw_app_enable_vif", cfg.efuse_sw_app_enable_vif)) begin
