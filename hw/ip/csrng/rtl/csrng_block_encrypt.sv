...
module csrng_block_encrypt import aes_pkg::*; #(
  ...
  localparam BlkEncFifoDepth = 1;
  localparam BlkEncFifoWidth = BlkLen+StateId+Cmd;
  // TODO: review all AES localparams
  localparam AES192Enable = 0;
  localparam Masking      = 0;
  localparam sbox_impl_e SBoxImpl = SBoxImplLut;
  localparam int NumShares = Masking ? 2 : 1;
...
//  assign     state_mask = {8'hff,8'hff,8'hff,8'hff,8'hff,8'hff,8'hff,8'hff,
//                           8'hff,8'hff,8'hff,8'hff,8'hff,8'hff,8'hff,8'hff};

  assign     state_init[0] = block_encrypt_v_i;
//  assign     state_init[1] = state_mask;

//  assign     key_mask = {8'hff,8'hff,8'hff,8'hff,8'hff,8'hff,8'hff,8'hff,
//                         8'hff,8'hff,8'hff,8'hff,8'hff,8'hff,8'hff,8'hff,
//                         8'hff,8'hff,8'hff,8'hff,8'hff,8'hff,8'hff,8'hff,
//                         8'hff,8'hff,8'hff,8'hff,8'hff,8'hff,8'hff,8'hff};

  assign     key_init[0] = block_encrypt_key_i;
//  assign     key_init[1] = key_mask;
...
//  assign     state_out = state_done[0] ^ state_done[1];
  ...
  // TODO: review all AES cipher connections
  // Cipher core
  aes_cipher_core #(
