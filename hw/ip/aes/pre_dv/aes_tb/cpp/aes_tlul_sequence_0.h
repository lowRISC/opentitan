...
static const TLI tl_i_transactions[num_transactions_max] = {
    ...
    {true, 0, 0, 2, 0, AES_CONFIG, 0xF,
     (0x0 << AES_CTRL_MANUAL_OPERATION_OFFSET) |
         (0x1 << AES_CTRL_KEY_LEN_OFFSET) | (kCryptoAesEcb << 1) | 0x1,
     0, true},  // ctrl - decrypt, 128-bit
    {true, 0, 0, 2, 0, AES_KEY_SHARE00 + 0x00, 0xF, 0x16157E2B, 0, true},
    {true, 0, 0, 2, 0, AES_KEY_SHARE00 + 0x04, 0xF, 0xA6D2AE28, 0, true},
    {true, 0, 0, 2, 0, AES_KEY_SHARE00 + 0x08, 0xF, 0x8815F7AB, 0, true},
    {true, 0, 0, 2, 0, AES_KEY_SHARE00 + 0x0C, 0xF, 0x3C4FCF09, 0, true},
    {true, 0, 0, 2, 0, AES_KEY_SHARE00 + 0x10, 0xF, 0xFFFFFFFF, 0, true},
    {true, 0, 0, 2, 0, AES_KEY_SHARE00 + 0x14, 0xF, 0xFFFFFFFF, 0, true},
    {true, 0, 0, 2, 0, AES_KEY_SHARE00 + 0x18, 0xF, 0xFFFFFFFF, 0, true},
    {true, 0, 0, 2, 0, AES_KEY_SHARE00 + 0x1c, 0xF, 0xFFFFFFFF, 0, true},
    ...
    {true, 0, 0, 2, 0, AES_KEY_SHARE10 + 0x10, 0xF, 0xFFFFFFFF, 0, true},
    {true, 0, 0, 2, 0, AES_KEY_SHARE10 + 0x14, 0xF, 0xFFFFFFFF, 0, true},
    {true, 0, 0, 2, 0, AES_KEY_SHARE10 + 0x18, 0xF, 0xFFFFFFFF, 0, true},
    {true, 0, 0, 2, 0, AES_KEY_SHARE10 + 0x1c, 0xF, 0xFFFFFFFF, 0, true},

    {true, 0, 0, 2, 0, AES_DATA_IN0 + 0x0, 0xF, 0xA8F64332, 0, true},
    {true, 0, 0, 2, 0, AES_DATA_IN0 + 0x4, 0xF, 0x8D305A88, 0, true},
    {true, 0, 0, 2, 0, AES_DATA_IN0 + 0x8, 0xF, 0xA2983131, 0, true},
    {true, 0, 0, 2, 0, AES_DATA_IN0 + 0xC, 0xF, 0x340737E0, 0, true},
    ...
    {true, 0, 0, 2, 0, AES_CONFIG, 0xF,
     (0x0 << AES_CTRL_MANUAL_OPERATION_OFFSET) |
         (0x2 << AES_CTRL_KEY_LEN_OFFSET) | (kCryptoAesEcb << 1) | 0x1,
     0, true},  // ctrl - decrypt, 192-bit
    {true, 0, 0, 2, 0, AES_KEY_SHARE00 + 0x00, 0xF, 0xF7B0738E, 0, true},
    {true, 0, 0, 2, 0, AES_KEY_SHARE00 + 0x04, 0xF, 0x52640EDA, 0, true},
    {true, 0, 0, 2, 0, AES_KEY_SHARE00 + 0x08, 0xF, 0x2BF310C8, 0, true},
    {true, 0, 0, 2, 0, AES_KEY_SHARE00 + 0x0C, 0xF, 0xE5799080, 0, true},
    {true, 0, 0, 2, 0, AES_KEY_SHARE00 + 0x10, 0xF, 0xD2EAF862, 0, true},
    {true, 0, 0, 2, 0, AES_KEY_SHARE00 + 0x14, 0xF, 0x7B6B2C52, 0, true},
    {true, 0, 0, 2, 0, AES_KEY_SHARE00 + 0x18, 0xF, 0xFFFFFFFF, 0, true},
    {true, 0, 0, 2, 0, AES_KEY_SHARE00 + 0x1c, 0xF, 0xFFFFFFFF, 0, true},
    ...
    {true, 0, 0, 2, 0, AES_CONFIG, 0xF,
     (0x0 << AES_CTRL_MANUAL_OPERATION_OFFSET) |
         (0x4 << AES_CTRL_KEY_LEN_OFFSET) | (kCryptoAesEcb << 1) | 0x1,
     0, true},  // ctrl - decrypt, 256-bit
    {true, 0, 0, 2, 0, AES_KEY_SHARE00 + 0x00, 0xF, 0x10EB3D60, 0, true},
    {true, 0, 0, 2, 0, AES_KEY_SHARE00 + 0x04, 0xF, 0xBE71CA15, 0, true},
    {true, 0, 0, 2, 0, AES_KEY_SHARE00 + 0x08, 0xF, 0xF0AE732B, 0, true},
    {true, 0, 0, 2, 0, AES_KEY_SHARE00 + 0x0C, 0xF, 0x81777D85, 0, true},
    {true, 0, 0, 2, 0, AES_KEY_SHARE00 + 0x10, 0xF, 0x072C351F, 0, true},
    {true, 0, 0, 2, 0, AES_KEY_SHARE00 + 0x14, 0xF, 0xD708613B, 0, true},
    {true, 0, 0, 2, 0, AES_KEY_SHARE00 + 0x18, 0xF, 0xA310982D, 0, true},
    {true, 0, 0, 2, 0, AES_KEY_SHARE00 + 0x1c, 0xF, 0xF4DF1409, 0, true},
    ...
    {true, 0, 0, 2, 0, AES_KEY_SHARE00, 0xF, 0x55555555, 0,
