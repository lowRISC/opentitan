...
### V1
 ...
 Type         | Item                                  | Resolution  | Note/Collaterals
--------------|---------------------------------------|-------------|------------------
Documentation | [DV_PLAN_DRAFT_COMPLETED][]           | Not Started | [PWRMGR DV Plan]({{<relref "hw/top_earlgrey/doc/dv_plan/index.md" >}})
Documentation | [VERIFICATION_PLAN_COMPLETED][]       | Not Started | [PWRMGR Testplan]()
