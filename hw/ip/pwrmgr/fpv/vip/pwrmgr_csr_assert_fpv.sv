...
// for all the regsters, declare assertion
  ...
  `ASSERT(control_wr_A, wr_P(6, 6'hc, i_pwrmgr.reg2hw.control.q, i_pwrmgr.i_reg_top.ctrl_cfg_regwen_qs))
  `ASSERT(control_stable_A, wr_regen_stable_P(i_pwrmgr.i_reg_top.ctrl_cfg_regwen_qs, i_pwrmgr.reg2hw.control.q))
  `ASSERT(control_rd_A, rd_P(6, 6'hc, i_pwrmgr.hw2reg.control.d))

  // read/write assertions for register: cfg_cdc_sync
  `ASSERT(cfg_cdc_sync_wr_A, wr_P(0, 6'h10, i_pwrmgr.reg2hw.cfg_cdc_sync.q, 0))
  `ASSERT(cfg_cdc_sync_rd_A, rd_P(0, 6'h10, i_pwrmgr.hw2reg.cfg_cdc_sync.d))

  // read/write assertions for register: ctrl_cfg_regwen
  `ASSERT(ctrl_cfg_regwen_wr_A, wr_ext_P(0, 6'h14, i_pwrmgr.reg2hw.ctrl_cfg_regwen.q, 0))
  `ASSERT(ctrl_cfg_regwen_rd_A, rd_ext_P(0, 6'h14, i_pwrmgr.hw2reg.ctrl_cfg_regwen.d))
  ...
  `ASSERT(wakeup_en_regwen_wr_A, wr_P(0, 6'h1c, i_pwrmgr.i_reg_top.wakeup_en_regwen_we, 0))
  `ASSERT(wakeup_en_regwen_rd_A, rd_P(0, 6'h1c, i_pwrmgr.i_reg_top.wakeup_en_regwen_qs))
  ...
  `ASSERT(reset_en_regwen_wr_A, wr_P(0, 6'h28, i_pwrmgr.i_reg_top.reset_en_regwen_we, 0))
  `ASSERT(reset_en_regwen_rd_A, rd_P(0, 6'h28, i_pwrmgr.i_reg_top.reset_en_regwen_qs))
