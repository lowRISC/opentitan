...
module adc_ctrl_intr import adc_ctrl_reg_pkg::*; (
  ...
  // inputs from aon domain
  input  [NumAdcFilter-1:0] aon_filter_status_i,

  // inputs from configuration domain
  input  [NumAdcFilter-1:0] adc_wakeup_status_i,
  ...
  // Update from hardware side whenever there is a matching event
  // Events that have already met, keep asserted and let software clear
  assign adc_wakeup_status_o.de = |filter_match_event;
  assign adc_wakeup_status_o.d  = filter_match_event | adc_wakeup_status_i;
