...
--------------|--------------------------------|-------------|------------------
Documentation | [SPEC_COMPLETE][]              | Not Started | [ADC_CTRL Design Spec]({{<relref "." >}})
...
Documentation | [DV_PLAN_COMPLETED][]                 | Not Started | [ADC_CTRL DV Plan]({{<relref "dv/index.md#dv_plan" >}})
