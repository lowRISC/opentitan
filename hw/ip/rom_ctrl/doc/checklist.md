...
### V1
 ...
 Type         | Item                                  | Resolution  | Note/Collaterals
--------------|---------------------------------------|-------------|------------------
Documentation | [DV_DOC_DRAFT_COMPLETED][]            | Done        | [ROM Controller DV document]({{<relref "dv" >}})
...
Tests         | [FPV_MAIN_ASSERTIONS_PROVEN][]        | N/A         | Not currently using FPV for this block
Tool Setup    | [SIM_ALT_TOOL_SETUP][]                | N/A         | No alternative tool available
Regression    | [SIM_SMOKE_REGRESSION_SETUP][]        | Done        |
Regression    | [SIM_NIGHTLY_REGRESSION_SETUP][]      | Done        |
Regression    | [FPV_REGRESSION_SETUP][]              | N/A         | Not currently using FPV for this block
Coverage      | [SIM_COVERAGE_MODEL_ADDED][]          | Done        |
Code Quality  | [TB_LINT_SETUP][]                     | Done        |
Integration   | [PRE_VERIFIED_SUB_MODULES_V1][]       | N/A         |
Review        | [DESIGN_SPEC_REVIEWED][]              | Done        |
Review        | [TESTPLAN_REVIEWED][]                 | Done        | Reviewed in PR
Review        | [STD_TEST_CATEGORIES_PLANNED][]       | Done        | Exception (Power/Debug/Performance)
