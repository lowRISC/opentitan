...
module tb;
  ...
  import rom_ctrl_util_pkg::rom_ctrl_util;
...
`endif
  ...
  initial begin
    rom_ctrl_util m_rom_ctrl_util;
    m_rom_ctrl_util = new(.name  ("rom_ctrl_util"),
    ...
    uvm_config_db#(rom_ctrl_util)::set(null, "*.env", "rom_ctrl_util", m_rom_ctrl_util);
