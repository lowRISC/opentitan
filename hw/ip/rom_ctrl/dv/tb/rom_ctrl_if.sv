...
interface rom_ctrl_if (
  ...
  // Ports that control how to force the kmac_data_i.rsp_valid signal to be high for a cycle. After
  // a posedge of force_kmac_rsp_valid_o, the rom_ctrl_bound_if in which this interface lies will
  // assert kmac_data_i.rsp_valid until the next negedge of the clock or a reset is asserted. It
  // will then flip the value of kmac_rsp_valid_forced_i.
