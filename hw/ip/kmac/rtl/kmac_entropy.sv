...
#(
  ...
  `OCAH_OT_ASSERT_KNOWN(ModeKnown_A, mode_i)
  ...
  `OCAH_OT_ASSUME(ConsumeNotAssertWhenNotValid_M,
  ...
  `OCAH_OT_ASSERT_KNOWN(RandStKnown_A, st)
  ...
  `OCAH_OT_ASSERT_INIT(EdnBusWidth_A, edn_pkg::ENDPOINT_BUS_WIDTH == 32)
