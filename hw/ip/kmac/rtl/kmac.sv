...
#(
  ...
  logic sha3_stop, sha3_continue, sha3_stop_error, sha3_state_restored;
  ...
  sha3 #(
    ...
    .state_restored_o (sha3_state_restored),
    ...
    .state_write_start_i (state_write_start),
  ...
  kmac_app #(
    ...
    .state_write_start_o  (state_write_start),
  ...
  kmac_errchk #(
    ...
    .state_restored_i (sha3_state_restored ),
