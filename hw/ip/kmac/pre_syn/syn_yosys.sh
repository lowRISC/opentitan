...
OT_DEP_SOURCES=(
    ...
    "$LR_SYNTH_SRC_DIR"/../prim/rtl/prim_ot_subreg.sv
    "$LR_SYNTH_SRC_DIR"/../prim/rtl/prim_ot_subreg_ext.sv
    "$LR_SYNTH_SRC_DIR"/../prim/rtl/prim_ot_subreg_shadow.sv
    "$LR_SYNTH_SRC_DIR"/../prim/rtl/prim_ot_subreg_arb.sv
