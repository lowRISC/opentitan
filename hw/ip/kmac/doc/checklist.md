...
This checklist is for [Hardware Stage]({{<relref "/doc/project/development_stages.md" >}}) transitions for the [KMAC peripheral](../).
...
Documentation | [VERIFICATION_PLAN_COMPLETED][]       | Not Started |
...
[SIM_FUNCTIONAL_COVERAGE_AT_100]:{{<relref "/doc/project/checklist.md#sim0functional_coverage_at_100" >}}
