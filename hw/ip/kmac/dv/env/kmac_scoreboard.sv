          ...
          begin
            ...
            foreach (item.m_req.m_reqs[i]) begin
              ...
              for (int byte_idx = 0; byte_idx < item.m_req.m_reqs[i].m_num_bytes; byte_idx++) begin
                bit [7:0] data_byte = (item.m_req.m_reqs[i].m_data >> (byte_idx * 8)) & 8'hff;
                kmac_app_msg.push_back(data_byte);
              end
            end
            ...
            if (item.m_rsp.m_error) begin
              ...
              kmac_app_digest_share0 = item.m_rsp.m_digest_share0;
              kmac_app_digest_share1 = item.m_rsp.m_digest_share1;
