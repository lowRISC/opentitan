...
class kmac_common_vseq extends kmac_base_vseq;
  ...
  virtual task pre_start();
    ...
    if (common_seq_type inside {"shadow_reg_errors", "shadow_reg_errors_with_csr_rw"}) begin
      ...
      $assertoff(0,
      "tb.dut.gen_entropy.u_prim_ot_sync_reqack_data.u_prim_ot_sync_reqack.SyncReqAckHoldReq");
      $assertoff(0,
      "tb.dut.gen_entropy.u_prim_ot_sync_reqack_data.u_prim_ot_sync_reqack.SyncReqAckAckNeedsReq");
