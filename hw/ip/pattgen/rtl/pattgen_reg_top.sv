...
module pattgen_reg_top (
  ...
  logic prediv2_we;
  logic [5:0] pttlen_len1_qs;
  logic [5:0] pttlen_len1_wd;
  logic pttlen_len1_we;
  logic [5:0] pttlen_len2_qs;
  logic [5:0] pttlen_len2_wd;
  logic pttlen_len2_we;
  logic [9:0] pttloop_loop1_qs;
  logic [9:0] pttloop_loop1_wd;
  logic pttloop_loop1_we;
  logic [9:0] pttloop_loop2_qs;
  logic [9:0] pttloop_loop2_wd;
  logic pttloop_loop2_we;
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (reg2hw.pttlen.len1.qe),
    .q      (reg2hw.pttlen.len1.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (reg2hw.pttlen.len2.qe),
    .q      (reg2hw.pttlen.len2.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (reg2hw.pttloop.loop1.qe),
    .q      (reg2hw.pttloop.loop1.q ),
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (reg2hw.pttloop.loop2.qe),
    .q      (reg2hw.pttloop.loop2.q ),
  ...
  always_comb begin
    ...
    addr_hit[7] = (reg_addr == PATTGEN_PTTLEN_OFFSET);
    addr_hit[8] = (reg_addr == PATTGEN_PTTLOOP_OFFSET);
  ...
  assign pttlen_len1_we = addr_hit[7] & reg_we & ~wr_err;
  assign pttlen_len1_wd = reg_wdata[5:0];

  assign pttlen_len2_we = addr_hit[7] & reg_we & ~wr_err;
  assign pttlen_len2_wd = reg_wdata[12:7];

  assign pttloop_loop1_we = addr_hit[8] & reg_we & ~wr_err;
  assign pttloop_loop1_wd = reg_wdata[9:0];

  assign pttloop_loop2_we = addr_hit[8] & reg_we & ~wr_err;
  assign pttloop_loop2_wd = reg_wdata[19:10];
  ...
  always_comb begin
    ...
    unique case (1'b1)
      ...
      addr_hit[7]: begin
        reg_rdata_next[5:0] = pttlen_len1_qs;
        reg_rdata_next[12:7] = pttlen_len2_qs;
      end

      addr_hit[8]: begin
        reg_rdata_next[9:0] = pttloop_loop1_qs;
        reg_rdata_next[19:10] = pttloop_loop2_qs;
      end
