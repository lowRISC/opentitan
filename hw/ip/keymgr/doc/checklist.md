...
--------------|--------------------------------|-------------|------------------
Documentation | [SPEC_COMPLETE][]              | Done        | [KEYMGR Design Spec](../)
...
Documentation | [FEATURE_FROZEN][]      | Done        | Based on currently known feature set
RTL           | [FEATURE_COMPLETE][]    | Done        | Based on currently known feature set
RTL           | [AREA_CHECK][]          | Done        |
RTL           | [PORT_FROZEN][]         | Done        |
RTL           | [ARCHITECTURE_FROZEN][] | Done        | Based on currently known feature set
RTL           | [REVIEW_TODO][]         | Done        |
RTL           | [STYLE_X][]             | Done        |
Code Quality  | [LINT_PASS][]           | Done        |
Code Quality  | [CDC_SETUP][]           | NA          | CDC not currently available
Code Quality  | [FPGA_TIMING][]         | Done        |
Code Quality  | [CDC_SYNCMACRO][]       | Done        |
Security      | [SEC_CM_IMPLEMENTED][]  | Waived      | Full security countermeasures delayed to post D2
Security      | [SEC_NON_RESET_FLOPS][] | Done        |
Security      | [SEC_SHADOW_REGS][]     | Waived      | Full security countermeasures delayed to post D2
