...
The identities flow employs an idea called [software binding](https://opentitan.org/book/doc/security/specs/identities_and_root_keys/#software-binding) to ensure that a particular key derivation scheme is only reproducible for a given software configuration.
