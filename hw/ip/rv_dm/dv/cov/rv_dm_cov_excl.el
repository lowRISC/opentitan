...
// construct a dm::DTM_ERR response.
//
// This waiver comes in two halves: waive the FSM state and also waive the conditional coverage for
// the branch where we test error_dmi_op_failed.
INSTANCE: tb.dut.dap
Fsm error_q "2073559246"
State DMIOPFailed "2"
Transition DMINoError->DMIOPFailed "0->2"
Transition DMIOPFailed->DMINoError "2->0"
Condition 10 "3574649122" "(error_dmi_op_failed && (error_q == DMINoError)) 1 -1" (2 "10")
Condition 10 "3574649122" "(error_dmi_op_failed && (error_q == DMINoError)) 1 -1" (3 "11")
