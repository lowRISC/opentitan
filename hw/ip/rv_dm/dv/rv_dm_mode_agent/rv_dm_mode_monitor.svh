...
task rv_dm_mode_monitor::run_phase(uvm_phase phase);
  fork
    ...
    forever begin
      @({cfg.vif.next_dm_addr,
         cfg.vif.mon_cb.lc_hw_debug_clr,
         cfg.vif.mon_cb.lc_hw_debug_en,
         cfg.vif.mon_cb.lc_dft_en,
         cfg.vif.mon_cb.pinmux_hw_debug_en,
         cfg.vif.mon_cb.lc_check_byp_en,
         cfg.vif.mon_cb.lc_escalate_en,
         cfg.vif.mon_cb.lc_init_done,
         cfg.vif.strap_en,
         cfg.vif.mon_cb.strap_en_override,
         cfg.vif.otp_dis_rv_dm_late_debug,
         cfg.vif.scanmode});
      take_snapshot();
    end
  join
...
function void rv_dm_mode_monitor::take_snapshot();
  ...
  item.m_lc_hw_debug_clr    = cfg.vif.mon_cb.lc_hw_debug_clr;
  item.m_lc_hw_debug_en     = cfg.vif.mon_cb.lc_hw_debug_en;
  item.m_lc_dft_en          = cfg.vif.mon_cb.lc_dft_en;
  item.m_pinmux_hw_debug_en = cfg.vif.mon_cb.pinmux_hw_debug_en;
  item.m_lc_check_byp_en    = cfg.vif.mon_cb.lc_check_byp_en;
  item.m_lc_escalate_en     = cfg.vif.mon_cb.lc_escalate_en;
  item.m_lc_init_done       = cfg.vif.mon_cb.lc_init_done;
  item.m_strap_en_override  = cfg.vif.mon_cb.strap_en_override;
