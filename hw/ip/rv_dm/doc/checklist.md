...
This checklist is for [Hardware Stage]({{< relref "/doc/project/development_stages.md" >}}) transitions for the [RV_DM peripheral.]({{< relref "." >}})
...
--------------|--------------------------------|-------------|------------------
Documentation | [SPEC_COMPLETE][]              | Done        | [RV_DM Design Spec]({{<relref "." >}})
...
### V1
 ...
 Type         | Item                                  | Resolution  | Note/Collaterals
--------------|---------------------------------------|-------------|------------------
Documentation | [DV_DOC_DRAFT_COMPLETED][]            | Not Started | RV_DM DV Plan
Documentation | [DV_PLAN_COMPLETED][]                 | Not Started | RV_DM Testplan
