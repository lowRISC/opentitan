...
--------------|--------------------------------|-------------|------------------
Documentation | [SPEC_COMPLETE][]              | Done        | [RV_DM Design Spec](../README.md)
...
### V1
 ...
 Type         | Item                                  | Resolution  | Note/Collaterals
--------------|---------------------------------------|-------------|------------------
Documentation | [DV_DOC_DRAFT_COMPLETED][]            | Done        | [RV_DM DV document](../dv/README.md)
Documentation | [TESTPLAN_COMPLETED][]                | Done        | [RV_DM Testplan](../dv/README.md#testplan)
