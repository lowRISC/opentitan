...
// encoding lands in the terminal error state. That state drives an invalid multi-bit value on
// the mode output, so consumers fail closed, and raises `error_o` for the fatal alert.

`include "prim_assert.sv"

module rv_core_ibex_cheriot_switch
