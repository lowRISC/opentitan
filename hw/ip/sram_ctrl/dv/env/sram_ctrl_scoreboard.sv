...
class sram_ctrl_scoreboard #(parameter int AddrWidth = 10) extends cip_base_scoreboard #(
  ...
  task run_phase(uvm_phase phase);
    string mem_path = dv_utils_pkg::get_parent_hier(cfg.sram_ctrl_util_h.get_path());
    ...
    mem_bkdr_scb.sram_ctrl_util_h = cfg.sram_ctrl_util_h;
  ...
  virtual task process_sram_init();
    ...
    forever begin
      ...
      `DV_SPINWAIT_EXIT(
          cfg.clk_rst_vif.wait_clks(cfg.sram_ctrl_util_h.get_depth());,
