...
module sram_ctrl_reg_top (
  ...
  logic status_error_we;
  logic status_error_re;
  logic status_scr_key_valid_qs;
  logic status_scr_key_valid_wd;
  logic status_scr_key_valid_we;
  logic status_scr_key_valid_re;
  logic status_scr_key_seed_valid_qs;
  logic status_scr_key_seed_valid_wd;
  logic status_scr_key_seed_valid_we;
  ...
  prim_subreg_ext #(
    ...
    .we     (status_scr_key_valid_we),
    .wd     (status_scr_key_valid_wd),
    .d      (hw2reg.status.scr_key_valid.d),
    .qre    (),
    .qe     (reg2hw.status.scr_key_valid.qe),
  ...
  prim_subreg_ext #(
    ...
    .we     (status_scr_key_seed_valid_we),
    .wd     (status_scr_key_seed_valid_wd),
    .d      (hw2reg.status.scr_key_seed_valid.d),
    .qre    (),
    .qe     (reg2hw.status.scr_key_seed_valid.qe),
  ...
  always_comb begin
    ...
    addr_hit[8] = (reg_addr == SRAM_CTRL_ERROR_ADDRESS_OFFSET);
  end
  ...
  assign status_error_we = addr_hit[3] & reg_we & ~wr_err;
  assign status_error_wd = reg_wdata[0];
  assign status_error_re = addr_hit[3] && reg_re;

  assign status_scr_key_valid_we = addr_hit[3] & reg_we & ~wr_err;
  assign status_scr_key_valid_wd = reg_wdata[1];
  assign status_scr_key_valid_re = addr_hit[3] && reg_re;

  assign status_scr_key_seed_valid_we = addr_hit[3] & reg_we & ~wr_err;
  assign status_scr_key_seed_valid_wd = reg_wdata[2];
