...
| dma.[`STATUS`](#status)                                         | 0x58     |        4 | Status indication for DMA data movement.                                                                                                                 |
...
| dma.[`INTR_SRC_ADDR_3`](#intr_src_addr)                         | 0xb8     |        4 | Destination address for interrupt source clearing write.                                                                                                 |
...
### DST_ADDR_ALMOST_LIMIT_LO . addr_limit_lo
