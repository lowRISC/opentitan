...
class spi_device_ram_cfg_vseq extends spi_device_base_vseq;
  ...
  virtual task body();
    prim_ram_2p_pkg::ram_2p_cfg_t src_ram_cfg, egress_ram_cfg, ingress_ram_cfg;
    string src_path = "tb.dut.ram_cfg_i";
    string egress_path = "tb.dut.u_spid_dpram.u_sys2spi_mem.u_mem.cfg_i";
    string ingress_path = "tb.dut.u_spid_dpram.u_spi2sys_mem.u_mem.cfg_i";
