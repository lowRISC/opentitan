...
This checklist is for [Hardware Stage]({{< relref "/doc/project/hw_stages.md" >}}) transitions for the [spi_device peripheral.]({{< relref "index.md" >}})
...
[SPI_DEVICE Spec]:    {{<relref "index.md">}}
