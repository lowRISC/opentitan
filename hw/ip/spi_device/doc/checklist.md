...
Code Quality  | [CDC_SETUP][]           | Waived      | CDC flow is not available.
...
### V1
 ...
 Type         | Item                                  | Resolution  | Note/Collaterals
--------------|---------------------------------------|-------------|------------------
Documentation | [DV_DOC_DRAFT_COMPLETED][]            | Done        |[SPI_DEVICE DV document]({{<relref "dv/index.md" >}})
Documentation | [TESTPLAN_COMPLETED][]                | Done        |[SPI_DEVICE Testplan]({{<relref "dv/index.md#testplan" >}})
