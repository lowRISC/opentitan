...
If set, the size of addresses for SPI commands with [`CMD_INFO.addr_mode`](#cmd_info) == `AddrCfg` is 4B, otherwise it is 3B.
This field is modified by HW on receiving the EN4B/EX4B commands. See [`CMD_INFO_EN4B`](#cmd_info_en4b), [`CMD_INFO_EX4B.`](#cmd_info_ex4b)
