...
The passthrough module snoops in on SPI transactions, and can filter out commands that are not permitted, re-direct them to be handled by HW, and transparently manipulate address and payload bits.
