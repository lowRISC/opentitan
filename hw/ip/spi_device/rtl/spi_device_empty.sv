...
#(
  ...
  assign cio_sd_o = 4'b0;
  assign cio_sd_en_o = 4'b0;
  assign passthrough_o = '0;
  assign intr_generic_rx_full_o = '0;
  assign intr_generic_rx_watermark_o = '0;
  assign intr_generic_tx_watermark_o = '0;
  assign intr_generic_rx_error_o = '0;
  assign intr_generic_rx_overflow_o = '0;
  assign intr_generic_tx_underflow_o = '0;
  assign intr_upload_cmdfifo_not_empty_o  = '0;
  assign intr_upload_payload_not_empty_o = '0;
  assign intr_upload_payload_overflow_o  = '0;
  assign intr_readbuf_watermark_o  = '0;
  assign intr_readbuf_flip_o  = '0;
  assign intr_tpm_header_not_empty_o  = '0;
  assign sck_monitor_o  = '0;
  assign tl_o = '0;
  assign alert_tx_o = '0;   

  logic  unused;
  assign unused = ^cio_sck_i & cio_csb_i & ^cio_sd_i & cio_tpm_csb_i & ^passthrough_i ^ram_cfg_i & ^mbist_en_i & ^scan_clk_i & ^scan_rst_ni & ^scanmode_i & ^tl_i & ^clk_i & ^rst_ni & ^alert_rx_i;
