...
module prim_lfsr_fpv #(
    ...
    localparam int unsigned MaxLfsrDw =
        GalXorMaxLfsrDw * GalMaxGtFibMax + FibXnorMaxLfsrDw * (1 - GalMaxGtFibMax),
    localparam int unsigned NumDuts =
        FibXnorMaxLfsrDw - FibXnorMinLfsrDw + 1 + GalXorMaxLfsrDw - GalXorMinLfsrDw + 1
) (
    input                                      clk_i,
    input                                      rst_ni,
