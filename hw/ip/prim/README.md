...
All technology-dependent primitives in OpenTitan use Virtual Cores to allow them to be substitued at build-time.
...
Any core that implements this virtual core may be chosen at build time to provide the implementation for all instantiations.
