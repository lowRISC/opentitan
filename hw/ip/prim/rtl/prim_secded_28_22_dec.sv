...
module prim_secded_28_22_dec (
  ...
  assign syndrome_o[1] = in[23] ^ in[0] ^ in[1] ^ in[2] ^ in[3] ^ in[10] ^ in[11] ^ in[12] ^
      in[13] ^ in[14] ^ in[15] ^ in[20] ^ in[21];
  assign syndrome_o[2] = in[24] ^ in[0] ^ in[4] ^ in[5] ^ in[6] ^ in[10] ^ in[11] ^ in[12] ^
      in[16] ^ in[17] ^ in[18] ^ in[20];
  assign syndrome_o[3] = in[25] ^ in[1] ^ in[4] ^ in[7] ^ in[8] ^ in[10] ^ in[13] ^ in[14] ^
      in[16] ^ in[17] ^ in[19] ^ in[21];
  assign syndrome_o[4] = in[26] ^ in[2] ^ in[5] ^ in[7] ^ in[9] ^ in[11] ^ in[13] ^ in[15] ^
      in[16] ^ in[18] ^ in[19] ^ in[20] ^ in[21];
  assign syndrome_o[5] = in[27] ^ in[3] ^ in[6] ^ in[8] ^ in[9] ^ in[12] ^ in[14] ^ in[15] ^
      in[17] ^ in[18] ^ in[19] ^ in[20] ^ in[21];
