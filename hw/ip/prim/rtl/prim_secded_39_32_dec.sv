...
module prim_secded_39_32_dec (
  ...
  assign syndrome_o[0] = in[32] ^ in[2] ^ in[3] ^ in[7] ^ in[8] ^ in[14] ^ in[15] ^ in[16] ^
      in[18] ^ in[19] ^ in[23] ^ in[24] ^ in[28] ^ in[29];
  assign syndrome_o[1] = in[33] ^ in[3] ^ in[6] ^ in[8] ^ in[12] ^ in[13] ^ in[15] ^ in[17] ^
      in[19] ^ in[21] ^ in[25] ^ in[27] ^ in[29] ^ in[30] ^ in[31];
  assign syndrome_o[2] = in[34] ^ in[0] ^ in[5] ^ in[7] ^ in[9] ^ in[10] ^ in[12] ^ in[13] ^
      in[15] ^ in[16] ^ in[22] ^ in[23] ^ in[26] ^ in[27] ^ in[31];
  assign syndrome_o[3] = in[35] ^ in[0] ^ in[1] ^ in[4] ^ in[6] ^ in[9] ^ in[11] ^ in[12] ^ in[14] ^
      in[22] ^ in[23] ^ in[25] ^ in[28] ^ in[29] ^ in[30];
  assign syndrome_o[4] = in[36] ^ in[0] ^ in[2] ^ in[3] ^ in[4] ^ in[5] ^ in[11] ^ in[17] ^ in[20] ^
      in[24] ^ in[26] ^ in[27] ^ in[30];
  assign syndrome_o[5] = in[37] ^ in[1] ^ in[2] ^ in[4] ^ in[6] ^ in[10] ^ in[13] ^ in[14] ^
      in[16] ^ in[18] ^ in[19] ^ in[20] ^ in[21] ^ in[22] ^ in[26];
  assign syndrome_o[6] = in[38] ^ in[1] ^ in[5] ^ in[7] ^ in[8] ^ in[9] ^ in[10] ^ in[11] ^ in[17] ^
      in[18] ^ in[20] ^ in[21] ^ in[24] ^ in[25] ^ in[28] ^ in[31];
