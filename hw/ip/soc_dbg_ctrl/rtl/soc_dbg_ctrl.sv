...
#(
  ...
  always_comb  begin
    ...
    if (lc_tx_test_true_strict(lc_dft_en_i)) begin
      ...
      jtag_hw2reg.jtag_boot_status.cpu_fetch_en.d     = lc_tx_test_true_strict(boot_status_i.cpu_fetch_en);
      jtag_hw2reg.jtag_boot_status.rom_ctrl_done.d[0] = mubi4_test_true_strict(boot_status_i.rom_ctrl_status[0].done);
      jtag_hw2reg.jtag_boot_status.rom_ctrl_done.d[1] = mubi4_test_true_strict(boot_status_i.rom_ctrl_status[1].done);
      jtag_hw2reg.jtag_boot_status.rom_ctrl_done.d[2] = mubi4_test_true_strict(boot_status_i.rom_ctrl_status[2].done);
      jtag_hw2reg.jtag_boot_status.rom_ctrl_good.d[0] = mubi4_test_true_strict(boot_status_i.rom_ctrl_status[0].good);
      jtag_hw2reg.jtag_boot_status.rom_ctrl_good.d[1] = mubi4_test_true_strict(boot_status_i.rom_ctrl_status[1].good);
      jtag_hw2reg.jtag_boot_status.rom_ctrl_good.d[2] = mubi4_test_true_strict(boot_status_i.rom_ctrl_status[2].good);
