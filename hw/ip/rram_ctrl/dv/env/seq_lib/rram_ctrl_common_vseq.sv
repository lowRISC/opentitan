...
class rram_ctrl_common_vseq extends rram_ctrl_base_vseq;
  ...
  // This sequence is mainly used to run the CSR tests, there is no need to run multiple
  // transactions in this sequence. Hence, the constraint is set to run only one transaction.
