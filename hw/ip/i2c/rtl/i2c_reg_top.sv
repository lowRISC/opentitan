...
module i2c_reg_top (
  ...
  logic timeout_ctrl_bus_timeout_en_qs;
  logic timeout_ctrl_bus_timeout_en_wd;
  ...
  //   F[multi_controller_monitor_en]: 6:6
  prim_subreg #(
    .DW      (1),
    .SwAccess(prim_subreg_pkg::SwAccessRW),
    .RESVAL  (1'h0),
  ...
  //   F[bus_timeout_en]: 30:30
  prim_subreg #(
    .DW      (1),
    .SwAccess(prim_subreg_pkg::SwAccessRW),
    .RESVAL  (1'h0),
    .Mubi    (1'b0)
  ) u_timeout_ctrl_bus_timeout_en (
    .clk_i   (clk_i),
    .rst_ni  (rst_ni),

    // from register interface
    .we     (timeout_ctrl_we),
    .wd     (timeout_ctrl_bus_timeout_en_wd),
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.timeout_ctrl.bus_timeout_en.q),
    .ds     (),

    // to register interface (read)
    .qs     (timeout_ctrl_bus_timeout_en_qs)
  );
  ...
  assign ctrl_multi_controller_monitor_en_wd = reg_wdata[6];
  ...
  assign timeout_ctrl_bus_timeout_en_wd = reg_wdata[30];
  ...
  always_comb begin
    ...
    unique case (1'b1)
      ...
      addr_hit[4]: begin
        ...
        reg_rdata_next[6] = ctrl_multi_controller_monitor_en_qs;
      end
      ...
      addr_hit[20]: begin
        ...
        reg_rdata_next[30] = timeout_ctrl_bus_timeout_en_qs;
