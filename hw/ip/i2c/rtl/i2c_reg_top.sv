...
module i2c_reg_top (
  ...
  assign intr_enable_acq_full_wd = reg_wdata[13];
  ...
  assign intr_test_acq_full_wd = reg_wdata[13];
  ...
  always_comb begin
    ...
    unique case (1'b1)
      addr_hit[0]: begin
        ...
        reg_rdata_next[13] = intr_state_acq_full_qs;
      ...
      addr_hit[1]: begin
        ...
        reg_rdata_next[13] = intr_enable_acq_full_qs;
