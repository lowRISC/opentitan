...
#(
  ...
  `OCAH_OT_ASSERT_KNOWN(CioSclKnownO_A, cio_scl_o)
  `OCAH_OT_ASSERT_KNOWN(CioSclEnKnownO_A, cio_scl_en_o)
  `OCAH_OT_ASSERT_KNOWN(CioSdaKnownO_A, cio_sda_o)
  `OCAH_OT_ASSERT_KNOWN(CioSdaEnKnownO_A, cio_sda_en_o)
  `OCAH_OT_ASSERT_KNOWN(IntrFmtWtmkKnownO_A, intr_fmt_threshold_o)
  `OCAH_OT_ASSERT_KNOWN(IntrRxWtmkKnownO_A, intr_rx_threshold_o)
  `OCAH_OT_ASSERT_KNOWN(IntrAcqWtmkKnownO_A, intr_acq_threshold_o)
  `OCAH_OT_ASSERT_KNOWN(IntrRxOflwKnownO_A, intr_rx_overflow_o)
  `OCAH_OT_ASSERT_KNOWN(IntrControllerHaltKnownO_A, intr_controller_halt_o)
  `OCAH_OT_ASSERT_KNOWN(IntrSclInterfKnownO_A, intr_scl_interference_o)
  `OCAH_OT_ASSERT_KNOWN(IntrSdaInterfKnownO_A, intr_sda_interference_o)
  `OCAH_OT_ASSERT_KNOWN(IntrStretchTimeoutKnownO_A, intr_stretch_timeout_o)
  `OCAH_OT_ASSERT_KNOWN(IntrSdaUnstableKnownO_A, intr_sda_unstable_o)
  `OCAH_OT_ASSERT_KNOWN(IntrCommandCompleteKnownO_A, intr_cmd_complete_o)
  `OCAH_OT_ASSERT_KNOWN(IntrTxStretchKnownO_A, intr_tx_stretch_o)
  `OCAH_OT_ASSERT_KNOWN(IntrTxWtmkKnownO_A, intr_tx_threshold_o)
  `OCAH_OT_ASSERT_KNOWN(IntrAcqStretchKnownO_A, intr_acq_stretch_o)
  `OCAH_OT_ASSERT_KNOWN(IntrUnexpStopKnownO_A, intr_unexp_stop_o)
  `OCAH_OT_ASSERT_KNOWN(IntrHostTimeoutKnownO_A, intr_host_timeout_o)
