...
module pinmux_csr_assert_fpv import tlul_pkg::*; import pinmux_reg_pkg::*; (
  ...
  property r_wo_P(bit [6:0] addr, bit [DWidth-1:0] exp_data, bit [DWidth-1:0] mask,
      int lsb);
    logic [DWidth-1:0] id;
  ...
  `ASSERT(mio_out_sleep_val0_wr_A, wr_P(7'h3c, mio_out_sleep_val_q_fpv[31:0], u_reg.regen_qs, 'hffffffff, 0))
  ...
  `ASSERT(mio_out_sleep_val1_wr_A, wr_P(7'h40, mio_out_sleep_val_q_fpv[63:32], u_reg.regen_qs, 'hffffffff, 0))
  ...
  `ASSERT(dio_out_sleep_val_wr_A, wr_ext_P(7'h44, dio_out_sleep_val_q_fpv[31:0], u_reg.regen_qs, 'hffffffff, 0))
  ...
  `ASSERT(wkup_detector_en_wr_A, wr_P(7'h48, wkup_detector_en_q_fpv[7:0], u_reg.regen_qs, 'hff, 0))
  ...
  `ASSERT(wkup_detector0_mode0_wr_A, wr_P(7'h4c, wkup_detector_mode_q_fpv[2:0], u_reg.regen_qs, 'h7, 0))
  `ASSERT(wkup_detector0_mode0_rd_A, rd_P(7'h4c, wkup_detector_mode_q_fpv[2:0], 'h7, 0))
  // this is a non-homog multi-reg
  `ASSERT(wkup_detector0_filter0_wr_A, wr_P(7'h4c, wkup_detector_filter_q_fpv[0:0], u_reg.regen_qs, 'h8, 3))
  `ASSERT(wkup_detector0_filter0_rd_A, rd_P(7'h4c, wkup_detector_filter_q_fpv[0:0], 'h8, 3))
  // this is a non-homog multi-reg
  `ASSERT(wkup_detector0_miodio0_wr_A, wr_P(7'h4c, wkup_detector_miodio_q_fpv[0:0], u_reg.regen_qs, 'h10, 4))
  `ASSERT(wkup_detector0_miodio0_rd_A, rd_P(7'h4c, wkup_detector_miodio_q_fpv[0:0], 'h10, 4))
  // assertions for register: wkup_detector1
  // this is a non-homog multi-reg
  `ASSERT(wkup_detector1_mode1_wr_A, wr_P(7'h50, wkup_detector_mode_q_fpv[5:3], u_reg.regen_qs, 'h7, 0))
  `ASSERT(wkup_detector1_mode1_rd_A, rd_P(7'h50, wkup_detector_mode_q_fpv[5:3], 'h7, 0))
  // this is a non-homog multi-reg
  `ASSERT(wkup_detector1_filter1_wr_A, wr_P(7'h50, wkup_detector_filter_q_fpv[1:1], u_reg.regen_qs, 'h8, 3))
  `ASSERT(wkup_detector1_filter1_rd_A, rd_P(7'h50, wkup_detector_filter_q_fpv[1:1], 'h8, 3))
  // this is a non-homog multi-reg
  `ASSERT(wkup_detector1_miodio1_wr_A, wr_P(7'h50, wkup_detector_miodio_q_fpv[1:1], u_reg.regen_qs, 'h10, 4))
  `ASSERT(wkup_detector1_miodio1_rd_A, rd_P(7'h50, wkup_detector_miodio_q_fpv[1:1], 'h10, 4))
  // assertions for register: wkup_detector2
  // this is a non-homog multi-reg
  `ASSERT(wkup_detector2_mode2_wr_A, wr_P(7'h54, wkup_detector_mode_q_fpv[8:6], u_reg.regen_qs, 'h7, 0))
  `ASSERT(wkup_detector2_mode2_rd_A, rd_P(7'h54, wkup_detector_mode_q_fpv[8:6], 'h7, 0))
  // this is a non-homog multi-reg
  `ASSERT(wkup_detector2_filter2_wr_A, wr_P(7'h54, wkup_detector_filter_q_fpv[2:2], u_reg.regen_qs, 'h8, 3))
  `ASSERT(wkup_detector2_filter2_rd_A, rd_P(7'h54, wkup_detector_filter_q_fpv[2:2], 'h8, 3))
  // this is a non-homog multi-reg
  `ASSERT(wkup_detector2_miodio2_wr_A, wr_P(7'h54, wkup_detector_miodio_q_fpv[2:2], u_reg.regen_qs, 'h10, 4))
  `ASSERT(wkup_detector2_miodio2_rd_A, rd_P(7'h54, wkup_detector_miodio_q_fpv[2:2], 'h10, 4))
  // assertions for register: wkup_detector3
  // this is a non-homog multi-reg
  `ASSERT(wkup_detector3_mode3_wr_A, wr_P(7'h58, wkup_detector_mode_q_fpv[11:9], u_reg.regen_qs, 'h7, 0))
  `ASSERT(wkup_detector3_mode3_rd_A, rd_P(7'h58, wkup_detector_mode_q_fpv[11:9], 'h7, 0))
  // this is a non-homog multi-reg
  `ASSERT(wkup_detector3_filter3_wr_A, wr_P(7'h58, wkup_detector_filter_q_fpv[3:3], u_reg.regen_qs, 'h8, 3))
  `ASSERT(wkup_detector3_filter3_rd_A, rd_P(7'h58, wkup_detector_filter_q_fpv[3:3], 'h8, 3))
  // this is a non-homog multi-reg
  `ASSERT(wkup_detector3_miodio3_wr_A, wr_P(7'h58, wkup_detector_miodio_q_fpv[3:3], u_reg.regen_qs, 'h10, 4))
  `ASSERT(wkup_detector3_miodio3_rd_A, rd_P(7'h58, wkup_detector_miodio_q_fpv[3:3], 'h10, 4))
  // assertions for register: wkup_detector4
  // this is a non-homog multi-reg
  `ASSERT(wkup_detector4_mode4_wr_A, wr_P(7'h5c, wkup_detector_mode_q_fpv[14:12], u_reg.regen_qs, 'h7, 0))
  `ASSERT(wkup_detector4_mode4_rd_A, rd_P(7'h5c, wkup_detector_mode_q_fpv[14:12], 'h7, 0))
  // this is a non-homog multi-reg
  `ASSERT(wkup_detector4_filter4_wr_A, wr_P(7'h5c, wkup_detector_filter_q_fpv[4:4], u_reg.regen_qs, 'h8, 3))
  `ASSERT(wkup_detector4_filter4_rd_A, rd_P(7'h5c, wkup_detector_filter_q_fpv[4:4], 'h8, 3))
  // this is a non-homog multi-reg
  `ASSERT(wkup_detector4_miodio4_wr_A, wr_P(7'h5c, wkup_detector_miodio_q_fpv[4:4], u_reg.regen_qs, 'h10, 4))
  `ASSERT(wkup_detector4_miodio4_rd_A, rd_P(7'h5c, wkup_detector_miodio_q_fpv[4:4], 'h10, 4))
  // assertions for register: wkup_detector5
  // this is a non-homog multi-reg
  `ASSERT(wkup_detector5_mode5_wr_A, wr_P(7'h60, wkup_detector_mode_q_fpv[17:15], u_reg.regen_qs, 'h7, 0))
  `ASSERT(wkup_detector5_mode5_rd_A, rd_P(7'h60, wkup_detector_mode_q_fpv[17:15], 'h7, 0))
  // this is a non-homog multi-reg
  `ASSERT(wkup_detector5_filter5_wr_A, wr_P(7'h60, wkup_detector_filter_q_fpv[5:5], u_reg.regen_qs, 'h8, 3))
  `ASSERT(wkup_detector5_filter5_rd_A, rd_P(7'h60, wkup_detector_filter_q_fpv[5:5], 'h8, 3))
  // this is a non-homog multi-reg
  `ASSERT(wkup_detector5_miodio5_wr_A, wr_P(7'h60, wkup_detector_miodio_q_fpv[5:5], u_reg.regen_qs, 'h10, 4))
  `ASSERT(wkup_detector5_miodio5_rd_A, rd_P(7'h60, wkup_detector_miodio_q_fpv[5:5], 'h10, 4))
  // assertions for register: wkup_detector6
  // this is a non-homog multi-reg
  `ASSERT(wkup_detector6_mode6_wr_A, wr_P(7'h64, wkup_detector_mode_q_fpv[20:18], u_reg.regen_qs, 'h7, 0))
  `ASSERT(wkup_detector6_mode6_rd_A, rd_P(7'h64, wkup_detector_mode_q_fpv[20:18], 'h7, 0))
  // this is a non-homog multi-reg
  `ASSERT(wkup_detector6_filter6_wr_A, wr_P(7'h64, wkup_detector_filter_q_fpv[6:6], u_reg.regen_qs, 'h8, 3))
  `ASSERT(wkup_detector6_filter6_rd_A, rd_P(7'h64, wkup_detector_filter_q_fpv[6:6], 'h8, 3))
  // this is a non-homog multi-reg
  `ASSERT(wkup_detector6_miodio6_wr_A, wr_P(7'h64, wkup_detector_miodio_q_fpv[6:6], u_reg.regen_qs, 'h10, 4))
  `ASSERT(wkup_detector6_miodio6_rd_A, rd_P(7'h64, wkup_detector_miodio_q_fpv[6:6], 'h10, 4))
  // assertions for register: wkup_detector7
  // this is a non-homog multi-reg
  `ASSERT(wkup_detector7_mode7_wr_A, wr_P(7'h68, wkup_detector_mode_q_fpv[23:21], u_reg.regen_qs, 'h7, 0))
  `ASSERT(wkup_detector7_mode7_rd_A, rd_P(7'h68, wkup_detector_mode_q_fpv[23:21], 'h7, 0))
  // this is a non-homog multi-reg
  `ASSERT(wkup_detector7_filter7_wr_A, wr_P(7'h68, wkup_detector_filter_q_fpv[7:7], u_reg.regen_qs, 'h8, 3))
  `ASSERT(wkup_detector7_filter7_rd_A, rd_P(7'h68, wkup_detector_filter_q_fpv[7:7], 'h8, 3))
  // this is a non-homog multi-reg
  `ASSERT(wkup_detector7_miodio7_wr_A, wr_P(7'h68, wkup_detector_miodio_q_fpv[7:7], u_reg.regen_qs, 'h10, 4))
  ...
  `ASSERT(wkup_detector_cnt_th0_wr_A, wr_P(7'h6c, wkup_detector_cnt_th_q_fpv[31:0], u_reg.regen_qs, 'hffffffff, 0))
  ...
  `ASSERT(wkup_detector_cnt_th1_wr_A, wr_P(7'h70, wkup_detector_cnt_th_q_fpv[63:32], u_reg.regen_qs, 'hffffffff, 0))
  ...
  `ASSERT(wkup_detector_padsel0_wr_A, wr_P(7'h74, wkup_detector_padsel_q_fpv[29:0], u_reg.regen_qs, 'h3fffffff, 0))
  ...
  `ASSERT(wkup_detector_padsel1_wr_A, wr_P(7'h78, wkup_detector_padsel_q_fpv[39:30], u_reg.regen_qs, 'h3ff, 0))
  ...
  `ASSERT(wkup_cause_wr_A, wr_ext_P(7'h7c, wkup_cause_q_fpv[7:0], u_reg.regen_qs, 'hff, 0))
