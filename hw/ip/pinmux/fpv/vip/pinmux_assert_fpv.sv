...
module pinmux_assert_fpv (
  ...
  `ASSERT(InSelOOB_A,
          periph_insel.q >= pinmux_reg_pkg::NMioPads + 2 |-> mio_to_periph_o[periph_sel_i] == 0)
  `ASSERT(MioToPeriphO_A,
          ##1 !$stable(mio_to_periph_o[periph_sel_i]) |->
  ...
  `ASSERT(OutSelOOB_A,
          mio_outsel.q >= pinmux_reg_pkg::NMioPeriphOut + 3 |-> mio_out_o[mio_sel_i] == 0)
  `ASSERT(MioOutO_A,
          ##1 !$stable(mio_out_o[mio_sel_i]) |->
  ...
  `ASSERT(OutSelOeOOB_A,
          mio_outsel.q >= pinmux_reg_pkg::NMioPeriphOut + 3 |-> mio_oe_o[mio_sel_i] == 0)
  `ASSERT(MioOeO_A,
          ##1 !$stable(mio_oe_o[mio_sel_i]) |->
