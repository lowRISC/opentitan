    ...
    { multireg: {
        ...
        fields: [
          ...
          { bits: "4",
            name: "keeper_en",
            desc: '''
                  Enable keeper termination.
                  This weakly drives the previous pad output value when output is disabled, similar to a verilog `trireg`.
                  '''
          },
          { bits: "5",
            name: "schmitt_en",
