    ...
    { multireg: { name:     "MIO_PAD_ATTR",
                  ...
                  fields: [
                    ...
                    { bits: "2",
                      ...
                      // Note: The special index (30) where this has a different resval depends on
                      // the TargetCfg parameter that gets passed in. That, in turn, is configured
                      // at chip level and it would be nicer if we could resolve it as we expanded
                      // this template.
