...
(
  ...
  // qe / re etc.
  `OCAH_OT_ASSERT_INIT(SameErrCnt_A, $bits(keymgr_dpe_reg2hw_fault_status_reg_t) ==
  ...
  // id operation
  `OCAH_OT_ASSERT(DataEn_A, data_hw_en_o | data_sw_en_o |-> gen_en_o & ~adv_en_o)

  // Check that the FSM is linear and does not contain any loops
  `OCAH_OT_ASSERT_FPV_LINEAR_FSM(SecCmCFILinear_A, state_q, keymgr_dpe_working_state_e)
