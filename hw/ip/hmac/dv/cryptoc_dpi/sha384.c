...
static const HASH_VTAB SHA384_VTAB = {SHA384_init, SHA512_update, SHA512_final,
                                      SHA384_hash, SHA384_DIGEST_SIZE};
...
const uint8_t *SHA384_final(LITE_SHA384_CTX *ctx) { return SHA512_final(ctx); }
