...
(
  ...
  assign unused_cfg_qe = {
    cfg_reg.sha_en.qe, cfg_reg.hmac_en.qe, cfg_reg.endian_swap.qe, cfg_reg.digest_swap.qe
  };
  ...
  assign reg_fifo_wentry.mask = {
    reg_fifo_wmask[0], reg_fifo_wmask[8], reg_fifo_wmask[16], reg_fifo_wmask[24]
  };
  ...
  assign err_valid = ~reg2hw.intr_state.hmac_err.q & (
      msg_push_sha_disabled | hash_start_sha_disabled | update_seckey_inprocess |
