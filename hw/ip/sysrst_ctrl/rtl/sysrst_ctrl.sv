...
#(
  ...
  `OCAH_OT_ASSERT_KNOWN(IntrEventOKnown_A, intr_event_detected_o)
  `OCAH_OT_ASSERT_KNOWN(OTWkOKnown_A, wkup_req_o)
  `OCAH_OT_ASSERT_KNOWN(OTRstOKnown_A, rst_req_o)
  `OCAH_OT_ASSERT_KNOWN(TlODValidKnown_A, tl_o.d_valid)
  `OCAH_OT_ASSERT_KNOWN(TlOAReadyKnown_A, tl_o.a_ready)
  `OCAH_OT_ASSERT_KNOWN(AlertKnown_A, alert_tx_o)
  `OCAH_OT_ASSERT_KNOWN(BatOKnown_A, cio_bat_disable_o)
  `OCAH_OT_ASSERT_KNOWN(ECRSTOKnown_A, cio_ec_rst_l_o)
  `OCAH_OT_ASSERT_KNOWN(PwrbOKnown_A, cio_pwrb_out_o)
  `OCAH_OT_ASSERT_KNOWN(Key0OKnown_A, cio_key0_out_o)
  `OCAH_OT_ASSERT_KNOWN(Key1OKnown_A, cio_key1_out_o)
  `OCAH_OT_ASSERT_KNOWN(Key2OKnown_A, cio_key2_out_o)
  `OCAH_OT_ASSERT_KNOWN(Z3WwakupOKnown_A, cio_z3_wakeup_o)
  `OCAH_OT_ASSERT_KNOWN(FlashWpOKnown_A, cio_flash_wp_l_o)

  // In this IP, all output enables are constantly set to 1
  `OCAH_OT_ASSERT(BatOEnIsOne_A, cio_bat_disable_en_o === 1'b1)
  `OCAH_OT_ASSERT(ECRSTOEnIsOne_A, cio_ec_rst_l_en_o === 1'b1)
  `OCAH_OT_ASSERT(PwrbOEnIsOne_A, cio_pwrb_out_en_o === 1'b1)
  `OCAH_OT_ASSERT(Key0OEnIsOne_A, cio_key0_out_en_o === 1'b1)
  `OCAH_OT_ASSERT(Key1OEnIsOne_A, cio_key1_out_en_o === 1'b1)
  `OCAH_OT_ASSERT(Key2OEnIsOne_A, cio_key2_out_en_o === 1'b1)
  `OCAH_OT_ASSERT(Z3WakeupOEnIsOne_A, cio_z3_wakeup_en_o === 1'b1)
  `OCAH_OT_ASSERT(FlashWpOEnIsOne_A, cio_flash_wp_l_en_o === 1'b1)
