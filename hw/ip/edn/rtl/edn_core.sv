...
module edn_core import edn_pkg::*; import csrng_pkg::*; #(
  ...
  logic packer_ep0_arb_req;
  logic packer_ep1_arb_req;
  logic packer_ep2_arb_req;
  logic packer_ep3_arb_req;
  ...
  logic                         packer_ep0_clr;
  logic                         packer_ep0_ack;
  logic                         packer_ep0_push;
  logic [CSGenBitsWidth-1:0]    packer_ep0_wdata;
  logic                         packer_ep0_wready;
  logic                         packer_ep0_rvalid;
  logic                         packer_ep0_rready;
  logic [EndPointBusWidth0-1:0] packer_ep0_rdata;

  logic                         packer_ep1_clr;
  logic                         packer_ep1_ack;
  logic                         packer_ep1_push;
  logic [CSGenBitsWidth-1:0]    packer_ep1_wdata;
  logic                         packer_ep1_wready;
  logic                         packer_ep1_rvalid;
  logic                         packer_ep1_rready;
  logic [EndPointBusWidth1-1:0] packer_ep1_rdata;

  logic                         packer_ep2_clr;
  logic                         packer_ep2_ack;
  logic                         packer_ep2_push;
  logic [CSGenBitsWidth-1:0]    packer_ep2_wdata;
  logic                         packer_ep2_wready;
  logic                         packer_ep2_rvalid;
  logic                         packer_ep2_rready;
  logic [EndPointBusWidth2-1:0] packer_ep2_rdata;

  logic                         packer_ep3_clr;
  logic                         packer_ep3_ack;
  logic                         packer_ep3_push;
  logic [CSGenBitsWidth-1:0]    packer_ep3_wdata;
  logic                         packer_ep3_wready;
  logic                         packer_ep3_rvalid;
  logic                         packer_ep3_rready;
  logic [EndPointBusWidth3-1:0] packer_ep3_rdata;
  ...
  assign event_edn_cmd_req_done = csrng_cmd_i.csrng_rsp_ack;
 ...
 // set the err code type bits
  ...
  assign hw2reg.sw_cmd_ack.de = csrng_cmd_ack;
  assign hw2reg.sw_cmd_ack.d = 1'b1;
  assign hw2reg.sw_cmd_sts.cmd_sts.de = csrng_cmd_i.csrng_rsp_ack;
  ...
  prim_arbiter_ppc #(
    ...
    .data_i({zero_bit,zero_bit,zero_bit,zero_bit}),
  ...
  assign packer_ep0_arb_req = !packer_ep0_rvalid && edn_i[0].edn_req;
  assign packer_ep1_arb_req = !packer_ep1_rvalid && edn_i[1].edn_req;
  assign packer_ep2_arb_req = !packer_ep2_rvalid && edn_i[2].edn_req;
  assign packer_ep3_arb_req = !packer_ep3_rvalid && edn_i[3].edn_req;

  assign packer_arb_req = {packer_ep3_arb_req,packer_ep2_arb_req,
                           packer_ep1_arb_req,packer_ep0_arb_req};
  ...
  //--------------------------------------------
  // end point interface packers
  //--------------------------------------------

  // Always add packer_0
  prim_packer_fifo #(
    .InW(CSGenBitsWidth),
    .OutW(EndPointBusWidth0)
  ) u_prim_packer_fifo_ep0 (
    .clk_i      (clk_i),
    .rst_ni     (rst_ni),
    .clr_i      (packer_ep0_clr),
    .wvalid_i   (packer_ep0_push),
    .wdata_i    (packer_ep0_wdata),
    .wready_o   (packer_ep0_wready),
    .rvalid_o   (packer_ep0_rvalid),
    .rdata_o    (packer_ep0_rdata),
    .rready_i   (packer_ep0_rready),
    .depth_o    ()
  );

  assign packer_ep0_clr = !edn_enable;
  assign packer_ep0_push = packer_arb_valid && packer_ep0_wready && packer_arb_gnt[0];
  assign packer_ep0_wdata = packer_cs_rdata;

  // fips indication
  assign edn_fips_d[0] = !edn_enable ? 1'b0 :
         (packer_ep0_push && packer_ep0_wready) ?  csrng_fips_q :
         edn_fips_q[0];
  assign edn_o[0].edn_fips = edn_fips_q[0];

  // gate returned data
  assign edn_o[0].edn_ack = packer_ep0_ack;
  assign edn_bus0_o = packer_ep0_ack ? packer_ep0_rdata : '0;

  edn_ack_sm u_edn_ack_sm_ep0 (
    .clk_i            (clk_i),
    .rst_ni           (rst_ni),
    .req_i            (edn_i[0].edn_req),
    .ack_o            (packer_ep0_ack),
    .fifo_not_empty_i (packer_ep0_rvalid),
    .fifo_pop_o       (packer_ep0_rready)
  );


  // Add packer_1 based on NumEndPoints
  if (NumEndPoints >= 2) begin : gen_packer_1

    prim_packer_fifo #(
      .InW(CSGenBitsWidth),
      .OutW(EndPointBusWidth1)
    ) u_prim_packer_fifo_ep1 (
      .clk_i      (clk_i),
      .rst_ni     (rst_ni),
      .clr_i      (packer_ep1_clr),
      .wvalid_i   (packer_ep1_push),
      .wdata_i    (packer_ep1_wdata),
      .wready_o   (packer_ep1_wready),
      .rvalid_o   (packer_ep1_rvalid),
      .rdata_o    (packer_ep1_rdata),
      .rready_i   (packer_ep1_rready),
      .depth_o    ()
    );

    assign packer_ep1_clr = !edn_enable;
    assign packer_ep1_push = packer_arb_valid && packer_ep1_wready && packer_arb_gnt[1];
    assign packer_ep1_wdata = packer_cs_rdata;

    // fips indication
    assign edn_fips_d[1] = !edn_enable ? 1'b0 :
           (packer_ep1_push && packer_ep1_wready) ?  csrng_fips_q :
           edn_fips_q[1];
    assign edn_o[1].edn_fips = edn_fips_q[1];

    // gate returned data
    assign edn_o[1].edn_ack = packer_ep1_ack;
    assign edn_bus1_o = packer_ep1_ack ? packer_ep1_rdata : '0;

    edn_ack_sm u_edn_ack_sm_ep1 (
      .clk_i            (clk_i),
      .rst_ni           (rst_ni),
      .req_i            (edn_i[1].edn_req),
      .ack_o            (packer_ep1_ack),
      .fifo_not_empty_i (packer_ep1_rvalid),
      .fifo_pop_o       (packer_ep1_rready)
    );

  end


  // Add packer_2 based on NumEndPoints
  if (NumEndPoints >= 3) begin : gen_packer_2

    prim_packer_fifo #(
      .InW(CSGenBitsWidth),
      .OutW(EndPointBusWidth2)
    ) u_prim_packer_fifo_ep2 (
      .clk_i      (clk_i),
      .rst_ni     (rst_ni),
      .clr_i      (packer_ep2_clr),
      .wvalid_i   (packer_ep2_push),
      .wdata_i    (packer_ep2_wdata),
      .wready_o   (packer_ep2_wready),
      .rvalid_o   (packer_ep2_rvalid),
      .rdata_o    (packer_ep2_rdata),
      .rready_i   (packer_ep2_rready),
      .depth_o    ()
    );

    assign packer_ep2_clr = !edn_enable;
    assign packer_ep2_push = packer_arb_valid && packer_ep2_wready && packer_arb_gnt[2];
    assign packer_ep2_wdata = packer_cs_rdata;

    // fips indication
    assign edn_fips_d[2] = !edn_enable ? 1'b0 :
           (packer_ep2_push && packer_ep2_wready) ?  csrng_fips_q :
           edn_fips_q[2];
    assign edn_o[2].edn_fips = edn_fips_q[2];

    // gate returned data
    assign edn_o[2].edn_ack = packer_ep2_ack;
    assign edn_bus2_o = packer_ep2_ack ? packer_ep2_rdata : '0;

    edn_ack_sm u_edn_ack_sm_ep2 (
      .clk_i            (clk_i),
      .rst_ni           (rst_ni),
      .req_i            (edn_i[2].edn_req),
      .ack_o            (packer_ep2_ack),
      .fifo_not_empty_i (packer_ep2_rvalid),
      .fifo_pop_o       (packer_ep2_rready)
    );

  end


  // Add packer_3 based on NumEndPoints
  if (NumEndPoints >= 4) begin : gen_packer_3

    prim_packer_fifo #(
      .InW(CSGenBitsWidth),
      .OutW(EndPointBusWidth3)
    ) u_prim_packer_fifo_ep3 (
      .clk_i      (clk_i),
      .rst_ni     (rst_ni),
      .clr_i      (packer_ep3_clr),
      .wvalid_i   (packer_ep3_push),
      .wdata_i    (packer_ep3_wdata),
      .wready_o   (packer_ep3_wready),
      .rvalid_o   (packer_ep3_rvalid),
      .rdata_o    (packer_ep3_rdata),
      .rready_i   (packer_ep3_rready),
      .depth_o    ()
    );

    assign packer_ep3_clr = !edn_enable;
    assign packer_ep3_push = packer_arb_valid && packer_ep3_wready && packer_arb_gnt[3];
    assign packer_ep3_wdata = packer_cs_rdata;

    // fips indication
    assign edn_fips_d[3] = !edn_enable ? 1'b0 :
           (packer_ep3_push && packer_ep3_wready) ?  csrng_fips_q :
           edn_fips_q[3];
    assign edn_o[3].edn_fips = edn_fips_q[3];

    // gate returned data
    assign edn_o[3].edn_ack = packer_ep3_ack;
    assign edn_bus3_o = packer_ep3_ack ? packer_ep3_rdata : '0;

    edn_ack_sm u_edn_ack_sm_ep3 (
      .clk_i            (clk_i),
      .rst_ni           (rst_ni),
      .req_i            (edn_i[3].edn_req),
      .ack_o            (packer_ep3_ack),
      .fifo_not_empty_i (packer_ep3_rvalid),
      .fifo_pop_o       (packer_ep3_rready)
    );
