...
<!-- Copy this file to hw/ip/edn/doc/edn_dv_plan.md and make changes as needed.
...
```console
$ $REPO_TOP/util/dvsim/dvsim.py $REPO_TOP/hw/ip/edn/dv/edn_sim_cfg.hjson -i edn_sanity
```
