...
class edn_env extends cip_base_env #(
  ...
  push_pull_agent#(.HostDataWidth(edn_pkg::FIPS_ENDPOINT_BUS_WIDTH))
       m_endpoint_agent [edn_env_pkg::MAX_NUM_ENDPOINTS];
  ...
  function void connect_phase(uvm_phase phase);
    ...
    if (cfg.en_scb) begin
      ...
      m_csrng_agent.m_genbits_push_agent.monitor.analysis_port.connect(scoreboard.genbits_fifo.analysis_export);
    end
