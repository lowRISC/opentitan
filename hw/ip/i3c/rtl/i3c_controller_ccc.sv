      ...
      case (r_i[CtrlCR_CCC])
        ...
        ENTDAA: begin  // 4.3.4.2
          case (ccc_req_i.idx)
            ...
            3'b011: begin
              // TODO(#31304): At this point we should be accepting/responding to ACK/NACK.
        ...
        SETDASA: begin  // 4.3.7.3.10
          case (ccc_req_i.idx)
            ...
            default: begin
              // TODO(#31304): Sending the Static and Dynamic Addresses with Open Drain signaling.
              ccc_rsp_o.req_dvalid = 1'b1;
        ...
        default: begin
          // TODO(#31304): Extend this for data reception too.
