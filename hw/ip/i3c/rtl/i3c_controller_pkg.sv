...
package i3c_controller_pkg;
  ...
  typedef enum logic [5:0] {
    ...
    CRR,        // TODO(#31308): CRR is not yet supported.
  ...
  // TODO(#31304): For the Controller we are quite likely to want to combine read data and response
  // to assist with producing an accurate count of the _write data_ transferred.
  typedef struct packed {
