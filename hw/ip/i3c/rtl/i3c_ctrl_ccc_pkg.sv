...
package i3c_ctrl_ccc_pkg;
  ...
  typedef struct packed {
    ...
    // Writing to Device Characteristics Table.
    logic                   dct_we;
    logic [CtrlCRWidth-1:0] dct_wdata;
    // Complete the under-construction DCT entry and advance to the next entry?
    logic                   dct_commit;
