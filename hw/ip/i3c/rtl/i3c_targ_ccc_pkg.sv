...
package i3c_targ_ccc_pkg;
  ...
  typedef enum logic [2:0] {
    ...
    //
    // Note: DEFTGTS and DEFGRPA will have to stream its data payload into the Rx + RxDesc buffers;
    // it could conceivably be hundreds of bytes (4 per target described, no intervening Sr/P).
    TargCR_WData0,
    TargCR_WData1,
    TargCR_WData2,
