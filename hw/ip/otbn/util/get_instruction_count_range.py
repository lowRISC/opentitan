...
from shared.instruction_count_range import program_insn_count_range, subroutine_insn_count_range
...
def main() -> int:
    ...
    if args.subroutine is None:
        ...
        min_count, max_count = subroutine_insn_count_range(program, args.subroutine)
