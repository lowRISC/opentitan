...
def main() -> int:
    ...
    parser.add_argument(
        ...
        required=False,
        help=(
            "The specific subroutine to check. If not provided, the start "
    ...
    parser.add_argument(
        ...
        required=False,
        help=(
            "Initial secret information-flow nodes. If not provided, "
    ...
    if args.subroutine is None:
        ...
        _, _, control_deps = get_subroutine_iflow(program, graph, args.subroutine, constants)
    ...
    if args.secrets is None:
        ...
        if args.verbose:
            print(
                "Analyzing {} with initial secrets {} and initial constants {}".format(
        ...
        secret_control_deps = {
            node: pcs for node, pcs in control_deps.items() if node in args.secrets
        }
    ...
    if len(secret_control_deps) != 0:
        ...
        msg += "\n  ".join(stringify_control_deps(program, secret_control_deps))
        out.err(msg)
