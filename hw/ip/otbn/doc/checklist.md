...
### V1
 ...
 Type         | Item                                  | Resolution  | Note/Collaterals
--------------|---------------------------------------|-------------|------------------
Documentation | [DV_DOC_DRAFT_COMPLETED][]            | Done        | [OTBN DV Plan]({{<relref "hw/ip/otbn/doc/dv_doc" >}})
Documentation | [VERIFICATION_PLAN_COMPLETED][]       | Done        | [OTBN verification plan]({{<relref "hw/ip/otbn/doc/dv_doc/index.md#verification_plan" >}})
