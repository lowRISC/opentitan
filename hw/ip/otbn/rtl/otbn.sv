...
(
  ...
  // bus window sizes. They are given in 32b words.
  localparam ImemSizeByte = otbn_reg_pkg::OTBN_IMEM_SIZE * 4;
  localparam DmemSizeByte = otbn_reg_pkg::OTBN_DMEM_SIZE * 4;
  ...
  logic [1:0] unused_imem_addr_core_wordbits = imem_addr_core[1:0]
  ...
  tlul_adapter_sram #(
    ...
    .Outstanding (1),
    .ByteAccess  (0),
    // TODO: Set to ErrOnRead to 1 if IMEM should be write-only from TL-UL.
    .ErrOnRead   (0)
  ...
  // TODO: Prevent switch-overs in the middle of a transaction.
  assign imem_access_core = busy;
  ...
  // IMEM data through the bus unintentionally.
  ...
  // TODO: Since rerror depends on rvalid we could save this mux, but could
  ...
  // LFSR ======================================================================
  // TODO: Potentially insert local LFSR, or otherwise produce enough randomness.
endmodule
