...
(
  ...
  input logic            sec_wipe_acc_zero_i,
  ...
  assign acc_d = sec_wipe_acc_urnd_i   ? urnd_data_i                                       :
                 sec_wipe_acc_zero_i   ? '0                                                :
                 ispr_acc_wr_en_i      ? ispr_acc_wr_data_i                                :
  ...
  assign acc_en = mac_en_i | ispr_acc_wr_en_i | sec_wipe_acc_urnd_i | sec_wipe_acc_zero_i;
