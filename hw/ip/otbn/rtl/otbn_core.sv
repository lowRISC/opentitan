...
#(
  ...
  logic sec_wipe_acc_zero;

  logic sec_wipe_mod_urnd;
  logic sec_wipe_mod_zero;

  logic sec_wipe_stack_reset;
  ...
  otbn_start_stop_control u_otbn_start_stop_control (
    ...
    .sec_wipe_acc_zero_o (sec_wipe_acc_zero),

    .sec_wipe_mod_urnd_o (sec_wipe_mod_urnd),
    .sec_wipe_mod_zero_o (sec_wipe_mod_zero),
    .sec_wipe_stack_reset_o (sec_wipe_stack_reset),
  ...
  otbn_rf_base #(
    ...
    .state_reset_i (state_reset),
    .sec_wipe_stack_reset_i (sec_wipe_stack_reset),
  ...
  assign rf_base_wr_data_no_intg = sec_wipe_base ? (sec_wipe_base_urnd ? urnd_data[31:0] : 32'd0) :
                                   rf_base_wr_data_no_intg_ctrl;
  ...
  assign rf_bignum_wr_data_no_intg = sec_wipe_wdr ? (sec_wipe_wdr_urnd ? urnd_data : 256'd0) :
                                     rf_bignum_wr_data_no_intg_ctrl;
  ...
  otbn_alu_bignum u_otbn_alu_bignum (
    ...
    .sec_wipe_mod_zero_i      (sec_wipe_mod_zero),
  ...
  otbn_mac_bignum u_otbn_mac_bignum (
    ...
    .sec_wipe_acc_zero_i (sec_wipe_acc_zero),
