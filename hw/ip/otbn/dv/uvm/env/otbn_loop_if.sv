...
interface otbn_loop_if #(
  ...
  `OCAH_OT_COVER(LoopEnd_C, current_loop_finish)
  ...
  `OCAH_OT_COVER(ShortestLoop_C, (loop_start_req_i && loop_start_commit_i) ##1 current_loop_finish)
  ...
  `OCAH_OT_COVER(BadNestingMiddle_C,
         current_loop_valid && next_loop_valid &&
