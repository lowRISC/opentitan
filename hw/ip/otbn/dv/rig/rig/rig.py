...
def gen_program(config: Config, fuel: int, insns_file: InsnsFile) -> Tuple[InitData, Snippet, int]:
    ...
    try:
        ...
        raise RuntimeError("Failed to initialise snippet generators: {}".format(err)) from None
