...
def prepare_sim_for_asm_file(
    asm_file: str, tmpdir: py.path.local, collect_stats: bool
) -> StandaloneSim:
...
def prepare_sim_for_asm_str(
    assembly: str, tmpdir: py.path.local, collect_stats: bool
) -> StandaloneSim:
