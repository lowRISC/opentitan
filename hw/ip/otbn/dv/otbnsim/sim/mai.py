...
# Compile-time permutation for the URND permutation in MAI.
_MAI_URND_PERM = (
    177, 101, 344, 337, 24, 99, 55, 180, 196, 226, 251, 381, 184, 183, 321,
    212, 340, 233, 205, 70, 258, 369, 368, 11, 200, 34, 58, 88, 301, 102,
    297, 97, 228, 121, 173, 238, 291, 23, 85, 361, 133, 316, 9, 234, 360,
    163, 388, 39, 328, 227, 45, 285, 65, 113, 352, 370, 164, 272, 7, 31,
    59, 336, 136, 286, 350, 280, 108, 185, 12, 353, 330, 255, 240, 371, 20,
    221, 283, 373, 257, 155, 236, 220, 311, 25, 122, 5, 190, 274, 62, 348,
    357, 72, 125, 296, 176, 35, 377, 341, 109, 223, 339, 87, 152, 198, 19,
    294, 154, 281, 245, 79, 146, 253, 208, 86, 71, 186, 306, 362, 262, 21,
    175, 118, 317, 26, 249, 153, 1, 18, 64, 78, 81, 197, 132, 260, 181,
    61, 92, 264, 379, 170, 41, 44, 106, 243, 141, 279, 312, 42, 0, 327,
    156, 282, 4, 334, 256, 324, 134, 206, 73, 57, 309, 140, 104, 364, 278,
    166, 242, 67, 91, 161, 241, 63, 8, 292, 244, 93, 346, 359, 135, 13,
    16, 271, 201, 372, 270, 299, 358, 277, 384, 367, 209, 111, 22, 214, 6,
    129, 230, 224, 40, 308, 203, 266, 322, 68, 313, 127, 158, 376, 167, 332,
    139, 293, 119, 335, 117, 267, 338, 246, 380, 160, 95, 43, 354, 320, 126,
    130, 333, 329, 159, 265, 94, 100, 14, 211, 149, 191, 27, 182, 144, 49,
    284, 315, 385, 33, 148, 89, 165, 217, 77, 107, 273, 90, 325, 187, 298,
    76, 290, 383, 232, 300, 138, 304, 216, 229, 310, 269, 252, 32, 219, 36,
    28, 247, 171, 254, 343, 120, 386, 261, 295, 204, 110, 382, 289, 15, 215,
    128, 143, 150, 307, 29, 263, 318, 96, 54, 51, 194, 207, 30, 174, 189,
    378, 168, 193, 314, 288, 83, 363, 84, 356, 351, 248, 38, 349, 116, 47,
    210, 239, 319, 151, 105, 287, 98, 60, 202, 178, 162, 231, 387, 323, 123,
    302, 112, 103, 69, 82, 268, 137, 50, 172, 347, 53, 157, 305, 147, 142,
    179, 114, 115, 145, 331, 124, 259, 56, 188, 345, 131, 2, 74, 375, 46,
    17, 342, 222, 37, 199, 276, 355, 80, 66, 213, 52, 237, 10, 218, 192,
    75, 326, 225, 250, 169, 303, 235, 195, 374, 48, 3, 365, 366, 275,
)
...
def _permute_urnd(urnd_val: int) -> int:
    """Apply the MAI URND permutation (see _MAI_URND_PERM) to a raw 389-bit URND word."""
    result = 0
    for i, src_bit in enumerate(_MAI_URND_PERM):
        result |= ((urnd_val >> src_bit) & 1) << i
    return result
...
def _urnd_fields(urnd_val: int) -> Tuple[int, int, int, int]:
    ...
    """
    urnd_val = _permute_urnd(urnd_val)
