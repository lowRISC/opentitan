...
#define TOP_ENGLISHBREAKFAST_NVM_BASE_ADDR TOP_ENGLISHBREAKFAST_FLASH_CTRL_MEM_BASE_ADDR
#define TOP_ENGLISHBREAKFAST_NVM_SIZE_BYTES TOP_ENGLISHBREAKFAST_FLASH_CTRL_MEM_SIZE_BYTES
