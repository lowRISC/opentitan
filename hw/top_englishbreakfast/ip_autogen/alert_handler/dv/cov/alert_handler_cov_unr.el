...
// Format Version: 2
// Date: Fri Aug 16 16:37:33 2024
// ExclMode: default
//==================================================
CHECKSUM: "1923524726 1594399761"
...
CHECKSUM: "3655552781 2169403375"
INSTANCE: tb.dut.u_edn_req.u_prim_packer_fifo
ANNOTATION: "VC_COV_UNR"
Condition 9 "2531947712" "(gen_unpack_mode.pull_data ? ((depth_q - DepthOne)) : depth_q) 1 -1" (2 "1")
ANNOTATION: "VC_COV_UNR"
Condition 11 "1372743715" "(gen_unpack_mode.pull_data ? ((gen_unpack_mode.ptr_q + DepthOne)) : gen_unpack_mode.ptr_q) 1 -1" (2 "1")
ANNOTATION: "VC_COV_UNR"
Condition 16 "1428458034" "(( ! (depth_q == '0) ) && ((!clr_q))) 1 -1" (2 "10")
CHECKSUM: "571876547 4131299725"
