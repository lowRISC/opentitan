...
interface rstmgr_rst_en_track_sva_if (
  ...
  `OCAH_OT_ASSERT(DAonRstPorIoDiv4ShadowedEnTracksRstPorIoDiv4ShadowedActive_A,
  ...
  `OCAH_OT_ASSERT(DAonRstPorIoDiv4ShadowedEnTracksRstPorIoDiv4ShadowedInactive_A,
  ...
  `OCAH_OT_ASSERT(DMainRstLcIoDiv4EnTracksRstLcIoDiv4Active_A,
          $fell(resets_i.rst_lc_io_div4_n[DomainMainSel]) |-> ##[0:DELAY]
          reset_en_i.lc_io_div4[DomainMainSel] == prim_mubi_pkg::MuBi4True,
          clk_io_div4_i,
          !rst_por_ni)

  `OCAH_OT_ASSERT(DMainRstLcIoDiv4EnTracksRstLcIoDiv4Inactive_A,
  ...
  `OCAH_OT_ASSERT(DAonRstLcIoDiv4EnTracksRstLcIoDiv4Active_A,
          $fell(resets_i.rst_lc_io_div4_n[DomainAonSel]) |-> ##[0:DELAY]
          reset_en_i.lc_io_div4[DomainAonSel] == prim_mubi_pkg::MuBi4True,
          clk_io_div4_i,
          !rst_por_ni)

  `OCAH_OT_ASSERT(DAonRstLcIoDiv4EnTracksRstLcIoDiv4Inactive_A,
  ...
  `OCAH_OT_ASSERT(DMainRstSysShadowedEnTracksRstSysShadowedActive_A,
          $fell(resets_i.rst_sys_shadowed_n[DomainMainSel]) |-> ##[0:DELAY]
          reset_en_i.sys_shadowed[DomainMainSel] == prim_mubi_pkg::MuBi4True,
          clk_main_i,
          !rst_por_ni)

  `OCAH_OT_ASSERT(DMainRstSysShadowedEnTracksRstSysShadowedInactive_A,
  ...
  `OCAH_OT_ASSERT(DMainRstSysIoDiv4EnTracksRstSysIoDiv4Active_A,
          $fell(resets_i.rst_sys_io_div4_n[DomainMainSel]) |-> ##[0:DELAY]
          reset_en_i.sys_io_div4[DomainMainSel] == prim_mubi_pkg::MuBi4True,
          clk_io_div4_i,
          !rst_por_ni)

  `OCAH_OT_ASSERT(DMainRstSysIoDiv4EnTracksRstSysIoDiv4Inactive_A,
  ...
  `OCAH_OT_ASSERT(DMainRstSysAonEnTracksRstSysAonActive_A,
          $fell(resets_i.rst_sys_aon_n[DomainMainSel]) |-> ##[0:DELAY]
          reset_en_i.sys_aon[DomainMainSel] == prim_mubi_pkg::MuBi4True,
          clk_aon_i,
          !rst_por_ni)

  `OCAH_OT_ASSERT(DMainRstSysAonEnTracksRstSysAonInactive_A,
  ...
  `OCAH_OT_ASSERT(DAonRstSysAonEnTracksRstSysAonActive_A,
          $fell(resets_i.rst_sys_aon_n[DomainAonSel]) |-> ##[0:DELAY]
          reset_en_i.sys_aon[DomainAonSel] == prim_mubi_pkg::MuBi4True,
          clk_aon_i,
          !rst_por_ni)

  `OCAH_OT_ASSERT(DAonRstSysAonEnTracksRstSysAonInactive_A,
