...
load("@lowrisc_opentitan//rules:signing.bzl", "KeyInfo")
...
SILICON_CREATOR_KEYS = struct(
    FAKE = struct(
        ECDSA = struct(
            TEST = [
                create_test_key("fake_ecdsa_test_key_0", "@lowrisc_opentitan//sw/device/silicon_creator/rom/keys/fake/ecdsa:test_key_0_ecdsa_p256"),
            ],
            DEV = [
                create_dev_key("fake_ecdsa_dev_key_0", "@lowrisc_opentitan//sw/device/silicon_creator/rom/keys/fake/ecdsa:dev_key_0_ecdsa_p256"),
            ],
            PROD = [
                create_prod_key("fake_ecdsa_prod_key_0", "@lowrisc_opentitan//sw/device/silicon_creator/rom/keys/fake/ecdsa:prod_key_0_ecdsa_p256"),
            ],
        ),
        SPX = struct(
            TEST = [
                create_test_key("fake_spx_test_key_0", "@lowrisc_opentitan//sw/device/silicon_creator/rom/keys/fake/spx:test_key_0_spx"),
            ],
            DEV = [
                create_dev_key("fake_spx_dev_key_0", "@lowrisc_opentitan//sw/device/silicon_creator/rom/keys/fake/spx:dev_key_0_spx"),
            ],
            PROD = [
                create_prod_key("fake_spx_prod_key_0", "@lowrisc_opentitan//sw/device/silicon_creator/rom/keys/fake/spx:prod_key_0_spx"),
            ],
        ),
    ),
    ...
    UNAUTHORIZED = struct(
        SPX = [
            create_key_("spx_unauthorized_0", "@lowrisc_opentitan//sw/device/silicon_creator/rom/keys/unauthorized/spx:unauthorized_0_spx", []),
        ],
    ),
)
...
SILICON_OWNER_KEYS = struct(
    FAKE = struct(
        RSA = struct(
            TEST = [
                create_test_key("fake_rsa_rom_ext_test_key_0", "@lowrisc_opentitan//sw/device/silicon_creator/rom_ext/keys/fake:rom_ext_test_private_key_0"),
            ],
            DEV = [
                create_dev_key("fake_rsa_rom_ext_dev_key_0", "@lowrisc_opentitan//sw/device/silicon_creator/rom_ext/keys/fake:rom_ext_dev_private_key_0"),
            ],
            PROD = None,
        ),
        # We can't expose real private keys publicly.
