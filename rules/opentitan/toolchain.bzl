...
localtools_toolchain = rule(
    ...
    attrs = {
        "opentitantool": attr.label(
            default = "@lowrisc_opentitan//sw/host/opentitantool:opentitantool",
            executable = True,
            cfg = host_tools_transition,
        ),
        "gen_devid": attr.label(
            default = "@lowrisc_opentitan//sw/host/provisioning/orchestrator/src:devid_header_gen",
            executable = True,
            cfg = host_tools_transition,
        ),
        "gen_mem_image": attr.label(
            default = "@lowrisc_opentitan//hw/ip/rom_ctrl/util:gen_vivado_mem_image",
            executable = True,
            cfg = host_tools_transition,
        ),
        "gen_otp_rot_auth_json": attr.label(
            default = "@lowrisc_opentitan//util/design:gen-otp-rot-auth-json",
            executable = True,
            cfg = host_tools_transition,
        ),
        "gen_otp_immutable_rom_ext_json": attr.label(
            default = "@lowrisc_opentitan//util/design:gen-otp-immutable-rom-ext-json",
            executable = True,
            cfg = host_tools_transition,
        ),
