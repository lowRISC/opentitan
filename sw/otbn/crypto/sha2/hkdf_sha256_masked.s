 ...
 *   - ikm_s0         (64B, aligned 32): Share 0 of Input Keying Material
 *   - ikm_s1         (64B, aligned 32): Share 1 of Input Keying Material
 *   - ikm_len        (4B,  aligned 4) : Byte length of IKM (0 <= ikm_len <= 64)
 *   - info           (32B, aligned 32): Unmasked context info string
 *   - info_len       (4B,  aligned 4) : Byte length of info (0 <= info_len <= 30)
...
.L_expand_loop:
  ...
  /* --- Case i > 1: prepend T(i-1) (32B) to hmac_msg_s0/s1[0..31] --- */
  addi     x14, x14, 32
