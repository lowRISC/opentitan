...
/**
 * OTBN simulation test for masked HKDF-SHA384 (RFC 5869 Test Case 1 inputs).
 *
 * Test Vector:
 *   Hash = SHA-384
 ...
 *   N    = 2 blocks (96 bytes contiguous OKM = T(1) || T(2))
 */
...
main:
  ...
  /* Unmask PRK (48B + 16B zero) into w2 (bytes 0..31) and w3 (bytes 32..63) */
  la       x2, prk_s0
  la       x3, prk_s1
  li       x4, 0
  li       x5, 1
  ...
  /* Unmask contiguous OKM (96B = 3 WDRs) into w4 (0..31), w5 (32..63), w6 (64..95) */
  la       x2, okm_s0
  la       x3, okm_s1
  bn.lid   x4, 0(x2)
  bn.lid   x5, 0(x3)
...
/* Generate 2 blocks (96 bytes contiguous OKM) */
.balign 4
