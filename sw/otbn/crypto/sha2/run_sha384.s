...
main:
  ...
  /* Run the masked sha384 process and update the state shares.
       dmem[state_s0, state_s1] = sha384_masked(dmem[state_s0, state_s1],
 ...
 * - sha384_masked uses 736 bytes (.data constants)
