 ...
 * @param[out] state_s0   : Share 0 of final hash state (384 bits: abcd at 32, ef00 at 0)
 ...
 *
 * SHA-384 defines 64-bit message words and state registers in big-endian byte
...
sha384_process_block_masked:
  ...
  loopi    20, 92   /* SCA_TEST_REPLACE: loopi 1, 92 */
    bn.lid   x22, 0(x18++)
    ...
    loopi    4, 89
      ...
      /* Compute masked Ch(e, f, g) into (w27, w30) */
      jal      x1, sha384_ch

      /* Prepare Lane 0 = h + S1(e), Lane 1 = Ch + W[t] */
      bn.and   w0,  w20, w25
      bn.or    w0,  w0,  w27 << 64
      bn.rshi  w2,  w31, w28 >> 192
      bn.or    w2,  w2,  w21 << 64
      bn.xor   w31, w31, w31

      bn.and   w1,  w20, w16, FG1
      bn.or    w1,  w1,  w30 << 64, FG1
      bn.rshi  w3,  w31, w11 >> 192
      bn.or    w3,  w3,  w12 << 64, FG1
      ...
      /* Add Lane 0 + Lane 1 -> T1 in bits 63..0 */
      bn.rshi  w2,  w31, w0 >> 64
      bn.xor   w31, w31, w31
      bn.rshi  w3,  w31, w1 >> 64
      jal      x1, sec_add64
      ...
      /* Prepare S0(a) + Maj */
      bn.rshi  w2,  w31, w29 >> 192
      bn.xor   w31, w31, w31
      bn.rshi  w3,  w31, w11 >> 192

      jal      x1, sec_add64

      /* Fuse T1 + T2 -> new_a (Lane 0) and d + T1 -> new_e (Lane 1) */
      bn.and   w0,  w0,  w20
      bn.or    w0,  w0,  w26 << 64
      bn.or    w2,  w27, w27 << 64
      bn.xor   w31, w31, w31
