...
impl SpxKms {
    ...
    // Legacy name: eliminate when cloud-kms rolls out the new name.
    const PREHASH_ALGORITHM_OLDNAME: &'static str = "PQ_SIGN_SLH_DSA_SHA2_128S_SHA256";
    ...
    fn kms_to_algorithm(kms_algo: &str) -> Result<String> {
        match kms_algo {
            Self::PURE_ALGORITHM | Self::PREHASH_ALGORITHM_OLDNAME | Self::PREHASH_ALGORITHM => {
                Ok("SLH-DSA-SHA2-128S".into())
            }
    ...
    fn kms_to_domain(kms_algo: &str) -> Result<SpxDomain> {
        match kms_algo {
            ...
            Self::PREHASH_ALGORITHM_OLDNAME | Self::PREHASH_ALGORITHM => {
                Ok(SpxDomain::PreHashedSha256)
            }
            _ => Err(HsmError::Unsupported(format!("algorithm {kms_algo}")).into()),
        }
    }
...
impl SpxInterface for SpxKms {
    ...
    fn generate_key(
        ...
        let algorithm = match domain {
            ...
            SpxDomain::PreHashedSha256 => Self::PREHASH_ALGORITHM_OLDNAME,
