...
use serde_annotate::{Annotate, AnnotateSerialize, ColorProfile};
use std::any::Any;
...
impl BasicResult {
    pub fn from_error(e: &anyhow::Error) -> Box<dyn AnnotateSerialize> {
        Box::new(BasicResult {
            success: false,
            id: AttrData::None,
            label: AttrData::None,
...
pub fn print_result(
    ...
    color: Option<bool>,
    quiet: bool,
    result: Result<Box<dyn AnnotateSerialize>>,
) -> Result<()> {
