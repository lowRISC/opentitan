...
pub struct ManufCpProvisioningActions {
    ...
    flash_info_erase_device_id_and_manuf_state: bool,
    ...
    flash_info_erase_wafer_auth_secret: bool,
    ...
    flash_info_write_device_id_and_manuf_state: bool,
    ...
    flash_info_write_wafer_auth_secret: bool,
    ...
    otp_write_and_lock_secret0: bool,
...
fn hex_string_to_u32_arrayvec<const N: usize>(hex_str: &str) -> Result<ArrayVec<u32, N>> {
