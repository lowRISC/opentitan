...
// `USE_RRAM` builds in sw/device/silicon_creator/lib/nvm_ctrl.h.
const NVM_BYTES_PER_PAGE: u32 = 512;
const NVM_PAGES_PER_SLOT: u16 = 2048;
// Number of reserved pages at the end of each slot (32kB, see top_earlgrey_memory.ld).
const RESERVED_PAGES: u16 = 64;
...
const FIRMWARE_PAGES: u16 = NVM_PAGES_PER_SLOT - RESERVED_PAGES - ROM_EXT_PAGES - FILESYSTEM_PAGES;
