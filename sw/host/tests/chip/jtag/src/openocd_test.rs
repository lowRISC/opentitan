...
use top_darjeeling::top_darjeeling_memory;
...
fn test_openocd(opts: &Opts, transport: &TransportWrapper) -> Result<()> {
    ...
    let lc_ctrl_base_addr = top_darjeeling_memory::TOP_DARJEELING_LC_CTRL_CORE_BASE_ADDR as u32;
    ...
    let test_ram_addr = top_darjeeling_memory::TOP_DARJEELING_RAM_RET_AON_BASE_ADDR as u32;
    const SIZE: usize = 20;
