...
class FiSimOwnerUpgrade(unittest.TestCase):
    def test_owner_upgrade(self):
        print("Starting the owner upgrade test")

        # Directory for the trace log files
        pc_trace_file = os.path.join(log_dir, "owner_upgrade_pc_trace.log")
        # Directory for the the log of the campaign
        campaign_file = os.path.join(log_dir, "owner_upgrade_test_campaign.log")
