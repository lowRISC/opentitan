...
case_to_alert_list_map = [
    ...
    29,  # Case 38 maps to alert_list index 29 ("pwm_aon_fatal_fault")
    22,  # Case 39 maps to alert_list index 22 ("pwrmgr_aon_fatal_fault")
    60,  # Case 40 maps to alert_list index 60 ("rom_ctrl_fatal")
    23,  # Case 41 maps to alert_list index 23 ("rstmgr_aon_fatal_fault")
    24,  # Case 42 maps to alert_list index 24 ("rstmgr_aon_fatal_cnsty_fault")
    61,  # Case 43 maps to alert_list index 61 ("rv_core_ibex_fatal_sw_err")
    62,  # Case 44 maps to alert_list index 62 ("rv_core_ibex_recov_sw_err")
    63,  # Case 45 maps to alert_list index 63 ("rv_core_ibex_fatal_hw_err")
    64,  # Case 46 maps to alert_list index 64 ("rv_core_ibex_recov_hw_err")
    41,  # Case 47 maps to alert_list index 41 ("rv_plic_fatal_fault")
    10,  # Case 48 maps to alert_list index 10 ("rv_timer_fatal_fault")
    32,  # Case 49 maps to alert_list index 32 ("sensor_ctrl_recov_alert")
    33,  # Case 50 maps to alert_list index 33 ("sensor_ctrl_fatal_alert")
    5,   # Case 51 maps to alert_list index 5 ("spi_device_fatal_fault")
    19,  # Case 52 maps to alert_list index 19 ("spi_host0_fatal_fault")
    20,  # Case 53 maps to alert_list index 20 ("spi_host1_fatal_fault")
    59,  # Case 54 maps to alert_list index 59 ("sram_ctrl_main_fatal_error")
    34,  # Case 55 maps to alert_list index 34 ("sram_ctrl_ret_aon_fatal_error")
    27,  # Case 56 maps to alert_list index 27 ("sysrst_ctrl_aon_fatal_fault")
    0,   # Case 57 maps to alert_list index 0 ("uart0_fatal_fault")
    1,   # Case 58 maps to alert_list index 1 ("uart1_fatal_fault")
    2,   # Case 59 maps to alert_list index 2 ("uart2_fatal_fault")
    3,   # Case 60 maps to alert_list index 3 ("uart3_fatal_fault")
    21,  # Case 61 maps to alert_list index 21 ("usbdev_fatal_fault")
]
