...
class HyperDebug:
    ...
    def start_openocd(self, startup_delay=2, print_output=True):
        ...
        self.openocd_process = Popen(command, stdout=PIPE, stderr=PIPE)
    ...
    def close_openocd(self):
        ...
        try:
            self.openocd_process.communicate(timeout=5)
