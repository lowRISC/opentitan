...
default_fpga_friendly_alert_config = {
    ...
    "enable_alerts": [
        ...
        True,  # "sensor_ctrl_fatal_alert",
        True,  # "sram_ctrl_ret_aon_fatal_error",
        # On FPGA, changing the flash alerts causes an alert itself
        False,  # "flash_ctrl_recov_err",
        False,  # "flash_ctrl_fatal_std_err",
        False,  # "flash_ctrl_fatal_err",
        False,  # "flash_ctrl_fatal_prim_flash_alert",
        False,  # "flash_ctrl_recov_prim_flash_alert",
        True,  # "rv_dm_fatal_fault",
        True,  # "rv_plic_fatal_fault",
        True,  # "aes_recov_ctrl_update_err",
        True,  # "aes_fatal_fault",
