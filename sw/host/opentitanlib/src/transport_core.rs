...
use crate::io::bootstrap_types::BootstrapOptions;
...
pub use crate::io::errors::{TransportError, TransportInterfaceType};

// Export capabilities
pub use crate::io::capabilities::{Capabilities, Capability, NeededCapabilities};
