...
pub fn prepare_epmp_for_sram(jtag: &Rc<dyn Jtag>) -> Result<()> {
    ...
    let base = top_darjeeling_memory::TOP_DARJEELING_SRAM_CTRL_MAIN_RAM_BASE_ADDR as u32;
    let size = top_darjeeling_memory::TOP_DARJEELING_SRAM_CTRL_MAIN_RAM_SIZE_BYTES as u32;
