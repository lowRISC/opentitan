...
impl DaiParam {
    ...
    pub const ROM_EXEC_EN: OtpParamMmap = OtpParamMmap {
        byte_addr: dif::OTP_CTRL_PARAM_CREATOR_SW_CFG_ROM_EXEC_EN_OFFSET,
        size: dif::OTP_CTRL_PARAM_CREATOR_SW_CFG_ROM_EXEC_EN_SIZE,
    };
    pub const ROM_BOOTSTRAP_DIS: OtpParamMmap = OtpParamMmap {
        byte_addr: dif::OTP_CTRL_PARAM_OWNER_SW_CFG_ROM_BOOTSTRAP_DIS_OFFSET,
        size: dif::OTP_CTRL_PARAM_OWNER_SW_CFG_ROM_BOOTSTRAP_DIS_SIZE,
    };
    ...
    pub const fn mmap(&self) -> OtpParamMmap {
        match self {
            Self::RomExecEn => Self::ROM_EXEC_EN,
            Self::RomBootstrapDis => Self::ROM_BOOTSTRAP_DIS,
