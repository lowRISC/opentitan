...
pub enum OtpCtrlReg {
    ...
    ErrCode0 = dif::OTP_CTRL_ERR_CODE_0_REG_OFFSET,
    ErrCode1 = dif::OTP_CTRL_ERR_CODE_1_REG_OFFSET,
    ErrCode2 = dif::OTP_CTRL_ERR_CODE_2_REG_OFFSET,
    ErrCode3 = dif::OTP_CTRL_ERR_CODE_3_REG_OFFSET,
    ErrCode4 = dif::OTP_CTRL_ERR_CODE_4_REG_OFFSET,
    ErrCode5 = dif::OTP_CTRL_ERR_CODE_5_REG_OFFSET,
    ErrCode6 = dif::OTP_CTRL_ERR_CODE_6_REG_OFFSET,
    ErrCode7 = dif::OTP_CTRL_ERR_CODE_7_REG_OFFSET,
    ErrCode8 = dif::OTP_CTRL_ERR_CODE_8_REG_OFFSET,
    ErrCode9 = dif::OTP_CTRL_ERR_CODE_9_REG_OFFSET,
    ...
    HwCfg0Digest0 = dif::OTP_CTRL_HW_CFG0_DIGEST_0_REG_OFFSET,
    HwCfg0Digest1 = dif::OTP_CTRL_HW_CFG0_DIGEST_1_REG_OFFSET,
    HwCfg1Digest0 = dif::OTP_CTRL_HW_CFG1_DIGEST_0_REG_OFFSET,
    HwCfg1Digest1 = dif::OTP_CTRL_HW_CFG1_DIGEST_1_REG_OFFSET,
...
bitflags! {
    ...
    pub struct OtpCtrlStatus: u32 {
        ...
        const HW_CFG1_ERROR         = 0b1 << dif::OTP_CTRL_STATUS_HW_CFG1_ERROR_BIT;
...
impl Partition {
    ...
    pub const HW_CFG1: Self = Self {
        access_granule: Granularity::B32,
        byte_addr: dif::OTP_CTRL_PARAM_HW_CFG1_OFFSET,
        digest: OtpParamMmap {
            byte_addr: dif::OTP_CTRL_PARAM_HW_CFG1_DIGEST_OFFSET,
            size: dif::OTP_CTRL_PARAM_HW_CFG1_DIGEST_SIZE,
        },
    };
...
impl DaiParam {
    ...
    pub const fn partition(&self) -> Partition {
        match self {
            ...
            Self::EnSramIfetch => Partition::HW_CFG1,
