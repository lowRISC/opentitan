...
static void execute_test(dif_aon_timer_t *aon_timer, uint64_t irq_time_us,
  ...
  peripheral = kTopDarjeelingPlicPeripheralUnknown;
  ...
  if (peripheral != kTopDarjeelingPlicPeripheralAonTimerAon) {
    ...
    } while (peripheral != kTopDarjeelingPlicPeripheralAonTimerAon &&
  ...
  CHECK(peripheral == kTopDarjeelingPlicPeripheralAonTimerAon,
        "Interrupt from incorrect peripheral: exp = %d, obs = %d",
        kTopDarjeelingPlicPeripheralAonTimerAon, peripheral);
...
void ottf_external_isr(void) {
  ...
  if (peripheral == kTopDarjeelingPlicPeripheralAonTimerAon) {
    ...
    } else if (irq_id == kTopDarjeelingPlicIrqIdAonTimerAonWdogTimerBark) {
