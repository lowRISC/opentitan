...
status_t handle_otbn_sca_ecc256_modinv(ujson_t *uj) {
  // As receiving 80 bytes over uJSON seems not to work, receive separate
  // 20 bytes packages.
  cryptotest_otbn_sca_k_t uj_data_0;
  TRY(ujson_deserialize_cryptotest_otbn_sca_k_t(uj, &uj_data_0));
  cryptotest_otbn_sca_k_t uj_data_1;
  TRY(ujson_deserialize_cryptotest_otbn_sca_k_t(uj, &uj_data_1));
  cryptotest_otbn_sca_k_t uj_data_2;
  TRY(ujson_deserialize_cryptotest_otbn_sca_k_t(uj, &uj_data_2));
  cryptotest_otbn_sca_k_t uj_data_3;
  TRY(ujson_deserialize_cryptotest_otbn_sca_k_t(uj, &uj_data_3));
  ...
  memcpy(modinv_k0, uj_data_0.k, kEcc256ModInvInputShareNumBytes / 2);
  memcpy(modinv_k0 + (kEcc256ModInvInputShareNumWords / 2), uj_data_1.k,
         kEcc256ModInvInputShareNumBytes / 2);

  memcpy(modinv_k1, uj_data_2.k, kEcc256ModInvInputShareNumBytes / 2);
  memcpy(modinv_k1 + (kEcc256ModInvInputShareNumWords / 2), uj_data_3.k,
         kEcc256ModInvInputShareNumBytes / 2);
