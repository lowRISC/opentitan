...
static const dif_pinmux_index_t kPinmuxMioOut[] = {
    kTopDarjeelingPinmuxMioOutIob9,   // pda0_tx
    kTopDarjeelingPinmuxMioOutIob10,  // pcl0_tx
    kTopDarjeelingPinmuxMioOutIob11,  // pda1_tx
    kTopDarjeelingPinmuxMioOutIob12,  // pcl1_tx
};
...
void ottf_external_isr(void) {
  ...
  switch (irq_id) {
    case kTopDarjeelingPlicIrqIdPattgenDoneCh0:
      LOG_INFO("Channel 0");
      break;
    case kTopDarjeelingPlicIrqIdPattgenDoneCh1:
      LOG_INFO("Channel 1");
      break;
    default:
...
bool test_main(void) {
  ...
  rv_plic_testutils_irq_range_enable(&plic, kPlicTarget,
                                     kTopDarjeelingPlicIrqIdPattgenDoneCh0,
                                     kTopDarjeelingPlicIrqIdPattgenDoneCh1);
