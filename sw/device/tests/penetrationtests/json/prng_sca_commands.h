...
UJSON_SERDE_STRUCT(PenetrationtestPrngScaLfsr, penetrationtest_prng_sca_lfsr_t, PRNG_SCA_LFSR);
...
#endif
#endif  // OPENTITAN_SW_DEVICE_TESTS_PENETRATIONTESTS_JSON_PRNG_SCA_COMMANDS_H_
