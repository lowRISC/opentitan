...
#define OTPFI_VENDORTEST_PARTITION(field, string) \
    field(vendor_test_comp, uint32_t, VENDORTEST_SIZE32) \
    field(vendor_test_fi, uint32_t, VENDORTEST_SIZE32) \
    field(otp_status_codes, uint32_t) \
    field(otp_error_causes, uint8_t, 10) \
    field(ibex_err_status, uint32_t) \
...
#define OTPFI_OWNERSWCFG_PARTITION(field, string) \
    field(owner_sw_cfg_comp, uint32_t, OWNERSWCFG_SIZE32) \
    field(owner_sw_cfg_fi, uint32_t, OWNERSWCFG_SIZE32) \
    field(otp_status_codes, uint32_t) \
    field(otp_error_causes, uint8_t, 10) \
    field(ibex_err_status, uint32_t) \
    field(alerts, uint32_t, 3)
...
#define OTPFI_HWCFG_PARTITION(field, string) \
    field(hw_cfg_comp, uint32_t, HWCFG_SIZE32) \
    field(hw_cfg_fi, uint32_t, HWCFG_SIZE32) \
    field(otp_status_codes, uint32_t) \
    field(otp_error_causes, uint8_t, 10) \
    field(ibex_err_status, uint32_t) \
    field(alerts, uint32_t, 3)
...
#define OTPFI_LIFECYCLE_PARTITION(field, string) \
    field(life_cycle_comp, uint32_t, LIFECYCLE_SIZE32) \
    field(life_cycle_fi, uint32_t, LIFECYCLE_SIZE32) \
    field(otp_status_codes, uint32_t) \
    field(otp_error_causes, uint8_t, 10) \
    field(ibex_err_status, uint32_t) \
    field(alerts, uint32_t, 3)
