...
status_t handle_sha3_sca_disable_masking(ujson_t *uj) {
  penetrationtest_sha3_sca_masks_off_t uj_data;
  TRY(ujson_deserialize_penetrationtest_sha3_sca_masks_off_t(uj, &uj_data));
  ...
  penetrationtest_sha3_sca_status_t uj_status;
  uj_status.status = 0;
  RESP_OK(ujson_serialize_penetrationtest_sha3_sca_status_t, uj, &uj_status);
...
status_t handle_sha3_sca_single_absorb(ujson_t *uj) {
  penetrationtest_sha3_sca_msg_t uj_msg;
  TRY(ujson_deserialize_penetrationtest_sha3_sca_msg_t(uj, &uj_msg));
  ...
  penetrationtest_sha3_sca_batch_digest_t uj_output;
  memcpy(uj_output.batch_digest, (uint8_t *)out, kDigestLength * 4);
  RESP_OK(ujson_serialize_penetrationtest_sha3_sca_batch_digest_t, uj,
          &uj_output);
...
status_t handle_sha3_sca_batch(ujson_t *uj) {
  penetrationtest_sha3_sca_data_t uj_data;
  TRY(ujson_deserialize_penetrationtest_sha3_sca_data_t(uj, &uj_data));
...
status_t handle_sha3_sca_seed_lfsr(ujson_t *uj) {
  penetrationtest_sha3_sca_lfsr_t uj_lfsr_data;
  TRY(ujson_deserialize_penetrationtest_sha3_sca_lfsr_t(uj, &uj_lfsr_data));
...
status_t handle_sha3_sca_init(ujson_t *uj) {
  ...
  penetrationtest_sha3_sca_fpga_mode_t uj_data;
  TRY(ujson_deserialize_penetrationtest_sha3_sca_fpga_mode_t(uj, &uj_data));
