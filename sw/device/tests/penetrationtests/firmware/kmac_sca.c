...
#include "sw/device/tests/penetrationtests/firmware/kmac_sca.h"
...
status_t handle_kmac_sca_init(ujson_t *uj) {
  ...
  penetrationtest_kmac_sca_fpga_mode_t uj_data;
  TRY(ujson_deserialize_penetrationtest_kmac_sca_fpga_mode_t(uj, &uj_data));
...
status_t handle_kmac_sca_set_key(ujson_t *uj) {
  penetrationtest_kmac_sca_key_t uj_key;
  TRY(ujson_deserialize_penetrationtest_kmac_sca_key_t(uj, &uj_key));
...
status_t handle_kmac_sca_single_absorb(ujson_t *uj) {
  penetrationtest_kmac_sca_msg_t uj_msg;
  TRY(ujson_deserialize_penetrationtest_kmac_sca_msg_t(uj, &uj_msg));
  ...
  penetrationtest_kmac_sca_batch_digest_t uj_output;
  memcpy(uj_output.batch_digest, (uint8_t *)out, kDigestLength * 4);
  RESP_OK(ujson_serialize_penetrationtest_kmac_sca_batch_digest_t, uj,
          &uj_output);
...
status_t handle_kmac_sca_batch(ujson_t *uj) {
  penetrationtest_kmac_sca_data_t uj_data;
  TRY(ujson_deserialize_penetrationtest_kmac_sca_data_t(uj, &uj_data));
...
status_t handle_kmac_sca_seed_lfsr(ujson_t *uj) {
  penetrationtest_kmac_sca_lfsr_t uj_lfsr_data;
  TRY(ujson_deserialize_penetrationtest_kmac_sca_lfsr_t(uj, &uj_lfsr_data));
