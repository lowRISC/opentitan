...
#ifndef OPENTITAN_SW_DEVICE_TESTS_PENETRATIONTESTS_FIRMWARE_FI_ASYM_CRYPTOLIB_FI_ASYM_H_
#define OPENTITAN_SW_DEVICE_TESTS_PENETRATIONTESTS_FIRMWARE_FI_ASYM_CRYPTOLIB_FI_ASYM_H_
