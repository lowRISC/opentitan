...
#include "sw/device/tests/penetrationtests/firmware/prng_sca.h"
...
status_t handle_prng_sca_seed_prng(ujson_t *uj) {
  penetrationtest_prng_sca_lfsr_t uj_data;
  TRY(ujson_deserialize_penetrationtest_prng_sca_lfsr_t(uj, &uj_data));
