...
// static const char kData2_endian[8] = " sU pleH";
...
static void test_start_endian_cfg(const dif_hmac_t *hmac, const uint8_t *key,
...
static void run_test_endianness(const dif_hmac_t *hmac, const char *data,
  ...
  test_start_endian_cfg(hmac, key, config);
