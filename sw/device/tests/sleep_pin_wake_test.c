...
OTTF_BACKDOOR_VAR(int8_t, sival_mio_pad, -1) // -1 means not assigned yet.
OTTF_BACKDOOR_VAR(int8_t, sival_wakeup_detector_idx, -1) // -1 means not assigned yet.
OTTF_BACKDOOR_VAR(bool, sival_ready_to_sleep, false)
