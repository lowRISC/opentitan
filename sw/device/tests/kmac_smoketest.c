...
#define MESSAGE_LEN_SHA3_MAX (1200 / 8)
...
typedef struct sha3_test {
  ...
  const char message[MESSAGE_LEN_SHA3_MAX];
  size_t message_len;
...
const sha3_test_t sha3_tests[] = {
    ...
    },
    {
        ...
        .message = {0xa7, 0x48, 0x47, 0x93, 0x0a, 0x03, 0xab, 0xee, 0xa4, 0x73,
                    0xe1, 0xf3, 0xdc, 0x30, 0xb8, 0x88, 0x15},
        .message_len = 136 / 8,
    ...
    },
    {
        ...
        .message = {0x66, 0x4e, 0xf2, 0xe3, 0xa7, 0x05, 0x9d, 0xaf, 0x1c, 0x58,
