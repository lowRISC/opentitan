...
typedef dif_flash_ctrl_data_region_properties_t
    dif_nvm_ctrl_data_region_properties_t;
...
#define dif_nvm_ctrl_get_default_region_properties \
  dif_flash_ctrl_get_default_region_properties
#define dif_nvm_ctrl_set_default_region_properties \
  dif_flash_ctrl_set_default_region_properties
#define dif_nvm_ctrl_set_data_region_properties \
  dif_flash_ctrl_set_data_region_properties
#define dif_nvm_ctrl_set_data_region_enablement \
