---
title: "RRAM Controller DIF Checklist"
---
...
to `sw/device/lib/dif/dif_rram_ctrl.md` for a new DIF that transitions
...
-->
This checklist is for [Development Stage](/doc/project_governance/development_stages.md) transitions for the [RRAM Controller DIF](/hw/ip/rram_ctrl/README.md).
