...
#include "dt_rv_timer.h"  // Generated.
 ...
 *
 * DEPRECATED Use `dt_rv_timer_irq_t` instead.
...
dif_result_t dif_rv_timer_irq_is_pending(const dif_rv_timer_t *rv_timer,
                                         dif_rv_timer_irq_t, bool *is_pending);
...
dif_result_t dif_rv_timer_irq_force(const dif_rv_timer_t *rv_timer,
                                    dif_rv_timer_irq_t, const bool val);
