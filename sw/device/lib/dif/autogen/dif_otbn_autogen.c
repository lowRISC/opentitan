...
dif_result_t dif_otbn_alert_force(const dif_otbn_t *otbn,
  ...
  mmio_region_write32(otbn->base_addr, (ptrdiff_t)OTBN_ALERT_TEST_REG_OFFSET,
                      alert_test_reg);
...
dif_result_t dif_otbn_irq_get_state(const dif_otbn_t *otbn,
  ...
  *snapshot = mmio_region_read32(otbn->base_addr,
                                 (ptrdiff_t)OTBN_INTR_STATE_REG_OFFSET);
...
dif_result_t dif_otbn_irq_acknowledge_state(
  ...
  mmio_region_write32(otbn->base_addr, (ptrdiff_t)OTBN_INTR_STATE_REG_OFFSET,
                      snapshot);
...
dif_result_t dif_otbn_irq_is_pending(const dif_otbn_t *otbn, dif_otbn_irq_t irq,
  ...
  uint32_t intr_state_reg = mmio_region_read32(
      otbn->base_addr, (ptrdiff_t)OTBN_INTR_STATE_REG_OFFSET);
...
dif_result_t dif_otbn_irq_force(const dif_otbn_t *otbn, dif_otbn_irq_t irq,
  ...
  mmio_region_write32(otbn->base_addr, (ptrdiff_t)OTBN_INTR_TEST_REG_OFFSET,
                      intr_test_reg);
...
dif_result_t dif_otbn_irq_get_enabled(const dif_otbn_t *otbn,
  ...
  uint32_t intr_enable_reg = mmio_region_read32(
      otbn->base_addr, (ptrdiff_t)OTBN_INTR_ENABLE_REG_OFFSET);
...
dif_result_t dif_otbn_irq_set_enabled(const dif_otbn_t *otbn,
  ...
  mmio_region_write32(otbn->base_addr, (ptrdiff_t)OTBN_INTR_ENABLE_REG_OFFSET,
                      intr_enable_reg);
...
dif_result_t dif_otbn_irq_disable_all(
  ...
  if (snapshot != NULL) {
    *snapshot = mmio_region_read32(otbn->base_addr,
                                   (ptrdiff_t)OTBN_INTR_ENABLE_REG_OFFSET);
  }
