...
#include "dt_otp_ctrl.h"  // Generated.
 ...
 *
 * DEPRECATED Use `dt_otp_ctrl_irq_t` instead.
 ...
 */
#define kDifOtpCtrlIrqOtpOperationDone kDtOtpCtrlIrqOtpOperationDone
/**
 * An error has occurred in the OTP controller. Check the !!ERR_CODE register to
 * get more information.
 */
#define kDifOtpCtrlIrqOtpError kDtOtpCtrlIrqOtpError

// DEPRECATED This typedef exists solely for the transition to
// dt-based interrupt numbers and will be removed in the future.
typedef dt_otp_ctrl_irq_t dif_otp_ctrl_irq_t;
...
dif_result_t dif_otp_ctrl_irq_is_pending(const dif_otp_ctrl_t *otp_ctrl,
                                         dif_otp_ctrl_irq_t, bool *is_pending);
...
dif_result_t dif_otp_ctrl_irq_force(const dif_otp_ctrl_t *otp_ctrl,
                                    dif_otp_ctrl_irq_t, const bool val);
