...
TEST_F(GetInternalStateTest, GetInternalStateOk) {
  ...
  EXPECT_WRITE32(CSRNG_HALT_MAIN_SM_REG_OFFSET,
                 {
                     {CSRNG_HALT_MAIN_SM_HALT_MAIN_SM_BIT, true},
                 });
  EXPECT_READ32(CSRNG_MAIN_SM_STS_REG_OFFSET,
                {
                    {CSRNG_MAIN_SM_STS_MAIN_SM_STS_BIT, true},
                });
  ...
  EXPECT_WRITE32(CSRNG_HALT_MAIN_SM_REG_OFFSET,
                 {
                     {CSRNG_HALT_MAIN_SM_HALT_MAIN_SM_BIT, false},
                 });
  EXPECT_READ32(CSRNG_MAIN_SM_STS_REG_OFFSET,
                {
                    {CSRNG_MAIN_SM_STS_MAIN_SM_STS_BIT, false},
                });
