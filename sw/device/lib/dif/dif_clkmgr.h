...
typedef enum dif_clkmgr_measure_frequency {
  /**
   * The Io clock.
   */
  kDifClkmgrMeasureIoFrequency,
  /**
   * The Io_div2 clock.
   */
  kDifClkmgrMeasureIoDiv2Frequency,
  /**
   * The Io div4 clock.
   */
  kDifClkmgrMeasureIoDiv4Frequency,
  /**
   * The Main clock.
   */
  kDifClkmgrMeasureMainFrequency,
  /**
   * The Usb clock.
   */
  kDifClkmgrMeasureUsbFrequency,
} dif_clkmgr_measure_frequency_t;
...
/**
 * Disable frequency measurement control updates.
 *
...
/**
 * Configure clk frequency measurements.
 *
 * @param clkmgr Clock Manager Handle.
