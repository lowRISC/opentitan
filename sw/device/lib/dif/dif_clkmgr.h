 ...
 * @param[out] sources The index of the clock.
 * @return `kDifError` if no gateable matches the description, `kDifOk`
 * otherwise.
 */
OT_WARN_UNUSED_RESULT
 ...
 * @param inst_id An instance ID.
 * @param[out] sources The index of the clock.
 * @return `kDifError` if no hintable matches the description, `kDifOk`
 * otherwise.
 */
OT_WARN_UNUSED_RESULT
