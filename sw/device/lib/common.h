...
static const usize UART_BAUD_RATE = 9600;
#else
#define CLK_FIXED_FREQ_HZ (50ULL * 1000 * 1000)
static const usize UART_BAUD_RATE = 230400;
#endif
...
#define REG8 VOLATILE_8
#define REG16 VOLATILE_16
#define REG32 VOLATILE_32
#define SETBIT(val, bit) SET_BIT(val, bit)
#define CLRBIT(val, bit) CLR_BIT(val, bit)
