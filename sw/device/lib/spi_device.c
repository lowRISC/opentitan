...
#define SPI_DEVICE_REG_DEF(id, rname) (REG_DEF(SPI_DEVICE, id, rname))
#define SPI_DEVICE_CONTROL(id) (SPI_DEVICE_REG_DEF(id, CONTROL))
#define SPI_DEVICE_CFG(id) (SPI_DEVICE_REG_DEF(id, CFG))
#define SPI_DEVICE_RXF_ADDR(id) (SPI_DEVICE_REG_DEF(id, RXF_ADDR))
#define SPI_DEVICE_TXF_ADDR(id) (SPI_DEVICE_REG_DEF(id, TXF_ADDR))
#define SPI_DEVICE_TXF_PTR(id) (SPI_DEVICE_REG_DEF(id, TXF_PTR))
#define SPI_DEVICE_RXF_PTR(id) (SPI_DEVICE_REG_DEF(id, RXF_PTR))
