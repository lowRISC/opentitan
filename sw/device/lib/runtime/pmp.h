 ...
 * "Volume II: RISC-V Privileged Architectures V20190608-Priv-MSU-Ratified",
 * "3.6 Physical Memory Protection", section "Address Matching".
 *
 ...
 *
 * Note: this function will clears PMP `region` configuration.
 *
...
typedef enum pmp_region_configure_na4_result {
   ...
   * "Volume II: RISC-V Privileged Architectures V20190608-Priv-MSU-Ratified",
   * "3.6 Physical Memory Protection", "Table 3.10" and section
   * "Address Matching".
   */
 ...
 * @param region PMP region to configure and set the address for.
 * @param config PMP region configuration information.
 * @param address PMP address to be set (must be aligned to `size`).
 * @param size PMP protected address range size (must be power-of-two).
 ...
 * @param region PMP region to configure and set the address for.
 * @param config PMP region configuration information.
 * @param address_start PMP bottom of the range address to be set. It must be
 *        0 for the "0" region.
 * @param address_end PMP top of the range address to be set.
 * @return `pmp_region_configure_result_t`.
 */
PMP_WARN_UNUSED_RESULT
