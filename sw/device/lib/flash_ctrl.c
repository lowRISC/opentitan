...
static int flash_write_internal(uint32 addr, const uint32 *data,
                                uint32 size) {
...
uint32 flash_read_scratch_reg(void) { return REG32(FLASH_CTRL_SCRATCH(0)); }
