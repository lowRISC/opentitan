...
#define FLASH_CTRL_REG_DEF(id, rname) (REG_DEF(FLASH_CTRL, id, rname))
#define FLASH_CTRL_OP_STATUS(id) (FLASH_CTRL_REG_DEF(id, OP_STATUS))
#define FLASH_CTRL_STATUS(id) (FLASH_CTRL_REG_DEF(id, STATUS))
#define FLASH_CTRL_STATUS(id) (FLASH_CTRL_REG_DEF(id, STATUS))
#define FLASH_CTRL_INTR_STATE(id) (FLASH_CTRL_REG_DEF(id, INTR_STATE))
#define FLASH_CTRL_ADDR(id) (FLASH_CTRL_REG_DEF(id, ADDR))
#define FLASH_CTRL_CONTROL(id) (FLASH_CTRL_REG_DEF(id, CONTROL))
#define FLASH_CTRL_MP_BANK_CFG(id) (FLASH_CTRL_REG_DEF(id, MP_BANK_CFG))
#define FLASH_CTRL_DEFAULT_REGION(id) (FLASH_CTRL_REG_DEF(id, DEFAULT_REGION))
#define FLASH_CTRL_MP_REGION_CFG0(id) (FLASH_CTRL_REG_DEF(id, MP_REGION_CFG0))
#define FLASH_CTRL_MP_REGION_CFG1(id) (FLASH_CTRL_REG_DEF(id, MP_REGION_CFG1))
#define FLASH_CTRL_MP_REGION_CFG2(id) (FLASH_CTRL_REG_DEF(id, MP_REGION_CFG2))
#define FLASH_CTRL_SCRATCH(id) (FLASH_CTRL_REG_DEF(id, SCRATCH))
