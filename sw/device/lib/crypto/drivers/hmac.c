...
static status_t hmac_context_wipe(hmac_ctx_t *ctx) {
  ...
  hardened_memshred(ibex_rnd32_read, ctx->key, kHmacMaxBlockWords);
  hardened_memshred(ibex_rnd32_read, ctx->H, kHmacMaxDigestWords);
  hardened_memshred(ibex_rnd32_read, (uint32_t *)(ctx->partial_block),
