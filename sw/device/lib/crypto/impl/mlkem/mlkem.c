...
OTBN_DECLARE_SYMBOL_ADDR(mlkem1024_keygen, mlkem1024_keygen_seed_z_share1);
...
OTBN_DECLARE_SYMBOL_ADDR(mlkem1024_keygen, mlkem1024_keygen_sk_s_share0);
OTBN_DECLARE_SYMBOL_ADDR(mlkem1024_keygen, mlkem1024_keygen_sk_s_share1);
...
OTBN_DECLARE_SYMBOL_ADDR(mlkem1024_keygen, mlkem1024_keygen_sk_z_share0);
OTBN_DECLARE_SYMBOL_ADDR(mlkem1024_keygen, mlkem1024_keygen_sk_z_share1);
...
OTBN_DECLARE_SYMBOL_ADDR(mlkem1024_decaps, mlkem1024_decaps_sk_s_share0);
OTBN_DECLARE_SYMBOL_ADDR(mlkem1024_decaps, mlkem1024_decaps_sk_s_share1);
...
OTBN_DECLARE_SYMBOL_ADDR(mlkem1024_decaps, mlkem1024_decaps_sk_z_share0);
OTBN_DECLARE_SYMBOL_ADDR(mlkem1024_decaps, mlkem1024_decaps_sk_z_share1);
...
enum {
  ...
  kMlkem1024PolyWords = 1536 / sizeof(uint32_t),
  kMlkem1024SkSWords = 3072 / sizeof(uint32_t),
  kMlkem1024SkHpkWords = 32 / sizeof(uint32_t),
  kMlkem1024SkZWords = 64 / sizeof(uint32_t),
...
status_t mlkem1024_det_keygen_internal_start(
  ...
  HARDENED_TRY(hardened_memcpy(d_share0, d->keyblob, 32));
  HARDENED_TRY(hardened_memcpy(
      d_share1, (const uint32_t *)d->keyblob + kMlkem1024SeedWords, 32));
  ...
  // Write seed z_share0 and z_share1.
...
status_t mlkem1024_keygen_internal_finalize(
  ...
  const otbn_addr_t kOtbnSkS0 =
      OTBN_ADDR_T_INIT(mlkem1024_keygen, mlkem1024_keygen_sk_s_share0);
  HARDENED_TRY(
      otbn_dmem_read(kMlkem1024PolyWords, kOtbnSkS0, secret_key->keyblob));

  const otbn_addr_t kOtbnSkS1 =
      OTBN_ADDR_T_INIT(mlkem1024_keygen, mlkem1024_keygen_sk_s_share1);
  HARDENED_TRY(otbn_dmem_read(kMlkem1024PolyWords, kOtbnSkS1,
                              secret_key->keyblob + kMlkem1024PolyWords));
  ...
  const otbn_addr_t kOtbnSkZ0 =
      OTBN_ADDR_T_INIT(mlkem1024_keygen, mlkem1024_keygen_sk_z_share0);
  HARDENED_TRY(otbn_dmem_read(kMlkem1024SeedWords, kOtbnSkZ0,
                              secret_key->keyblob + kMlkem1024SkSWords +
                                  kMlkem1024PkTWords + kMlkem1024PkRhoWords +
                                  kMlkem1024SkHpkWords));

  const otbn_addr_t kOtbnSkZ1 =
      OTBN_ADDR_T_INIT(mlkem1024_keygen, mlkem1024_keygen_sk_z_share1);
  HARDENED_TRY(otbn_dmem_read(kMlkem1024SeedWords, kOtbnSkZ1,
                              secret_key->keyblob + kMlkem1024SkSWords +
                                  kMlkem1024PkTWords + kMlkem1024PkRhoWords +
                                  kMlkem1024SkHpkWords + kMlkem1024SeedWords));
...
status_t mlkem1024_encaps_finalize(otcrypto_word32_buf_t *ciphertext,
  ...
  const otbn_addr_t kOtbnOk =
      OTBN_ADDR_T_INIT(mlkem1024_encaps, mlkem1024_encaps_res_ok);
  HARDENED_TRY(otbn_dmem_read(1, kOtbnOk, &ok));
  if (launder32(ok) != kMlkem1024StatusOk) {
    return OTCRYPTO_BAD_ARGS;
  }
  HARDENED_CHECK_EQ(ok, kMlkem1024StatusOk);
...
status_t mlkem1024_decaps_start(const otcrypto_blinded_key_t *secret_key,
  ...
  const otbn_addr_t kOtbnSkS0 =
      OTBN_ADDR_T_INIT(mlkem1024_decaps, mlkem1024_decaps_sk_s_share0);
  HARDENED_TRY(
      otbn_dmem_write(kMlkem1024PolyWords, secret_key->keyblob, kOtbnSkS0));

  const otbn_addr_t kOtbnSkS1 =
      OTBN_ADDR_T_INIT(mlkem1024_decaps, mlkem1024_decaps_sk_s_share1);
  HARDENED_TRY(otbn_dmem_write(kMlkem1024PolyWords,
                               secret_key->keyblob + kMlkem1024PolyWords,
                               kOtbnSkS1));
  ...
  const otbn_addr_t kOtbnSkZ0 =
      OTBN_ADDR_T_INIT(mlkem1024_decaps, mlkem1024_decaps_sk_z_share0);
  HARDENED_TRY(otbn_dmem_write(kMlkem1024SeedWords,
                               secret_key->keyblob + kMlkem1024SkSWords +
                                   kMlkem1024PkTWords + kMlkem1024PkRhoWords +
                                   kMlkem1024SkHpkWords,
                               kOtbnSkZ0));
  ...
  const otbn_addr_t kOtbnSkZ1 =
      OTBN_ADDR_T_INIT(mlkem1024_decaps, mlkem1024_decaps_sk_z_share1);
  HARDENED_TRY(otbn_dmem_write(kMlkem1024SeedWords,
                               secret_key->keyblob + kMlkem1024SkSWords +
                                   kMlkem1024PkTWords + kMlkem1024PkRhoWords +
                                   kMlkem1024SkHpkWords + kMlkem1024SeedWords,
