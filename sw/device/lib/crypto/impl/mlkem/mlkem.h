 ...
 *
 * OTBN will sample random seeds d and z internally.
 ...
 *
 * @param[out] public_key Generated public key pk.
 * @param[out] secret_key Generated secret key sk.
 * @return Result of the operation (OK or error).
 */
 ...
 * Returns an `OTCRYPTO_ASYNC_INCOMPLETE` error if OTBN is busy.
 *
 * @param secret_key Secret key for decapsulation.
 ...
 * Blocks until OTBN is idle.
 *
 * @param[out] shared_secret Decapsulated shared secret.
 * @return Result of the operation (OK or error).
 */
