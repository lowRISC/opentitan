...
#ifndef OPENTITAN_SW_DEVICE_LIB_CRYPTO_IMPL_ECC_ECDSA_sm2_H_
#define OPENTITAN_SW_DEVICE_LIB_CRYPTO_IMPL_ECC_ECDSA_sm2_H_
 ...
 */
typedef struct ecdsa_sm2_signature_t {
  uint32_t r[ksm2ScalarWords];
  uint32_t s[ksm2ScalarWords];
} ecdsa_sm2_signature_t;
 ...
 * private as with `ecdsa_sm2_keygen_finalize`. Blocks until OTBN is idle.
 *
 ...
 *
 * See the documentation of `ecdsa_sm2_sign` for details.
 *
 * Blocks until OTBN is idle.
 *
 ...
 *
 * See the documentation of `ecdsa_sm2_verify` for details.
 *
 * Returns an `OTCRYPTO_ASYNC_INCOMPLETE` error if OTBN is busy.
 *
...
#endif  // OPENTITAN_SW_DEVICE_LIB_CRYPTO_IMPL_ECC_ECDSA_sm2_H_
