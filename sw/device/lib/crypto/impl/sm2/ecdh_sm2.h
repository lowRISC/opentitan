...
#ifndef OPENTITAN_SW_DEVICE_LIB_CRYPTO_IMPL_ECC_ECDH_sm2_H_
#define OPENTITAN_SW_DEVICE_LIB_CRYPTO_IMPL_ECC_ECDH_sm2_H_
 ...
 */
typedef struct ecdh_sm2_shared_key {
  uint32_t share0[ksm2CoordWords];
  uint32_t share1[ksm2CoordWords];
} ecdh_sm2_shared_key_t;
 ...
 * `ecdh_sm2_shared_key_start` or `ecdh_sm2_sideload_shared_key_start`; the
...
#endif  // OPENTITAN_SW_DEVICE_LIB_CRYPTO_IMPL_ECC_ECDH_sm2_H_
