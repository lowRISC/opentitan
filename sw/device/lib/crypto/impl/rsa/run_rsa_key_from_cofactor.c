...
status_t rsa_keygen_from_cofactor_start(rsa_size_t size,
  ...
  const otbn_app_t kOtbnAppRsaKeygen =
  ...
  switch (launder32(size)) {
    case kRsaSize2048:
      ...
      const uint32_t kOtbnRsaModeCofactor2048 =
    ...
    case kRsaSize3072:
      ...
      const uint32_t kOtbnRsaModeCofactor3072 =
    ...
    case kRsaSize4096:
      ...
      const uint32_t kOtbnRsaModeCofactor4096 =
...
status_t rsa_keygen_from_cofactor_finalize(rsa_size_t size,
  ...
  const otbn_addr_t kOtbnVarRsaD0 =
  ...
  const otbn_addr_t kOtbnVarRsaD1 =
