...
otcrypto_status_t otcrypto_ecdsa_p256_verify(
  ...
  HARDENED_TRY(otcrypto_ecdsa_p256_verify_async_start(public_key, message_digest,
                                                 signature));
...
otcrypto_status_t otcrypto_ecdsa_p384_verify(
    ...
    otcrypto_const_word32_buf_t signature,
    hardened_bool_t *verification_result) {
  HARDENED_TRY(otcrypto_ecdsa_p384_verify_async_start(public_key, message_digest,
                                                 signature));
