 ...
 * key consists of two Boolean shares of eight words each. The actual key is
 * retrieved by the word-wise XOR of the two shares.
 *
 * key should first be passed to otcrypto_hw_backed_key when
 * attestation is kHardenedBoolFalse or otcrypto_hw_backed_attestation_key when
 * attestation is kHardenedBoolTrue to set the key handle.
 *
