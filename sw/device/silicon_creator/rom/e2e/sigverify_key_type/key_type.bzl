...
load("@lowrisc_opentitan//rules/opentitan:defs.bzl", "DEFAULT_TEST_FAILURE_MSG")
load("@lowrisc_opentitan//rules:const.bzl", "CONST", "hex_digits")
load(
    "@lowrisc_opentitan//sw/device/silicon_creator/rom/e2e:defs.bzl",
    "MSG_PASS",
    "MSG_TEMPLATE_BFV_LCV",
)
load("@lowrisc_opentitan//rules/opentitan:keyutils.bzl", "key_allowed_in_lc_state")
