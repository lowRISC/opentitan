...
| RvTimerFatalFault            | 11   | X          | C      | C          | X     | X     | X       |
| UsbdevFatalFault             | 12   | X          | C      | C          | X     | X     | X       |
| OtpCtrlFatalMacroError       | 13   | X          | A      | A          | D     | X     | X       |
| OtpCtrlFatalCheckError       | 14   | X          | A      | A          | D     | X     | X       |
| OtpCtrlFatalBusIntegError    | 15   | X          | A      | A          | D     | X     | X       |
| LcCtrlFatalProgError         | 16   | X          | A      | A          | D     | X     | X       |
| LcCtrlFatalStateError        | 17   | X          | A      | A          | D     | X     | X       |
| LcCtrlFatalBusIntegError     | 18   | X          | A      | A          | D     | X     | X       |
| PwrmgrAonFatalFault          | 19   | X          | C      | C          | X     | X     | X       |
| RstmgrAonFatalFault          | 20   | X          | C      | C          | X     | X     | X       |
| ClkmgrAonRecovFault          | 21   | X          | C      | C          | X     | X     | X       |
| ClkmgrAonFatalFault          | 22   | X          | C      | C          | X     | X     | X       |
| SysrstCtrlAonFatalFault      | 23   | X          | C      | C          | X     | X     | X       |
| AdcCtrlAonFatalFault         | 24   | X          | C      | C          | X     | X     | X       |
| PwmAonFatalFault             | 25   | X          | C      | C          | X     | X     | X       |
| PinmuxAonFatalFault          | 26   | X          | C      | C          | X     | X     | X       |
| AonTimerAonFatalFault        | 27   | X          | C      | C          | X     | X     | X       |
| SensorCtrlRecovAlert         | 28   | X          | C      | C          | X     | X     | X       |
| SensorCtrlFatalAlert         | 29   | X          | C      | C          | X     | X     | X       |
| SramCtrlRetAonFatalIntgError | 30   | X          | B      | B          | D     | X     | X       |
| FlashCtrlRecovErr            | 31   | X          | D      | D          | D     | X     | X       |
| FlashCtrlFatalErr            | 32   | X          | A      | A          | D     | X     | X       |
| RvDmFatalFault               | 33   | X          | C      | C          | X     | X     | X       |
| RvPlicFatalFault             | 34   | X          | C      | C          | X     | X     | X       |
| AesRecovCtrlUpdateErr        | 35   | X          | D      | D          | D     | X     | X       |
| AesFatalFault                | 36   | X          | A      | A          | D     | X     | X       |
| HmacFatalFault               | 37   | X          | A      | A          | D     | X     | X       |
| KmacFatalFault               | 38   | X          | A      | A          | D     | X     | X       |
| KeymgrFatalFaultErr          | 39   | X          | A      | A          | D     | X     | X       |
| KeymgrRecovOperationErr      | 40   | X          | D      | D          | D     | X     | X       |
| CsrngRecovAlert              | 41   | X          | D      | D          | D     | X     | X       |
| CsrngFatalAlert              | 42   | X          | A      | A          | D     | X     | X       |
| EntropySrcRecovAlert         | 43   | X          | D      | D          | D     | X     | X       |
| EntropySrcFatalAlert         | 44   | X          | A      | A          | D     | X     | X       |
| Edn0FatalAlert               | 45   | X          | A      | A          | D     | X     | X       |
| Edn0RecovAlert               | 46   | X          | D      | D          | D     | X     | X       |
| Edn1FatalAlert               | 47   | X          | A      | A          | D     | X     | X       |
| Edn1RecovAlert               | 48   | X          | D      | D          | D     | X     | X       |
| SramCtrlMainFatalError       | 49   | X          | A      | A          | D     | X     | X       |
| OtbnFatal                    | 50   | X          | A      | A          | D     | X     | X       |
| OtbnRecov                    | 51   | X          | D      | D          | D     | X     | X       |
| RomCtrlFatal                 | 52   | X          | A      | A          | D     | X     | X       |
| RvCoreIbexFatalSwErr         | 53   | X          | A      | A          | D     | X     | X       |
| RvCoreIbexRecovSwErr         | 54   | X          | D      | D          | D     | X     | X       |
| RvCoreIbexFatalHwErr         | 55   | X          | A      | A          | D     | X     | X       |
| RvCoreIbexRecovHwErr         | 56   | X          | D      | D          | D     | X     | X       |
