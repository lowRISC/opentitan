...
| PwrmgrFatalFault          | 19   | X          | C      | C          | X     | X     | X       |
| RstmgrFatalFault          | 20   | X          | C      | C          | X     | X     | X       |
| ClkmgrRecovFault          | 21   | X          | C      | C          | X     | X     | X       |
| ClkmgrFatalFault          | 22   | X          | C      | C          | X     | X     | X       |
| SysrstCtrlFatalFault      | 23   | X          | C      | C          | X     | X     | X       |
| AdcCtrlFatalFault         | 24   | X          | C      | C          | X     | X     | X       |
| PinmuxFatalFault          | 25   | X          | C      | C          | X     | X     | X       |
| AonTimerFatalFault        | 26   | X          | C      | C          | X     | X     | X       |
| SensorCtrlRecovAlert         | 27   | X          | C      | C          | X     | X     | X       |
| SensorCtrlFatalAlert         | 28   | X          | C      | C          | X     | X     | X       |
| SramCtrlRetFatalIntgError | 29   | X          | B      | B          | D     | X     | X       |
