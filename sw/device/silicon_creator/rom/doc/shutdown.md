...
| PinmuxAonFatalFault          | 25   | X          | C      | C          | X     | X     | X       |
| AonTimerAonFatalFault        | 26   | X          | C      | C          | X     | X     | X       |
| SensorCtrlRecovAlert         | 27   | X          | C      | C          | X     | X     | X       |
| SensorCtrlFatalAlert         | 28   | X          | C      | C          | X     | X     | X       |
| SramCtrlRetAonFatalIntgError | 29   | X          | B      | B          | D     | X     | X       |
| FlashCtrlRecovErr            | 30   | X          | D      | D          | D     | X     | X       |
| FlashCtrlFatalErr            | 31   | X          | A      | A          | D     | X     | X       |
| RvDmFatalFault               | 32   | X          | C      | C          | X     | X     | X       |
| RvPlicFatalFault             | 33   | X          | C      | C          | X     | X     | X       |
| AesRecovCtrlUpdateErr        | 34   | X          | D      | D          | D     | X     | X       |
| AesFatalFault                | 35   | X          | A      | A          | D     | X     | X       |
| HmacFatalFault               | 36   | X          | A      | A          | D     | X     | X       |
| KmacFatalFault               | 37   | X          | A      | A          | D     | X     | X       |
| KeymgrFatalFaultErr          | 38   | X          | A      | A          | D     | X     | X       |
| KeymgrRecovOperationErr      | 39   | X          | D      | D          | D     | X     | X       |
| CsrngRecovAlert              | 40   | X          | D      | D          | D     | X     | X       |
| CsrngFatalAlert              | 41   | X          | A      | A          | D     | X     | X       |
| EntropySrcRecovAlert         | 42   | X          | D      | D          | D     | X     | X       |
| EntropySrcFatalAlert         | 43   | X          | A      | A          | D     | X     | X       |
| Edn0FatalAlert               | 44   | X          | A      | A          | D     | X     | X       |
| Edn0RecovAlert               | 45   | X          | D      | D          | D     | X     | X       |
| Edn1FatalAlert               | 46   | X          | A      | A          | D     | X     | X       |
| Edn1RecovAlert               | 47   | X          | D      | D          | D     | X     | X       |
| SramCtrlMainFatalError       | 48   | X          | A      | A          | D     | X     | X       |
| OtbnFatal                    | 49   | X          | A      | A          | D     | X     | X       |
| OtbnRecov                    | 50   | X          | D      | D          | D     | X     | X       |
| RomCtrlFatal                 | 51   | X          | A      | A          | D     | X     | X       |
| RvCoreIbexFatalSwErr         | 52   | X          | A      | A          | D     | X     | X       |
| RvCoreIbexRecovSwErr         | 53   | X          | D      | D          | D     | X     | X       |
| RvCoreIbexFatalHwErr         | 54   | X          | A      | A          | D     | X     | X       |
| RvCoreIbexRecovHwErr         | 55   | X          | D      | D          | D     | X     | X       |
