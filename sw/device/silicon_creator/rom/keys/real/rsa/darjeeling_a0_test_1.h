...
#ifndef OPENTITAN_SW_DEVICE_SILICON_CREATOR_ROM_KEYS_REAL_RSA_DARJEELING_A0_TEST_1_H_
#define OPENTITAN_SW_DEVICE_SILICON_CREATOR_ROM_KEYS_REAL_RSA_DARJEELING_A0_TEST_1_H_

#define DARJEELING_A0_TEST_1                                            \
  {                                                                     \
    .n =                                                                \
        {{                                                              \
...
#endif  // OPENTITAN_SW_DEVICE_SILICON_CREATOR_ROM_KEYS_REAL_RSA_DARJEELING_A0_TEST_1_H_
