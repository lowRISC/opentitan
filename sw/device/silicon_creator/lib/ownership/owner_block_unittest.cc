...
const owner_flash_config_2 flash_config_contains_rom_ext_wrapped = {
    .header =
        {
            .tag = kTlvTagFlashConfig,
...
const owner_flash_config_8 legacy_flash_config_wrapped = {
    .header =
        {
            .tag = kTlvTagFlashConfig,
            .length = sizeof(owner_flash_config_8),
        },
    .config =
        {
            {
...
const owner_flash_config_t &legacy_flash_config =
    reinterpret_cast<const owner_flash_config_t &>(legacy_flash_config_wrapped);
