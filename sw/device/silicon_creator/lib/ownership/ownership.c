...
void ownership_pages_lockdown(boot_data_t *bootdata, hardened_bool_t rescue) {
  ...
  flash_ctrl_info_perms_set(&kFlashCtrlInfoPageOwnerSlot0, perm);
  flash_ctrl_info_cfg_set(&kFlashCtrlInfoPageOwnerSlot0, cfg);
  abs_mmio_write32(kFlashCtrlInfoPageOwnerSlot0.base_addr +
                       kFlashCtrlInfoPageOwnerSlot0.cfg_wen_offset,
                   0);
  ...
  abs_mmio_write32(kFlashCtrlInfoPageOwnerSlot1.base_addr +
                       kFlashCtrlInfoPageOwnerSlot1.cfg_wen_offset,
                   0);
  return;
}
