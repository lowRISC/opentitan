...
const keymgr_diversification_t kTpmEkKeymgrDiversifier = {
    .salt =
        {
            0x3fd3bc42,
            0x5a401205,
...
const keymgr_diversification_t kTpmCekKeymgrDiversifier = {
    .salt =
        {
            0x8a5d086c,
            0xcbe850b4,
...
const keymgr_diversification_t kTpmCikKeymgrDiversifier = {
    .salt =
        {
            0x9d664be2,
            0x8a9739a9,
