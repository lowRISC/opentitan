...
static const size_t SIGVERIFY_NUM_TESTS = 3;

static const sigverify_test_vector_t sigverify_tests[3] = {
    {
        .key =
            {
                .n = {.data =
                ...
                .n0_inv = {
                              0x080cf451, 0x8a5c2646, 0xaf76461b, 0x39c75f05,
                              0x739cd6e9, 0xaeddff6b, 0xe228696c, 0xb5fb5926,
                          },
            },
        .sig =
            {.data =
    ...
    },
    {
        .key =
            {
                ...
                .n0_inv = {
                              0x0a773bfb, 0x4ebeae67, 0xf3e646f4, 0x2967bd03,
                              0x424b48e5, 0x5265a457, 0x4252aac5, 0x63dccfd3,
                          },
            },
        .sig =
            {.data =
        ...
        .encoded_msg = {
                        0xbb0f6d00, 0x1e8da2cd, 0xbbf164ef, 0x95ca9849, 0xe0c75f59,
                        0x5793b2dd, 0xc64b42a3, 0x141e9b85, 0x05000420, 0x03040201,
                        0x86480165, 0x0d060960, 0x00303130, 0xffffffff, 0xffffffff,
                        0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff,
                        0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff,
                        0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff,
