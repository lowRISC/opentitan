...
enum {
  kNvmCtrlSecMmioCertInfoPageCreatorCfg =
      kFlashCtrlSecMmioCertInfoPageCreatorCfg,
  kNvmCtrlSecMmioCertInfoPageOwnerRestrict =
      kFlashCtrlSecMmioCertInfoPageOwnerRestrict,
  kNvmCtrlSecMmioCertInfoPagesOwnerRestrict =
      kFlashCtrlSecMmioCertInfoPagesOwnerRestrict,
  kNvmCtrlSecMmioCreatorInfoPagesLockdown =
...
#define kNvmCtrlInfoPageAttestationKeySeeds \
...
void nvm_ctrl_cert_info_page_creator_cfg(const nvm_ctrl_info_page_t *info_page);
