 ...
 */
static keymgr_dpe_binding_value_t kBindingValueRom = {
 ...
 */
static keymgr_dpe_binding_value_t kBindingValueRomExt = {
 ...
 */
static keymgr_dpe_binding_value_t kBindingValueBl0Attestation = {
    .data = {0xe4987b39, 0x3f83d390, 0xc2f3bbaf, 0x3195dbfa, 0x23fb480c,
             0xb012ae5e, 0xf1394d28, 0x1940ceeb},
};
static keymgr_dpe_binding_value_t kBindingValueBl0Sealing = {
 ...
 */
static sc_keymgr_dpe_policies_t kDefaultPolicy = {
...
const uint32_t kSealingSlot = 0;
const uint32_t kAttestationSlot = 1;
...
rom_error_t keymgr_dpe_rom_test(void) {
  ...
  if (retention_sram_get()
    ...
    ASSERT_OK(sc_keymgr_dpe_advance_initial(kSealingSlot));
...
rom_error_t keymgr_dpe_disable_test(void) {
  ASSERT_OK(sc_keymgr_dpe_disable());
