...
static status_t personalize_gen_tpm_ek_certificate(
  ...
  // Set the NVM info page layout.
  cert_nvm_layout[kCertNvmLayoutExt0Idx].used = true;
  cert_nvm_layout[kCertNvmLayoutExt0Idx].group_name = "TPM";
  cert_nvm_layout[kCertNvmLayoutExt0Idx].num_certs = 1;

  // Provision TPM keygen seeds to flash info.
  TRY(manuf_personalize_nvm_asymm_key_seed(kNvmInfoFieldTpmEkAttestationKeySeed,
