...
# these bazel targets.
EARLGREY_OTP_CFGS = {
    "sv00": "@lowrisc_opentitan//hw/top_earlgrey/data/otp/sival_skus:otp_consts",
    "em00": "@lowrisc_opentitan//hw/top_earlgrey/data/otp/emulation:otp_consts",
} | EXT_EARLGREY_OTP_CFGS
...
EARLGREY_SKUS = {
    ...
    "emulation": {
        ...
        "rom_ext": "@lowrisc_opentitan//sw/device/silicon_creator/rom_ext:rom_ext_dice_x509_slot_b",
    ...
    "emulation_dice_cwt": {
        "otp": "em00",
        "ca_data": "@lowrisc_opentitan//sw/device/silicon_creator/manuf/keys/fake:ca_data",
        "dice_libs": ["@lowrisc_opentitan//sw/device/silicon_creator/lib/cert:dice_cwt"],
        "host_ext_libs": ["@provisioning_exts//:default_ft_ext_lib"],
        "device_ext_libs": ["@provisioning_exts//:default_perso_fw_ext"],
        "ownership_libs": ["@lowrisc_opentitan//sw/device/silicon_creator/lib/ownership:test_owner"],
        "rom_ext": "@lowrisc_opentitan//sw/device/silicon_creator/rom_ext:rom_ext_dice_cwt_slot_b",
        "owner_fw": "@lowrisc_opentitan//sw/device/silicon_owner/bare_metal:bare_metal_slot_b",
        "ecdsa_key": {},
        "spx_key": {},
        "signature_prefix": None,
    ...
    "emulation_tpm": {
        ...
        "host_ext_libs": ["@provisioning_exts//:default_ft_ext_lib"],
        "device_ext_libs": [
            "@lowrisc_opentitan//sw/device/silicon_creator/lib/cert:tpm_ek_template_library",
            "@lowrisc_opentitan//sw/device/silicon_creator/manuf/base:tpm_perso_fw_ext",
        ],
        "ownership_libs": ["@lowrisc_opentitan//sw/device/silicon_creator/lib/ownership:test_owner"],
        "rom_ext": "@lowrisc_opentitan//sw/device/silicon_creator/rom_ext:rom_ext_dice_x509_slot_b",
        "owner_fw": "@lowrisc_opentitan//sw/device/silicon_owner/bare_metal:bare_metal_slot_b",
    ...
    #     "host_ext_libs": ["@provisioning_exts//:default_ft_ext_lib"],
    #     "device_ext_libs": ["@provisioning_exts//:default_perso_fw_ext"],
    #     "ownership_libs": ["@lowrisc_opentitan//sw/device/silicon_creator/rom_ext/sival:sival_owner"],
    #     "rom_ext": "@lowrisc_opentitan//sw/device/silicon_creator/rom_ext/sival/binaries:rom_ext_dice_x509_prod",
    ...
    #     "owner_fw": "@lowrisc_opentitan//sw/device/silicon_owner/bare_metal:bare_metal_slot_b",
    #     "ecdsa_key": {"@lowrisc_opentitan//hw/top_earlgrey/data/otp/skus/sival/keys:keyset": "sv00-earlgrey-a1-root-ecdsa-prod-0"},
    #     "spx_key": {},
    #     "signature_prefix": None,
    #     "perso_bin": "@lowrisc_opentitan//sw/device/silicon_creator/manuf/base/binaries:ft_personalize_sival",
