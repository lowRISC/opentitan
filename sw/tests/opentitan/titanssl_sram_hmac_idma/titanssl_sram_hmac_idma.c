...
#define TITANSSL_ADDR_PAYLOAD      0x80000000
...
{
    buffer_payload.data = (uint8_t*)TITANSSL_ADDR_PAYLOAD_IDMA;
    buffer_payload.n = TITANSSL_SIZE_PAYLOAD;

    buffer_digest.data = (uint8_t*)TITANSSL_ADDR_DIGEST_IDMA;
        ...
        titanssl_buffer_t *const key)
{
    ...
    next_id = issue_idma_transaction(TITANSSL_ADDR_PAYLOAD,TITANSSL_ADDR_PAYLOAD_IDMA,TITANSSL_SIZE_PAYLOAD);
    ...
    next_id = issue_idma_transaction(TITANSSL_ADDR_DIGEST_IDMA,TITANSSL_ADDR_DIGEST,TITANSSL_SIZE_DIGEST);
