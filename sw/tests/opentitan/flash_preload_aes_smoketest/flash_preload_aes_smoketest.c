...
//
//
<<<<<<<< HEAD:sw/tests/opentitan/flash_preload_hmac_smoketest/flash_preload_hmac_smoketest.c
#include "../flash_hmac_smoketest/bazel-out/flash_hmac_smoketest_signed32.h"
========
#include "../flash_aes_smoketest/bazel-out/flash_aes_smoketest_signed32.h"
>>>>>>>> 01a67b2fc (Major updates: secure boot, repo organization, automation.):sw/tests/opentitan/flash_preload_aes_smoketest/flash_preload_aes_smoketest.c
...
========
        *payload_1 = FLASH_AES_SMOKETEST_SIGNED[i];
        *payload_2 = FLASH_AES_SMOKETEST_SIGNED[i+1];
        *payload_3 = FLASH_AES_SMOKETEST_SIGNED[i+2];
>>>>>>>> 01a67b2fc (Major updates: secure boot, repo organization, automation.):sw/tests/opentitan/flash_preload_aes_smoketest/flash_preload_aes_smoketest.c
        *address = i/3;
        *start = 0x1;
     }
