...
#ifndef OPENTITAN_SW_LIB_SW_DEVICE_SILICON_CREATOR_KEYMGR_BINDING_VALUE_H_
#define OPENTITAN_SW_LIB_SW_DEVICE_SILICON_CREATOR_KEYMGR_BINDING_VALUE_H_
...
#endif  // OPENTITAN_SW_LIB_SW_DEVICE_SILICON_CREATOR_KEYMGR_BINDING_VALUE_H_
