...
#ifndef OPENTITAN_SW_LIB_SW_DEVICE_SILICON_CREATOR_BASE_SEC_MMIO_H_
#define OPENTITAN_SW_LIB_SW_DEVICE_SILICON_CREATOR_BASE_SEC_MMIO_H_
...
#endif  // OPENTITAN_SW_LIB_SW_DEVICE_SILICON_CREATOR_BASE_SEC_MMIO_H_
