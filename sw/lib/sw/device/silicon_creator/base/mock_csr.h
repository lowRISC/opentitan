...
#ifndef OPENTITAN_SW_LIB_SW_DEVICE_SILICON_CREATOR_BASE_MOCK_CSR_H_
#define OPENTITAN_SW_LIB_SW_DEVICE_SILICON_CREATOR_BASE_MOCK_CSR_H_
...
#endif  // OPENTITAN_SW_LIB_SW_DEVICE_SILICON_CREATOR_BASE_MOCK_CSR_H_
