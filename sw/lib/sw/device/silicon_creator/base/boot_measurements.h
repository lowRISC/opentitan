...
#ifndef OPENTITAN_SW_LIB_SW_DEVICE_SILICON_CREATOR_BASE_BOOT_MEASUREMENTS_H_
#define OPENTITAN_SW_LIB_SW_DEVICE_SILICON_CREATOR_BASE_BOOT_MEASUREMENTS_H_
...
#endif  // OPENTITAN_SW_LIB_SW_DEVICE_SILICON_CREATOR_BASE_BOOT_MEASUREMENTS_H_
