...
#ifndef OPENTITAN_SW_LIB_SW_DEVICE_SILICON_CREATOR_MANUF_SRAM_START_H_
#define OPENTITAN_SW_LIB_SW_DEVICE_SILICON_CREATOR_MANUF_SRAM_START_H_
...
#endif  // OPENTITAN_SW_LIB_SW_DEVICE_SILICON_CREATOR_MANUF_SRAM_START_H_
