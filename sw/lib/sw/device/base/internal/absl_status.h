...
#ifndef OPENTITAN_SW_LIB_SW_DEVICE_BASE_INTERNAL_ABSL_STATUS_H_
#define OPENTITAN_SW_LIB_SW_DEVICE_BASE_INTERNAL_ABSL_STATUS_H_
...
#endif  // OPENTITAN_SW_LIB_SW_DEVICE_BASE_INTERNAL_ABSL_STATUS_H_
