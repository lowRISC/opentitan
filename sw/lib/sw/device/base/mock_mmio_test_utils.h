...
#ifndef OPENTITAN_SW_LIB_SW_DEVICE_BASE_MOCK_MMIO_TEST_UTILS_H_
#define OPENTITAN_SW_LIB_SW_DEVICE_BASE_MOCK_MMIO_TEST_UTILS_H_
...
#endif  // OPENTITAN_SW_LIB_SW_DEVICE_BASE_MOCK_MMIO_TEST_UTILS_H_
