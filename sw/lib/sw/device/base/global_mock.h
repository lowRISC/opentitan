...
#ifndef OPENTITAN_SW_LIB_SW_DEVICE_BASE_GLOBAL_MOCK_H_
#define OPENTITAN_SW_LIB_SW_DEVICE_BASE_GLOBAL_MOCK_H_
...
#endif  // OPENTITAN_SW_LIB_SW_DEVICE_BASE_GLOBAL_MOCK_H_
