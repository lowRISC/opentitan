...
#ifndef OPENTITAN_SW_IP_FLASH_CTRL_DRIVER_FLASH_CTRL_H_
#define OPENTITAN_SW_IP_FLASH_CTRL_DRIVER_FLASH_CTRL_H_
 ...
 */
extern const uint32_t kFlashCtrlCoreBaseAddr[1];

/**
 * Peripheral base address for mem device on flash_ctrl in top chip.
 *
 * This should be used with #mmio_region_from_addr to access the memory-mapped
 * registers associated with the peripheral (usually via a DIF).
 */
extern const uint32_t kFlashCtrlMemBaseAddr[1];

#ifdef __cplusplus
}  // extern "C"
#endif  // __cplusplus

#endif  // OPENTITAN_SW_IP_FLASH_CTRL_DRIVER_FLASH_CTRL_H_
