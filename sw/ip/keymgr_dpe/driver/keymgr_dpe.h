...
#ifndef OPENTITAN_SW_IP_KEYMGR_DPE_DRIVER_KEYMGR_H_
#define OPENTITAN_SW_IP_KEYMGR_DPE_DRIVER_KEYMGR_H_
...
#endif  // OPENTITAN_SW_IP_KEYMGR__DPE_DRIVER_KEYMGR_H_
