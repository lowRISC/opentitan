...
#ifndef OPENTITAN_SW_IP_RV_CORE_IBEX_DIF_DIF_RV_CORE_IBEX_H_
#define OPENTITAN_SW_IP_RV_CORE_IBEX_DIF_DIF_RV_CORE_IBEX_H_
...
#endif  // __cplusplus
#endif  // OPENTITAN_SW_IP_RV_CORE_IBEX_DIF_DIF_RV_CORE_IBEX_H_
