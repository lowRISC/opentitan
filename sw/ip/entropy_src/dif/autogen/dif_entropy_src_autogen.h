...
#ifndef OPENTITAN_SW_IP_ENTROPY_SRC_DIF_AUTOGEN_DIF_ENTROPY_SRC_AUTOGEN_H_
#define OPENTITAN_SW_IP_ENTROPY_SRC_DIF_AUTOGEN_DIF_ENTROPY_SRC_AUTOGEN_H_
...
#endif  // OPENTITAN_SW_IP_ENTROPY_SRC_DIF_AUTOGEN_DIF_ENTROPY_SRC_AUTOGEN_H_
