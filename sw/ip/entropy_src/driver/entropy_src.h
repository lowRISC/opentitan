...
#ifndef OPENTITAN_SW_IP_ENTROPY_SRC_DRIVER_ENTROPY_SRC_H_
#define OPENTITAN_SW_IP_ENTROPY_SRC_DRIVER_ENTROPY_SRC_H_
...
/**
 * Peripheral base address for entropy_src in top chip.
 *
 * This should be used with #mmio_region_from_addr to access the memory-mapped
 * registers associated with the peripheral (usually via a DIF).
 */
extern const uint32_t kEntropySrcBaseAddr[1];

#ifdef __cplusplus
}  // extern "C"
#endif  // __cplusplus

#endif  // OPENTITAN_SW_IP_ENTROPY_SRC_DRIVER_ENTROPY_SRC_H_
