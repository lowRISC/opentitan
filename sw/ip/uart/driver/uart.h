...
#ifndef OPENTITAN_SW_IP_UART_DRIVER_UART_H_
#define OPENTITAN_SW_IP_UART_DRIVER_UART_H_
...
/**
 * Peripheral base address for uarts in top chip.
 *
 * This should be used with #mmio_region_from_addr to access the memory-mapped
 * registers associated with the peripheral (usually via a DIF).
 */
extern const uint32_t kUartBaseAddr[4];

#ifdef __cplusplus
}  // extern "C"
#endif  // __cplusplus

#endif  // OPENTITAN_SW_IP_UART_DRIVER_UART_H_
