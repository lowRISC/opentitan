...
#ifndef OPENTITAN_SW_IP_UART_DIF_AUTOGEN_DIF_UART_AUTOGEN_H_
#define OPENTITAN_SW_IP_UART_DIF_AUTOGEN_DIF_UART_AUTOGEN_H_
...
#endif  // OPENTITAN_SW_IP_UART_DIF_AUTOGEN_DIF_UART_AUTOGEN_H_
