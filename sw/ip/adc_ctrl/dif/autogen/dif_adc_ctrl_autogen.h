...
#ifndef OPENTITAN_SW_IP_ADC_CTRL_DIF_AUTOGEN_DIF_ADC_CTRL_AUTOGEN_H_
#define OPENTITAN_SW_IP_ADC_CTRL_DIF_AUTOGEN_DIF_ADC_CTRL_AUTOGEN_H_
...
#endif  // OPENTITAN_SW_IP_ADC_CTRL_DIF_AUTOGEN_DIF_ADC_CTRL_AUTOGEN_H_
