...
#ifndef OPENTITAN_SW_IP_GPIO_DIF_AUTOGEN_DIF_GPIO_AUTOGEN_H_
#define OPENTITAN_SW_IP_GPIO_DIF_AUTOGEN_DIF_GPIO_AUTOGEN_H_
...
#endif  // OPENTITAN_SW_IP_GPIO_DIF_AUTOGEN_DIF_GPIO_AUTOGEN_H_
