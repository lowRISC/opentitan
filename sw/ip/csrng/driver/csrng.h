...
#ifndef OPENTITAN_SW_IP_CSRNG_DRIVER_CSRNG_H_
#define OPENTITAN_SW_IP_CSRNG_DRIVER_CSRNG_H_
...
/**
 * Peripheral base address for csrng in top chip.
 *
 * This should be used with #mmio_region_from_addr to access the memory-mapped
 * registers associated with the peripheral (usually via a DIF).
 */
extern const uint32_t kCsrngBaseAddr[1];

#ifdef __cplusplus
}  // extern "C"
#endif  // __cplusplus

#endif  // OPENTITAN_SW_IP_CSRNG_DRIVER_CSRNG_H_
