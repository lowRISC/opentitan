...
#ifndef OPENTITAN_SW_IP_SPI_HOST_DIF_DIF_SPI_HOST_H_
#define OPENTITAN_SW_IP_SPI_HOST_DIF_DIF_SPI_HOST_H_
/**
 * @file
...
#endif  // OPENTITAN_SW_IP_SPI_HOST_DIF_DIF_SPI_HOST_H_
