...
#ifndef OPENTITAN_SW_IP_SPI_HOST_TEST_UTILS_SPI_FLASH_EMULATOR_H_
#define OPENTITAN_SW_IP_SPI_HOST_TEST_UTILS_SPI_FLASH_EMULATOR_H_
...
#endif  // OPENTITAN_SW_IP_SPI_HOST_TEST_UTILS_SPI_FLASH_EMULATOR_H_
