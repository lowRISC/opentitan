...
#ifndef OPENTITAN_SW_IP_RSTMGR_DRIVER_RSTMGR_H_
#define OPENTITAN_SW_IP_RSTMGR_DRIVER_RSTMGR_H_
...
/**
 * Peripheral base address for rstmgr_aon.
 *
 * This should be used with #mmio_region_from_addr to access the memory-mapped
 * registers associated with the peripheral (usually via a DIF).
 */
extern const uint32_t kRstmgrAonBaseAddr[1];

#ifdef __cplusplus
}  // extern "C"
#endif  // __cplusplus

#endif  // OPENTITAN_SW_IP_RSTMGR_DRIVER_RSTMGR_H_
