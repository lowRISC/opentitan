...
#ifndef OPENTITAN_SW_IP_USBDEV_DRIVER_USBDEV_H_
#define OPENTITAN_SW_IP_USBDEV_DRIVER_USBDEV_H_
...
/**
 * Peripheral base address for usbdev.
 *
 * This should be used with #mmio_region_from_addr to access the memory-mapped
 * registers associated with the peripheral (usually via a DIF).
 */
extern const uint32_t kUsbdevBaseAddr[1];

#ifdef __cplusplus
}  // extern "C"
#endif  // __cplusplus

#endif  // OPENTITAN_SW_IP_USBDEV_DRIVER_USBDEV_H_
