...
#ifndef OPENTITAN_SW_IP_EDN_DRIVER_EDN_H_
#define OPENTITAN_SW_IP_EDN_DRIVER_EDN_H_
...
/**
 * Peripheral base address for edn in top chip.
 *
 * This should be used with #mmio_region_from_addr to access the memory-mapped
 * registers associated with the peripheral (usually via a DIF).
 */
extern const uint32_t kEdnBaseAddr[2];

#ifdef __cplusplus
}  // extern "C"
#endif  // __cplusplus

#endif  // OPENTITAN_SW_IP_EDN_DRIVER_EDN_H_
