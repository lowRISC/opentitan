...
#ifndef OPENTITAN_SW_IP_DMA_TEST_UTILS_DMA_TESTUTILS_H_
#define OPENTITAN_SW_IP_DMA_TEST_UTILS_DMA_TESTUTILS_H_
...
#endif  // OPENTITAN_SW_IP_DMA_TEST_UTILS_DMA_TESTUTILS_H_
