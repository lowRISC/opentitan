...
void setup_spi_dma_transaction(dif_spi_host_t *spi_host, dif_dma_t *dma,
  ...
  dif_dma_handshake_t handshake_config = {.fifo_auto_increment = false,
                                          .memory_auto_increment = true,
                                          .direction_from_mem_to_fifo = false};
  ...
  CHECK_DIF_OK(dif_dma_handshake_enable(dma, handshake_config));
}
