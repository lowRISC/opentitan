...
#ifndef OPENTITAN_SW_IP_SRAM_CTRL_DRIVER_SRAM_CTRL_H_
#define OPENTITAN_SW_IP_SRAM_CTRL_DRIVER_SRAM_CTRL_H_
...
/**
 * Peripheral base address for regs device on sram_ctrl_main in top chip.
 *
 * This should be used with #mmio_region_from_addr to access the memory-mapped
 * registers associated with the peripheral (usually via a DIF).
 */
extern const uint32_t kSramCtrlMainRegsBaseAddr[1];

#ifdef __cplusplus
}  // extern "C"
#endif  // __cplusplus

#endif  // OPENTITAN_SW_IP_SRAM_CTRL_DRIVER_SRAM_CTRL_H_
