...
#ifndef OPENTITAN_SW_IP_SRAM_CTRL_TEST_UTILS_RET_SRAM_TESTUTILS_H_
#define OPENTITAN_SW_IP_SRAM_CTRL_TEST_UTILS_RET_SRAM_TESTUTILS_H_
 ...
 *
 * All data read must have been initialized, or it will trigger ECC errors.
 */
enum {
  /**
...
#endif  // OPENTITAN_SW_IP_SRAM_CTRL_TEST_UTILS_RET_SRAM_TESTUTILS_H_
