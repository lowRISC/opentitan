...
#ifndef OPENTITAN_SW_IP_OTP_CTRL_DRIVER_OTP_CTRL_H_
#define OPENTITAN_SW_IP_OTP_CTRL_DRIVER_OTP_CTRL_H_
...
/**
 * Peripheral base address for core device on otp_ctrl in top chip.
 *
 * This should be used with #mmio_region_from_addr to access the memory-mapped
 * registers associated with the peripheral (usually via a DIF).
 */
extern const uint32_t kOtpCtrlCoreBaseAddr[1];

#ifdef __cplusplus
}  // extern "C"
#endif  // __cplusplus

#endif  // OPENTITAN_SW_IP_OTP_CTRL_DRIVER_OTP_CTRL_H_
