# Signing Ceremony 2024-05-07

- Purpose: Create new ROM\_EXT binaries for integration testing.
- Participants: cfrantz (leader), ttrippel (witness).

## Ceremony Prolog

Before the ceremony, we double checked build reproducibility.
At opentitan commit ecd6e4794179996ebdbc9c642557f6eaf4949379 on branch
...
a03db45190eadb7a7a0b88687dd9529d272caaae9a5250739ebb9abca79395c2  bazel-out/k8-fastbuild/bin/sw/device/silicon_creator/rom_ext/proda/digests.tar
509df58342f5df122759f9b016c461bc4cdb7fb9db704f743f8065e9eb930454  bazel-out/k8-fastbuild/bin/sw/device/silicon_creator/rom_ext/prodc/digests.tar
8296986d8c07104f0bfc9af8ba3ad4197d9b375b03ca7b9fa66c4345f48b79d4  bazel-out/k8-fastbuild/bin/sw/device/silicon_creator/rom_ext/sival/digests.tar
```
