# Signing Ceremony 2024-04-02

- Purpose: Create new provisioning and ROM\_EXT binaries for integration testing.
- Participants: cfrantz (leader), ttrippel (witness).

## Ceremony Prolog

Before the ceremony, we double checked build reproducibility.
At opentitan commit 39cf48bb91e55740fd0d0b8179ac903e5654d41b on branch
...
67ba09a8d2aaf37003d9bca1fb513125c2feb9053cf295ecf793e976e36fcc37  bazel-out/k8-fastbuild/bin/sw/device/silicon_creator/rom_ext/proda/digests.tar
6d0ece1b16f51396945346680f8d40ad858f63768c4851ccc7e7371230b27a15  bazel-out/k8-fastbuild/bin/sw/device/silicon_creator/rom_ext/prodc/digests.tar
82d6f860aba176ef6ed4af3583abfbfa524fc675cfbdc9e3f8b4c67b64e7c89d  bazel-out/k8-fastbuild/bin/sw/device/silicon_creator/rom_ext/sival/digests.tar
16131ea2825d7d7291d4a88b9e5873809e60e1e2f2c7b7a068fb93578e02b549  bazel-out/k8-fastbuild/bin/sw/device/silicon_creator/manuf/skus/earlgrey_a0/sival_bringup/digests.tar
```
...
A driver re-compile was required because of a Linux kernel firmware update.
...
provisioning/ft_personalize_1_fpga_cw310_rom_with_fake_keys.rsa_sig
provisioning/ft_personalize_1_silicon_creator.rsa_sig
provisioning/ft_personalize_2_fpga_cw310_rom_with_fake_keys.rsa_sig
provisioning/ft_personalize_2_silicon_creator.rsa_sig
provisioning/ft_personalize_3_fpga_cw310_rom_with_fake_keys.rsa_sig
provisioning/ft_personalize_3_silicon_creator.rsa_sig
