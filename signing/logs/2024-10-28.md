...
- Purpose:
    ...
    - Correct the `primary_bl0_slot` defect in ROM_EXT 0.6.
- Participants: cfrantz (leader), moidx(witness), ttrippel (witness).

## Ceremony Prolog

Before the ceremony, we double checked build reproducibility.
At opentitan commit 00684874b82c0505e544a8b9823f8cdf649b03f2 on branch
...
69ee510a4d6782d01f81d9a9c6c10fb5f4fcdad8ca6d733fe56ae58051653122  bazel-out/k8-fastbuild/bin/sw/device/silicon_creator/rom_ext/proda/digests.tar
c65feeaf1171565779fbe8d6e4a7334ed40794ddf6f63c1fe6ce9669d37e16f7  bazel-out/k8-fastbuild/bin/sw/device/silicon_creator/rom_ext/prodc/digests.tar
c844c95581835226280bd74871221d3e8c0f5a95b9067daff877a7faa774c045  bazel-out/k8-fastbuild/bin/sw/device/silicon_creator/rom_ext/sival/digests.tar
```
